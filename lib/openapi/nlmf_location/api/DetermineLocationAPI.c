...
DetermineLocationAPI_determineLocation(apiClient_t *apiClient, input_data_t *input_data)
{
    ...
    // create the path
    char *localVarPath = strdup("/determine-location");
    ...
    location_data_ext_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *DetermineLocationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = location_data_ext_parseFromJSON(DetermineLocationAPIlocalVarJSON);
