...
typedef enum  { lmf_location_access_token_req_GRANTTYPE_NULL = 0, lmf_location_access_token_req_GRANTTYPE_client_credentials } lmf_location_access_token_req_GRANTTYPE_e;
...
typedef struct access_token_req_t {
    lmf_location_access_token_req_GRANTTYPE_e grant_type; //enum
