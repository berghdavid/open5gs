...
mapped_location_qo_s_eps_t* instantiate_mapped_location_qo_s_eps(int include_optional);
...
void test_mapped_location_qo_s_eps(int include_optional) {
    mapped_location_qo_s_eps_t* mapped_location_qo_s_eps_1 = instantiate_mapped_location_qo_s_eps(include_optional);

	cJSON* jsonmapped_location_qo_s_eps_1 = mapped_location_qo_s_eps_convertToJSON(mapped_location_qo_s_eps_1);
	printf("mapped_location_qo_s_eps :\n%s\n", cJSON_Print(jsonmapped_location_qo_s_eps_1));
	mapped_location_qo_s_eps_t* mapped_location_qo_s_eps_2 = mapped_location_qo_s_eps_parseFromJSON(jsonmapped_location_qo_s_eps_1);
	cJSON* jsonmapped_location_qo_s_eps_2 = mapped_location_qo_s_eps_convertToJSON(mapped_location_qo_s_eps_2);
