...
void test_civic_address(int include_optional) {
    civic_address_t* civic_address_1 = instantiate_civic_address(include_optional);

	cJSON* jsoncivic_address_1 = civic_address_convertToJSON(civic_address_1);
	printf("civic_address :\n%s\n", cJSON_Print(jsoncivic_address_1));
	civic_address_t* civic_address_2 = civic_address_parseFromJSON(jsoncivic_address_1);
	cJSON* jsoncivic_address_2 = civic_address_convertToJSON(civic_address_2);
	printf("repeating civic_address:\n%s\n", cJSON_Print(jsoncivic_address_2));
}
