...
void test_horizontal_velocity(int include_optional) {
    horizontal_velocity_t* horizontal_velocity_1 = instantiate_horizontal_velocity(include_optional);

	cJSON* jsonhorizontal_velocity_1 = horizontal_velocity_convertToJSON(horizontal_velocity_1);
	printf("horizontal_velocity :\n%s\n", cJSON_Print(jsonhorizontal_velocity_1));
	horizontal_velocity_t* horizontal_velocity_2 = horizontal_velocity_parseFromJSON(jsonhorizontal_velocity_1);
	cJSON* jsonhorizontal_velocity_2 = horizontal_velocity_convertToJSON(horizontal_velocity_2);
