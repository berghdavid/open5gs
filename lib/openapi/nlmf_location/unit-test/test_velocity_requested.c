...
void test_velocity_requested(int include_optional) {
    velocity_requested_t* velocity_requested_1 = instantiate_velocity_requested(include_optional);

	cJSON* jsonvelocity_requested_1 = velocity_requested_convertToJSON(velocity_requested_1);
	printf("velocity_requested :\n%s\n", cJSON_Print(jsonvelocity_requested_1));
	velocity_requested_t* velocity_requested_2 = velocity_requested_parseFromJSON(jsonvelocity_requested_1);
	cJSON* jsonvelocity_requested_2 = velocity_requested_convertToJSON(velocity_requested_2);
