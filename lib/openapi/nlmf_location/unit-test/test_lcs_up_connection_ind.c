...
void test_lcs_up_connection_ind(int include_optional) {
    lcs_up_connection_ind_t* lcs_up_connection_ind_1 = instantiate_lcs_up_connection_ind(include_optional);

	cJSON* jsonlcs_up_connection_ind_1 = lcs_up_connection_ind_convertToJSON(lcs_up_connection_ind_1);
	printf("lcs_up_connection_ind :\n%s\n", cJSON_Print(jsonlcs_up_connection_ind_1));
	lcs_up_connection_ind_t* lcs_up_connection_ind_2 = lcs_up_connection_ind_parseFromJSON(jsonlcs_up_connection_ind_1);
	cJSON* jsonlcs_up_connection_ind_2 = lcs_up_connection_ind_convertToJSON(lcs_up_connection_ind_2);
