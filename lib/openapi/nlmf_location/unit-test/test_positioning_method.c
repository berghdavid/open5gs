...
void test_positioning_method(int include_optional) {
    positioning_method_t* positioning_method_1 = instantiate_positioning_method(include_optional);

	cJSON* jsonpositioning_method_1 = positioning_method_convertToJSON(positioning_method_1);
	printf("positioning_method :\n%s\n", cJSON_Print(jsonpositioning_method_1));
	positioning_method_t* positioning_method_2 = positioning_method_parseFromJSON(jsonpositioning_method_1);
	cJSON* jsonpositioning_method_2 = positioning_method_convertToJSON(positioning_method_2);
