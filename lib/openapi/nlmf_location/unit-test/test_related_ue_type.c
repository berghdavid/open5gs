...
void test_related_ue_type(int include_optional) {
    related_ue_type_t* related_ue_type_1 = instantiate_related_ue_type(include_optional);

	cJSON* jsonrelated_ue_type_1 = related_ue_type_convertToJSON(related_ue_type_1);
	printf("related_ue_type :\n%s\n", cJSON_Print(jsonrelated_ue_type_1));
	related_ue_type_t* related_ue_type_2 = related_ue_type_parseFromJSON(jsonrelated_ue_type_1);
	cJSON* jsonrelated_ue_type_2 = related_ue_type_convertToJSON(related_ue_type_2);
