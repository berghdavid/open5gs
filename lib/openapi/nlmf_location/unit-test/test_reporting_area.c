...
#include "test_reporting_area_type.c"
#include "test_tai.c"
#include "test_ecgi.c"
#include "test_ncgi.c"
...
void test_reporting_area(int include_optional) {
    reporting_area_t* reporting_area_1 = instantiate_reporting_area(include_optional);

	cJSON* jsonreporting_area_1 = reporting_area_convertToJSON(reporting_area_1);
	printf("reporting_area :\n%s\n", cJSON_Print(jsonreporting_area_1));
	reporting_area_t* reporting_area_2 = reporting_area_parseFromJSON(jsonreporting_area_1);
	cJSON* jsonreporting_area_2 = reporting_area_convertToJSON(reporting_area_2);
