...
void test_ue_location_info(int include_optional) {
    ue_location_info_t* ue_location_info_1 = instantiate_ue_location_info(include_optional);

	cJSON* jsonue_location_info_1 = ue_location_info_convertToJSON(ue_location_info_1);
	printf("ue_location_info :\n%s\n", cJSON_Print(jsonue_location_info_1));
	ue_location_info_t* ue_location_info_2 = ue_location_info_parseFromJSON(jsonue_location_info_1);
	cJSON* jsonue_location_info_2 = ue_location_info_convertToJSON(ue_location_info_2);
