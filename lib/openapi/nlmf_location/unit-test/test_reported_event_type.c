...
void test_reported_event_type(int include_optional) {
    reported_event_type_t* reported_event_type_1 = instantiate_reported_event_type(include_optional);

	cJSON* jsonreported_event_type_1 = reported_event_type_convertToJSON(reported_event_type_1);
	printf("reported_event_type :\n%s\n", cJSON_Print(jsonreported_event_type_1));
	reported_event_type_t* reported_event_type_2 = reported_event_type_parseFromJSON(jsonreported_event_type_1);
	cJSON* jsonreported_event_type_2 = reported_event_type_convertToJSON(reported_event_type_2);
