...
void test_ranging_sl_result(int include_optional) {
    ranging_sl_result_t* ranging_sl_result_1 = instantiate_ranging_sl_result(include_optional);

	cJSON* jsonranging_sl_result_1 = ranging_sl_result_convertToJSON(ranging_sl_result_1);
	printf("ranging_sl_result :\n%s\n", cJSON_Print(jsonranging_sl_result_1));
	ranging_sl_result_t* ranging_sl_result_2 = ranging_sl_result_parseFromJSON(jsonranging_sl_result_1);
	cJSON* jsonranging_sl_result_2 = ranging_sl_result_convertToJSON(ranging_sl_result_2);
