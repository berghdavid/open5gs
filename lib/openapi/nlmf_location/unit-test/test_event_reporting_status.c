...
event_reporting_status_t* instantiate_event_reporting_status(int include_optional);
...
void test_event_reporting_status(int include_optional) {
    event_reporting_status_t* event_reporting_status_1 = instantiate_event_reporting_status(include_optional);

	cJSON* jsonevent_reporting_status_1 = event_reporting_status_convertToJSON(event_reporting_status_1);
	printf("event_reporting_status :\n%s\n", cJSON_Print(jsonevent_reporting_status_1));
	event_reporting_status_t* event_reporting_status_2 = event_reporting_status_parseFromJSON(jsonevent_reporting_status_1);
	cJSON* jsonevent_reporting_status_2 = event_reporting_status_convertToJSON(event_reporting_status_2);
