...
model_3_d_relative_location_t* instantiate_model_3_d_relative_location(int include_optional);
...
model_3_d_relative_location_t* instantiate_model_3_d_relative_location(int include_optional) {
  ...
  if (include_optional) {
    model_3_d_relative_location = model_3_d_relative_location_create(
      0,
      0,
      0,
      0
...
void test_model_3_d_relative_location(int include_optional) {
    model_3_d_relative_location_t* model_3_d_relative_location_1 = instantiate_model_3_d_relative_location(include_optional);

	cJSON* jsonmodel_3_d_relative_location_1 = model_3_d_relative_location_convertToJSON(model_3_d_relative_location_1);
	printf("model_3_d_relative_location :\n%s\n", cJSON_Print(jsonmodel_3_d_relative_location_1));
	model_3_d_relative_location_t* model_3_d_relative_location_2 = model_3_d_relative_location_parseFromJSON(jsonmodel_3_d_relative_location_1);
	cJSON* jsonmodel_3_d_relative_location_2 = model_3_d_relative_location_convertToJSON(model_3_d_relative_location_2);
