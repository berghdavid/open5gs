...
positioning_method_and_usage_t* instantiate_positioning_method_and_usage(int include_optional);
...
positioning_method_and_usage_t* instantiate_positioning_method_and_usage(int include_optional) {
  ...
  if (include_optional) {
    positioning_method_and_usage = positioning_method_and_usage_create(
      null,
      null,
      null,
      16
...
void test_positioning_method_and_usage(int include_optional) {
    positioning_method_and_usage_t* positioning_method_and_usage_1 = instantiate_positioning_method_and_usage(include_optional);

	cJSON* jsonpositioning_method_and_usage_1 = positioning_method_and_usage_convertToJSON(positioning_method_and_usage_1);
	printf("positioning_method_and_usage :\n%s\n", cJSON_Print(jsonpositioning_method_and_usage_1));
	positioning_method_and_usage_t* positioning_method_and_usage_2 = positioning_method_and_usage_parseFromJSON(jsonpositioning_method_and_usage_1);
	cJSON* jsonpositioning_method_and_usage_2 = positioning_method_and_usage_convertToJSON(positioning_method_and_usage_2);
