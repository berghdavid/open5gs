...
void test_supported_gad_shapes(int include_optional) {
    supported_gad_shapes_t* supported_gad_shapes_1 = instantiate_supported_gad_shapes(include_optional);

	cJSON* jsonsupported_gad_shapes_1 = supported_gad_shapes_convertToJSON(supported_gad_shapes_1);
	printf("supported_gad_shapes :\n%s\n", cJSON_Print(jsonsupported_gad_shapes_1));
	supported_gad_shapes_t* supported_gad_shapes_2 = supported_gad_shapes_parseFromJSON(jsonsupported_gad_shapes_1);
	cJSON* jsonsupported_gad_shapes_2 = supported_gad_shapes_convertToJSON(supported_gad_shapes_2);
