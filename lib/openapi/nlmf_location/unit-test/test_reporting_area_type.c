...
void test_reporting_area_type(int include_optional) {
    reporting_area_type_t* reporting_area_type_1 = instantiate_reporting_area_type(include_optional);

	cJSON* jsonreporting_area_type_1 = reporting_area_type_convertToJSON(reporting_area_type_1);
	printf("reporting_area_type :\n%s\n", cJSON_Print(jsonreporting_area_type_1));
	reporting_area_type_t* reporting_area_type_2 = reporting_area_type_parseFromJSON(jsonreporting_area_type_1);
	cJSON* jsonreporting_area_type_2 = reporting_area_type_convertToJSON(reporting_area_type_2);
