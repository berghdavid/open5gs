...
void test_occurrence_info(int include_optional) {
    occurrence_info_t* occurrence_info_1 = instantiate_occurrence_info(include_optional);

	cJSON* jsonoccurrence_info_1 = occurrence_info_convertToJSON(occurrence_info_1);
	printf("occurrence_info :\n%s\n", cJSON_Print(jsonoccurrence_info_1));
	occurrence_info_t* occurrence_info_2 = occurrence_info_parseFromJSON(jsonoccurrence_info_1);
	cJSON* jsonoccurrence_info_2 = occurrence_info_convertToJSON(occurrence_info_2);
