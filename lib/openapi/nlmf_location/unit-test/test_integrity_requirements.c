...
integrity_requirements_t* instantiate_integrity_requirements(int include_optional);
...
void test_integrity_requirements(int include_optional) {
    integrity_requirements_t* integrity_requirements_1 = instantiate_integrity_requirements(include_optional);

	cJSON* jsonintegrity_requirements_1 = integrity_requirements_convertToJSON(integrity_requirements_1);
	printf("integrity_requirements :\n%s\n", cJSON_Print(jsonintegrity_requirements_1));
	integrity_requirements_t* integrity_requirements_2 = integrity_requirements_parseFromJSON(jsonintegrity_requirements_1);
	cJSON* jsonintegrity_requirements_2 = integrity_requirements_convertToJSON(integrity_requirements_2);
