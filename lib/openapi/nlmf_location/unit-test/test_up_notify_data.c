...
void test_up_notify_data(int include_optional) {
    up_notify_data_t* up_notify_data_1 = instantiate_up_notify_data(include_optional);

	cJSON* jsonup_notify_data_1 = up_notify_data_convertToJSON(up_notify_data_1);
	printf("up_notify_data :\n%s\n", cJSON_Print(jsonup_notify_data_1));
	up_notify_data_t* up_notify_data_2 = up_notify_data_parseFromJSON(jsonup_notify_data_1);
	cJSON* jsonup_notify_data_2 = up_notify_data_convertToJSON(up_notify_data_2);
