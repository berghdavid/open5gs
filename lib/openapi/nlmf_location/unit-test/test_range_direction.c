...
void test_range_direction(int include_optional) {
    range_direction_t* range_direction_1 = instantiate_range_direction(include_optional);

	cJSON* jsonrange_direction_1 = range_direction_convertToJSON(range_direction_1);
	printf("range_direction :\n%s\n", cJSON_Print(jsonrange_direction_1));
	range_direction_t* range_direction_2 = range_direction_parseFromJSON(jsonrange_direction_1);
	cJSON* jsonrange_direction_2 = range_direction_convertToJSON(range_direction_2);
