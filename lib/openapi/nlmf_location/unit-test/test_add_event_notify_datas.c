...
add_event_notify_datas_t* instantiate_add_event_notify_datas(int include_optional);
...
void test_add_event_notify_datas(int include_optional) {
    add_event_notify_datas_t* add_event_notify_datas_1 = instantiate_add_event_notify_datas(include_optional);

	cJSON* jsonadd_event_notify_datas_1 = add_event_notify_datas_convertToJSON(add_event_notify_datas_1);
	printf("add_event_notify_datas :\n%s\n", cJSON_Print(jsonadd_event_notify_datas_1));
	add_event_notify_datas_t* add_event_notify_datas_2 = add_event_notify_datas_parseFromJSON(jsonadd_event_notify_datas_1);
	cJSON* jsonadd_event_notify_datas_2 = add_event_notify_datas_convertToJSON(add_event_notify_datas_2);
