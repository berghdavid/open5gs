...
void test_loc_measurements(int include_optional) {
    loc_measurements_t* loc_measurements_1 = instantiate_loc_measurements(include_optional);

	cJSON* jsonloc_measurements_1 = loc_measurements_convertToJSON(loc_measurements_1);
	printf("loc_measurements :\n%s\n", cJSON_Print(jsonloc_measurements_1));
	loc_measurements_t* loc_measurements_2 = loc_measurements_parseFromJSON(jsonloc_measurements_1);
	cJSON* jsonloc_measurements_2 = loc_measurements_convertToJSON(loc_measurements_2);
