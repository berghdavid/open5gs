...
void test_event_report_message(int include_optional) {
    event_report_message_t* event_report_message_1 = instantiate_event_report_message(include_optional);

	cJSON* jsonevent_report_message_1 = event_report_message_convertToJSON(event_report_message_1);
	printf("event_report_message :\n%s\n", cJSON_Print(jsonevent_report_message_1));
	event_report_message_t* event_report_message_2 = event_report_message_parseFromJSON(jsonevent_report_message_1);
	cJSON* jsonevent_report_message_2 = event_report_message_convertToJSON(event_report_message_2);
