...
void test_cancel_loc_data(int include_optional) {
    cancel_loc_data_t* cancel_loc_data_1 = instantiate_cancel_loc_data(include_optional);

	cJSON* jsoncancel_loc_data_1 = cancel_loc_data_convertToJSON(cancel_loc_data_1);
	printf("cancel_loc_data :\n%s\n", cJSON_Print(jsoncancel_loc_data_1));
	cancel_loc_data_t* cancel_loc_data_2 = cancel_loc_data_parseFromJSON(jsoncancel_loc_data_1);
	cJSON* jsoncancel_loc_data_2 = cancel_loc_data_convertToJSON(cancel_loc_data_2);
