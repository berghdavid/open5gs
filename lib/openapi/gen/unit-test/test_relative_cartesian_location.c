...
relative_cartesian_location_t* instantiate_relative_cartesian_location(int include_optional);
...
relative_cartesian_location_t* instantiate_relative_cartesian_location(int include_optional) {
  ...
  if (include_optional) {
    relative_cartesian_location = relative_cartesian_location_create(
      1.337,
      1.337,
      1.337
    );
...
void test_relative_cartesian_location(int include_optional) {
    relative_cartesian_location_t* relative_cartesian_location_1 = instantiate_relative_cartesian_location(include_optional);

	cJSON* jsonrelative_cartesian_location_1 = relative_cartesian_location_convertToJSON(relative_cartesian_location_1);
	printf("relative_cartesian_location :\n%s\n", cJSON_Print(jsonrelative_cartesian_location_1));
	relative_cartesian_location_t* relative_cartesian_location_2 = relative_cartesian_location_parseFromJSON(jsonrelative_cartesian_location_1);
	cJSON* jsonrelative_cartesian_location_2 = relative_cartesian_location_convertToJSON(relative_cartesian_location_2);
