...
ue_up_positioning_capabilities_t* instantiate_ue_up_positioning_capabilities(int include_optional);
...
ue_up_positioning_capabilities_t* instantiate_ue_up_positioning_capabilities(int include_optional) {
  ...
  if (include_optional) {
    ue_up_positioning_capabilities = ue_up_positioning_capabilities_create(
    );
  } else {
    ue_up_positioning_capabilities = ue_up_positioning_capabilities_create(
    );
...
void test_ue_up_positioning_capabilities(int include_optional) {
    ue_up_positioning_capabilities_t* ue_up_positioning_capabilities_1 = instantiate_ue_up_positioning_capabilities(include_optional);

	cJSON* jsonue_up_positioning_capabilities_1 = ue_up_positioning_capabilities_convertToJSON(ue_up_positioning_capabilities_1);
	printf("ue_up_positioning_capabilities :\n%s\n", cJSON_Print(jsonue_up_positioning_capabilities_1));
	ue_up_positioning_capabilities_t* ue_up_positioning_capabilities_2 = ue_up_positioning_capabilities_parseFromJSON(jsonue_up_positioning_capabilities_1);
	cJSON* jsonue_up_positioning_capabilities_2 = ue_up_positioning_capabilities_convertToJSON(ue_up_positioning_capabilities_2);
