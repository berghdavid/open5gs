...
void test_area_event_info(int include_optional) {
    area_event_info_t* area_event_info_1 = instantiate_area_event_info(include_optional);

	cJSON* jsonarea_event_info_1 = area_event_info_convertToJSON(area_event_info_1);
	printf("area_event_info :\n%s\n", cJSON_Print(jsonarea_event_info_1));
	area_event_info_t* area_event_info_2 = area_event_info_parseFromJSON(jsonarea_event_info_1);
	cJSON* jsonarea_event_info_2 = area_event_info_convertToJSON(area_event_info_2);
