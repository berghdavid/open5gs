...
#include "test_occurrence_info.c"
...
void test_motion_event_info(int include_optional) {
    motion_event_info_t* motion_event_info_1 = instantiate_motion_event_info(include_optional);

	cJSON* jsonmotion_event_info_1 = motion_event_info_convertToJSON(motion_event_info_1);
	printf("motion_event_info :\n%s\n", cJSON_Print(jsonmotion_event_info_1));
	motion_event_info_t* motion_event_info_2 = motion_event_info_parseFromJSON(jsonmotion_event_info_1);
	cJSON* jsonmotion_event_info_2 = motion_event_info_convertToJSON(motion_event_info_2);
