...
void test_location_data(int include_optional) {
    location_data_t* location_data_1 = instantiate_location_data(include_optional);

	cJSON* jsonlocation_data_1 = location_data_convertToJSON(location_data_1);
	printf("location_data :\n%s\n", cJSON_Print(jsonlocation_data_1));
	location_data_t* location_data_2 = location_data_parseFromJSON(jsonlocation_data_1);
	cJSON* jsonlocation_data_2 = location_data_convertToJSON(location_data_2);
	printf("repeating location_data:\n%s\n", cJSON_Print(jsonlocation_data_2));
}
