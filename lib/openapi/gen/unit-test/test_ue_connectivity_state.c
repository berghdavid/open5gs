...
void test_ue_connectivity_state(int include_optional) {
    ue_connectivity_state_t* ue_connectivity_state_1 = instantiate_ue_connectivity_state(include_optional);

	cJSON* jsonue_connectivity_state_1 = ue_connectivity_state_convertToJSON(ue_connectivity_state_1);
	printf("ue_connectivity_state :\n%s\n", cJSON_Print(jsonue_connectivity_state_1));
	ue_connectivity_state_t* ue_connectivity_state_2 = ue_connectivity_state_parseFromJSON(jsonue_connectivity_state_1);
	cJSON* jsonue_connectivity_state_2 = ue_connectivity_state_convertToJSON(ue_connectivity_state_2);
