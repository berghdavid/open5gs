...
void test_external_client_type(int include_optional) {
    external_client_type_t* external_client_type_1 = instantiate_external_client_type(include_optional);

	cJSON* jsonexternal_client_type_1 = external_client_type_convertToJSON(external_client_type_1);
	printf("external_client_type :\n%s\n", cJSON_Print(jsonexternal_client_type_1));
	external_client_type_t* external_client_type_2 = external_client_type_parseFromJSON(jsonexternal_client_type_1);
	cJSON* jsonexternal_client_type_2 = external_client_type_convertToJSON(external_client_type_2);
