...
void test_up_connection_status(int include_optional) {
    up_connection_status_t* up_connection_status_1 = instantiate_up_connection_status(include_optional);

	cJSON* jsonup_connection_status_1 = up_connection_status_convertToJSON(up_connection_status_1);
	printf("up_connection_status :\n%s\n", cJSON_Print(jsonup_connection_status_1));
	up_connection_status_t* up_connection_status_2 = up_connection_status_parseFromJSON(jsonup_connection_status_1);
	cJSON* jsonup_connection_status_2 = up_connection_status_convertToJSON(up_connection_status_2);
