...
void test_ellipsoid_arc(int include_optional) {
    ellipsoid_arc_t* ellipsoid_arc_1 = instantiate_ellipsoid_arc(include_optional);

	cJSON* jsonellipsoid_arc_1 = ellipsoid_arc_convertToJSON(ellipsoid_arc_1);
	printf("ellipsoid_arc :\n%s\n", cJSON_Print(jsonellipsoid_arc_1));
	ellipsoid_arc_t* ellipsoid_arc_2 = ellipsoid_arc_parseFromJSON(jsonellipsoid_arc_1);
	cJSON* jsonellipsoid_arc_2 = ellipsoid_arc_convertToJSON(ellipsoid_arc_2);
	printf("repeating ellipsoid_arc:\n%s\n", cJSON_Print(jsonellipsoid_arc_2));
}
