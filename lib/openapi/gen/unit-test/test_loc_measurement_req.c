...
#include "test_time_windows_nrppa.c"
...
loc_measurement_req_t* instantiate_loc_measurement_req(int include_optional) {
  ...
  if (include_optional) {
    loc_measurement_req = loc_measurement_req_create(
      ...
      list_createList(),
       // false, not to have infinite recursion
      instantiate_time_windows_nrppa(0),
      null,
      list_createList()
    );
  } else {
...
void test_loc_measurement_req(int include_optional) {
    loc_measurement_req_t* loc_measurement_req_1 = instantiate_loc_measurement_req(include_optional);

	cJSON* jsonloc_measurement_req_1 = loc_measurement_req_convertToJSON(loc_measurement_req_1);
	printf("loc_measurement_req :\n%s\n", cJSON_Print(jsonloc_measurement_req_1));
	loc_measurement_req_t* loc_measurement_req_2 = loc_measurement_req_parseFromJSON(jsonloc_measurement_req_1);
	cJSON* jsonloc_measurement_req_2 = loc_measurement_req_convertToJSON(loc_measurement_req_2);
