...
void test_additional_ue_info(int include_optional) {
    additional_ue_info_t* additional_ue_info_1 = instantiate_additional_ue_info(include_optional);

	cJSON* jsonadditional_ue_info_1 = additional_ue_info_convertToJSON(additional_ue_info_1);
	printf("additional_ue_info :\n%s\n", cJSON_Print(jsonadditional_ue_info_1));
	additional_ue_info_t* additional_ue_info_2 = additional_ue_info_parseFromJSON(jsonadditional_ue_info_1);
	cJSON* jsonadditional_ue_info_2 = additional_ue_info_convertToJSON(additional_ue_info_2);
