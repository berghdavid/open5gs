...
up_cum_evt_rpt_criteria_t* instantiate_up_cum_evt_rpt_criteria(int include_optional);
...
void test_up_cum_evt_rpt_criteria(int include_optional) {
    up_cum_evt_rpt_criteria_t* up_cum_evt_rpt_criteria_1 = instantiate_up_cum_evt_rpt_criteria(include_optional);

	cJSON* jsonup_cum_evt_rpt_criteria_1 = up_cum_evt_rpt_criteria_convertToJSON(up_cum_evt_rpt_criteria_1);
	printf("up_cum_evt_rpt_criteria :\n%s\n", cJSON_Print(jsonup_cum_evt_rpt_criteria_1));
	up_cum_evt_rpt_criteria_t* up_cum_evt_rpt_criteria_2 = up_cum_evt_rpt_criteria_parseFromJSON(jsonup_cum_evt_rpt_criteria_1);
	cJSON* jsonup_cum_evt_rpt_criteria_2 = up_cum_evt_rpt_criteria_convertToJSON(up_cum_evt_rpt_criteria_2);
