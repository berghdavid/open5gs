...
void test_ue_lcs_capability(int include_optional) {
    ue_lcs_capability_t* ue_lcs_capability_1 = instantiate_ue_lcs_capability(include_optional);

	cJSON* jsonue_lcs_capability_1 = ue_lcs_capability_convertToJSON(ue_lcs_capability_1);
	printf("ue_lcs_capability :\n%s\n", cJSON_Print(jsonue_lcs_capability_1));
	ue_lcs_capability_t* ue_lcs_capability_2 = ue_lcs_capability_parseFromJSON(jsonue_lcs_capability_1);
	cJSON* jsonue_lcs_capability_2 = ue_lcs_capability_convertToJSON(ue_lcs_capability_2);
