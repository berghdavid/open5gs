...
high_accuracy_gnss_metrics_t* instantiate_high_accuracy_gnss_metrics(int include_optional);

#include "test_fix_type.c"
...
void test_high_accuracy_gnss_metrics(int include_optional) {
    high_accuracy_gnss_metrics_t* high_accuracy_gnss_metrics_1 = instantiate_high_accuracy_gnss_metrics(include_optional);

	cJSON* jsonhigh_accuracy_gnss_metrics_1 = high_accuracy_gnss_metrics_convertToJSON(high_accuracy_gnss_metrics_1);
	printf("high_accuracy_gnss_metrics :\n%s\n", cJSON_Print(jsonhigh_accuracy_gnss_metrics_1));
	high_accuracy_gnss_metrics_t* high_accuracy_gnss_metrics_2 = high_accuracy_gnss_metrics_parseFromJSON(jsonhigh_accuracy_gnss_metrics_1);
	cJSON* jsonhigh_accuracy_gnss_metrics_2 = high_accuracy_gnss_metrics_convertToJSON(high_accuracy_gnss_metrics_2);
