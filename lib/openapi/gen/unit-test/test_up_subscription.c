...
void test_up_subscription(int include_optional) {
    up_subscription_t* up_subscription_1 = instantiate_up_subscription(include_optional);

	cJSON* jsonup_subscription_1 = up_subscription_convertToJSON(up_subscription_1);
	printf("up_subscription :\n%s\n", cJSON_Print(jsonup_subscription_1));
	up_subscription_t* up_subscription_2 = up_subscription_parseFromJSON(jsonup_subscription_1);
	cJSON* jsonup_subscription_2 = up_subscription_convertToJSON(up_subscription_2);
