...
void test_indoor_outdoor_ind(int include_optional) {
    indoor_outdoor_ind_t* indoor_outdoor_ind_1 = instantiate_indoor_outdoor_ind(include_optional);

	cJSON* jsonindoor_outdoor_ind_1 = indoor_outdoor_ind_convertToJSON(indoor_outdoor_ind_1);
	printf("indoor_outdoor_ind :\n%s\n", cJSON_Print(jsonindoor_outdoor_ind_1));
	indoor_outdoor_ind_t* indoor_outdoor_ind_2 = indoor_outdoor_ind_parseFromJSON(jsonindoor_outdoor_ind_1);
	cJSON* jsonindoor_outdoor_ind_2 = indoor_outdoor_ind_convertToJSON(indoor_outdoor_ind_2);
