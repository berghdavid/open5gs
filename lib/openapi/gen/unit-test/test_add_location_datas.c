...
void test_add_location_datas(int include_optional) {
    add_location_datas_t* add_location_datas_1 = instantiate_add_location_datas(include_optional);

	cJSON* jsonadd_location_datas_1 = add_location_datas_convertToJSON(add_location_datas_1);
	printf("add_location_datas :\n%s\n", cJSON_Print(jsonadd_location_datas_1));
	add_location_datas_t* add_location_datas_2 = add_location_datas_parseFromJSON(jsonadd_location_datas_1);
	cJSON* jsonadd_location_datas_2 = add_location_datas_convertToJSON(add_location_datas_2);
