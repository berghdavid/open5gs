...
void test_no_profile_match_info(int include_optional) {
    no_profile_match_info_t* no_profile_match_info_1 = instantiate_no_profile_match_info(include_optional);

	cJSON* jsonno_profile_match_info_1 = no_profile_match_info_convertToJSON(no_profile_match_info_1);
	printf("no_profile_match_info :\n%s\n", cJSON_Print(jsonno_profile_match_info_1));
	no_profile_match_info_t* no_profile_match_info_2 = no_profile_match_info_parseFromJSON(jsonno_profile_match_info_1);
	cJSON* jsonno_profile_match_info_2 = no_profile_match_info_convertToJSON(no_profile_match_info_2);
