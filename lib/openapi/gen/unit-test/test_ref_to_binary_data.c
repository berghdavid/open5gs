...
void test_ref_to_binary_data(int include_optional) {
    ref_to_binary_data_t* ref_to_binary_data_1 = instantiate_ref_to_binary_data(include_optional);

	cJSON* jsonref_to_binary_data_1 = ref_to_binary_data_convertToJSON(ref_to_binary_data_1);
	printf("ref_to_binary_data :\n%s\n", cJSON_Print(jsonref_to_binary_data_1));
	ref_to_binary_data_t* ref_to_binary_data_2 = ref_to_binary_data_parseFromJSON(jsonref_to_binary_data_1);
	cJSON* jsonref_to_binary_data_2 = ref_to_binary_data_convertToJSON(ref_to_binary_data_2);
