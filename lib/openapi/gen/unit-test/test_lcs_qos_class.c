...
void test_lcs_qos_class(int include_optional) {
    lcs_qos_class_t* lcs_qos_class_1 = instantiate_lcs_qos_class(include_optional);

	cJSON* jsonlcs_qos_class_1 = lcs_qos_class_convertToJSON(lcs_qos_class_1);
	printf("lcs_qos_class :\n%s\n", cJSON_Print(jsonlcs_qos_class_1));
	lcs_qos_class_t* lcs_qos_class_2 = lcs_qos_class_parseFromJSON(jsonlcs_qos_class_1);
	cJSON* jsonlcs_qos_class_2 = lcs_qos_class_convertToJSON(lcs_qos_class_2);
	printf("repeating lcs_qos_class:\n%s\n", cJSON_Print(jsonlcs_qos_class_2));
}
