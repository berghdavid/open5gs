...
void test_reporting_access_type(int include_optional) {
    reporting_access_type_t* reporting_access_type_1 = instantiate_reporting_access_type(include_optional);

	cJSON* jsonreporting_access_type_1 = reporting_access_type_convertToJSON(reporting_access_type_1);
	printf("reporting_access_type :\n%s\n", cJSON_Print(jsonreporting_access_type_1));
	reporting_access_type_t* reporting_access_type_2 = reporting_access_type_parseFromJSON(jsonreporting_access_type_1);
	cJSON* jsonreporting_access_type_2 = reporting_access_type_convertToJSON(reporting_access_type_2);
