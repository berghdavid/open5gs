...
void test_point_altitude(int include_optional) {
    point_altitude_t* point_altitude_1 = instantiate_point_altitude(include_optional);

	cJSON* jsonpoint_altitude_1 = point_altitude_convertToJSON(point_altitude_1);
	printf("point_altitude :\n%s\n", cJSON_Print(jsonpoint_altitude_1));
	point_altitude_t* point_altitude_2 = point_altitude_parseFromJSON(jsonpoint_altitude_1);
	cJSON* jsonpoint_altitude_2 = point_altitude_convertToJSON(point_altitude_2);
