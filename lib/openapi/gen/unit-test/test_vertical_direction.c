...
void test_vertical_direction(int include_optional) {
    vertical_direction_t* vertical_direction_1 = instantiate_vertical_direction(include_optional);

	cJSON* jsonvertical_direction_1 = vertical_direction_convertToJSON(vertical_direction_1);
	printf("vertical_direction :\n%s\n", cJSON_Print(jsonvertical_direction_1));
	vertical_direction_t* vertical_direction_2 = vertical_direction_parseFromJSON(jsonvertical_direction_1);
	cJSON* jsonvertical_direction_2 = vertical_direction_convertToJSON(vertical_direction_2);
