...
void test_event_notify_data_ext(int include_optional) {
    event_notify_data_ext_t* event_notify_data_ext_1 = instantiate_event_notify_data_ext(include_optional);

	cJSON* jsonevent_notify_data_ext_1 = event_notify_data_ext_convertToJSON(event_notify_data_ext_1);
	printf("event_notify_data_ext :\n%s\n", cJSON_Print(jsonevent_notify_data_ext_1));
	event_notify_data_ext_t* event_notify_data_ext_2 = event_notify_data_ext_parseFromJSON(jsonevent_notify_data_ext_1);
	cJSON* jsonevent_notify_data_ext_2 = event_notify_data_ext_convertToJSON(event_notify_data_ext_2);
