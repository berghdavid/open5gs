...
void test_cipher_request_data(int include_optional) {
    cipher_request_data_t* cipher_request_data_1 = instantiate_cipher_request_data(include_optional);

	cJSON* jsoncipher_request_data_1 = cipher_request_data_convertToJSON(cipher_request_data_1);
	printf("cipher_request_data :\n%s\n", cJSON_Print(jsoncipher_request_data_1));
	cipher_request_data_t* cipher_request_data_2 = cipher_request_data_parseFromJSON(jsoncipher_request_data_1);
	cJSON* jsoncipher_request_data_2 = cipher_request_data_convertToJSON(cipher_request_data_2);
