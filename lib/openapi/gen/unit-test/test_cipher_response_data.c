...
void test_cipher_response_data(int include_optional) {
    cipher_response_data_t* cipher_response_data_1 = instantiate_cipher_response_data(include_optional);

	cJSON* jsoncipher_response_data_1 = cipher_response_data_convertToJSON(cipher_response_data_1);
	printf("cipher_response_data :\n%s\n", cJSON_Print(jsoncipher_response_data_1));
	cipher_response_data_t* cipher_response_data_2 = cipher_response_data_parseFromJSON(jsoncipher_response_data_1);
	cJSON* jsoncipher_response_data_2 = cipher_response_data_convertToJSON(cipher_response_data_2);
