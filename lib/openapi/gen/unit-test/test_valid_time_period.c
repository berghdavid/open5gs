...
void test_valid_time_period(int include_optional) {
    valid_time_period_t* valid_time_period_1 = instantiate_valid_time_period(include_optional);

	cJSON* jsonvalid_time_period_1 = valid_time_period_convertToJSON(valid_time_period_1);
	printf("valid_time_period :\n%s\n", cJSON_Print(jsonvalid_time_period_1));
	valid_time_period_t* valid_time_period_2 = valid_time_period_parseFromJSON(jsonvalid_time_period_1);
	cJSON* jsonvalid_time_period_2 = valid_time_period_convertToJSON(valid_time_period_2);
