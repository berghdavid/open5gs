...
void test_termination_cause(int include_optional) {
    termination_cause_t* termination_cause_1 = instantiate_termination_cause(include_optional);

	cJSON* jsontermination_cause_1 = termination_cause_convertToJSON(termination_cause_1);
	printf("termination_cause :\n%s\n", cJSON_Print(jsontermination_cause_1));
	termination_cause_t* termination_cause_2 = termination_cause_parseFromJSON(jsontermination_cause_1);
	cJSON* jsontermination_cause_2 = termination_cause_convertToJSON(termination_cause_2);
