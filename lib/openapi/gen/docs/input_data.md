...
------------ | ------------- | ------------- | -------------
**external_client_type** | [**external_client_type_t**](external_client_type.md) \* |  | [optional] 
**correlation_id** | **char \*** | LCS Correlation ID. | [optional] 
**amf_id** | **char \*** | String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4.   | [optional] 
...
**priority** | [**lcs_priority_t**](lcs_priority.md) \* |  | [optional] 
**velocity_requested** | [**velocity_requested_t**](velocity_requested.md) \* |  | [optional] 
**ue_lcs_cap** | [**ue_lcs_capability_t**](ue_lcs_capability.md) \* |  | [optional] 
**lcs_service_type** | **int** | LCS service type. | [optional] 
**ldr_type** | [**ldr_type_t**](ldr_type.md) \* |  | [optional] 
...
**ue_location_service_ind** | [**ue_location_service_ind_t**](ue_location_service_ind.md) \* |  | [optional] 
...
**reporting_ind** | [**reporting_ind_t**](reporting_ind.md) \* |  | [optional] 
**mbsr_info** | [**mbsr_info_t**](mbsr_info.md) \* |  | [optional] 
**mwab_support_ind** | **int** |  | [optional] 
**integrity_requirements** | [**integrity_requirements_t**](integrity_requirements.md) \* |  | [optional] 
**up_loc_rep_addr_af** | [**up_loc_rep_addr_af_t**](up_loc_rep_addr_af.md) \* |  | [optional] 
...
**sl_positioning_capabilities** | [**list_t**](sl_positioning_capability.md) \* |  | [optional] 
