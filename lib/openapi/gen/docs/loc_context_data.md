...
------------ | ------------- | ------------- | -------------
**amf_id** | **char \*** | String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4.   | 
...
**add_loc_context_list** | [**list_t**](add_location_context.md) \* |  | [optional] 
**ldr_type** | [**ldr_type_t**](ldr_type.md) \* |  | 
...
**indoor_outdoor_ind** | [**indoor_outdoor_ind_t**](indoor_outdoor_ind.md) \* |  | [optional] 
**los_nlos_measure_ind** | [**los_nlos_measure_ind_t**](los_nlos_measure_ind.md) \* |  | [optional] 
**up_cum_evt_rpt_criteria** | [**up_cum_evt_rpt_criteria_t**](up_cum_evt_rpt_criteria.md) \* |  | [optional] 
**lcs_upp_exist_ind** | **int** |  | [optional] 
**src_lmf_routing_info** | **char \*** | LMF identification. | [optional] 
**extended_facility_ind** | **int** |  | [optional] 
