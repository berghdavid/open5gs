...
cJSON *OpenAPI_area_event_info_convertToJSON(OpenAPI_area_event_info_t *area_event_info)
{
    ...
    OpenAPI_lnode_t *area_definition_node;
    if (area_event_info->area_definition) {
        OpenAPI_list_for_each(area_event_info->area_definition, area_definition_node) {
            cJSON *itemLocal = OpenAPI_reporting_area_convertToJSON(area_definition_node->data);
            if (itemLocal == NULL) {
                ogs_error("OpenAPI_area_event_info_convertToJSON() failed [area_definition]");
                goto end;
            }
...
OpenAPI_area_event_info_t *OpenAPI_area_event_info_parseFromJSON(cJSON *area_event_infoJSON)
{
    ...
    OpenAPI_list_t *area_definitionList;
    cJSON *area_definition_local_nonprimitive;
    ...
    cJSON_ArrayForEach(area_definition_local_nonprimitive, area_definition ) {
        ...
        OpenAPI_reporting_area_t *area_definitionItem = OpenAPI_reporting_area_parseFromJSON(area_definition_local_nonprimitive);
