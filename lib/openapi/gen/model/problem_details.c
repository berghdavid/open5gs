...
cJSON *OpenAPI_problem_details_convertToJSON(OpenAPI_problem_details_t *problem_details)
{
    ...
    OpenAPI_lnode_t *supported_api_versions_node;
    OpenAPI_list_for_each(problem_details->supported_api_versions, supported_api_versions_node)  {
    if (cJSON_AddStringToObject(supported_api_versions, "", (char*)supported_api_versions_node->data) == NULL) {
        ogs_error("OpenAPI_problem_details_convertToJSON() failed [supported_api_versions]");
        goto end;
    }
                    }
...
OpenAPI_problem_details_t *OpenAPI_problem_details_parseFromJSON(cJSON *problem_detailsJSON)
{
    ...
    OpenAPI_list_t *supported_api_versionsList;
    if (supported_api_versions) {
    cJSON *supported_api_versions_local;
