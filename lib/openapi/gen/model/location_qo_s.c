...
cJSON *OpenAPI_location_qo_s_convertToJSON(OpenAPI_location_qo_s_t *location_qo_s)
{
    ...
    OpenAPI_lnode_t *minor_loc_qoses_node;
    if (location_qo_s->minor_loc_qoses) {
        OpenAPI_list_for_each(location_qo_s->minor_loc_qoses, minor_loc_qoses_node) {
            cJSON *itemLocal = OpenAPI_minor_location_qo_s_convertToJSON(minor_loc_qoses_node->data);
            if (itemLocal == NULL) {
                ogs_error("OpenAPI_location_qo_s_convertToJSON() failed [minor_loc_qoses]");
                goto end;
            }
...
OpenAPI_location_qo_s_t *OpenAPI_location_qo_s_parseFromJSON(cJSON *location_qo_sJSON)
{
    ...
    OpenAPI_list_t *minor_loc_qosesList;
    if (minor_loc_qoses) {
    cJSON *minor_loc_qoses_local_nonprimitive;
    ...
    cJSON_ArrayForEach(minor_loc_qoses_local_nonprimitive, minor_loc_qoses ) {
        ...
        OpenAPI_minor_location_qo_s_t *minor_loc_qosesItem = OpenAPI_minor_location_qo_s_parseFromJSON(minor_loc_qoses_local_nonprimitive);
