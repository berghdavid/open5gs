...
cJSON *OpenAPI_query_param_combination_convertToJSON(OpenAPI_query_param_combination_t *query_param_combination)
{
    ...
    OpenAPI_lnode_t *query_params_node;
    if (query_param_combination->query_params) {
        OpenAPI_list_for_each(query_param_combination->query_params, query_params_node) {
            cJSON *itemLocal = OpenAPI_query_parameter_convertToJSON(query_params_node->data);
            if (itemLocal == NULL) {
                ogs_error("OpenAPI_query_param_combination_convertToJSON() failed [query_params]");
                goto end;
            }
...
OpenAPI_query_param_combination_t *OpenAPI_query_param_combination_parseFromJSON(cJSON *query_param_combinationJSON)
{
    ...
    OpenAPI_list_t *query_paramsList;
    cJSON *query_params_local_nonprimitive;
    ...
    cJSON_ArrayForEach(query_params_local_nonprimitive, query_params ) {
        ...
        OpenAPI_query_parameter_t *query_paramsItem = OpenAPI_query_parameter_parseFromJSON(query_params_local_nonprimitive);
