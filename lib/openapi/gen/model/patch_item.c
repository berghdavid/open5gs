...
void OpenAPI_patch_item_free(OpenAPI_patch_item_t *patch_item)
{
    ...
    OpenAPI_patch_operation_free(patch_item->op);
...
cJSON *OpenAPI_patch_item_convertToJSON(OpenAPI_patch_item_t *patch_item)
{
    ...
    cJSON *op_local_JSON = OpenAPI_patch_operation_convertToJSON(patch_item->op);
...
OpenAPI_patch_item_t *OpenAPI_patch_item_parseFromJSON(cJSON *patch_itemJSON)
{
    ...
    OpenAPI_patch_operation_t *op_local_nonprim = NULL;
    op_local_nonprim = OpenAPI_patch_operation_parseFromJSON(op);
