...
## Documentation for Models
 ...
 - [add_location_context_t](docs/add_location_context.md)
 ...
 - [determine_location_request_t](docs/determine_location_request.md)
 - [ecgi_t](docs/ecgi.md)
 ...
 - [sl_positioning_capability_t](docs/sl_positioning_capability.md)
 - [snssai_t](docs/snssai.md)
 - [supported_gad_shapes_t](docs/supported_gad_shapes.md)
 - [tai_t](docs/tai.md)
 - [termination_cause_t](docs/termination_cause.md)
 - [time_windows_nrppa_t](docs/time_windows_nrppa.md)
 - [tnap_id_t](docs/tnap_id.md)
 - [trp_parameter_t](docs/trp_parameter.md)
 ...
 - [up_loc_rep_addr_af_t](docs/up_loc_rep_addr_af.md)
