...
point_uncertainty_circle_t* instantiate_point_uncertainty_circle(int include_optional);
...
void test_point_uncertainty_circle(int include_optional) {
    point_uncertainty_circle_t* point_uncertainty_circle_1 = instantiate_point_uncertainty_circle(include_optional);

	cJSON* jsonpoint_uncertainty_circle_1 = point_uncertainty_circle_convertToJSON(point_uncertainty_circle_1);
	printf("point_uncertainty_circle :\n%s\n", cJSON_Print(jsonpoint_uncertainty_circle_1));
	point_uncertainty_circle_t* point_uncertainty_circle_2 = point_uncertainty_circle_parseFromJSON(jsonpoint_uncertainty_circle_1);
	cJSON* jsonpoint_uncertainty_circle_2 = point_uncertainty_circle_convertToJSON(point_uncertainty_circle_2);
