...
geographical_coordinates_t* instantiate_geographical_coordinates(int include_optional);
...
void test_geographical_coordinates(int include_optional) {
    geographical_coordinates_t* geographical_coordinates_1 = instantiate_geographical_coordinates(include_optional);

	cJSON* jsongeographical_coordinates_1 = geographical_coordinates_convertToJSON(geographical_coordinates_1);
	printf("geographical_coordinates :\n%s\n", cJSON_Print(jsongeographical_coordinates_1));
	geographical_coordinates_t* geographical_coordinates_2 = geographical_coordinates_parseFromJSON(jsongeographical_coordinates_1);
	cJSON* jsongeographical_coordinates_2 = geographical_coordinates_convertToJSON(geographical_coordinates_2);
