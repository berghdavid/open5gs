...
accuracy_fulfilment_indicator_t* instantiate_accuracy_fulfilment_indicator(int include_optional);
...
accuracy_fulfilment_indicator_t* instantiate_accuracy_fulfilment_indicator(int include_optional) {
  ...
  if (include_optional) {
    accuracy_fulfilment_indicator = accuracy_fulfilment_indicator_create(
    );
  } else {
    accuracy_fulfilment_indicator = accuracy_fulfilment_indicator_create(
    );
...
void test_accuracy_fulfilment_indicator(int include_optional) {
    accuracy_fulfilment_indicator_t* accuracy_fulfilment_indicator_1 = instantiate_accuracy_fulfilment_indicator(include_optional);

	cJSON* jsonaccuracy_fulfilment_indicator_1 = accuracy_fulfilment_indicator_convertToJSON(accuracy_fulfilment_indicator_1);
	printf("accuracy_fulfilment_indicator :\n%s\n", cJSON_Print(jsonaccuracy_fulfilment_indicator_1));
	accuracy_fulfilment_indicator_t* accuracy_fulfilment_indicator_2 = accuracy_fulfilment_indicator_parseFromJSON(jsonaccuracy_fulfilment_indicator_1);
	cJSON* jsonaccuracy_fulfilment_indicator_2 = accuracy_fulfilment_indicator_convertToJSON(accuracy_fulfilment_indicator_2);
