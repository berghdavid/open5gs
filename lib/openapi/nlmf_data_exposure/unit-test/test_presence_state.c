...
void test_presence_state(int include_optional) {
    presence_state_t* presence_state_1 = instantiate_presence_state(include_optional);

	cJSON* jsonpresence_state_1 = presence_state_convertToJSON(presence_state_1);
	printf("presence_state :\n%s\n", cJSON_Print(jsonpresence_state_1));
	presence_state_t* presence_state_2 = presence_state_parseFromJSON(jsonpresence_state_1);
	cJSON* jsonpresence_state_2 = presence_state_convertToJSON(presence_state_2);
