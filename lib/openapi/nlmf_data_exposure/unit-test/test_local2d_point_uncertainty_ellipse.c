...
local2d_point_uncertainty_ellipse_t* instantiate_local2d_point_uncertainty_ellipse(int include_optional);
...
local2d_point_uncertainty_ellipse_t* instantiate_local2d_point_uncertainty_ellipse(int include_optional) {
  local2d_point_uncertainty_ellipse_t* local2d_point_uncertainty_ellipse = NULL;
  if (include_optional) {
    local2d_point_uncertainty_ellipse = local2d_point_uncertainty_ellipse_create(
      null,
...
void test_local2d_point_uncertainty_ellipse(int include_optional) {
    local2d_point_uncertainty_ellipse_t* local2d_point_uncertainty_ellipse_1 = instantiate_local2d_point_uncertainty_ellipse(include_optional);

	cJSON* jsonlocal2d_point_uncertainty_ellipse_1 = local2d_point_uncertainty_ellipse_convertToJSON(local2d_point_uncertainty_ellipse_1);
	printf("local2d_point_uncertainty_ellipse :\n%s\n", cJSON_Print(jsonlocal2d_point_uncertainty_ellipse_1));
	local2d_point_uncertainty_ellipse_t* local2d_point_uncertainty_ellipse_2 = local2d_point_uncertainty_ellipse_parseFromJSON(jsonlocal2d_point_uncertainty_ellipse_1);
	cJSON* jsonlocal2d_point_uncertainty_ellipse_2 = local2d_point_uncertainty_ellipse_convertToJSON(local2d_point_uncertainty_ellipse_2);
	printf("repeating local2d_point_uncertainty_ellipse:\n%s\n", cJSON_Print(jsonlocal2d_point_uncertainty_ellipse_2));
}
