...
void test_positioning_mode(int include_optional) {
    positioning_mode_t* positioning_mode_1 = instantiate_positioning_mode(include_optional);

	cJSON* jsonpositioning_mode_1 = positioning_mode_convertToJSON(positioning_mode_1);
	printf("positioning_mode :\n%s\n", cJSON_Print(jsonpositioning_mode_1));
	positioning_mode_t* positioning_mode_2 = positioning_mode_parseFromJSON(jsonpositioning_mode_1);
	cJSON* jsonpositioning_mode_2 = positioning_mode_convertToJSON(positioning_mode_2);
