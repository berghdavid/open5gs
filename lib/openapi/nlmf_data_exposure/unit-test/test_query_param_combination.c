...
query_param_combination_t* instantiate_query_param_combination(int include_optional);
...
void test_query_param_combination(int include_optional) {
    query_param_combination_t* query_param_combination_1 = instantiate_query_param_combination(include_optional);

	cJSON* jsonquery_param_combination_1 = query_param_combination_convertToJSON(query_param_combination_1);
	printf("query_param_combination :\n%s\n", cJSON_Print(jsonquery_param_combination_1));
	query_param_combination_t* query_param_combination_2 = query_param_combination_parseFromJSON(jsonquery_param_combination_1);
	cJSON* jsonquery_param_combination_2 = query_param_combination_convertToJSON(query_param_combination_2);
