...
no_profile_match_reason_t* instantiate_no_profile_match_reason(int include_optional);
...
void test_no_profile_match_reason(int include_optional) {
    no_profile_match_reason_t* no_profile_match_reason_1 = instantiate_no_profile_match_reason(include_optional);

	cJSON* jsonno_profile_match_reason_1 = no_profile_match_reason_convertToJSON(no_profile_match_reason_1);
	printf("no_profile_match_reason :\n%s\n", cJSON_Print(jsonno_profile_match_reason_1));
	no_profile_match_reason_t* no_profile_match_reason_2 = no_profile_match_reason_parseFromJSON(jsonno_profile_match_reason_1);
	cJSON* jsonno_profile_match_reason_2 = no_profile_match_reason_convertToJSON(no_profile_match_reason_2);
