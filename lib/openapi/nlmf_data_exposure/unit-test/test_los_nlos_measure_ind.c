...
void test_los_nlos_measure_ind(int include_optional) {
    los_nlos_measure_ind_t* los_nlos_measure_ind_1 = instantiate_los_nlos_measure_ind(include_optional);

	cJSON* jsonlos_nlos_measure_ind_1 = los_nlos_measure_ind_convertToJSON(los_nlos_measure_ind_1);
	printf("los_nlos_measure_ind :\n%s\n", cJSON_Print(jsonlos_nlos_measure_ind_1));
	los_nlos_measure_ind_t* los_nlos_measure_ind_2 = los_nlos_measure_ind_parseFromJSON(jsonlos_nlos_measure_ind_1);
	cJSON* jsonlos_nlos_measure_ind_2 = los_nlos_measure_ind_convertToJSON(los_nlos_measure_ind_2);
