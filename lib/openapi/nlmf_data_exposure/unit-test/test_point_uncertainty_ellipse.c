...
point_uncertainty_ellipse_t* instantiate_point_uncertainty_ellipse(int include_optional);
...
void test_point_uncertainty_ellipse(int include_optional) {
    point_uncertainty_ellipse_t* point_uncertainty_ellipse_1 = instantiate_point_uncertainty_ellipse(include_optional);

	cJSON* jsonpoint_uncertainty_ellipse_1 = point_uncertainty_ellipse_convertToJSON(point_uncertainty_ellipse_1);
	printf("point_uncertainty_ellipse :\n%s\n", cJSON_Print(jsonpoint_uncertainty_ellipse_1));
	point_uncertainty_ellipse_t* point_uncertainty_ellipse_2 = point_uncertainty_ellipse_parseFromJSON(jsonpoint_uncertainty_ellipse_1);
	cJSON* jsonpoint_uncertainty_ellipse_2 = point_uncertainty_ellipse_convertToJSON(point_uncertainty_ellipse_2);
