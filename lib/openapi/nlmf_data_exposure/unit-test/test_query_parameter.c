...
void test_query_parameter(int include_optional) {
    query_parameter_t* query_parameter_1 = instantiate_query_parameter(include_optional);

	cJSON* jsonquery_parameter_1 = query_parameter_convertToJSON(query_parameter_1);
	printf("query_parameter :\n%s\n", cJSON_Print(jsonquery_parameter_1));
	query_parameter_t* query_parameter_2 = query_parameter_parseFromJSON(jsonquery_parameter_1);
	cJSON* jsonquery_parameter_2 = query_parameter_convertToJSON(query_parameter_2);
