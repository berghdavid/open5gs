...
void test_response_time(int include_optional) {
    response_time_t* response_time_1 = instantiate_response_time(include_optional);

	cJSON* jsonresponse_time_1 = response_time_convertToJSON(response_time_1);
	printf("response_time :\n%s\n", cJSON_Print(jsonresponse_time_1));
	response_time_t* response_time_2 = response_time_parseFromJSON(jsonresponse_time_1);
	cJSON* jsonresponse_time_2 = response_time_convertToJSON(response_time_2);
	printf("repeating response_time:\n%s\n", cJSON_Print(jsonresponse_time_2));
}
