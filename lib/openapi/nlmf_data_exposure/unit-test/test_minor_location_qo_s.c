...
void test_minor_location_qo_s(int include_optional) {
    minor_location_qo_s_t* minor_location_qo_s_1 = instantiate_minor_location_qo_s(include_optional);

	cJSON* jsonminor_location_qo_s_1 = minor_location_qo_s_convertToJSON(minor_location_qo_s_1);
	printf("minor_location_qo_s :\n%s\n", cJSON_Print(jsonminor_location_qo_s_1));
	minor_location_qo_s_t* minor_location_qo_s_2 = minor_location_qo_s_parseFromJSON(jsonminor_location_qo_s_1);
	cJSON* jsonminor_location_qo_s_2 = minor_location_qo_s_convertToJSON(minor_location_qo_s_2);
