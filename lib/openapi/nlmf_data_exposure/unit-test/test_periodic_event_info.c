...
void test_periodic_event_info(int include_optional) {
    periodic_event_info_t* periodic_event_info_1 = instantiate_periodic_event_info(include_optional);

	cJSON* jsonperiodic_event_info_1 = periodic_event_info_convertToJSON(periodic_event_info_1);
	printf("periodic_event_info :\n%s\n", cJSON_Print(jsonperiodic_event_info_1));
	periodic_event_info_t* periodic_event_info_2 = periodic_event_info_parseFromJSON(jsonperiodic_event_info_1);
	cJSON* jsonperiodic_event_info_2 = periodic_event_info_convertToJSON(periodic_event_info_2);
