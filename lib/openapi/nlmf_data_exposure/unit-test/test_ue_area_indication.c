...
void test_ue_area_indication(int include_optional) {
    ue_area_indication_t* ue_area_indication_1 = instantiate_ue_area_indication(include_optional);

	cJSON* jsonue_area_indication_1 = ue_area_indication_convertToJSON(ue_area_indication_1);
	printf("ue_area_indication :\n%s\n", cJSON_Print(jsonue_area_indication_1));
	ue_area_indication_t* ue_area_indication_2 = ue_area_indication_parseFromJSON(jsonue_area_indication_1);
	cJSON* jsonue_area_indication_2 = ue_area_indication_convertToJSON(ue_area_indication_2);
