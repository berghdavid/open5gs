...
model_2_d_relative_location_t* instantiate_model_2_d_relative_location(int include_optional);
...
model_2_d_relative_location_t* instantiate_model_2_d_relative_location(int include_optional) {
  ...
  if (include_optional) {
    model_2_d_relative_location = model_2_d_relative_location_create(
      0,
      0,
      0
    );
...
void test_model_2_d_relative_location(int include_optional) {
    model_2_d_relative_location_t* model_2_d_relative_location_1 = instantiate_model_2_d_relative_location(include_optional);

	cJSON* jsonmodel_2_d_relative_location_1 = model_2_d_relative_location_convertToJSON(model_2_d_relative_location_1);
	printf("model_2_d_relative_location :\n%s\n", cJSON_Print(jsonmodel_2_d_relative_location_1));
	model_2_d_relative_location_t* model_2_d_relative_location_2 = model_2_d_relative_location_parseFromJSON(jsonmodel_2_d_relative_location_1);
	cJSON* jsonmodel_2_d_relative_location_2 = model_2_d_relative_location_convertToJSON(model_2_d_relative_location_2);
