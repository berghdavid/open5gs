...
void test_global_ran_node_id(int include_optional) {
    global_ran_node_id_t* global_ran_node_id_1 = instantiate_global_ran_node_id(include_optional);

	cJSON* jsonglobal_ran_node_id_1 = global_ran_node_id_convertToJSON(global_ran_node_id_1);
	printf("global_ran_node_id :\n%s\n", cJSON_Print(jsonglobal_ran_node_id_1));
	global_ran_node_id_t* global_ran_node_id_2 = global_ran_node_id_parseFromJSON(jsonglobal_ran_node_id_1);
	cJSON* jsonglobal_ran_node_id_2 = global_ran_node_id_convertToJSON(global_ran_node_id_2);
