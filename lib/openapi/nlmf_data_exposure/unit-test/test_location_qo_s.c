...
#include "test_response_time.c"
#include "test_lcs_qos_class.c"
...
void test_location_qo_s(int include_optional) {
    location_qo_s_t* location_qo_s_1 = instantiate_location_qo_s(include_optional);

	cJSON* jsonlocation_qo_s_1 = location_qo_s_convertToJSON(location_qo_s_1);
	printf("location_qo_s :\n%s\n", cJSON_Print(jsonlocation_qo_s_1));
	location_qo_s_t* location_qo_s_2 = location_qo_s_parseFromJSON(jsonlocation_qo_s_1);
	cJSON* jsonlocation_qo_s_2 = location_qo_s_convertToJSON(location_qo_s_2);
	printf("repeating location_qo_s:\n%s\n", cJSON_Print(jsonlocation_qo_s_2));
}
