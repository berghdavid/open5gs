...
void test_uncertainty_ellipse(int include_optional) {
    uncertainty_ellipse_t* uncertainty_ellipse_1 = instantiate_uncertainty_ellipse(include_optional);

	cJSON* jsonuncertainty_ellipse_1 = uncertainty_ellipse_convertToJSON(uncertainty_ellipse_1);
	printf("uncertainty_ellipse :\n%s\n", cJSON_Print(jsonuncertainty_ellipse_1));
	uncertainty_ellipse_t* uncertainty_ellipse_2 = uncertainty_ellipse_parseFromJSON(jsonuncertainty_ellipse_1);
	cJSON* jsonuncertainty_ellipse_2 = uncertainty_ellipse_convertToJSON(uncertainty_ellipse_2);
