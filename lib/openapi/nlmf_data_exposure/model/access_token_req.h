...
typedef enum  { nlmf_dataexposure_access_token_req_GRANTTYPE_NULL = 0, nlmf_dataexposure_access_token_req_GRANTTYPE_client_credentials } nlmf_dataexposure_access_token_req_GRANTTYPE_e;
...
typedef struct access_token_req_t {
    nlmf_dataexposure_access_token_req_GRANTTYPE_e grant_type; //enum
