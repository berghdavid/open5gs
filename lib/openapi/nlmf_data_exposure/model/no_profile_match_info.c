...
static no_profile_match_info_t *no_profile_match_info_create_internal(
    ...
    memset(no_profile_match_info_local_var, 0, sizeof(no_profile_match_info_t));
    no_profile_match_info_local_var->_library_owned = 1;
...
__attribute__((deprecated)) no_profile_match_info_t *no_profile_match_info_create(
    ...
    no_profile_match_info_t *result = no_profile_match_info_create_internal (
        reason,
...
void no_profile_match_info_free(no_profile_match_info_t *no_profile_match_info) {
    ...
    if(no_profile_match_info->_library_owned != 1){
...
cJSON *no_profile_match_info_convertToJSON(no_profile_match_info_t *no_profile_match_info) {
    ...
    cJSON *reason_local_JSON = no_profile_match_reason_convertToJSON(no_profile_match_info->reason);
...
no_profile_match_info_t *no_profile_match_info_parseFromJSON(cJSON *no_profile_match_infoJSON){
    ...
    reason_local_nonprim = no_profile_match_reason_parseFromJSON(reason); //nonprimitive

    // no_profile_match_info->query_param_combination_list
    cJSON *query_param_combination_list = cJSON_GetObjectItemCaseSensitive(no_profile_match_infoJSON, "queryParamCombinationList");
    if (cJSON_IsNull(query_param_combination_list)) {
        query_param_combination_list = NULL;
    }
    ...
    no_profile_match_info_local_var = no_profile_match_info_create_internal (
