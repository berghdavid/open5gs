...
------------ | ------------- | ------------- | -------------
**grant_type** | **nlmf_dataexposure_access_token_req_GRANTTYPE_e** |  | 
**nf_instance_id** | **char \*** | String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4.   | 
**nf_type** | [**nf_type_t**](nf_type.md) \* |  | [optional] 
**target_nf_type** | [**nf_type_t**](nf_type.md) \* |  | [optional] 
**scope** | **char \*** |  | 
**target_nf_instance_id** | **char \*** | String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4.   | [optional] 
...
**source_nf_instance_id** | **char \*** | String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4.   | [optional] 
**vendor_id** | **char \*** | Vendor ID of the NF Service instance (Private Enterprise Number assigned by IANA) | [optional] 
**analytics_ids** | [**list_t**](nwdaf_event.md) \* |  | [optional] 
**requester_inter_ind_list** | [**list_t**](ml_model_inter_ind.md) \* |  | [optional] 
**source_vendor_id** | **char \*** | Vendor ID of the NF Service instance (Private Enterprise Number assigned by IANA) | [optional] 
**af_id** | **char \*** |  | [optional] 
