...
static query_param_combination_t *query_param_combination_create_internal(
    list_t *query_params
    ) {
    ...
    memset(query_param_combination_local_var, 0, sizeof(query_param_combination_t));
    query_param_combination_local_var->_library_owned = 1;
    query_param_combination_local_var->query_params = query_params;
    return query_param_combination_local_var;
}

__attribute__((deprecated)) query_param_combination_t *query_param_combination_create(
    list_t *query_params
    ) {
    query_param_combination_t *result = query_param_combination_create_internal (
        query_params
        );
    if (!result) {
    }
...
void query_param_combination_free(query_param_combination_t *query_param_combination) {
    ...
    if(query_param_combination->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "query_param_combination_free");
        return ;
    }
...
query_param_combination_t *query_param_combination_parseFromJSON(cJSON *query_param_combinationJSON){
    ...
    query_param_combination_local_var = query_param_combination_create_internal (
        query_paramsList
        );
