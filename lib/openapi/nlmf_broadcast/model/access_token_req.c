...
char* access_token_req_grant_type_ToString(lmf_broadcast_access_token_req_GRANTTYPE_e grant_type) {
    char* grant_typeArray[] =  { "NULL", "client_credentials" };
    return grant_typeArray[grant_type];
}

lmf_broadcast_access_token_req_GRANTTYPE_e access_token_req_grant_type_FromString(char* grant_type){
...
static access_token_req_t *access_token_req_create_internal(
    lmf_broadcast_access_token_req_GRANTTYPE_e grant_type,
    char *nf_instance_id,
    nf_type_t *nf_type,
...
cJSON *access_token_req_convertToJSON(access_token_req_t *access_token_req) {
    ...
    if (lmf_broadcast_access_token_req_GRANTTYPE_NULL == access_token_req->grant_type) {
        goto fail;
    }
...
access_token_req_t *access_token_req_parseFromJSON(cJSON *access_token_reqJSON){
    ...
    lmf_broadcast_access_token_req_GRANTTYPE_e grant_typeVariable;
