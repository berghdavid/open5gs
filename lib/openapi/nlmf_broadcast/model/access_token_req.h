...
typedef enum  { lmf_broadcast_access_token_req_GRANTTYPE_NULL = 0, lmf_broadcast_access_token_req_GRANTTYPE_client_credentials } lmf_broadcast_access_token_req_GRANTTYPE_e;
...
typedef struct access_token_req_t {
    lmf_broadcast_access_token_req_GRANTTYPE_e grant_type; //enum
