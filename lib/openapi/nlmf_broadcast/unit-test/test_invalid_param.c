...
void test_invalid_param(int include_optional) {
    invalid_param_t* invalid_param_1 = instantiate_invalid_param(include_optional);

	cJSON* jsoninvalid_param_1 = invalid_param_convertToJSON(invalid_param_1);
	printf("invalid_param :\n%s\n", cJSON_Print(jsoninvalid_param_1));
	invalid_param_t* invalid_param_2 = invalid_param_parseFromJSON(jsoninvalid_param_1);
	cJSON* jsoninvalid_param_2 = invalid_param_convertToJSON(invalid_param_2);
	printf("repeating invalid_param:\n%s\n", cJSON_Print(jsoninvalid_param_2));
}
