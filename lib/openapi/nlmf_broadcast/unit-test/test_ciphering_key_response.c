...
ciphering_key_response_t* instantiate_ciphering_key_response(int include_optional);
...
void test_ciphering_key_response(int include_optional) {
    ciphering_key_response_t* ciphering_key_response_1 = instantiate_ciphering_key_response(include_optional);

	cJSON* jsonciphering_key_response_1 = ciphering_key_response_convertToJSON(ciphering_key_response_1);
	printf("ciphering_key_response :\n%s\n", cJSON_Print(jsonciphering_key_response_1));
	ciphering_key_response_t* ciphering_key_response_2 = ciphering_key_response_parseFromJSON(jsonciphering_key_response_1);
	cJSON* jsonciphering_key_response_2 = ciphering_key_response_convertToJSON(ciphering_key_response_2);
