...
void test_data_availability(int include_optional) {
    data_availability_t* data_availability_1 = instantiate_data_availability(include_optional);

	cJSON* jsondata_availability_1 = data_availability_convertToJSON(data_availability_1);
	printf("data_availability :\n%s\n", cJSON_Print(jsondata_availability_1));
	data_availability_t* data_availability_2 = data_availability_parseFromJSON(jsondata_availability_1);
	cJSON* jsondata_availability_2 = data_availability_convertToJSON(data_availability_2);
