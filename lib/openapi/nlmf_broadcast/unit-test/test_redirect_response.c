...
void test_redirect_response(int include_optional) {
    redirect_response_t* redirect_response_1 = instantiate_redirect_response(include_optional);

	cJSON* jsonredirect_response_1 = redirect_response_convertToJSON(redirect_response_1);
	printf("redirect_response :\n%s\n", cJSON_Print(jsonredirect_response_1));
	redirect_response_t* redirect_response_2 = redirect_response_parseFromJSON(jsonredirect_response_1);
	cJSON* jsonredirect_response_2 = redirect_response_convertToJSON(redirect_response_2);
