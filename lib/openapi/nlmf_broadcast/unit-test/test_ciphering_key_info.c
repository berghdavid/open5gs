...
void test_ciphering_key_info(int include_optional) {
    ciphering_key_info_t* ciphering_key_info_1 = instantiate_ciphering_key_info(include_optional);

	cJSON* jsonciphering_key_info_1 = ciphering_key_info_convertToJSON(ciphering_key_info_1);
	printf("ciphering_key_info :\n%s\n", cJSON_Print(jsonciphering_key_info_1));
	ciphering_key_info_t* ciphering_key_info_2 = ciphering_key_info_parseFromJSON(jsonciphering_key_info_1);
	cJSON* jsonciphering_key_info_2 = ciphering_key_info_convertToJSON(ciphering_key_info_2);
