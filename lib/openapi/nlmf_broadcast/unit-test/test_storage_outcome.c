...
void test_storage_outcome(int include_optional) {
    storage_outcome_t* storage_outcome_1 = instantiate_storage_outcome(include_optional);

	cJSON* jsonstorage_outcome_1 = storage_outcome_convertToJSON(storage_outcome_1);
	printf("storage_outcome :\n%s\n", cJSON_Print(jsonstorage_outcome_1));
	storage_outcome_t* storage_outcome_2 = storage_outcome_parseFromJSON(jsonstorage_outcome_1);
	cJSON* jsonstorage_outcome_2 = storage_outcome_convertToJSON(storage_outcome_2);
