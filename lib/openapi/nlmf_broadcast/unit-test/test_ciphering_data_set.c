...
void test_ciphering_data_set(int include_optional) {
    ciphering_data_set_t* ciphering_data_set_1 = instantiate_ciphering_data_set(include_optional);

	cJSON* jsonciphering_data_set_1 = ciphering_data_set_convertToJSON(ciphering_data_set_1);
	printf("ciphering_data_set :\n%s\n", cJSON_Print(jsonciphering_data_set_1));
	ciphering_data_set_t* ciphering_data_set_2 = ciphering_data_set_parseFromJSON(jsonciphering_data_set_1);
	cJSON* jsonciphering_data_set_2 = ciphering_data_set_convertToJSON(ciphering_data_set_2);
