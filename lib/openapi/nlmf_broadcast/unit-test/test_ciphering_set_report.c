...
void test_ciphering_set_report(int include_optional) {
    ciphering_set_report_t* ciphering_set_report_1 = instantiate_ciphering_set_report(include_optional);

	cJSON* jsonciphering_set_report_1 = ciphering_set_report_convertToJSON(ciphering_set_report_1);
	printf("ciphering_set_report :\n%s\n", cJSON_Print(jsonciphering_set_report_1));
	ciphering_set_report_t* ciphering_set_report_2 = ciphering_set_report_parseFromJSON(jsonciphering_set_report_1);
	cJSON* jsonciphering_set_report_2 = ciphering_set_report_convertToJSON(ciphering_set_report_2);
