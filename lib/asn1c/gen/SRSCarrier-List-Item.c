...
asn_TYPE_member_t asn_MBR_SRSCarrier_List_Item_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct SRSCarrier_List_Item, uplinkChannelBW_PerSCS_List),
	...
	{ ATF_POINTER, 0, offsetof(struct SRSCarrier_List_Item, activeULBWP),
	...
	{ ATF_POINTER, 1, offsetof(struct SRSCarrier_List_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_126P126,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
