...
static int asn_validate_RxTxTimingErrorMargin_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_RxTxTimingErrorMargin value = *(e_RxTxTimingErrorMargin*)sptr;
    switch(value) {
    case RxTxTimingErrorMargin_tc0dot5:
    case RxTxTimingErrorMargin_tc1:
    case RxTxTimingErrorMargin_tc2:
    case RxTxTimingErrorMargin_tc4:
    case RxTxTimingErrorMargin_tc8:
    case RxTxTimingErrorMargin_tc12:
    case RxTxTimingErrorMargin_tc16:
    case RxTxTimingErrorMargin_tc20:
    case RxTxTimingErrorMargin_tc24:
    case RxTxTimingErrorMargin_tc32:
    case RxTxTimingErrorMargin_tc40:
    case RxTxTimingErrorMargin_tc48:
    case RxTxTimingErrorMargin_tc64:
    case RxTxTimingErrorMargin_tc80:
    case RxTxTimingErrorMargin_tc96:
    case RxTxTimingErrorMargin_tc128:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_RxTxTimingErrorMargin = {
		...
		/sizeof(asn_DEF_RxTxTimingErrorMargin_tags_1[0]), /* 1 */
	{
		...
		asn_validate_RxTxTimingErrorMargin_1
	},
