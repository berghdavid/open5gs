...
extern asn_TYPE_descriptor_t asn_DEF_periodicity __attribute__((weak, alias("asn_DEF_periodicity_2")));
#else
static asn_TYPE_descriptor_t asn_DEF_periodicity_2;
static asn_TYPE_descriptor_t asn_DEF_periodicity;
__attribute__((constructor)) static void asn_DEF_periodicity_2_alias_init(void) {
	asn_DEF_periodicity = asn_DEF_periodicity_2;
}
#endif
...
static int asn_validate_periodicity_2(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ResourceTypeSemi_persistent__periodicity value = *(e_ResourceTypeSemi_persistent__periodicity*)sptr;
    switch(value) {
    case ResourceTypeSemi_persistent__periodicity_slot1:
    case ResourceTypeSemi_persistent__periodicity_slot2:
    case ResourceTypeSemi_persistent__periodicity_slot4:
    case ResourceTypeSemi_persistent__periodicity_slot5:
    case ResourceTypeSemi_persistent__periodicity_slot8:
    case ResourceTypeSemi_persistent__periodicity_slot10:
    case ResourceTypeSemi_persistent__periodicity_slot16:
    case ResourceTypeSemi_persistent__periodicity_slot20:
    case ResourceTypeSemi_persistent__periodicity_slot32:
    case ResourceTypeSemi_persistent__periodicity_slot40:
    case ResourceTypeSemi_persistent__periodicity_slot64:
    case ResourceTypeSemi_persistent__periodicity_slot80:
    case ResourceTypeSemi_persistent__periodicity_slot160:
    case ResourceTypeSemi_persistent__periodicity_slot320:
    case ResourceTypeSemi_persistent__periodicity_slot640:
    case ResourceTypeSemi_persistent__periodicity_slot1280:
    case ResourceTypeSemi_persistent__periodicity_slot2560:
        return 0;
    }
    return -1;
}
...
asn_TYPE_member_t asn_MBR_ResourceTypeSemi_persistent_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct ResourceTypeSemi_persistent, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_126P94,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
