...
extern asn_TYPE_descriptor_t asn_DEF_encrypted __attribute__((weak, alias("asn_DEF_encrypted_2")));
#else
static asn_TYPE_descriptor_t asn_DEF_encrypted_2;
static asn_TYPE_descriptor_t asn_DEF_encrypted;
__attribute__((constructor)) static void asn_DEF_encrypted_2_alias_init(void) {
	asn_DEF_encrypted = asn_DEF_encrypted_2;
}
#endif
...
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_gNSSID __attribute__((weak, alias("asn_DEF_gNSSID_5")));
#else
static asn_TYPE_descriptor_t asn_DEF_gNSSID_5;
static asn_TYPE_descriptor_t asn_DEF_gNSSID;
__attribute__((constructor)) static void asn_DEF_gNSSID_5_alias_init(void) {
	asn_DEF_gNSSID = asn_DEF_gNSSID_5;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
/*
...
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_sBASID __attribute__((weak, alias("asn_DEF_sBASID_14")));
#else
static asn_TYPE_descriptor_t asn_DEF_sBASID_14;
static asn_TYPE_descriptor_t asn_DEF_sBASID;
__attribute__((constructor)) static void asn_DEF_sBASID_14_alias_init(void) {
	asn_DEF_sBASID = asn_DEF_sBASID_14;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
/*
...
static int asn_validate_encrypted_2(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_AssistanceInformationMetaData__encrypted value = *(e_AssistanceInformationMetaData__encrypted*)sptr;
    switch(value) {
    case AssistanceInformationMetaData__encrypted_true:
        return 0;
    }
    return -1;
}
...
static int asn_validate_gNSSID_5(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_AssistanceInformationMetaData__gNSSID value = *(e_AssistanceInformationMetaData__gNSSID*)sptr;
    switch(value) {
    case AssistanceInformationMetaData__gNSSID_gps:
    case AssistanceInformationMetaData__gNSSID_sbas:
    case AssistanceInformationMetaData__gNSSID_qzss:
    case AssistanceInformationMetaData__gNSSID_galileo:
    case AssistanceInformationMetaData__gNSSID_glonass:
    case AssistanceInformationMetaData__gNSSID_bds:
    case AssistanceInformationMetaData__gNSSID_navic:
        return 0;
    }
    return -1;
}
...
static int asn_validate_sBASID_14(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_AssistanceInformationMetaData__sBASID value = *(e_AssistanceInformationMetaData__sBASID*)sptr;
    switch(value) {
    case AssistanceInformationMetaData__sBASID_waas:
    case AssistanceInformationMetaData__sBASID_egnos:
    case AssistanceInformationMetaData__sBASID_msas:
    case AssistanceInformationMetaData__sBASID_gagan:
        return 0;
    }
    return -1;
}
...
asn_TYPE_member_t asn_MBR_AssistanceInformationMetaData_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct AssistanceInformationMetaData, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_126P14,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
