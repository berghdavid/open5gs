...
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_cyclicPrefix __attribute__((weak, alias("asn_DEF_cyclicPrefix_11")));
#else
static asn_TYPE_descriptor_t asn_DEF_cyclicPrefix_11;
static asn_TYPE_descriptor_t asn_DEF_cyclicPrefix;
__attribute__((constructor)) static void asn_DEF_cyclicPrefix_11_alias_init(void) {
	asn_DEF_cyclicPrefix = asn_DEF_cyclicPrefix_11;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
/*
...
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_shift7dot5kHz __attribute__((weak, alias("asn_DEF_shift7dot5kHz_15")));
#else
static asn_TYPE_descriptor_t asn_DEF_shift7dot5kHz_15;
static asn_TYPE_descriptor_t asn_DEF_shift7dot5kHz;
__attribute__((constructor)) static void asn_DEF_shift7dot5kHz_15_alias_init(void) {
	asn_DEF_shift7dot5kHz = asn_DEF_shift7dot5kHz_15;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
/*
...
static int asn_validate_subcarrierSpacing_3(const asn_TYPE_descriptor_t *td,
                       ...
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ActiveULBWP__subcarrierSpacing value = *(e_ActiveULBWP__subcarrierSpacing*)sptr;
    switch(value) {
    case ActiveULBWP__subcarrierSpacing_kHz15:
    case ActiveULBWP__subcarrierSpacing_kHz30:
    case ActiveULBWP__subcarrierSpacing_kHz60:
    case ActiveULBWP__subcarrierSpacing_kHz120:
    case ActiveULBWP__subcarrierSpacing_kHz480:
    case ActiveULBWP__subcarrierSpacing_kHz960:
        return 0;
    }
    return -1;
}
...
static int asn_validate_cyclicPrefix_11(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ActiveULBWP__cyclicPrefix value = *(e_ActiveULBWP__cyclicPrefix*)sptr;
    switch(value) {
    case ActiveULBWP__cyclicPrefix_normal:
    case ActiveULBWP__cyclicPrefix_extended:
        return 0;
    }
    return -1;
}
...
static int asn_validate_shift7dot5kHz_15(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ActiveULBWP__shift7dot5kHz value = *(e_ActiveULBWP__shift7dot5kHz*)sptr;
    switch(value) {
    case ActiveULBWP__shift7dot5kHz_true:
        return 0;
    }
    return -1;
}
...
asn_TYPE_member_t asn_MBR_ActiveULBWP_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct ActiveULBWP, sRSConfig),
	...
	{ ATF_POINTER, 1, offsetof(struct ActiveULBWP, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_126P0,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
