...
asn_TYPE_member_t asn_MBR_TRPPositionReferenced_1[] = {
	{ ATF_POINTER, 0, offsetof(struct TRPPositionReferenced, referencePoint),
	...
	{ ATF_POINTER, 0, offsetof(struct TRPPositionReferenced, referencePointType),
	...
	{ ATF_POINTER, 1, offsetof(struct TRPPositionReferenced, iE_extensions),
		...
		&asn_DEF_ProtocolExtensionContainer_126P165,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
