...
extern asn_TYPE_descriptor_t asn_DEF_nrofSymbols __attribute__((weak, alias("asn_DEF_nrofSymbols_5")));
#else
static asn_TYPE_descriptor_t asn_DEF_nrofSymbols_5;
static asn_TYPE_descriptor_t asn_DEF_nrofSymbols;
__attribute__((constructor)) static void asn_DEF_nrofSymbols_5_alias_init(void) {
	asn_DEF_nrofSymbols = asn_DEF_nrofSymbols_5;
}
#endif
...
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_groupOrSequenceHopping __attribute__((weak, alias("asn_DEF_groupOrSequenceHopping_13")));
#else
static asn_TYPE_descriptor_t asn_DEF_groupOrSequenceHopping_13;
static asn_TYPE_descriptor_t asn_DEF_groupOrSequenceHopping;
__attribute__((constructor)) static void asn_DEF_groupOrSequenceHopping_13_alias_init(void) {
	asn_DEF_groupOrSequenceHopping = asn_DEF_groupOrSequenceHopping_13;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
/*
...
static int asn_validate_nrofSymbols_5(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_PosSRSResource_Item__nrofSymbols value = *(e_PosSRSResource_Item__nrofSymbols*)sptr;
    switch(value) {
    case PosSRSResource_Item__nrofSymbols_n1:
    case PosSRSResource_Item__nrofSymbols_n2:
    case PosSRSResource_Item__nrofSymbols_n4:
    case PosSRSResource_Item__nrofSymbols_n8:
    case PosSRSResource_Item__nrofSymbols_n12:
        return 0;
    }
    return -1;
}
...
static int asn_validate_groupOrSequenceHopping_13(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_PosSRSResource_Item__groupOrSequenceHopping value = *(e_PosSRSResource_Item__groupOrSequenceHopping*)sptr;
    switch(value) {
    case PosSRSResource_Item__groupOrSequenceHopping_neither:
    case PosSRSResource_Item__groupOrSequenceHopping_groupHopping:
    case PosSRSResource_Item__groupOrSequenceHopping_sequenceHopping:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_groupOrSequenceHopping_13 = {
		...
		/sizeof(asn_DEF_groupOrSequenceHopping_tags_13[0]), /* 2 */
	{
		...
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
		asn_validate_groupOrSequenceHopping_13
	},
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_PosSRSResource_Item_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct PosSRSResource_Item, transmissionCombPos),
	...
	{ ATF_POINTER, 0, offsetof(struct PosSRSResource_Item, resourceTypePos),
	...
	{ ATF_POINTER, 1, offsetof(struct PosSRSResource_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_126P55,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
