...
static int asn_validate_PRS_Bandwidth_EUTRA_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_PRS_Bandwidth_EUTRA value = *(e_PRS_Bandwidth_EUTRA*)sptr;
    switch(value) {
    case PRS_Bandwidth_EUTRA_bw6:
    case PRS_Bandwidth_EUTRA_bw15:
    case PRS_Bandwidth_EUTRA_bw25:
    case PRS_Bandwidth_EUTRA_bw50:
    case PRS_Bandwidth_EUTRA_bw75:
    case PRS_Bandwidth_EUTRA_bw100:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_PRS_Bandwidth_EUTRA = {
		...
		/sizeof(asn_DEF_PRS_Bandwidth_EUTRA_tags_1[0]), /* 1 */
	{
		...
		asn_validate_PRS_Bandwidth_EUTRA_1
	},
