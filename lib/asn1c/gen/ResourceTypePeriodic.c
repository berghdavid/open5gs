...
static int asn_validate_periodicity_2(const asn_TYPE_descriptor_t *td,
                       ...
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ResourceTypePeriodic__periodicity value = *(e_ResourceTypePeriodic__periodicity*)sptr;
    switch(value) {
    case ResourceTypePeriodic__periodicity_slot1:
    case ResourceTypePeriodic__periodicity_slot2:
    case ResourceTypePeriodic__periodicity_slot4:
    case ResourceTypePeriodic__periodicity_slot5:
    case ResourceTypePeriodic__periodicity_slot8:
    case ResourceTypePeriodic__periodicity_slot10:
    case ResourceTypePeriodic__periodicity_slot16:
    case ResourceTypePeriodic__periodicity_slot20:
    case ResourceTypePeriodic__periodicity_slot32:
    case ResourceTypePeriodic__periodicity_slot40:
    case ResourceTypePeriodic__periodicity_slot64:
    case ResourceTypePeriodic__periodicity_slot80:
    case ResourceTypePeriodic__periodicity_slot160:
    case ResourceTypePeriodic__periodicity_slot320:
    case ResourceTypePeriodic__periodicity_slot640:
    case ResourceTypePeriodic__periodicity_slot1280:
    case ResourceTypePeriodic__periodicity_slot2560:
        return 0;
    }
    return -1;
}
...
asn_TYPE_member_t asn_MBR_ResourceTypePeriodic_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct ResourceTypePeriodic, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_126P93,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
