...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static asn_TYPE_member_t asn_MBR_TransmissionComb__n2_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_n2_2 = {
	...
	asn_MBR_TransmissionComb__n2_2,
	2,	/* Elements count */
	&asn_SPC_n2_specs_2	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_TransmissionComb__n4_5[] = {
...
asn_TYPE_descriptor_t asn_DEF_n4_5 = {
	...
	asn_MBR_TransmissionComb__n4_5,
	2,	/* Elements count */
...
asn_TYPE_member_t asn_MBR_TransmissionComb_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct TransmissionComb, choice.choice_extension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolIE_Single_Container_100P36,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
