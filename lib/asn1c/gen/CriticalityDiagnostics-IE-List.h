...
struct ProtocolExtensionContainer_126P20;
struct ProtocolExtensionContainer;

/* Forward definitions */
typedef struct CriticalityDiagnostics_IE_List__CriticalityDiagnostics_IE_List_Member {
...
} CriticalityDiagnostics_IE_List__CriticalityDiagnostics_IE_List_Member;

/* CriticalityDiagnostics-IE-List */
typedef struct CriticalityDiagnostics_IE_List {
	A_SEQUENCE_OF(CriticalityDiagnostics_IE_List__CriticalityDiagnostics_IE_List_Member) list;
