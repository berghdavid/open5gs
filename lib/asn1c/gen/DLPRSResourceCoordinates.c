...
extern asn_TYPE_descriptor_t asn_DEF_listofDL_PRSResourceSetARP __attribute__((weak, alias("asn_DEF_listofDL_PRSResourceSetARP_2")));
#else
static asn_TYPE_descriptor_t asn_DEF_listofDL_PRSResourceSetARP_2;
static asn_TYPE_descriptor_t asn_DEF_listofDL_PRSResourceSetARP;
__attribute__((constructor)) static void asn_DEF_listofDL_PRSResourceSetARP_2_alias_init(void) {
	asn_DEF_listofDL_PRSResourceSetARP = asn_DEF_listofDL_PRSResourceSetARP_2;
}
#endif
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static asn_TYPE_member_t asn_MBR_DLPRSResourceCoordinates__listofDL_PRSResourceSetARP_2[] = {
	{ ATF_POINTER, 0, 0,
...
asn_TYPE_descriptor_t asn_DEF_listofDL_PRSResourceSetARP_2 = {
	...
	asn_MBR_DLPRSResourceCoordinates__listofDL_PRSResourceSetARP_2,
	1,	/* Single element */
...
asn_TYPE_member_t asn_MBR_DLPRSResourceCoordinates_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct DLPRSResourceCoordinates, iE_Extensions),
		...
		&asn_DEF_ProtocolExtensionContainer_126P23,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
