...
)
{
    ...
    log_assert(relocate_ue_context_request_local_var);
...
cJSON *OpenAPI_relocate_ue_context_request_convertToJSON(OpenAPI_relocate_ue_context_request_t *relocate_ue_context_request)
{
    ...
    if (relocate_ue_context_request == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [RelocateUEContext_request]");
        return NULL;
    }
    ...
    if (json_data_local_JSON == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [json_data]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataForwardRelocationRequest", encoded_str_binary_data_forward_relocation_request) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_forward_relocation_request]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2Information", encoded_str_binary_data_n2_information) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt1", encoded_str_binary_data_n2_information_ext1) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext1]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt2", encoded_str_binary_data_n2_information_ext2) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext2]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt3", encoded_str_binary_data_n2_information_ext3) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext3]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt4", encoded_str_binary_data_n2_information_ext4) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext4]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt5", encoded_str_binary_data_n2_information_ext5) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext5]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt6", encoded_str_binary_data_n2_information_ext6) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext6]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt7", encoded_str_binary_data_n2_information_ext7) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext7]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt8", encoded_str_binary_data_n2_information_ext8) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext8]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt9", encoded_str_binary_data_n2_information_ext9) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext9]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt10", encoded_str_binary_data_n2_information_ext10) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext10]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt11", encoded_str_binary_data_n2_information_ext11) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext11]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt12", encoded_str_binary_data_n2_information_ext12) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext12]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt13", encoded_str_binary_data_n2_information_ext13) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext13]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt14", encoded_str_binary_data_n2_information_ext14) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext14]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt15", encoded_str_binary_data_n2_information_ext15) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext15]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt16", encoded_str_binary_data_n2_information_ext16) == NULL) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext16]");
        goto end;
    }
...
OpenAPI_relocate_ue_context_request_t *OpenAPI_relocate_ue_context_request_parseFromJSON(cJSON *relocate_ue_context_requestJSON)
{
    ...
    if (!json_data_local_nonprim) {
        log_error("OpenAPI_ue_context_relocate_data_parseFromJSON failed [json_data]");
        goto end;
    }
    }
    ...
    log_assert(decoded_str_binary_data_forward_relocation_request);
    if (!cJSON_IsString(binary_data_forward_relocation_request)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_forward_relocation_request]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext1)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext1]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext2)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext2]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext3)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext3]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext4)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext4]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext5)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext5]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext6)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext6]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext7)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext7]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext8)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext8]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext9)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext9]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext10)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext10]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext11)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext11]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext12)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext12]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext13)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext13]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext14)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext14]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext15)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext15]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext16)) {
        log_error("OpenAPI_relocate_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext16]");
        goto end;
    }
...
OpenAPI_relocate_ue_context_request_t *OpenAPI_relocate_ue_context_request_copy(OpenAPI_relocate_ue_context_request_t *dst, OpenAPI_relocate_ue_context_request_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_relocate_ue_context_request_convertToJSON() failed");
        return NULL;
    }
