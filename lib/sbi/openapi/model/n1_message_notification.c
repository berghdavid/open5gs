...
)
{
    ...
    log_assert(n1_message_notification_local_var);
...
cJSON *OpenAPI_n1_message_notification_convertToJSON(OpenAPI_n1_message_notification_t *n1_message_notification)
{
    ...
    if (n1_message_notification == NULL) {
        log_error("OpenAPI_n1_message_notification_convertToJSON() failed [N1MessageNotification]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "n1NotifySubscriptionId", n1_message_notification->n1_notify_subscription_id) == NULL) {
        log_error("OpenAPI_n1_message_notification_convertToJSON() failed [n1_notify_subscription_id]");
        goto end;
    }
    }

    if (!n1_message_notification->n1_message_container) {
        log_error("OpenAPI_n1_message_notification_convertToJSON() failed [n1_message_container]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "lcsCorrelationId", n1_message_notification->lcs_correlation_id) == NULL) {
        log_error("OpenAPI_n1_message_notification_convertToJSON() failed [lcs_correlation_id]");
        goto end;
    }
    }
    ...
    if (registration_ctxt_container_local_JSON == NULL) {
        log_error("OpenAPI_n1_message_notification_convertToJSON() failed [registration_ctxt_container]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "newLmfIdentification", n1_message_notification->new_lmf_identification) == NULL) {
        log_error("OpenAPI_n1_message_notification_convertToJSON() failed [new_lmf_identification]");
        goto end;
    }
    }
    ...
    if (guami_local_JSON == NULL) {
        log_error("OpenAPI_n1_message_notification_convertToJSON() failed [guami]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "cIoT5GSOptimisation", n1_message_notification->c_io_t5_gs_optimisation) == NULL) {
        log_error("OpenAPI_n1_message_notification_convertToJSON() failed [c_io_t5_gs_optimisation]");
        goto end;
    }
    }
    ...
    if (ecgi_local_JSON == NULL) {
        log_error("OpenAPI_n1_message_notification_convertToJSON() failed [ecgi]");
        goto end;
    }
    ...
    if (ncgi_local_JSON == NULL) {
        log_error("OpenAPI_n1_message_notification_convertToJSON() failed [ncgi]");
        goto end;
    }
...
OpenAPI_n1_message_notification_t *OpenAPI_n1_message_notification_parseFromJSON(cJSON *n1_message_notificationJSON)
{
    ...
    if (!cJSON_IsString(n1_notify_subscription_id) && !cJSON_IsNull(n1_notify_subscription_id)) {
        log_error("OpenAPI_n1_message_notification_parseFromJSON() failed [n1_notify_subscription_id]");
        goto end;
    }
    }
    ...
    if (!n1_message_container) {
        log_error("OpenAPI_n1_message_notification_parseFromJSON() failed [n1_message_container]");
        goto end;
    }
    ...
    if (!cJSON_IsString(lcs_correlation_id) && !cJSON_IsNull(lcs_correlation_id)) {
        log_error("OpenAPI_n1_message_notification_parseFromJSON() failed [lcs_correlation_id]");
        goto end;
    }
    }
    ...
    if (!registration_ctxt_container_local_nonprim) {
        log_error("OpenAPI_registration_context_container_parseFromJSON failed [registration_ctxt_container]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(new_lmf_identification) && !cJSON_IsNull(new_lmf_identification)) {
        log_error("OpenAPI_n1_message_notification_parseFromJSON() failed [new_lmf_identification]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(c_io_t5_gs_optimisation)) {
        log_error("OpenAPI_n1_message_notification_parseFromJSON() failed [c_io_t5_gs_optimisation]");
        goto end;
    }
    }
...
OpenAPI_n1_message_notification_t *OpenAPI_n1_message_notification_copy(OpenAPI_n1_message_notification_t *dst, OpenAPI_n1_message_notification_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_n1_message_notification_convertToJSON() failed");
        return NULL;
    }
