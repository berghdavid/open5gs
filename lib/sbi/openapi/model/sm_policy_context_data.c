...
)
{
    ...
    log_assert(sm_policy_context_data_local_var);
...
cJSON *OpenAPI_sm_policy_context_data_convertToJSON(OpenAPI_sm_policy_context_data_t *sm_policy_context_data)
{
    ...
    if (sm_policy_context_data == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [SmPolicyContextData]");
        return NULL;
    }
    ...
    if (acc_net_ch_id_local_JSON == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [acc_net_ch_id]");
        goto end;
    }
    ...
    if (charg_entity_addr_local_JSON == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [charg_entity_addr]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "gpsi", sm_policy_context_data->gpsi) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [gpsi]");
        goto end;
    }
    }

    if (!sm_policy_context_data->supi) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [supi]");
        return NULL;
    }
    ...
    if (cJSON_AddBoolToObject(item, "invalidSupi", sm_policy_context_data->invalid_supi) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [invalid_supi]");
        goto end;
    }
    }
    ...
    if (inter_grp_idsList == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [inter_grp_ids]");
        goto end;
    }
    OpenAPI_list_for_each(sm_policy_context_data->inter_grp_ids, node) {
    ...
    if (cJSON_AddNumberToObject(item, "pduSessionId", sm_policy_context_data->pdu_session_id) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [pdu_session_id]");
        goto end;
    }

    if (sm_policy_context_data->pdu_session_type == OpenAPI_pdu_session_type_NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [pdu_session_type]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "chargingcharacteristics", sm_policy_context_data->chargingcharacteristics) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [chargingcharacteristics]");
        goto end;
    }
    }

    if (!sm_policy_context_data->dnn) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [dnn]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "dnnSelMode", OpenAPI_dnn_selection_mode_ToString(sm_policy_context_data->dnn_sel_mode)) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [dnn_sel_mode]");
        goto end;
    }
    }

    if (!sm_policy_context_data->notification_uri) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [notification_uri]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "accessType", OpenAPI_access_type_ToString(sm_policy_context_data->access_type)) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [access_type]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ratType", OpenAPI_rat_type_ToString(sm_policy_context_data->rat_type)) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [rat_type]");
        goto end;
    }
    }
    ...
    if (add_access_info_local_JSON == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [add_access_info]");
        goto end;
    }
    ...
    if (serving_network_local_JSON == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [serving_network]");
        goto end;
    }
    ...
    if (user_location_info_local_JSON == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [user_location_info]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "ueTimeZone", sm_policy_context_data->ue_time_zone) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [ue_time_zone]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "pei", sm_policy_context_data->pei) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [pei]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ipv4Address", sm_policy_context_data->ipv4_address) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [ipv4_address]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ipv6AddressPrefix", sm_policy_context_data->ipv6_address_prefix) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [ipv6_address_prefix]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ipDomain", sm_policy_context_data->ip_domain) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [ip_domain]");
        goto end;
    }
    }
    ...
    if (subs_sess_ambr_local_JSON == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [subs_sess_ambr]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "authProfIndex", sm_policy_context_data->auth_prof_index) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [auth_prof_index]");
        goto end;
    }
    }
    ...
    if (subs_def_qos_local_JSON == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [subs_def_qos]");
        goto end;
    }
    ...
    if (vplmn_qos_local_JSON == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [vplmn_qos]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "numOfPackFilter", sm_policy_context_data->num_of_pack_filter) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [num_of_pack_filter]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "online", sm_policy_context_data->online) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [online]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "offline", sm_policy_context_data->offline) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [offline]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "3gppPsDataOffStatus", sm_policy_context_data->_3gpp_ps_data_off_status) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [_3gpp_ps_data_off_status]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "refQosIndication", sm_policy_context_data->ref_qos_indication) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [ref_qos_indication]");
        goto end;
    }
    }
    ...
    if (trace_req_local_JSON == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [trace_req]");
        goto end;
    }
    ...
    if (!sm_policy_context_data->slice_info) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [slice_info]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "qosFlowUsage", OpenAPI_qos_flow_usage_ToString(sm_policy_context_data->qos_flow_usage)) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [qos_flow_usage]");
        goto end;
    }
    }
    ...
    if (serv_nf_id_local_JSON == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [serv_nf_id]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "suppFeat", sm_policy_context_data->supp_feat) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [supp_feat]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "smfId", sm_policy_context_data->smf_id) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [smf_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "recoveryTime", sm_policy_context_data->recovery_time) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [recovery_time]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "maPduInd", OpenAPI_ma_pdu_indication_ToString(sm_policy_context_data->ma_pdu_ind)) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [ma_pdu_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "atsssCapab", OpenAPI_npcf_atsss_capability_ToString(sm_policy_context_data->atsss_capab)) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [atsss_capab]");
        goto end;
    }
    }
    ...
    if (ipv4_frame_route_listList == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [ipv4_frame_route_list]");
        goto end;
    }
    OpenAPI_list_for_each(sm_policy_context_data->ipv4_frame_route_list, node) {
    ...
    if (ipv6_frame_route_listList == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [ipv6_frame_route_list]");
        goto end;
    }
    OpenAPI_list_for_each(sm_policy_context_data->ipv6_frame_route_list, node) {
    ...
    if (cJSON_AddStringToObject(item, "satBackhaulCategory", OpenAPI_satellite_backhaul_category_ToString(sm_policy_context_data->sat_backhaul_category)) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [sat_backhaul_category]");
        goto end;
    }
    }
    ...
    if (pcf_ue_info_local_JSON == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [pcf_ue_info]");
        goto end;
    }
    ...
    if (pvs_infoList == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [pvs_info]");
        goto end;
    }
    OpenAPI_list_for_each(sm_policy_context_data->pvs_info, node) {
    ...
    if (cJSON_AddBoolToObject(item, "onboardInd", sm_policy_context_data->onboard_ind) == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [onboard_ind]");
        goto end;
    }
    }
    ...
    if (nwdaf_datasList == NULL) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed [nwdaf_datas]");
        goto end;
    }
    OpenAPI_list_for_each(sm_policy_context_data->nwdaf_datas, node) {
...
OpenAPI_sm_policy_context_data_t *OpenAPI_sm_policy_context_data_parseFromJSON(cJSON *sm_policy_context_dataJSON)
{
    ...
    if (!acc_net_ch_id_local_nonprim) {
        log_error("OpenAPI_acc_net_ch_id_parseFromJSON failed [acc_net_ch_id]");
        goto end;
    }
    }
    ...
    if (!charg_entity_addr_local_nonprim) {
        log_error("OpenAPI_acc_net_charging_address_parseFromJSON failed [charg_entity_addr]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(gpsi) && !cJSON_IsNull(gpsi)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [gpsi]");
        goto end;
    }
    }
    ...
    if (!supi) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [supi]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(invalid_supi)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [invalid_supi]");
        goto end;
    }
    }
    ...
    if (inter_grp_ids) {
        ...
        if (!cJSON_IsArray(inter_grp_ids)) {
            log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [inter_grp_ids]");
            goto end;
        }
    ...
    if (!pdu_session_id) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [pdu_session_id]");
        goto end;
    }
    ...
    if (!pdu_session_type) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [pdu_session_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(chargingcharacteristics) && !cJSON_IsNull(chargingcharacteristics)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [chargingcharacteristics]");
        goto end;
    }
    }
    ...
    if (!dnn) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [dnn]");
        goto end;
    }
    ...
    if (!cJSON_IsString(dnn_sel_mode)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [dnn_sel_mode]");
        goto end;
    }
    ...
    if (!notification_uri) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [notification_uri]");
        goto end;
    }
    ...
    if (!cJSON_IsString(access_type)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [access_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(rat_type)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [rat_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(ue_time_zone) && !cJSON_IsNull(ue_time_zone)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [ue_time_zone]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(pei) && !cJSON_IsNull(pei)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [pei]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ipv4_address) && !cJSON_IsNull(ipv4_address)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [ipv4_address]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ipv6_address_prefix) && !cJSON_IsNull(ipv6_address_prefix)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [ipv6_address_prefix]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ip_domain) && !cJSON_IsNull(ip_domain)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [ip_domain]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(auth_prof_index) && !cJSON_IsNull(auth_prof_index)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [auth_prof_index]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(num_of_pack_filter)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [num_of_pack_filter]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(online)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [online]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(offline)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [offline]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(_3gpp_ps_data_off_status)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [_3gpp_ps_data_off_status]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(ref_qos_indication)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [ref_qos_indication]");
        goto end;
    }
    }
    ...
    if (!slice_info) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [slice_info]");
        goto end;
    }
    ...
    if (!cJSON_IsString(qos_flow_usage)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [qos_flow_usage]");
        goto end;
    }
    ...
    if (!cJSON_IsString(supp_feat) && !cJSON_IsNull(supp_feat)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [supp_feat]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(smf_id) && !cJSON_IsNull(smf_id)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [smf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(recovery_time) && !cJSON_IsNull(recovery_time)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [recovery_time]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ma_pdu_ind)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [ma_pdu_ind]");
        goto end;
    }
    ...
    if (!cJSON_IsString(atsss_capab)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [atsss_capab]");
        goto end;
    }
    ...
    if (ipv4_frame_route_list) {
        ...
        if (!cJSON_IsArray(ipv4_frame_route_list)) {
            log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [ipv4_frame_route_list]");
            goto end;
        }
    ...
    if (ipv6_frame_route_list) {
        ...
        if (!cJSON_IsArray(ipv6_frame_route_list)) {
            log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [ipv6_frame_route_list]");
            goto end;
        }
    ...
    if (!cJSON_IsString(sat_backhaul_category)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [sat_backhaul_category]");
        goto end;
    }
    ...
    if (pvs_info) {
        ...
        if (!cJSON_IsArray(pvs_info)) {
            log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [pvs_info]");
            goto end;
        }
    ...
    if (!cJSON_IsBool(onboard_ind)) {
        log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [onboard_ind]");
        goto end;
    }
    }
    ...
    if (nwdaf_datas) {
        ...
        if (!cJSON_IsArray(nwdaf_datas)) {
            log_error("OpenAPI_sm_policy_context_data_parseFromJSON() failed [nwdaf_datas]");
            goto end;
        }
...
OpenAPI_sm_policy_context_data_t *OpenAPI_sm_policy_context_data_copy(OpenAPI_sm_policy_context_data_t *dst, OpenAPI_sm_policy_context_data_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_sm_policy_context_data_convertToJSON() failed");
        return NULL;
    }
