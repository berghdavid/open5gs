...
)
{
    ...
    log_assert(n3ga_location_local_var);
...
cJSON *OpenAPI_n3ga_location_convertToJSON(OpenAPI_n3ga_location_t *n3ga_location)
{
    ...
    if (n3ga_location == NULL) {
        log_error("OpenAPI_n3ga_location_convertToJSON() failed [N3gaLocation]");
        return NULL;
    }
    ...
    if (n3gpp_tai_local_JSON == NULL) {
        log_error("OpenAPI_n3ga_location_convertToJSON() failed [n3gpp_tai]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "n3IwfId", n3ga_location->n3_iwf_id) == NULL) {
        log_error("OpenAPI_n3ga_location_convertToJSON() failed [n3_iwf_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ueIpv4Addr", n3ga_location->ue_ipv4_addr) == NULL) {
        log_error("OpenAPI_n3ga_location_convertToJSON() failed [ue_ipv4_addr]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ueIpv6Addr", n3ga_location->ue_ipv6_addr) == NULL) {
        log_error("OpenAPI_n3ga_location_convertToJSON() failed [ue_ipv6_addr]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "portNumber", n3ga_location->port_number) == NULL) {
        log_error("OpenAPI_n3ga_location_convertToJSON() failed [port_number]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "protocol", OpenAPI_transport_protocol_ToString(n3ga_location->protocol)) == NULL) {
        log_error("OpenAPI_n3ga_location_convertToJSON() failed [protocol]");
        goto end;
    }
    }
    ...
    if (tnap_id_local_JSON == NULL) {
        log_error("OpenAPI_n3ga_location_convertToJSON() failed [tnap_id]");
        goto end;
    }
    ...
    if (twap_id_local_JSON == NULL) {
        log_error("OpenAPI_n3ga_location_convertToJSON() failed [twap_id]");
        goto end;
    }
    ...
    if (hfc_node_id_local_JSON == NULL) {
        log_error("OpenAPI_n3ga_location_convertToJSON() failed [hfc_node_id]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "gli", n3ga_location->gli) == NULL) {
        log_error("OpenAPI_n3ga_location_convertToJSON() failed [gli]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "w5gbanLineType", OpenAPI_line_type_ToString(n3ga_location->w5gban_line_type)) == NULL) {
        log_error("OpenAPI_n3ga_location_convertToJSON() failed [w5gban_line_type]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "gci", n3ga_location->gci) == NULL) {
        log_error("OpenAPI_n3ga_location_convertToJSON() failed [gci]");
        goto end;
    }
    }
...
OpenAPI_n3ga_location_t *OpenAPI_n3ga_location_parseFromJSON(cJSON *n3ga_locationJSON)
{
    ...
    if (!n3gpp_tai_local_nonprim) {
        log_error("OpenAPI_tai_parseFromJSON failed [n3gpp_tai]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(n3_iwf_id) && !cJSON_IsNull(n3_iwf_id)) {
        log_error("OpenAPI_n3ga_location_parseFromJSON() failed [n3_iwf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ue_ipv4_addr) && !cJSON_IsNull(ue_ipv4_addr)) {
        log_error("OpenAPI_n3ga_location_parseFromJSON() failed [ue_ipv4_addr]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ue_ipv6_addr) && !cJSON_IsNull(ue_ipv6_addr)) {
        log_error("OpenAPI_n3ga_location_parseFromJSON() failed [ue_ipv6_addr]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(port_number)) {
        log_error("OpenAPI_n3ga_location_parseFromJSON() failed [port_number]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(protocol)) {
        log_error("OpenAPI_n3ga_location_parseFromJSON() failed [protocol]");
        goto end;
    }
    ...
    if (!hfc_node_id_local_nonprim) {
        log_error("OpenAPI_hfc_node_id_parseFromJSON failed [hfc_node_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(gli) && !cJSON_IsNull(gli)) {
        log_error("OpenAPI_n3ga_location_parseFromJSON() failed [gli]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(w5gban_line_type)) {
        log_error("OpenAPI_n3ga_location_parseFromJSON() failed [w5gban_line_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(gci) && !cJSON_IsNull(gci)) {
        log_error("OpenAPI_n3ga_location_parseFromJSON() failed [gci]");
        goto end;
    }
    }
...
OpenAPI_n3ga_location_t *OpenAPI_n3ga_location_copy(OpenAPI_n3ga_location_t *dst, OpenAPI_n3ga_location_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_n3ga_location_convertToJSON() failed");
        return NULL;
    }
