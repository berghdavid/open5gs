...
)
{
    ...
    log_assert(alternative_service_requirements_data_local_var);
...
cJSON *OpenAPI_alternative_service_requirements_data_convertToJSON(OpenAPI_alternative_service_requirements_data_t *alternative_service_requirements_data)
{
    ...
    if (alternative_service_requirements_data == NULL) {
        log_error("OpenAPI_alternative_service_requirements_data_convertToJSON() failed [AlternativeServiceRequirementsData]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!alternative_service_requirements_data->alt_qos_param_set_ref) {
        log_error("OpenAPI_alternative_service_requirements_data_convertToJSON() failed [alt_qos_param_set_ref]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "gbrUl", alternative_service_requirements_data->gbr_ul) == NULL) {
        log_error("OpenAPI_alternative_service_requirements_data_convertToJSON() failed [gbr_ul]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "gbrDl", alternative_service_requirements_data->gbr_dl) == NULL) {
        log_error("OpenAPI_alternative_service_requirements_data_convertToJSON() failed [gbr_dl]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "pdb", alternative_service_requirements_data->pdb) == NULL) {
        log_error("OpenAPI_alternative_service_requirements_data_convertToJSON() failed [pdb]");
        goto end;
    }
    }
...
OpenAPI_alternative_service_requirements_data_t *OpenAPI_alternative_service_requirements_data_parseFromJSON(cJSON *alternative_service_requirements_dataJSON)
{
    ...
    if (!alt_qos_param_set_ref) {
        log_error("OpenAPI_alternative_service_requirements_data_parseFromJSON() failed [alt_qos_param_set_ref]");
        goto end;
    }
    ...
    if (!cJSON_IsString(gbr_ul) && !cJSON_IsNull(gbr_ul)) {
        log_error("OpenAPI_alternative_service_requirements_data_parseFromJSON() failed [gbr_ul]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(gbr_dl) && !cJSON_IsNull(gbr_dl)) {
        log_error("OpenAPI_alternative_service_requirements_data_parseFromJSON() failed [gbr_dl]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(pdb)) {
        log_error("OpenAPI_alternative_service_requirements_data_parseFromJSON() failed [pdb]");
        goto end;
    }
    }
...
OpenAPI_alternative_service_requirements_data_t *OpenAPI_alternative_service_requirements_data_copy(OpenAPI_alternative_service_requirements_data_t *dst, OpenAPI_alternative_service_requirements_data_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_alternative_service_requirements_data_convertToJSON() failed");
        return NULL;
    }
