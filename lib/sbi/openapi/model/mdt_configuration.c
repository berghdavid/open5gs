...
)
{
    ...
    log_assert(mdt_configuration_local_var);
...
cJSON *OpenAPI_mdt_configuration_convertToJSON(OpenAPI_mdt_configuration_t *mdt_configuration)
{
    ...
    if (mdt_configuration == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [MdtConfiguration]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (mdt_configuration->job_type == OpenAPI_job_type_NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [job_type]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "reportType", OpenAPI_report_type_mdt_ToString(mdt_configuration->report_type)) == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [report_type]");
        goto end;
    }
    }
    ...
    if (area_scope_local_JSON == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [area_scope]");
        goto end;
    }
    ...
    if (measurement_lte_listList == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [measurement_lte_list]");
        goto end;
    }
    ...
    if (measurement_nr_listList == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [measurement_nr_list]");
        goto end;
    }
    ...
    if (sensor_measurement_listList == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [sensor_measurement_list]");
        goto end;
    }
    ...
    if (reporting_trigger_listList == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [reporting_trigger_list]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "reportInterval", OpenAPI_report_interval_mdt_ToString(mdt_configuration->report_interval)) == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [report_interval]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "reportIntervalNr", OpenAPI_report_interval_nr_mdt_ToString(mdt_configuration->report_interval_nr)) == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [report_interval_nr]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "reportAmount", OpenAPI_report_amount_mdt_ToString(mdt_configuration->report_amount)) == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [report_amount]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "eventThresholdRsrp", mdt_configuration->event_threshold_rsrp) == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [event_threshold_rsrp]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "eventThresholdRsrpNr", mdt_configuration->event_threshold_rsrp_nr) == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [event_threshold_rsrp_nr]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "eventThresholdRsrq", mdt_configuration->event_threshold_rsrq) == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [event_threshold_rsrq]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "eventThresholdRsrqNr", mdt_configuration->event_threshold_rsrq_nr) == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [event_threshold_rsrq_nr]");
        goto end;
    }
    }
    ...
    if (event_listList == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [event_list]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "loggingInterval", OpenAPI_logging_interval_mdt_ToString(mdt_configuration->logging_interval)) == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [logging_interval]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "loggingIntervalNr", OpenAPI_logging_interval_nr_mdt_ToString(mdt_configuration->logging_interval_nr)) == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [logging_interval_nr]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "loggingDuration", OpenAPI_logging_duration_mdt_ToString(mdt_configuration->logging_duration)) == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [logging_duration]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "loggingDurationNr", OpenAPI_logging_duration_nr_mdt_ToString(mdt_configuration->logging_duration_nr)) == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [logging_duration_nr]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "positioningMethod", OpenAPI_positioning_method_mdt_ToString(mdt_configuration->positioning_method)) == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [positioning_method]");
        goto end;
    }
    }
    ...
    if (add_positioning_method_listList == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [add_positioning_method_list]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "collectionPeriodRmmLte", OpenAPI_collection_period_rmm_lte_mdt_ToString(mdt_configuration->collection_period_rmm_lte)) == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [collection_period_rmm_lte]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "collectionPeriodRmmNr", OpenAPI_collection_period_rmm_nr_mdt_ToString(mdt_configuration->collection_period_rmm_nr)) == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [collection_period_rmm_nr]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "measurementPeriodLte", OpenAPI_measurement_period_lte_mdt_ToString(mdt_configuration->measurement_period_lte)) == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [measurement_period_lte]");
        goto end;
    }
    }
    ...
    if (mdt_allowed_plmn_id_listList == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [mdt_allowed_plmn_id_list]");
        goto end;
    }
    OpenAPI_list_for_each(mdt_configuration->mdt_allowed_plmn_id_list, node) {
    ...
    if (mbsfn_area_listList == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [mbsfn_area_list]");
        goto end;
    }
    OpenAPI_list_for_each(mdt_configuration->mbsfn_area_list, node) {
    ...
    if (inter_freq_target_listList == NULL) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed [inter_freq_target_list]");
        goto end;
    }
    OpenAPI_list_for_each(mdt_configuration->inter_freq_target_list, node) {
...
OpenAPI_mdt_configuration_t *OpenAPI_mdt_configuration_parseFromJSON(cJSON *mdt_configurationJSON)
{
    ...
    if (!job_type) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [job_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(report_type)) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [report_type]");
        goto end;
    }
    ...
    if (measurement_lte_list) {
        ...
        if (!cJSON_IsArray(measurement_lte_list)) {
            log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [measurement_lte_list]");
            goto end;
        }
        ...
        if (measurement_lte_listList->count == 0) {
            log_error("OpenAPI_mdt_configuration_parseFromJSON() failed: Expected measurement_lte_listList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (measurement_nr_list) {
        ...
        if (!cJSON_IsArray(measurement_nr_list)) {
            log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [measurement_nr_list]");
            goto end;
        }
        ...
        if (measurement_nr_listList->count == 0) {
            log_error("OpenAPI_mdt_configuration_parseFromJSON() failed: Expected measurement_nr_listList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (sensor_measurement_list) {
        ...
        if (!cJSON_IsArray(sensor_measurement_list)) {
            log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [sensor_measurement_list]");
            goto end;
        }
        ...
        if (sensor_measurement_listList->count == 0) {
            log_error("OpenAPI_mdt_configuration_parseFromJSON() failed: Expected sensor_measurement_listList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (reporting_trigger_list) {
        ...
        if (!cJSON_IsArray(reporting_trigger_list)) {
            log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [reporting_trigger_list]");
            goto end;
        }
        ...
        if (reporting_trigger_listList->count == 0) {
            log_error("OpenAPI_mdt_configuration_parseFromJSON() failed: Expected reporting_trigger_listList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (!cJSON_IsString(report_interval)) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [report_interval]");
        goto end;
    }
    ...
    if (!cJSON_IsString(report_interval_nr)) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [report_interval_nr]");
        goto end;
    }
    ...
    if (!cJSON_IsString(report_amount)) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [report_amount]");
        goto end;
    }
    ...
    if (!cJSON_IsNumber(event_threshold_rsrp)) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [event_threshold_rsrp]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(event_threshold_rsrp_nr)) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [event_threshold_rsrp_nr]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(event_threshold_rsrq)) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [event_threshold_rsrq]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(event_threshold_rsrq_nr)) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [event_threshold_rsrq_nr]");
        goto end;
    }
    }
    ...
    if (event_list) {
        ...
        if (!cJSON_IsArray(event_list)) {
            log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [event_list]");
            goto end;
        }
        ...
        if (event_listList->count == 0) {
            log_error("OpenAPI_mdt_configuration_parseFromJSON() failed: Expected event_listList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (!cJSON_IsString(logging_interval)) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [logging_interval]");
        goto end;
    }
    ...
    if (!cJSON_IsString(logging_interval_nr)) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [logging_interval_nr]");
        goto end;
    }
    ...
    if (!cJSON_IsString(logging_duration)) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [logging_duration]");
        goto end;
    }
    ...
    if (!cJSON_IsString(logging_duration_nr)) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [logging_duration_nr]");
        goto end;
    }
    ...
    if (!cJSON_IsString(positioning_method)) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [positioning_method]");
        goto end;
    }
    ...
    if (add_positioning_method_list) {
        ...
        if (!cJSON_IsArray(add_positioning_method_list)) {
            log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [add_positioning_method_list]");
            goto end;
        }
        ...
        if (add_positioning_method_listList->count == 0) {
            log_error("OpenAPI_mdt_configuration_parseFromJSON() failed: Expected add_positioning_method_listList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (!cJSON_IsString(collection_period_rmm_lte)) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [collection_period_rmm_lte]");
        goto end;
    }
    ...
    if (!cJSON_IsString(collection_period_rmm_nr)) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [collection_period_rmm_nr]");
        goto end;
    }
    ...
    if (!cJSON_IsString(measurement_period_lte)) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [measurement_period_lte]");
        goto end;
    }
    ...
    if (mdt_allowed_plmn_id_list) {
        ...
        if (!cJSON_IsArray(mdt_allowed_plmn_id_list)) {
            log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [mdt_allowed_plmn_id_list]");
            goto end;
        }
    ...
    if (mbsfn_area_list) {
        ...
        if (!cJSON_IsArray(mbsfn_area_list)) {
            log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [mbsfn_area_list]");
            goto end;
        }
    ...
    if (inter_freq_target_list) {
        ...
        if (!cJSON_IsArray(inter_freq_target_list)) {
            log_error("OpenAPI_mdt_configuration_parseFromJSON() failed [inter_freq_target_list]");
            goto end;
        }
...
OpenAPI_mdt_configuration_t *OpenAPI_mdt_configuration_copy(OpenAPI_mdt_configuration_t *dst, OpenAPI_mdt_configuration_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_mdt_configuration_convertToJSON() failed");
        return NULL;
    }
