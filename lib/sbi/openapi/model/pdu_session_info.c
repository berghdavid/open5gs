...
)
{
    ...
    log_assert(pdu_session_info_local_var);
...
cJSON *OpenAPI_pdu_session_info_convertToJSON(OpenAPI_pdu_session_info_t *pdu_session_info)
{
    ...
    if (pdu_session_info == NULL) {
        log_error("OpenAPI_pdu_session_info_convertToJSON() failed [PduSessionInfo]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!pdu_session_info->snssai) {
        log_error("OpenAPI_pdu_session_info_convertToJSON() failed [snssai]");
        return NULL;
    }
    ...
    if (!pdu_session_info->dnn) {
        log_error("OpenAPI_pdu_session_info_convertToJSON() failed [dnn]");
        return NULL;
    }
...
OpenAPI_pdu_session_info_t *OpenAPI_pdu_session_info_parseFromJSON(cJSON *pdu_session_infoJSON)
{
    ...
    if (!snssai) {
        log_error("OpenAPI_pdu_session_info_parseFromJSON() failed [snssai]");
        goto end;
    }
    ...
    if (!dnn) {
        log_error("OpenAPI_pdu_session_info_parseFromJSON() failed [dnn]");
        goto end;
    }
...
OpenAPI_pdu_session_info_t *OpenAPI_pdu_session_info_copy(OpenAPI_pdu_session_info_t *dst, OpenAPI_pdu_session_info_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_pdu_session_info_convertToJSON() failed");
        return NULL;
    }
