...
)
{
    ...
    log_assert(expected_ue_behavior_local_var);
...
cJSON *OpenAPI_expected_ue_behavior_convertToJSON(OpenAPI_expected_ue_behavior_t *expected_ue_behavior)
{
    ...
    if (expected_ue_behavior == NULL) {
        log_error("OpenAPI_expected_ue_behavior_convertToJSON() failed [ExpectedUeBehavior]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!expected_ue_behavior->exp_move_trajectory) {
        log_error("OpenAPI_expected_ue_behavior_convertToJSON() failed [exp_move_trajectory]");
        return NULL;
    }
    ...
    if (!expected_ue_behavior->validity_time) {
        log_error("OpenAPI_expected_ue_behavior_convertToJSON() failed [validity_time]");
        return NULL;
    }
...
OpenAPI_expected_ue_behavior_t *OpenAPI_expected_ue_behavior_parseFromJSON(cJSON *expected_ue_behaviorJSON)
{
    ...
    if (!exp_move_trajectory) {
        log_error("OpenAPI_expected_ue_behavior_parseFromJSON() failed [exp_move_trajectory]");
        goto end;
    }
        ...
        cJSON_ArrayForEach(exp_move_trajectory_local, exp_move_trajectory) {
            ...
            if (!exp_move_trajectoryItem) {
                log_error("No exp_move_trajectoryItem");
                goto end;
            }
    ...
    if (!validity_time) {
        log_error("OpenAPI_expected_ue_behavior_parseFromJSON() failed [validity_time]");
        goto end;
    }
...
OpenAPI_expected_ue_behavior_t *OpenAPI_expected_ue_behavior_copy(OpenAPI_expected_ue_behavior_t *dst, OpenAPI_expected_ue_behavior_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_expected_ue_behavior_convertToJSON() failed");
        return NULL;
    }
