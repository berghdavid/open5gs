...
)
{
    ...
    log_assert(complex_query_local_var);
...
cJSON *OpenAPI_complex_query_convertToJSON(OpenAPI_complex_query_t *complex_query)
{
    ...
    if (complex_query == NULL) {
        log_error("OpenAPI_complex_query_convertToJSON() failed [ComplexQuery]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!complex_query->cnf_units) {
        log_error("OpenAPI_complex_query_convertToJSON() failed [cnf_units]");
        return NULL;
    }
    ...
    if (!complex_query->dnf_units) {
        log_error("OpenAPI_complex_query_convertToJSON() failed [dnf_units]");
        return NULL;
    }
...
OpenAPI_complex_query_t *OpenAPI_complex_query_parseFromJSON(cJSON *complex_queryJSON)
{
    ...
    if (!cnf_units) {
        log_error("OpenAPI_complex_query_parseFromJSON() failed [cnf_units]");
        goto end;
    }
    ...
    if (!dnf_units) {
        log_error("OpenAPI_complex_query_parseFromJSON() failed [dnf_units]");
        goto end;
    }
...
OpenAPI_complex_query_t *OpenAPI_complex_query_copy(OpenAPI_complex_query_t *dst, OpenAPI_complex_query_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_complex_query_convertToJSON() failed");
        return NULL;
    }
