...
)
{
    ...
    log_assert(transfer_mt_data_error_local_var);
...
cJSON *OpenAPI_transfer_mt_data_error_convertToJSON(OpenAPI_transfer_mt_data_error_t *transfer_mt_data_error)
{
    ...
    if (transfer_mt_data_error == NULL) {
        log_error("OpenAPI_transfer_mt_data_error_convertToJSON() failed [TransferMtDataError]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "type", transfer_mt_data_error->type) == NULL) {
        log_error("OpenAPI_transfer_mt_data_error_convertToJSON() failed [type]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "title", transfer_mt_data_error->title) == NULL) {
        log_error("OpenAPI_transfer_mt_data_error_convertToJSON() failed [title]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "status", transfer_mt_data_error->status) == NULL) {
        log_error("OpenAPI_transfer_mt_data_error_convertToJSON() failed [status]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "detail", transfer_mt_data_error->detail) == NULL) {
        log_error("OpenAPI_transfer_mt_data_error_convertToJSON() failed [detail]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "instance", transfer_mt_data_error->instance) == NULL) {
        log_error("OpenAPI_transfer_mt_data_error_convertToJSON() failed [instance]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "cause", transfer_mt_data_error->cause) == NULL) {
        log_error("OpenAPI_transfer_mt_data_error_convertToJSON() failed [cause]");
        goto end;
    }
    }
    ...
    if (invalid_paramsList == NULL) {
        log_error("OpenAPI_transfer_mt_data_error_convertToJSON() failed [invalid_params]");
        goto end;
    }
    OpenAPI_list_for_each(transfer_mt_data_error->invalid_params, node) {
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", transfer_mt_data_error->supported_features) == NULL) {
        log_error("OpenAPI_transfer_mt_data_error_convertToJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (access_token_error_local_JSON == NULL) {
        log_error("OpenAPI_transfer_mt_data_error_convertToJSON() failed [access_token_error]");
        goto end;
    }
    ...
    if (access_token_request_local_JSON == NULL) {
        log_error("OpenAPI_transfer_mt_data_error_convertToJSON() failed [access_token_request]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "nrfId", transfer_mt_data_error->nrf_id) == NULL) {
        log_error("OpenAPI_transfer_mt_data_error_convertToJSON() failed [nrf_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "remoteError", transfer_mt_data_error->remote_error) == NULL) {
        log_error("OpenAPI_transfer_mt_data_error_convertToJSON() failed [remote_error]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "maxWaitingTime", transfer_mt_data_error->max_waiting_time) == NULL) {
        log_error("OpenAPI_transfer_mt_data_error_convertToJSON() failed [max_waiting_time]");
        goto end;
    }
    }
...
OpenAPI_transfer_mt_data_error_t *OpenAPI_transfer_mt_data_error_parseFromJSON(cJSON *transfer_mt_data_errorJSON)
{
    ...
    if (!cJSON_IsString(type) && !cJSON_IsNull(type)) {
        log_error("OpenAPI_transfer_mt_data_error_parseFromJSON() failed [type]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(title) && !cJSON_IsNull(title)) {
        log_error("OpenAPI_transfer_mt_data_error_parseFromJSON() failed [title]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(status)) {
        log_error("OpenAPI_transfer_mt_data_error_parseFromJSON() failed [status]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(detail) && !cJSON_IsNull(detail)) {
        log_error("OpenAPI_transfer_mt_data_error_parseFromJSON() failed [detail]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(instance) && !cJSON_IsNull(instance)) {
        log_error("OpenAPI_transfer_mt_data_error_parseFromJSON() failed [instance]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(cause) && !cJSON_IsNull(cause)) {
        log_error("OpenAPI_transfer_mt_data_error_parseFromJSON() failed [cause]");
        goto end;
    }
    }
    ...
    if (invalid_params) {
        ...
        if (!cJSON_IsArray(invalid_params)) {
            log_error("OpenAPI_transfer_mt_data_error_parseFromJSON() failed [invalid_params]");
            goto end;
        }
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_transfer_mt_data_error_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(nrf_id) && !cJSON_IsNull(nrf_id)) {
        log_error("OpenAPI_transfer_mt_data_error_parseFromJSON() failed [nrf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(remote_error)) {
        log_error("OpenAPI_transfer_mt_data_error_parseFromJSON() failed [remote_error]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(max_waiting_time)) {
        log_error("OpenAPI_transfer_mt_data_error_parseFromJSON() failed [max_waiting_time]");
        goto end;
    }
    }
...
OpenAPI_transfer_mt_data_error_t *OpenAPI_transfer_mt_data_error_copy(OpenAPI_transfer_mt_data_error_t *dst, OpenAPI_transfer_mt_data_error_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_transfer_mt_data_error_convertToJSON() failed");
        return NULL;
    }
