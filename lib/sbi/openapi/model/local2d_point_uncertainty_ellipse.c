...
)
{
    ...
    log_assert(local2d_point_uncertainty_ellipse_local_var);
...
cJSON *OpenAPI_local2d_point_uncertainty_ellipse_convertToJSON(OpenAPI_local2d_point_uncertainty_ellipse_t *local2d_point_uncertainty_ellipse)
{
    ...
    if (local2d_point_uncertainty_ellipse == NULL) {
        log_error("OpenAPI_local2d_point_uncertainty_ellipse_convertToJSON() failed [Local2dPointUncertaintyEllipse]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!local2d_point_uncertainty_ellipse->shape) {
        log_error("OpenAPI_local2d_point_uncertainty_ellipse_convertToJSON() failed [shape]");
        return NULL;
    }
    ...
    if (!local2d_point_uncertainty_ellipse->local_origin) {
        log_error("OpenAPI_local2d_point_uncertainty_ellipse_convertToJSON() failed [local_origin]");
        return NULL;
    }
    ...
    if (!local2d_point_uncertainty_ellipse->point) {
        log_error("OpenAPI_local2d_point_uncertainty_ellipse_convertToJSON() failed [point]");
        return NULL;
    }
    ...
    if (!local2d_point_uncertainty_ellipse->uncertainty_ellipse) {
        log_error("OpenAPI_local2d_point_uncertainty_ellipse_convertToJSON() failed [uncertainty_ellipse]");
        return NULL;
    }
    ...
    if (cJSON_AddNumberToObject(item, "confidence", local2d_point_uncertainty_ellipse->confidence) == NULL) {
        log_error("OpenAPI_local2d_point_uncertainty_ellipse_convertToJSON() failed [confidence]");
        goto end;
    }
...
OpenAPI_local2d_point_uncertainty_ellipse_t *OpenAPI_local2d_point_uncertainty_ellipse_parseFromJSON(cJSON *local2d_point_uncertainty_ellipseJSON)
{
    ...
    if (!shape) {
        log_error("OpenAPI_local2d_point_uncertainty_ellipse_parseFromJSON() failed [shape]");
        goto end;
    }
    ...
    if (!local_origin) {
        log_error("OpenAPI_local2d_point_uncertainty_ellipse_parseFromJSON() failed [local_origin]");
        goto end;
    }
    ...
    if (!point) {
        log_error("OpenAPI_local2d_point_uncertainty_ellipse_parseFromJSON() failed [point]");
        goto end;
    }
    ...
    if (!uncertainty_ellipse) {
        log_error("OpenAPI_local2d_point_uncertainty_ellipse_parseFromJSON() failed [uncertainty_ellipse]");
        goto end;
    }
    ...
    if (!confidence) {
        log_error("OpenAPI_local2d_point_uncertainty_ellipse_parseFromJSON() failed [confidence]");
        goto end;
    }
...
OpenAPI_local2d_point_uncertainty_ellipse_t *OpenAPI_local2d_point_uncertainty_ellipse_copy(OpenAPI_local2d_point_uncertainty_ellipse_t *dst, OpenAPI_local2d_point_uncertainty_ellipse_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_local2d_point_uncertainty_ellipse_convertToJSON() failed");
        return NULL;
    }
