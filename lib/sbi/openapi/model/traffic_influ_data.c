...
)
{
    ...
    log_assert(traffic_influ_data_local_var);
...
cJSON *OpenAPI_traffic_influ_data_convertToJSON(OpenAPI_traffic_influ_data_t *traffic_influ_data)
{
    ...
    if (traffic_influ_data == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [TrafficInfluData]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "upPathChgNotifCorreId", traffic_influ_data->up_path_chg_notif_corre_id) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [up_path_chg_notif_corre_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "appReloInd", traffic_influ_data->app_relo_ind) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [app_relo_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "afAppId", traffic_influ_data->af_app_id) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [af_app_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "dnn", traffic_influ_data->dnn) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [dnn]");
        goto end;
    }
    }
    ...
    if (eth_traffic_filtersList == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [eth_traffic_filters]");
        goto end;
    }
    OpenAPI_list_for_each(traffic_influ_data->eth_traffic_filters, node) {
    ...
    if (snssai_local_JSON == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [snssai]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "interGroupId", traffic_influ_data->inter_group_id) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [inter_group_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "supi", traffic_influ_data->supi) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [supi]");
        goto end;
    }
    }
    ...
    if (traffic_filtersList == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [traffic_filters]");
        goto end;
    }
    OpenAPI_list_for_each(traffic_influ_data->traffic_filters, node) {
    ...
    if (traffic_routesList == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [traffic_routes]");
        goto end;
    }
    OpenAPI_list_for_each(traffic_influ_data->traffic_routes, node) {
    ...
    if (cJSON_AddBoolToObject(item, "traffCorreInd", traffic_influ_data->traff_corre_ind) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [traff_corre_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "validStartTime", traffic_influ_data->valid_start_time) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [valid_start_time]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "validEndTime", traffic_influ_data->valid_end_time) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [valid_end_time]");
        goto end;
    }
    }
    ...
    if (temp_validitiesList == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [temp_validities]");
        goto end;
    }
    OpenAPI_list_for_each(traffic_influ_data->temp_validities, node) {
    ...
    if (nw_area_info_local_JSON == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [nw_area_info]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "upPathChgNotifUri", traffic_influ_data->up_path_chg_notif_uri) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [up_path_chg_notif_uri]");
        goto end;
    }
    }
    ...
    if (headersList == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [headers]");
        goto end;
    }
    OpenAPI_list_for_each(traffic_influ_data->headers, node) {
    ...
    if (subscribed_eventsList == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [subscribed_events]");
        goto end;
    }
    OpenAPI_list_for_each(traffic_influ_data->subscribed_events, node) {
    ...
    if (cJSON_AddStringToObject(item, "dnaiChgType", OpenAPI_dnai_change_type_ToString(traffic_influ_data->dnai_chg_type)) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [dnai_chg_type]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "afAckInd", traffic_influ_data->af_ack_ind) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [af_ack_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "addrPreserInd", traffic_influ_data->addr_preser_ind) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [addr_preser_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "maxAllowedUpLat", traffic_influ_data->max_allowed_up_lat) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [max_allowed_up_lat]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "simConnInd", traffic_influ_data->sim_conn_ind) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [sim_conn_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "simConnTerm", traffic_influ_data->sim_conn_term) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [sim_conn_term]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", traffic_influ_data->supported_features) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "resUri", traffic_influ_data->res_uri) == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [res_uri]");
        goto end;
    }
    }
    ...
    if (reset_idsList == NULL) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed [reset_ids]");
        goto end;
    }
    OpenAPI_list_for_each(traffic_influ_data->reset_ids, node) {
...
OpenAPI_traffic_influ_data_t *OpenAPI_traffic_influ_data_parseFromJSON(cJSON *traffic_influ_dataJSON)
{
    ...
    if (!cJSON_IsString(up_path_chg_notif_corre_id) && !cJSON_IsNull(up_path_chg_notif_corre_id)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [up_path_chg_notif_corre_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(app_relo_ind)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [app_relo_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(af_app_id) && !cJSON_IsNull(af_app_id)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [af_app_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(dnn) && !cJSON_IsNull(dnn)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [dnn]");
        goto end;
    }
    }
    ...
    if (eth_traffic_filters) {
        ...
        if (!cJSON_IsArray(eth_traffic_filters)) {
            log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [eth_traffic_filters]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(eth_traffic_filters_local, eth_traffic_filters) {
            ...
            if (!eth_traffic_filtersItem) {
                log_error("No eth_traffic_filtersItem");
                goto end;
            }
    ...
    if (!cJSON_IsString(inter_group_id) && !cJSON_IsNull(inter_group_id)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [inter_group_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(supi) && !cJSON_IsNull(supi)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [supi]");
        goto end;
    }
    }
    ...
    if (traffic_filters) {
        ...
        if (!cJSON_IsArray(traffic_filters)) {
            log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [traffic_filters]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(traffic_filters_local, traffic_filters) {
            ...
            if (!traffic_filtersItem) {
                log_error("No traffic_filtersItem");
                goto end;
            }
    ...
    if (traffic_routes) {
        ...
        if (!cJSON_IsArray(traffic_routes)) {
            log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [traffic_routes]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(traffic_routes_local, traffic_routes) {
            ...
            if (!traffic_routesItem) {
                log_error("No traffic_routesItem");
                goto end;
            }
    ...
    if (!cJSON_IsBool(traff_corre_ind)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [traff_corre_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(valid_start_time) && !cJSON_IsNull(valid_start_time)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [valid_start_time]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(valid_end_time) && !cJSON_IsNull(valid_end_time)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [valid_end_time]");
        goto end;
    }
    }
    ...
    if (temp_validities) {
        ...
        if (!cJSON_IsArray(temp_validities)) {
            log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [temp_validities]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(temp_validities_local, temp_validities) {
            ...
            if (!temp_validitiesItem) {
                log_error("No temp_validitiesItem");
                goto end;
            }
    ...
    if (!nw_area_info_local_nonprim) {
        log_error("OpenAPI_network_area_info_2_parseFromJSON failed [nw_area_info]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(up_path_chg_notif_uri) && !cJSON_IsNull(up_path_chg_notif_uri)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [up_path_chg_notif_uri]");
        goto end;
    }
    }
    ...
    if (headers) {
        ...
        if (!cJSON_IsArray(headers)) {
            log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [headers]");
            goto end;
        }
    ...
    if (subscribed_events) {
        ...
        if (!cJSON_IsArray(subscribed_events)) {
            log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [subscribed_events]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(subscribed_events_local, subscribed_events) {
            ...
            if (!subscribed_eventsItem) {
                log_error("No subscribed_eventsItem");
                goto end;
            }
    ...
    if (!cJSON_IsString(dnai_chg_type)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [dnai_chg_type]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(af_ack_ind)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [af_ack_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(addr_preser_ind)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [addr_preser_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(max_allowed_up_lat)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [max_allowed_up_lat]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(sim_conn_ind)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [sim_conn_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(sim_conn_term)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [sim_conn_term]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(res_uri) && !cJSON_IsNull(res_uri)) {
        log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [res_uri]");
        goto end;
    }
    }
    ...
    if (reset_ids) {
        ...
        if (!cJSON_IsArray(reset_ids)) {
            log_error("OpenAPI_traffic_influ_data_parseFromJSON() failed [reset_ids]");
            goto end;
        }
...
OpenAPI_traffic_influ_data_t *OpenAPI_traffic_influ_data_copy(OpenAPI_traffic_influ_data_t *dst, OpenAPI_traffic_influ_data_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_traffic_influ_data_convertToJSON() failed");
        return NULL;
    }
