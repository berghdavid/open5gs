...
)
{
    ...
    log_assert(guami_list_cond_local_var);
...
cJSON *OpenAPI_guami_list_cond_convertToJSON(OpenAPI_guami_list_cond_t *guami_list_cond)
{
    ...
    if (guami_list_cond == NULL) {
        log_error("OpenAPI_guami_list_cond_convertToJSON() failed [GuamiListCond]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!guami_list_cond->guami_list) {
        log_error("OpenAPI_guami_list_cond_convertToJSON() failed [guami_list]");
        return NULL;
    }
...
OpenAPI_guami_list_cond_t *OpenAPI_guami_list_cond_parseFromJSON(cJSON *guami_list_condJSON)
{
    ...
    if (!guami_list) {
        log_error("OpenAPI_guami_list_cond_parseFromJSON() failed [guami_list]");
        goto end;
    }
...
OpenAPI_guami_list_cond_t *OpenAPI_guami_list_cond_copy(OpenAPI_guami_list_cond_t *dst, OpenAPI_guami_list_cond_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_guami_list_cond_convertToJSON() failed");
        return NULL;
    }
