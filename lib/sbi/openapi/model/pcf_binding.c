...
)
{
    ...
    log_assert(pcf_binding_local_var);
...
cJSON *OpenAPI_pcf_binding_convertToJSON(OpenAPI_pcf_binding_t *pcf_binding)
{
    ...
    if (pcf_binding == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [PcfBinding]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "supi", pcf_binding->supi) == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [supi]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "gpsi", pcf_binding->gpsi) == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [gpsi]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ipv4Addr", pcf_binding->ipv4_addr) == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [ipv4_addr]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ipv6Prefix", pcf_binding->ipv6_prefix) == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [ipv6_prefix]");
        goto end;
    }
    }
    ...
    if (add_ipv6_prefixesList == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [add_ipv6_prefixes]");
        goto end;
    }
    OpenAPI_list_for_each(pcf_binding->add_ipv6_prefixes, node) {
    ...
    if (cJSON_AddStringToObject(item, "ipDomain", pcf_binding->ip_domain) == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [ip_domain]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "macAddr48", pcf_binding->mac_addr48) == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [mac_addr48]");
        goto end;
    }
    }
    ...
    if (add_mac_addrsList == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [add_mac_addrs]");
        goto end;
    }
    OpenAPI_list_for_each(pcf_binding->add_mac_addrs, node) {
    ...
    if (!pcf_binding->dnn) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [dnn]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "pcfFqdn", pcf_binding->pcf_fqdn) == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [pcf_fqdn]");
        goto end;
    }
    }
    ...
    if (pcf_ip_end_pointsList == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [pcf_ip_end_points]");
        goto end;
    }
    OpenAPI_list_for_each(pcf_binding->pcf_ip_end_points, node) {
    ...
    if (cJSON_AddStringToObject(item, "pcfDiamHost", pcf_binding->pcf_diam_host) == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [pcf_diam_host]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "pcfDiamRealm", pcf_binding->pcf_diam_realm) == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [pcf_diam_realm]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "pcfSmFqdn", pcf_binding->pcf_sm_fqdn) == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [pcf_sm_fqdn]");
        goto end;
    }
    }
    ...
    if (pcf_sm_ip_end_pointsList == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [pcf_sm_ip_end_points]");
        goto end;
    }
    OpenAPI_list_for_each(pcf_binding->pcf_sm_ip_end_points, node) {
        cJSON *itemLocal = OpenAPI_ip_end_point_convertToJSON(node->data);
    ...
    if (!pcf_binding->snssai) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [snssai]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "suppFeat", pcf_binding->supp_feat) == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [supp_feat]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "pcfId", pcf_binding->pcf_id) == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [pcf_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "pcfSetId", pcf_binding->pcf_set_id) == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [pcf_set_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "recoveryTime", pcf_binding->recovery_time) == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [recovery_time]");
        goto end;
    }
    }
    ...
    if (para_com_local_JSON == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [para_com]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "bindLevel", OpenAPI_binding_level_ToString(pcf_binding->bind_level)) == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [bind_level]");
        goto end;
    }
    }
    ...
    if (ipv4_frame_route_listList == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [ipv4_frame_route_list]");
        goto end;
    }
    OpenAPI_list_for_each(pcf_binding->ipv4_frame_route_list, node) {
    ...
    if (ipv6_frame_route_listList == NULL) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed [ipv6_frame_route_list]");
        goto end;
    }
    OpenAPI_list_for_each(pcf_binding->ipv6_frame_route_list, node) {
...
OpenAPI_pcf_binding_t *OpenAPI_pcf_binding_parseFromJSON(cJSON *pcf_bindingJSON)
{
    ...
    if (!cJSON_IsString(supi) && !cJSON_IsNull(supi)) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [supi]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(gpsi) && !cJSON_IsNull(gpsi)) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [gpsi]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ipv4_addr) && !cJSON_IsNull(ipv4_addr)) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [ipv4_addr]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ipv6_prefix) && !cJSON_IsNull(ipv6_prefix)) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [ipv6_prefix]");
        goto end;
    }
    }
    ...
    if (add_ipv6_prefixes) {
        ...
        if (!cJSON_IsArray(add_ipv6_prefixes)) {
            log_error("OpenAPI_pcf_binding_parseFromJSON() failed [add_ipv6_prefixes]");
            goto end;
        }
    ...
    if (!cJSON_IsString(ip_domain) && !cJSON_IsNull(ip_domain)) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [ip_domain]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(mac_addr48) && !cJSON_IsNull(mac_addr48)) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [mac_addr48]");
        goto end;
    }
    }
    ...
    if (add_mac_addrs) {
        ...
        if (!cJSON_IsArray(add_mac_addrs)) {
            log_error("OpenAPI_pcf_binding_parseFromJSON() failed [add_mac_addrs]");
            goto end;
        }
    ...
    if (!dnn) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [dnn]");
        goto end;
    }
    ...
    if (!cJSON_IsString(pcf_fqdn) && !cJSON_IsNull(pcf_fqdn)) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [pcf_fqdn]");
        goto end;
    }
    }
    ...
    if (pcf_ip_end_points) {
        ...
        if (!cJSON_IsArray(pcf_ip_end_points)) {
            log_error("OpenAPI_pcf_binding_parseFromJSON() failed [pcf_ip_end_points]");
            goto end;
        }
    ...
    if (!cJSON_IsString(pcf_diam_host) && !cJSON_IsNull(pcf_diam_host)) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [pcf_diam_host]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(pcf_diam_realm) && !cJSON_IsNull(pcf_diam_realm)) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [pcf_diam_realm]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(pcf_sm_fqdn) && !cJSON_IsNull(pcf_sm_fqdn)) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [pcf_sm_fqdn]");
        goto end;
    }
    }
    ...
    if (pcf_sm_ip_end_points) {
        ...
        if (!cJSON_IsArray(pcf_sm_ip_end_points)) {
            log_error("OpenAPI_pcf_binding_parseFromJSON() failed [pcf_sm_ip_end_points]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(pcf_sm_ip_end_points_local, pcf_sm_ip_end_points) {
            ...
            if (!pcf_sm_ip_end_pointsItem) {
                log_error("No pcf_sm_ip_end_pointsItem");
                goto end;
            }
    ...
    if (!snssai) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [snssai]");
        goto end;
    }
    ...
    if (!cJSON_IsString(supp_feat) && !cJSON_IsNull(supp_feat)) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [supp_feat]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(pcf_id) && !cJSON_IsNull(pcf_id)) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [pcf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(pcf_set_id) && !cJSON_IsNull(pcf_set_id)) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [pcf_set_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(recovery_time) && !cJSON_IsNull(recovery_time)) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [recovery_time]");
        goto end;
    }
    }
    ...
    if (!para_com_local_nonprim) {
        log_error("OpenAPI_parameter_combination_parseFromJSON failed [para_com]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(bind_level)) {
        log_error("OpenAPI_pcf_binding_parseFromJSON() failed [bind_level]");
        goto end;
    }
    ...
    if (ipv4_frame_route_list) {
        ...
        if (!cJSON_IsArray(ipv4_frame_route_list)) {
            log_error("OpenAPI_pcf_binding_parseFromJSON() failed [ipv4_frame_route_list]");
            goto end;
        }
    ...
    if (ipv6_frame_route_list) {
        ...
        if (!cJSON_IsArray(ipv6_frame_route_list)) {
            log_error("OpenAPI_pcf_binding_parseFromJSON() failed [ipv6_frame_route_list]");
            goto end;
        }
...
OpenAPI_pcf_binding_t *OpenAPI_pcf_binding_copy(OpenAPI_pcf_binding_t *dst, OpenAPI_pcf_binding_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_pcf_binding_convertToJSON() failed");
        return NULL;
    }
