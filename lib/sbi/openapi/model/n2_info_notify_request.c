...
)
{
    ...
    log_assert(n2_info_notify_request_local_var);
...
cJSON *OpenAPI_n2_info_notify_request_convertToJSON(OpenAPI_n2_info_notify_request_t *n2_info_notify_request)
{
    ...
    if (n2_info_notify_request == NULL) {
        log_error("OpenAPI_n2_info_notify_request_convertToJSON() failed [N2InfoNotify_request]");
        return NULL;
    }
    ...
    if (json_data_local_JSON == NULL) {
        log_error("OpenAPI_n2_info_notify_request_convertToJSON() failed [json_data]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN1Message", encoded_str_binary_data_n1_message) == NULL) {
        log_error("OpenAPI_n2_info_notify_request_convertToJSON() failed [binary_data_n1_message]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2Information", encoded_str_binary_data_n2_information) == NULL) {
        log_error("OpenAPI_n2_info_notify_request_convertToJSON() failed [binary_data_n2_information]");
        goto end;
    }
...
OpenAPI_n2_info_notify_request_t *OpenAPI_n2_info_notify_request_parseFromJSON(cJSON *n2_info_notify_requestJSON)
{
    ...
    if (!json_data_local_nonprim) {
        log_error("OpenAPI_n2_information_notification_parseFromJSON failed [json_data]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(binary_data_n1_message)) {
        log_error("OpenAPI_n2_info_notify_request_parseFromJSON() failed [binary_data_n1_message]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information)) {
        log_error("OpenAPI_n2_info_notify_request_parseFromJSON() failed [binary_data_n2_information]");
        goto end;
    }
...
OpenAPI_n2_info_notify_request_t *OpenAPI_n2_info_notify_request_copy(OpenAPI_n2_info_notify_request_t *dst, OpenAPI_n2_info_notify_request_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_n2_info_notify_request_convertToJSON() failed");
        return NULL;
    }
