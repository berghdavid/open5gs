...
)
{
    ...
    log_assert(atsss_capability_local_var);
...
cJSON *OpenAPI_atsss_capability_convertToJSON(OpenAPI_atsss_capability_t *atsss_capability)
{
    ...
    if (atsss_capability == NULL) {
        log_error("OpenAPI_atsss_capability_convertToJSON() failed [AtsssCapability]");
        return NULL;
    }
    ...
    if (cJSON_AddBoolToObject(item, "atsssLL", atsss_capability->atsss_ll) == NULL) {
        log_error("OpenAPI_atsss_capability_convertToJSON() failed [atsss_ll]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "mptcp", atsss_capability->mptcp) == NULL) {
        log_error("OpenAPI_atsss_capability_convertToJSON() failed [mptcp]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "rttWithoutPmf", atsss_capability->rtt_without_pmf) == NULL) {
        log_error("OpenAPI_atsss_capability_convertToJSON() failed [rtt_without_pmf]");
        goto end;
    }
    }
...
OpenAPI_atsss_capability_t *OpenAPI_atsss_capability_parseFromJSON(cJSON *atsss_capabilityJSON)
{
    ...
    if (!cJSON_IsBool(atsss_ll)) {
        log_error("OpenAPI_atsss_capability_parseFromJSON() failed [atsss_ll]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(mptcp)) {
        log_error("OpenAPI_atsss_capability_parseFromJSON() failed [mptcp]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(rtt_without_pmf)) {
        log_error("OpenAPI_atsss_capability_parseFromJSON() failed [rtt_without_pmf]");
        goto end;
    }
    }
...
OpenAPI_atsss_capability_t *OpenAPI_atsss_capability_copy(OpenAPI_atsss_capability_t *dst, OpenAPI_atsss_capability_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_atsss_capability_convertToJSON() failed");
        return NULL;
    }
