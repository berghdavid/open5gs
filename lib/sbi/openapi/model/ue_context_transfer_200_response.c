...
)
{
    ...
    log_assert(ue_context_transfer_200_response_local_var);
...
cJSON *OpenAPI_ue_context_transfer_200_response_convertToJSON(OpenAPI_ue_context_transfer_200_response_t *ue_context_transfer_200_response)
{
    ...
    if (ue_context_transfer_200_response == NULL) {
        log_error("OpenAPI_ue_context_transfer_200_response_convertToJSON() failed [UEContextTransfer_200_response]");
        return NULL;
    }
    ...
    if (json_data_local_JSON == NULL) {
        log_error("OpenAPI_ue_context_transfer_200_response_convertToJSON() failed [json_data]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2Information", encoded_str_binary_data_n2_information) == NULL) {
        log_error("OpenAPI_ue_context_transfer_200_response_convertToJSON() failed [binary_data_n2_information]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt1", encoded_str_binary_data_n2_information_ext1) == NULL) {
        log_error("OpenAPI_ue_context_transfer_200_response_convertToJSON() failed [binary_data_n2_information_ext1]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt2", encoded_str_binary_data_n2_information_ext2) == NULL) {
        log_error("OpenAPI_ue_context_transfer_200_response_convertToJSON() failed [binary_data_n2_information_ext2]");
        goto end;
    }
...
OpenAPI_ue_context_transfer_200_response_t *OpenAPI_ue_context_transfer_200_response_parseFromJSON(cJSON *ue_context_transfer_200_responseJSON)
{
    ...
    if (!json_data_local_nonprim) {
        log_error("OpenAPI_ue_context_transfer_rsp_data_parseFromJSON failed [json_data]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information)) {
        log_error("OpenAPI_ue_context_transfer_200_response_parseFromJSON() failed [binary_data_n2_information]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext1)) {
        log_error("OpenAPI_ue_context_transfer_200_response_parseFromJSON() failed [binary_data_n2_information_ext1]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext2)) {
        log_error("OpenAPI_ue_context_transfer_200_response_parseFromJSON() failed [binary_data_n2_information_ext2]");
        goto end;
    }
...
OpenAPI_ue_context_transfer_200_response_t *OpenAPI_ue_context_transfer_200_response_copy(OpenAPI_ue_context_transfer_200_response_t *dst, OpenAPI_ue_context_transfer_200_response_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_ue_context_transfer_200_response_convertToJSON() failed");
        return NULL;
    }
