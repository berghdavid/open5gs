...
)
{
    ...
    log_assert(acs_info_1_local_var);
...
cJSON *OpenAPI_acs_info_1_convertToJSON(OpenAPI_acs_info_1_t *acs_info_1)
{
    ...
    if (acs_info_1 == NULL) {
        log_error("OpenAPI_acs_info_1_convertToJSON() failed [AcsInfo_1]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "acsUrl", acs_info_1->acs_url) == NULL) {
        log_error("OpenAPI_acs_info_1_convertToJSON() failed [acs_url]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "acsIpv4Addr", acs_info_1->acs_ipv4_addr) == NULL) {
        log_error("OpenAPI_acs_info_1_convertToJSON() failed [acs_ipv4_addr]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "acsIpv6Addr", acs_info_1->acs_ipv6_addr) == NULL) {
        log_error("OpenAPI_acs_info_1_convertToJSON() failed [acs_ipv6_addr]");
        goto end;
    }
    }
...
OpenAPI_acs_info_1_t *OpenAPI_acs_info_1_parseFromJSON(cJSON *acs_info_1JSON)
{
    ...
    if (!cJSON_IsString(acs_url) && !cJSON_IsNull(acs_url)) {
        log_error("OpenAPI_acs_info_1_parseFromJSON() failed [acs_url]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(acs_ipv4_addr) && !cJSON_IsNull(acs_ipv4_addr)) {
        log_error("OpenAPI_acs_info_1_parseFromJSON() failed [acs_ipv4_addr]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(acs_ipv6_addr) && !cJSON_IsNull(acs_ipv6_addr)) {
        log_error("OpenAPI_acs_info_1_parseFromJSON() failed [acs_ipv6_addr]");
        goto end;
    }
    }
...
OpenAPI_acs_info_1_t *OpenAPI_acs_info_1_copy(OpenAPI_acs_info_1_t *dst, OpenAPI_acs_info_1_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_acs_info_1_convertToJSON() failed");
        return NULL;
    }
