...
)
{
    ...
    log_assert(event_report_message_local_var);
...
cJSON *OpenAPI_event_report_message_convertToJSON(OpenAPI_event_report_message_t *event_report_message)
{
    ...
    if (event_report_message == NULL) {
        log_error("OpenAPI_event_report_message_convertToJSON() failed [EventReportMessage]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!event_report_message->event_class) {
        log_error("OpenAPI_event_report_message_convertToJSON() failed [event_class]");
        return NULL;
    }
    ...
    if (!event_report_message->event_content) {
        log_error("OpenAPI_event_report_message_convertToJSON() failed [event_content]");
        return NULL;
    }
...
OpenAPI_event_report_message_t *OpenAPI_event_report_message_copy(OpenAPI_event_report_message_t *dst, OpenAPI_event_report_message_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_event_report_message_convertToJSON() failed");
        return NULL;
    }
