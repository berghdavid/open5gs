...
)
{
    ...
    log_assert(iwmsc_info_local_var);
...
cJSON *OpenAPI_iwmsc_info_convertToJSON(OpenAPI_iwmsc_info_t *iwmsc_info)
{
    ...
    if (iwmsc_info == NULL) {
        log_error("OpenAPI_iwmsc_info_convertToJSON() failed [IwmscInfo]");
        return NULL;
    }
    ...
    if (msisdn_rangesList == NULL) {
        log_error("OpenAPI_iwmsc_info_convertToJSON() failed [msisdn_ranges]");
        goto end;
    }
    OpenAPI_list_for_each(iwmsc_info->msisdn_ranges, node) {
    ...
    if (supi_rangesList == NULL) {
        log_error("OpenAPI_iwmsc_info_convertToJSON() failed [supi_ranges]");
        goto end;
    }
    OpenAPI_list_for_each(iwmsc_info->supi_ranges, node) {
    ...
    if (tai_range_listList == NULL) {
        log_error("OpenAPI_iwmsc_info_convertToJSON() failed [tai_range_list]");
        goto end;
    }
    OpenAPI_list_for_each(iwmsc_info->tai_range_list, node) {
    ...
    if (cJSON_AddStringToObject(item, "scNumber", iwmsc_info->sc_number) == NULL) {
        log_error("OpenAPI_iwmsc_info_convertToJSON() failed [sc_number]");
        goto end;
    }
    }
...
OpenAPI_iwmsc_info_t *OpenAPI_iwmsc_info_parseFromJSON(cJSON *iwmsc_infoJSON)
{
    ...
    if (msisdn_ranges) {
        ...
        if (!cJSON_IsArray(msisdn_ranges)) {
            log_error("OpenAPI_iwmsc_info_parseFromJSON() failed [msisdn_ranges]");
            goto end;
        }
    ...
    if (supi_ranges) {
        ...
        if (!cJSON_IsArray(supi_ranges)) {
            log_error("OpenAPI_iwmsc_info_parseFromJSON() failed [supi_ranges]");
            goto end;
        }
    ...
    if (tai_range_list) {
        ...
        if (!cJSON_IsArray(tai_range_list)) {
            log_error("OpenAPI_iwmsc_info_parseFromJSON() failed [tai_range_list]");
            goto end;
        }
    ...
    if (!cJSON_IsString(sc_number) && !cJSON_IsNull(sc_number)) {
        log_error("OpenAPI_iwmsc_info_parseFromJSON() failed [sc_number]");
        goto end;
    }
    }
...
OpenAPI_iwmsc_info_t *OpenAPI_iwmsc_info_copy(OpenAPI_iwmsc_info_t *dst, OpenAPI_iwmsc_info_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_iwmsc_info_convertToJSON() failed");
        return NULL;
    }
