...
)
{
    ...
    log_assert(release_pdu_session_200_response_local_var);
...
cJSON *OpenAPI_release_pdu_session_200_response_convertToJSON(OpenAPI_release_pdu_session_200_response_t *release_pdu_session_200_response)
{
    ...
    if (release_pdu_session_200_response == NULL) {
        log_error("OpenAPI_release_pdu_session_200_response_convertToJSON() failed [ReleasePduSession_200_response]");
        return NULL;
    }
    ...
    if (json_data_local_JSON == NULL) {
        log_error("OpenAPI_release_pdu_session_200_response_convertToJSON() failed [json_data]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN4Information", encoded_str_binary_data_n4_information) == NULL) {
        log_error("OpenAPI_release_pdu_session_200_response_convertToJSON() failed [binary_data_n4_information]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN4InformationExt1", encoded_str_binary_data_n4_information_ext1) == NULL) {
        log_error("OpenAPI_release_pdu_session_200_response_convertToJSON() failed [binary_data_n4_information_ext1]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN4InformationExt2", encoded_str_binary_data_n4_information_ext2) == NULL) {
        log_error("OpenAPI_release_pdu_session_200_response_convertToJSON() failed [binary_data_n4_information_ext2]");
        goto end;
    }
...
OpenAPI_release_pdu_session_200_response_t *OpenAPI_release_pdu_session_200_response_parseFromJSON(cJSON *release_pdu_session_200_responseJSON)
{
    ...
    if (!json_data_local_nonprim) {
        log_error("OpenAPI_released_data_parseFromJSON failed [json_data]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(binary_data_n4_information)) {
        log_error("OpenAPI_release_pdu_session_200_response_parseFromJSON() failed [binary_data_n4_information]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n4_information_ext1)) {
        log_error("OpenAPI_release_pdu_session_200_response_parseFromJSON() failed [binary_data_n4_information_ext1]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n4_information_ext2)) {
        log_error("OpenAPI_release_pdu_session_200_response_parseFromJSON() failed [binary_data_n4_information_ext2]");
        goto end;
    }
...
OpenAPI_release_pdu_session_200_response_t *OpenAPI_release_pdu_session_200_response_copy(OpenAPI_release_pdu_session_200_response_t *dst, OpenAPI_release_pdu_session_200_response_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_release_pdu_session_200_response_convertToJSON() failed");
        return NULL;
    }
