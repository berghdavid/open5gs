...
)
{
    ...
    log_assert(retainability_threshold_local_var);
...
cJSON *OpenAPI_retainability_threshold_convertToJSON(OpenAPI_retainability_threshold_t *retainability_threshold)
{
    ...
    if (retainability_threshold == NULL) {
        log_error("OpenAPI_retainability_threshold_convertToJSON() failed [RetainabilityThreshold]");
        return NULL;
    }
    ...
    if (cJSON_AddNumberToObject(item, "relFlowNum", retainability_threshold->rel_flow_num) == NULL) {
        log_error("OpenAPI_retainability_threshold_convertToJSON() failed [rel_flow_num]");
        goto end;
    }
    }
    ...
    if (rel_time_unit_local_JSON == NULL) {
        log_error("OpenAPI_retainability_threshold_convertToJSON() failed [rel_time_unit]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "relFlowRatio", retainability_threshold->rel_flow_ratio) == NULL) {
        log_error("OpenAPI_retainability_threshold_convertToJSON() failed [rel_flow_ratio]");
        goto end;
    }
    }
...
OpenAPI_retainability_threshold_t *OpenAPI_retainability_threshold_parseFromJSON(cJSON *retainability_thresholdJSON)
{
    ...
    if (!cJSON_IsNumber(rel_flow_num)) {
        log_error("OpenAPI_retainability_threshold_parseFromJSON() failed [rel_flow_num]");
        goto end;
    }
    }
    ...
    if (!rel_time_unit_local_nonprim) {
        log_error("OpenAPI_time_unit_parseFromJSON failed [rel_time_unit]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(rel_flow_ratio)) {
        log_error("OpenAPI_retainability_threshold_parseFromJSON() failed [rel_flow_ratio]");
        goto end;
    }
    }
...
OpenAPI_retainability_threshold_t *OpenAPI_retainability_threshold_copy(OpenAPI_retainability_threshold_t *dst, OpenAPI_retainability_threshold_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_retainability_threshold_convertToJSON() failed");
        return NULL;
    }
