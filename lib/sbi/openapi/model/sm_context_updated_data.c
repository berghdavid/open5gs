...
)
{
    ...
    log_assert(sm_context_updated_data_local_var);
...
cJSON *OpenAPI_sm_context_updated_data_convertToJSON(OpenAPI_sm_context_updated_data_t *sm_context_updated_data)
{
    ...
    if (sm_context_updated_data == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [SmContextUpdatedData]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "upCnxState", OpenAPI_up_cnx_state_ToString(sm_context_updated_data->up_cnx_state)) == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [up_cnx_state]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "hoState", OpenAPI_ho_state_ToString(sm_context_updated_data->ho_state)) == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [ho_state]");
        goto end;
    }
    }
    ...
    if (release_ebi_listList == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [release_ebi_list]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_updated_data->release_ebi_list, node) {
        if (node->data == NULL) {
    ...
    if (allocated_ebi_listList == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [allocated_ebi_list]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_updated_data->allocated_ebi_list, node) {
    ...
    if (modified_ebi_listList == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [modified_ebi_list]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_updated_data->modified_ebi_list, node) {
        cJSON *itemLocal = OpenAPI_ebi_arp_mapping_convertToJSON(node->data);
    ...
    if (n1_sm_msg_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [n1_sm_msg]");
        goto end;
    }
    ...
    if (n2_sm_info_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [n2_sm_info]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "n2SmInfoType", OpenAPI_n2_sm_info_type_ToString(sm_context_updated_data->n2_sm_info_type)) == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [n2_sm_info_type]");
        goto end;
    }
    }
    ...
    if (eps_bearer_setupList == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [eps_bearer_setup]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_updated_data->eps_bearer_setup, node) {
    ...
    if (cJSON_AddBoolToObject(item, "dataForwarding", sm_context_updated_data->data_forwarding) == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [data_forwarding]");
        goto end;
    }
    }
    ...
    if (n3_dl_forwarding_tnl_listList == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [n3_dl_forwarding_tnl_list]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_updated_data->n3_dl_forwarding_tnl_list, node) {
    ...
    if (n3_ul_forwarding_tnl_listList == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [n3_ul_forwarding_tnl_list]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_updated_data->n3_ul_forwarding_tnl_list, node) {
        cJSON *itemLocal = OpenAPI_indirect_data_forwarding_tunnel_info_convertToJSON(node->data);
    ...
    if (n9_ul_forwarding_tunnel_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [n9_ul_forwarding_tunnel]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "cause", OpenAPI_cause_ToString(sm_context_updated_data->cause)) == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [cause]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "maAcceptedInd", sm_context_updated_data->ma_accepted_ind) == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [ma_accepted_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", sm_context_updated_data->supported_features) == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "forwardingFTeid", sm_context_updated_data->forwarding_f_teid) == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [forwarding_f_teid]");
        goto end;
    }
    }
    ...
    if (forwarding_bearer_contextsList == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [forwarding_bearer_contexts]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_updated_data->forwarding_bearer_contexts, node) {
    ...
    if (cJSON_AddStringToObject(item, "selectedSmfId", sm_context_updated_data->selected_smf_id) == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [selected_smf_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "selectedOldSmfId", sm_context_updated_data->selected_old_smf_id) == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [selected_old_smf_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "interPlmnApiRoot", sm_context_updated_data->inter_plmn_api_root) == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [inter_plmn_api_root]");
        goto end;
    }
    }
    ...
    if (anchor_smf_features_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed [anchor_smf_features]");
        goto end;
    }
...
OpenAPI_sm_context_updated_data_t *OpenAPI_sm_context_updated_data_parseFromJSON(cJSON *sm_context_updated_dataJSON)
{
    ...
    if (!cJSON_IsString(up_cnx_state)) {
        log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [up_cnx_state]");
        goto end;
    }
    ...
    if (!cJSON_IsString(ho_state)) {
        log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [ho_state]");
        goto end;
    }
    ...
    if (release_ebi_list) {
        ...
        if (!cJSON_IsArray(release_ebi_list)) {
            log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [release_ebi_list]");
            goto end;
        }
    ...
    if (allocated_ebi_list) {
        ...
        if (!cJSON_IsArray(allocated_ebi_list)) {
            log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [allocated_ebi_list]");
            goto end;
        }
    ...
    if (modified_ebi_list) {
        ...
        if (!cJSON_IsArray(modified_ebi_list)) {
            log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [modified_ebi_list]");
            goto end;
        }
    ...
    if (!cJSON_IsString(n2_sm_info_type)) {
        log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [n2_sm_info_type]");
        goto end;
    }
    ...
    if (eps_bearer_setup) {
        ...
        if (!cJSON_IsArray(eps_bearer_setup)) {
            log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [eps_bearer_setup]");
            goto end;
        }
    ...
    if (!cJSON_IsBool(data_forwarding)) {
        log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [data_forwarding]");
        goto end;
    }
    }
    ...
    if (n3_dl_forwarding_tnl_list) {
        ...
        if (!cJSON_IsArray(n3_dl_forwarding_tnl_list)) {
            log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [n3_dl_forwarding_tnl_list]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(n3_dl_forwarding_tnl_list_local, n3_dl_forwarding_tnl_list) {
            ...
            if (!n3_dl_forwarding_tnl_listItem) {
                log_error("No n3_dl_forwarding_tnl_listItem");
                goto end;
            }
    ...
    if (n3_ul_forwarding_tnl_list) {
        ...
        if (!cJSON_IsArray(n3_ul_forwarding_tnl_list)) {
            log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [n3_ul_forwarding_tnl_list]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(n3_ul_forwarding_tnl_list_local, n3_ul_forwarding_tnl_list) {
            ...
            if (!n3_ul_forwarding_tnl_listItem) {
                log_error("No n3_ul_forwarding_tnl_listItem");
                goto end;
            }
    ...
    if (!n9_ul_forwarding_tunnel_local_nonprim) {
        log_error("OpenAPI_tunnel_info_parseFromJSON failed [n9_ul_forwarding_tunnel]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(cause)) {
        log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [cause]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(ma_accepted_ind)) {
        log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [ma_accepted_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(forwarding_f_teid) && !cJSON_IsNull(forwarding_f_teid)) {
        log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [forwarding_f_teid]");
        goto end;
    }
    }
    ...
    if (forwarding_bearer_contexts) {
        ...
        if (!cJSON_IsArray(forwarding_bearer_contexts)) {
            log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [forwarding_bearer_contexts]");
            goto end;
        }
    ...
    if (!cJSON_IsString(selected_smf_id) && !cJSON_IsNull(selected_smf_id)) {
        log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [selected_smf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(selected_old_smf_id) && !cJSON_IsNull(selected_old_smf_id)) {
        log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [selected_old_smf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(inter_plmn_api_root) && !cJSON_IsNull(inter_plmn_api_root)) {
        log_error("OpenAPI_sm_context_updated_data_parseFromJSON() failed [inter_plmn_api_root]");
        goto end;
    }
    }
    ...
    if (!anchor_smf_features_local_nonprim) {
        log_error("OpenAPI_anchor_smf_features_parseFromJSON failed [anchor_smf_features]");
        goto end;
    }
    }
...
OpenAPI_sm_context_updated_data_t *OpenAPI_sm_context_updated_data_copy(OpenAPI_sm_context_updated_data_t *dst, OpenAPI_sm_context_updated_data_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_sm_context_updated_data_convertToJSON() failed");
        return NULL;
    }
