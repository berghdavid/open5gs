...
)
{
    ...
    log_assert(pro_se_authentication_info_request_local_var);
...
cJSON *OpenAPI_pro_se_authentication_info_request_convertToJSON(OpenAPI_pro_se_authentication_info_request_t *pro_se_authentication_info_request)
{
    ...
    if (pro_se_authentication_info_request == NULL) {
        log_error("OpenAPI_pro_se_authentication_info_request_convertToJSON() failed [ProSeAuthenticationInfoRequest]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!pro_se_authentication_info_request->serving_network_name) {
        log_error("OpenAPI_pro_se_authentication_info_request_convertToJSON() failed [serving_network_name]");
        return NULL;
    }
    ...
    if (cJSON_AddNumberToObject(item, "relayServiceCode", pro_se_authentication_info_request->relay_service_code) == NULL) {
        log_error("OpenAPI_pro_se_authentication_info_request_convertToJSON() failed [relay_service_code]");
        goto end;
    }
    ...
    if (resynchronization_info_local_JSON == NULL) {
        log_error("OpenAPI_pro_se_authentication_info_request_convertToJSON() failed [resynchronization_info]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", pro_se_authentication_info_request->supported_features) == NULL) {
        log_error("OpenAPI_pro_se_authentication_info_request_convertToJSON() failed [supported_features]");
        goto end;
    }
    }
...
OpenAPI_pro_se_authentication_info_request_t *OpenAPI_pro_se_authentication_info_request_parseFromJSON(cJSON *pro_se_authentication_info_requestJSON)
{
    ...
    if (!serving_network_name) {
        log_error("OpenAPI_pro_se_authentication_info_request_parseFromJSON() failed [serving_network_name]");
        goto end;
    }
    ...
    if (!relay_service_code) {
        log_error("OpenAPI_pro_se_authentication_info_request_parseFromJSON() failed [relay_service_code]");
        goto end;
    }
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_pro_se_authentication_info_request_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
...
OpenAPI_pro_se_authentication_info_request_t *OpenAPI_pro_se_authentication_info_request_copy(OpenAPI_pro_se_authentication_info_request_t *dst, OpenAPI_pro_se_authentication_info_request_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_pro_se_authentication_info_request_convertToJSON() failed");
        return NULL;
    }
