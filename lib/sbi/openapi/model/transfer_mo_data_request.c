...
)
{
    ...
    log_assert(transfer_mo_data_request_local_var);
...
cJSON *OpenAPI_transfer_mo_data_request_convertToJSON(OpenAPI_transfer_mo_data_request_t *transfer_mo_data_request)
{
    ...
    if (transfer_mo_data_request == NULL) {
        log_error("OpenAPI_transfer_mo_data_request_convertToJSON() failed [TransferMoData_request]");
        return NULL;
    }
    ...
    if (json_data_local_JSON == NULL) {
        log_error("OpenAPI_transfer_mo_data_request_convertToJSON() failed [json_data]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryMoData", encoded_str_binary_mo_data) == NULL) {
        log_error("OpenAPI_transfer_mo_data_request_convertToJSON() failed [binary_mo_data]");
        goto end;
    }
...
OpenAPI_transfer_mo_data_request_t *OpenAPI_transfer_mo_data_request_parseFromJSON(cJSON *transfer_mo_data_requestJSON)
{
    ...
    if (!json_data_local_nonprim) {
        log_error("OpenAPI_transfer_mo_data_req_data_parseFromJSON failed [json_data]");
        goto end;
    }
    }
    ...
    log_assert(decoded_str_binary_mo_data);
    if (!cJSON_IsString(binary_mo_data)) {
        log_error("OpenAPI_transfer_mo_data_request_parseFromJSON() failed [binary_mo_data]");
        goto end;
    }
...
OpenAPI_transfer_mo_data_request_t *OpenAPI_transfer_mo_data_request_copy(OpenAPI_transfer_mo_data_request_t *dst, OpenAPI_transfer_mo_data_request_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_transfer_mo_data_request_convertToJSON() failed");
        return NULL;
    }
