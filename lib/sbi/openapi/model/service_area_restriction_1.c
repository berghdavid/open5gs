...
)
{
    ...
    log_assert(service_area_restriction_1_local_var);
...
cJSON *OpenAPI_service_area_restriction_1_convertToJSON(OpenAPI_service_area_restriction_1_t *service_area_restriction_1)
{
    ...
    if (service_area_restriction_1 == NULL) {
        log_error("OpenAPI_service_area_restriction_1_convertToJSON() failed [ServiceAreaRestriction_1]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "restrictionType", OpenAPI_restriction_type_ToString(service_area_restriction_1->restriction_type)) == NULL) {
        log_error("OpenAPI_service_area_restriction_1_convertToJSON() failed [restriction_type]");
        goto end;
    }
    }
    ...
    if (areasList == NULL) {
        log_error("OpenAPI_service_area_restriction_1_convertToJSON() failed [areas]");
        goto end;
    }
    OpenAPI_list_for_each(service_area_restriction_1->areas, node) {
    ...
    if (cJSON_AddNumberToObject(item, "maxNumOfTAs", service_area_restriction_1->max_num_of_tas) == NULL) {
        log_error("OpenAPI_service_area_restriction_1_convertToJSON() failed [max_num_of_tas]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "maxNumOfTAsForNotAllowedAreas", service_area_restriction_1->max_num_of_tas_for_not_allowed_areas) == NULL) {
        log_error("OpenAPI_service_area_restriction_1_convertToJSON() failed [max_num_of_tas_for_not_allowed_areas]");
        goto end;
    }
    }
...
OpenAPI_service_area_restriction_1_t *OpenAPI_service_area_restriction_1_parseFromJSON(cJSON *service_area_restriction_1JSON)
{
    ...
    if (!cJSON_IsString(restriction_type)) {
        log_error("OpenAPI_service_area_restriction_1_parseFromJSON() failed [restriction_type]");
        goto end;
    }
    ...
    if (areas) {
        ...
        if (!cJSON_IsArray(areas)) {
            log_error("OpenAPI_service_area_restriction_1_parseFromJSON() failed [areas]");
            goto end;
        }
    ...
    if (!cJSON_IsNumber(max_num_of_tas)) {
        log_error("OpenAPI_service_area_restriction_1_parseFromJSON() failed [max_num_of_tas]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(max_num_of_tas_for_not_allowed_areas)) {
        log_error("OpenAPI_service_area_restriction_1_parseFromJSON() failed [max_num_of_tas_for_not_allowed_areas]");
        goto end;
    }
    }
...
OpenAPI_service_area_restriction_1_t *OpenAPI_service_area_restriction_1_copy(OpenAPI_service_area_restriction_1_t *dst, OpenAPI_service_area_restriction_1_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_service_area_restriction_1_convertToJSON() failed");
        return NULL;
    }
