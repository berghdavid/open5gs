...
)
{
    ...
    log_assert(snssai_info_local_var);
...
cJSON *OpenAPI_snssai_info_convertToJSON(OpenAPI_snssai_info_t *snssai_info)
{
    ...
    if (snssai_info == NULL) {
        log_error("OpenAPI_snssai_info_convertToJSON() failed [SnssaiInfo]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!snssai_info->dnn_infos) {
        log_error("OpenAPI_snssai_info_convertToJSON() failed [dnn_infos]");
        return NULL;
    }
...
OpenAPI_snssai_info_t *OpenAPI_snssai_info_parseFromJSON(cJSON *snssai_infoJSON)
{
    ...
    if (!dnn_infos) {
        log_error("OpenAPI_snssai_info_parseFromJSON() failed [dnn_infos]");
        goto end;
    }
...
OpenAPI_snssai_info_t *OpenAPI_snssai_info_copy(OpenAPI_snssai_info_t *dst, OpenAPI_snssai_info_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_snssai_info_convertToJSON() failed");
        return NULL;
    }
