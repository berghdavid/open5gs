...
)
{
    ...
    log_assert(access_and_mobility_subscription_data_local_var);
...
cJSON *OpenAPI_access_and_mobility_subscription_data_convertToJSON(OpenAPI_access_and_mobility_subscription_data_t *access_and_mobility_subscription_data)
{
    ...
    if (access_and_mobility_subscription_data == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [AccessAndMobilitySubscriptionData]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", access_and_mobility_subscription_data->supported_features) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (gpsisList == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [gpsis]");
        goto end;
    }
    OpenAPI_list_for_each(access_and_mobility_subscription_data->gpsis, node) {
    ...
    if (cJSON_AddStringToObject(item, "hssGroupId", access_and_mobility_subscription_data->hss_group_id) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [hss_group_id]");
        goto end;
    }
    }
    ...
    if (internal_group_idsList == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [internal_group_ids]");
        goto end;
    }
    OpenAPI_list_for_each(access_and_mobility_subscription_data->internal_group_ids, node) {
    ...
    if (shared_vn_group_data_ids == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [shared_vn_group_data_ids]");
        goto end;
    }
    ...
    if (access_and_mobility_subscription_data->shared_vn_group_data_ids) {
        OpenAPI_list_for_each(access_and_mobility_subscription_data->shared_vn_group_data_ids, node) {
            ...
            if (cJSON_AddStringToObject(localMapObject, localKeyValue->key, (char*)localKeyValue->value) == NULL) {
                log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [inner]");
                goto end;
            }
        }
    }
    ...
    if (subscribed_ue_ambr_local_JSON == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [subscribed_ue_ambr]");
        goto end;
    }
    ...
    if (nssai_local_JSON == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [nssai]");
        goto end;
    }
    ...
    if (rat_restrictionsList == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [rat_restrictions]");
        goto end;
    }
    ...
    if (forbidden_areasList == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [forbidden_areas]");
        goto end;
    }
    OpenAPI_list_for_each(access_and_mobility_subscription_data->forbidden_areas, node) {
    ...
    if (service_area_restriction_local_JSON == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [service_area_restriction]");
        goto end;
    }
    ...
    if (core_network_type_restrictionsList == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [core_network_type_restrictions]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "rfspIndex", access_and_mobility_subscription_data->rfsp_index) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [rfsp_index]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "subsRegTimer", access_and_mobility_subscription_data->subs_reg_timer) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [subs_reg_timer]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "ueUsageType", access_and_mobility_subscription_data->ue_usage_type) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [ue_usage_type]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "mpsPriority", access_and_mobility_subscription_data->mps_priority) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [mps_priority]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "mcsPriority", access_and_mobility_subscription_data->mcs_priority) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [mcs_priority]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "activeTime", access_and_mobility_subscription_data->active_time) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [active_time]");
        goto end;
    }
    ...
    if (sor_info_local_JSON == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [sor_info]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "sorInfoExpectInd", access_and_mobility_subscription_data->sor_info_expect_ind) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [sor_info_expect_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "sorafRetrieval", access_and_mobility_subscription_data->soraf_retrieval) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [soraf_retrieval]");
        goto end;
    }
    }
    ...
    if (sor_update_indicator_listList == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [sor_update_indicator_list]");
        goto end;
    }
    ...
    if (upu_info_local_JSON == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [upu_info]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "routingIndicator", access_and_mobility_subscription_data->routing_indicator) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [routing_indicator]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "micoAllowed", access_and_mobility_subscription_data->mico_allowed) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [mico_allowed]");
        goto end;
    }
    }
    ...
    if (shared_am_data_idsList == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [shared_am_data_ids]");
        goto end;
    }
    OpenAPI_list_for_each(access_and_mobility_subscription_data->shared_am_data_ids, node) {
    ...
    if (cJSON_AddStringToObject(item, "odbPacketServices", OpenAPI_odb_packet_services_ToString(access_and_mobility_subscription_data->odb_packet_services)) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [odb_packet_services]");
        goto end;
    }
    }
    ...
    if (subscribed_dnn_listList == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [subscribed_dnn_list]");
        goto end;
    }
    OpenAPI_list_for_each(access_and_mobility_subscription_data->subscribed_dnn_list, node) {
    ...
    if (cJSON_AddNumberToObject(item, "serviceGapTime", access_and_mobility_subscription_data->service_gap_time) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [service_gap_time]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "mdtUserConsent", OpenAPI_mdt_user_consent_ToString(access_and_mobility_subscription_data->mdt_user_consent)) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [mdt_user_consent]");
        goto end;
    }
    }
    ...
    if (mdt_configuration_local_JSON == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [mdt_configuration]");
        goto end;
    }
    ...
    if (trace_data_local_JSON == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [trace_data]");
        goto end;
    }
    ...
    if (cag_data_local_JSON == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [cag_data]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "stnSr", access_and_mobility_subscription_data->stn_sr) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [stn_sr]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "cMsisdn", access_and_mobility_subscription_data->c_msisdn) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [c_msisdn]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "nbIoTUePriority", access_and_mobility_subscription_data->nb_io_tue_priority) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [nb_io_tue_priority]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "nssaiInclusionAllowed", access_and_mobility_subscription_data->nssai_inclusion_allowed) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [nssai_inclusion_allowed]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "rgWirelineCharacteristics", access_and_mobility_subscription_data->rg_wireline_characteristics) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [rg_wireline_characteristics]");
        goto end;
    }
    }
    ...
    if (ec_restriction_data_wb_local_JSON == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [ec_restriction_data_wb]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "ecRestrictionDataNb", access_and_mobility_subscription_data->ec_restriction_data_nb) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [ec_restriction_data_nb]");
        goto end;
    }
    }
    ...
    if (expected_ue_behaviour_list_local_JSON == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [expected_ue_behaviour_list]");
        goto end;
    }
    ...
    if (primary_rat_restrictionsList == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [primary_rat_restrictions]");
        goto end;
    }
    ...
    if (secondary_rat_restrictionsList == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [secondary_rat_restrictions]");
        goto end;
    }
    ...
    if (edrx_parameters_listList == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [edrx_parameters_list]");
        goto end;
    }
    OpenAPI_list_for_each(access_and_mobility_subscription_data->edrx_parameters_list, node) {
    ...
    if (ptw_parameters_listList == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [ptw_parameters_list]");
        goto end;
    }
    OpenAPI_list_for_each(access_and_mobility_subscription_data->ptw_parameters_list, node) {
    ...
    if (cJSON_AddBoolToObject(item, "iabOperationAllowed", access_and_mobility_subscription_data->iab_operation_allowed) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [iab_operation_allowed]");
        goto end;
    }
    }
    ...
    if (adjacent_plmn_restrictions == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [adjacent_plmn_restrictions]");
        goto end;
    }
    ...
    if (wireline_forbidden_areasList == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [wireline_forbidden_areas]");
        goto end;
    }
    OpenAPI_list_for_each(access_and_mobility_subscription_data->wireline_forbidden_areas, node) {
    ...
    if (wireline_service_area_restriction_local_JSON == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [wireline_service_area_restriction]");
        goto end;
    }
    ...
    if (pcf_selection_assistance_infosList == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [pcf_selection_assistance_infos]");
        goto end;
    }
    OpenAPI_list_for_each(access_and_mobility_subscription_data->pcf_selection_assistance_infos, node) {
    ...
    if (aerial_ue_sub_info_local_JSON == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [aerial_ue_sub_info]");
        goto end;
    }
    ...
    if (roaming_restrictions_local_JSON == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [roaming_restrictions]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "remoteProvInd", access_and_mobility_subscription_data->remote_prov_ind) == NULL) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [remote_prov_ind]");
        goto end;
    }
    }
...
OpenAPI_access_and_mobility_subscription_data_t *OpenAPI_access_and_mobility_subscription_data_parseFromJSON(cJSON *access_and_mobility_subscription_dataJSON)
{
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (gpsis) {
        ...
        if (!cJSON_IsArray(gpsis)) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [gpsis]");
            goto end;
        }
    ...
    if (!cJSON_IsString(hss_group_id) && !cJSON_IsNull(hss_group_id)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [hss_group_id]");
        goto end;
    }
    }
    ...
    if (internal_group_ids) {
        ...
        if (!cJSON_IsArray(internal_group_ids)) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [internal_group_ids]");
            goto end;
        }
    ...
    if (shared_vn_group_data_ids) {
        ...
        if (!cJSON_IsObject(shared_vn_group_data_ids) && !cJSON_IsNull(shared_vn_group_data_ids)) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [shared_vn_group_data_ids]");
            goto end;
        }
        if (cJSON_IsObject(shared_vn_group_data_ids)) {
            ...
            cJSON_ArrayForEach(shared_vn_group_data_ids_local_map, shared_vn_group_data_ids) {
                ...
                if (!cJSON_IsString(localMapObject)) {
                    log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [inner]");
                    goto end;
                }
    ...
    if (!nssai_local_nonprim) {
        log_error("OpenAPI_nssai_parseFromJSON failed [nssai]");
        goto end;
    }
    }
    }
    ...
    if (rat_restrictions) {
        ...
        if (!cJSON_IsArray(rat_restrictions)) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [rat_restrictions]");
            goto end;
        }
        ...
        if (rat_restrictionsList->count == 0) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed: Expected rat_restrictionsList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (forbidden_areas) {
        ...
        if (!cJSON_IsArray(forbidden_areas)) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [forbidden_areas]");
            goto end;
        }
    ...
    if (core_network_type_restrictions) {
        ...
        if (!cJSON_IsArray(core_network_type_restrictions)) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [core_network_type_restrictions]");
            goto end;
        }
        ...
        if (core_network_type_restrictionsList->count == 0) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed: Expected core_network_type_restrictionsList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (!cJSON_IsNumber(rfsp_index)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [rfsp_index]");
        goto end;
    }
    }
    }
    ...
    if (!cJSON_IsNumber(subs_reg_timer)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [subs_reg_timer]");
        goto end;
    }
    }
    }
    ...
    if (!cJSON_IsNumber(ue_usage_type)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [ue_usage_type]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(mps_priority)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [mps_priority]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(mcs_priority)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [mcs_priority]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(active_time)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [active_time]");
        goto end;
    }
    }
    }
    ...
    if (!cJSON_IsBool(sor_info_expect_ind)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [sor_info_expect_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(soraf_retrieval)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [soraf_retrieval]");
        goto end;
    }
    }
    ...
    if (sor_update_indicator_list) {
        ...
        if (!cJSON_IsArray(sor_update_indicator_list)) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [sor_update_indicator_list]");
            goto end;
        }
        ...
        if (sor_update_indicator_listList->count == 0) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed: Expected sor_update_indicator_listList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (!upu_info_local_nonprim) {
        log_error("OpenAPI_upu_info_parseFromJSON failed [upu_info]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(routing_indicator) && !cJSON_IsNull(routing_indicator)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [routing_indicator]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(mico_allowed)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [mico_allowed]");
        goto end;
    }
    }
    ...
    if (shared_am_data_ids) {
        ...
        if (!cJSON_IsArray(shared_am_data_ids)) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [shared_am_data_ids]");
            goto end;
        }
    ...
    if (!cJSON_IsString(odb_packet_services)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [odb_packet_services]");
        goto end;
    }
    ...
    if (subscribed_dnn_list) {
        ...
        if (!cJSON_IsArray(subscribed_dnn_list)) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [subscribed_dnn_list]");
            goto end;
        }
    ...
    if (!cJSON_IsNumber(service_gap_time)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [service_gap_time]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(mdt_user_consent)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [mdt_user_consent]");
        goto end;
    }
    ...
    if (!mdt_configuration_local_nonprim) {
        log_error("OpenAPI_mdt_configuration_parseFromJSON failed [mdt_configuration]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(stn_sr) && !cJSON_IsNull(stn_sr)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [stn_sr]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(c_msisdn) && !cJSON_IsNull(c_msisdn)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [c_msisdn]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(nb_io_tue_priority)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [nb_io_tue_priority]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(nssai_inclusion_allowed)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [nssai_inclusion_allowed]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(rg_wireline_characteristics) && !cJSON_IsNull(rg_wireline_characteristics)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [rg_wireline_characteristics]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(ec_restriction_data_nb)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [ec_restriction_data_nb]");
        goto end;
    }
    }
    ...
    if (!expected_ue_behaviour_list_local_nonprim) {
        log_error("OpenAPI_expected_ue_behaviour_data_parseFromJSON failed [expected_ue_behaviour_list]");
        goto end;
    }
    }
    ...
    if (primary_rat_restrictions) {
        ...
        if (!cJSON_IsArray(primary_rat_restrictions)) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [primary_rat_restrictions]");
            goto end;
        }
        ...
        if (primary_rat_restrictionsList->count == 0) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed: Expected primary_rat_restrictionsList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (secondary_rat_restrictions) {
        ...
        if (!cJSON_IsArray(secondary_rat_restrictions)) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [secondary_rat_restrictions]");
            goto end;
        }
        ...
        if (secondary_rat_restrictionsList->count == 0) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed: Expected secondary_rat_restrictionsList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (edrx_parameters_list) {
        ...
        if (!cJSON_IsArray(edrx_parameters_list)) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [edrx_parameters_list]");
            goto end;
        }
    ...
    if (ptw_parameters_list) {
        ...
        if (!cJSON_IsArray(ptw_parameters_list)) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [ptw_parameters_list]");
            goto end;
        }
    ...
    if (!cJSON_IsBool(iab_operation_allowed)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [iab_operation_allowed]");
        goto end;
    }
    }
    ...
    if (adjacent_plmn_restrictions) {
        ...
        if (!cJSON_IsObject(adjacent_plmn_restrictions) && !cJSON_IsNull(adjacent_plmn_restrictions)) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [adjacent_plmn_restrictions]");
            goto end;
        }
    ...
    if (wireline_forbidden_areas) {
        ...
        if (!cJSON_IsArray(wireline_forbidden_areas)) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [wireline_forbidden_areas]");
            goto end;
        }
    ...
    if (!wireline_service_area_restriction_local_nonprim) {
        log_error("OpenAPI_wireline_service_area_restriction_parseFromJSON failed [wireline_service_area_restriction]");
        goto end;
    }
    }
    ...
    if (pcf_selection_assistance_infos) {
        ...
        if (!cJSON_IsArray(pcf_selection_assistance_infos)) {
            log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [pcf_selection_assistance_infos]");
            goto end;
        }
    ...
    if (!aerial_ue_sub_info_local_nonprim) {
        log_error("OpenAPI_aerial_ue_subscription_info_parseFromJSON failed [aerial_ue_sub_info]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(remote_prov_ind)) {
        log_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [remote_prov_ind]");
        goto end;
    }
    }
...
OpenAPI_access_and_mobility_subscription_data_t *OpenAPI_access_and_mobility_subscription_data_copy(OpenAPI_access_and_mobility_subscription_data_t *dst, OpenAPI_access_and_mobility_subscription_data_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed");
        return NULL;
    }
