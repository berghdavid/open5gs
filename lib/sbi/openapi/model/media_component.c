...
)
{
    ...
    log_assert(media_component_local_var);
...
cJSON *OpenAPI_media_component_convertToJSON(OpenAPI_media_component_t *media_component)
{
    ...
    if (media_component == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [MediaComponent]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "afAppId", media_component->af_app_id) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [af_app_id]");
        goto end;
    }
    }
    ...
    if (af_rout_req_local_JSON == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [af_rout_req]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "qosReference", media_component->qos_reference) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [qos_reference]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "disUeNotif", media_component->dis_ue_notif) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [dis_ue_notif]");
        goto end;
    }
    }
    ...
    if (alt_ser_reqsList == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [alt_ser_reqs]");
        goto end;
    }
    OpenAPI_list_for_each(media_component->alt_ser_reqs, node) {
    ...
    if (alt_ser_reqs_dataList == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [alt_ser_reqs_data]");
        goto end;
    }
    OpenAPI_list_for_each(media_component->alt_ser_reqs_data, node) {
    ...
    if (cJSON_AddNumberToObject(item, "contVer", media_component->cont_ver) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [cont_ver]");
        goto end;
    }
    }
    ...
    if (codecsList == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [codecs]");
        goto end;
    }
    OpenAPI_list_for_each(media_component->codecs, node) {
    ...
    if (cJSON_AddNumberToObject(item, "desMaxLatency", media_component->des_max_latency) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [des_max_latency]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "desMaxLoss", media_component->des_max_loss) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [des_max_loss]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "flusId", media_component->flus_id) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [flus_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "fStatus", OpenAPI_flow_status_ToString(media_component->f_status)) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [f_status]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "marBwDl", media_component->mar_bw_dl) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [mar_bw_dl]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "marBwUl", media_component->mar_bw_ul) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [mar_bw_ul]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "maxPacketLossRateDl", media_component->max_packet_loss_rate_dl) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [max_packet_loss_rate_dl]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "maxPacketLossRateUl", media_component->max_packet_loss_rate_ul) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [max_packet_loss_rate_ul]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "maxSuppBwDl", media_component->max_supp_bw_dl) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [max_supp_bw_dl]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "maxSuppBwUl", media_component->max_supp_bw_ul) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [max_supp_bw_ul]");
        goto end;
    }
    }

    if (cJSON_AddNumberToObject(item, "medCompN", media_component->med_comp_n) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [med_comp_n]");
        goto end;
    }
    ...
    if (med_sub_comps == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [med_sub_comps]");
        goto end;
    }
    ...
    if (media_component->med_sub_comps) {
        OpenAPI_list_for_each(media_component->med_sub_comps, node) {
            ...
            cJSON *itemLocal = localKeyValue->value ?
                ...
                cJSON_CreateNull();
            if (itemLocal == NULL) {
                log_error("OpenAPI_media_component_convertToJSON() failed [inner]");
                goto end;
            }
    ...
    if (cJSON_AddStringToObject(item, "medType", OpenAPI_media_type_ToString(media_component->med_type)) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [med_type]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "minDesBwDl", media_component->min_des_bw_dl) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [min_des_bw_dl]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "minDesBwUl", media_component->min_des_bw_ul) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [min_des_bw_ul]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "mirBwDl", media_component->mir_bw_dl) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [mir_bw_dl]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "mirBwUl", media_component->mir_bw_ul) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [mir_bw_ul]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "preemptCap", OpenAPI_preemption_capability_ToString(media_component->preempt_cap)) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [preempt_cap]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "preemptVuln", OpenAPI_preemption_vulnerability_ToString(media_component->preempt_vuln)) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [preempt_vuln]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "prioSharingInd", OpenAPI_priority_sharing_indicator_ToString(media_component->prio_sharing_ind)) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [prio_sharing_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "resPrio", OpenAPI_reserv_priority_ToString(media_component->res_prio)) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [res_prio]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "rrBw", media_component->rr_bw) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [rr_bw]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "rsBw", media_component->rs_bw) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [rs_bw]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "sharingKeyDl", media_component->sharing_key_dl) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [sharing_key_dl]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "sharingKeyUl", media_component->sharing_key_ul) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [sharing_key_ul]");
        goto end;
    }
    }
    ...
    if (tsn_qos_local_JSON == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [tsn_qos]");
        goto end;
    }
    ...
    if (tscai_input_dl_local_JSON == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [tscai_input_dl]");
        goto end;
    }
    ...
    if (tscai_input_ul_local_JSON == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [tscai_input_ul]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "tscaiTimeDom", media_component->tscai_time_dom) == NULL) {
        log_error("OpenAPI_media_component_convertToJSON() failed [tscai_time_dom]");
        goto end;
    }
    }
...
OpenAPI_media_component_t *OpenAPI_media_component_parseFromJSON(cJSON *media_componentJSON)
{
    ...
    if (!cJSON_IsString(af_app_id) && !cJSON_IsNull(af_app_id)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [af_app_id]");
        goto end;
    }
    }
    ...
    if (!af_rout_req_local_nonprim) {
        log_error("OpenAPI_af_routing_requirement_parseFromJSON failed [af_rout_req]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(qos_reference) && !cJSON_IsNull(qos_reference)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [qos_reference]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(dis_ue_notif)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [dis_ue_notif]");
        goto end;
    }
    }
    ...
    if (alt_ser_reqs) {
        ...
        if (!cJSON_IsArray(alt_ser_reqs)) {
            log_error("OpenAPI_media_component_parseFromJSON() failed [alt_ser_reqs]");
            goto end;
        }
    ...
    if (alt_ser_reqs_data) {
        ...
        if (!cJSON_IsArray(alt_ser_reqs_data)) {
            log_error("OpenAPI_media_component_parseFromJSON() failed [alt_ser_reqs_data]");
            goto end;
        }
    ...
    if (!cJSON_IsNumber(cont_ver)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [cont_ver]");
        goto end;
    }
    }
    ...
    if (codecs) {
        ...
        if (!cJSON_IsArray(codecs)) {
            log_error("OpenAPI_media_component_parseFromJSON() failed [codecs]");
            goto end;
        }
    ...
    if (!cJSON_IsNumber(des_max_latency)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [des_max_latency]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(des_max_loss)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [des_max_loss]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(flus_id) && !cJSON_IsNull(flus_id)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [flus_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(f_status)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [f_status]");
        goto end;
    }
    ...
    if (!cJSON_IsString(mar_bw_dl) && !cJSON_IsNull(mar_bw_dl)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [mar_bw_dl]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(mar_bw_ul) && !cJSON_IsNull(mar_bw_ul)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [mar_bw_ul]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(max_packet_loss_rate_dl)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [max_packet_loss_rate_dl]");
        goto end;
    }
    }
    }
    ...
    if (!cJSON_IsNumber(max_packet_loss_rate_ul)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [max_packet_loss_rate_ul]");
        goto end;
    }
    }
    }
    ...
    if (!cJSON_IsString(max_supp_bw_dl) && !cJSON_IsNull(max_supp_bw_dl)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [max_supp_bw_dl]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(max_supp_bw_ul) && !cJSON_IsNull(max_supp_bw_ul)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [max_supp_bw_ul]");
        goto end;
    }
    }
    ...
    if (!med_comp_n) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [med_comp_n]");
        goto end;
    }
    ...
    if (med_sub_comps) {
        ...
        if (!cJSON_IsObject(med_sub_comps) && !cJSON_IsNull(med_sub_comps)) {
            log_error("OpenAPI_media_component_parseFromJSON() failed [med_sub_comps]");
            goto end;
        }
        if (cJSON_IsObject(med_sub_comps)) {
            ...
            cJSON_ArrayForEach(med_sub_comps_local_map, med_sub_comps) {
                ...
                if (cJSON_IsObject(localMapObject)) {
                    ...
                    log_error("OpenAPI_media_component_parseFromJSON() failed [inner]");
                    goto end;
                }
    ...
    if (!cJSON_IsString(med_type)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [med_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(min_des_bw_dl) && !cJSON_IsNull(min_des_bw_dl)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [min_des_bw_dl]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(min_des_bw_ul) && !cJSON_IsNull(min_des_bw_ul)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [min_des_bw_ul]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(mir_bw_dl) && !cJSON_IsNull(mir_bw_dl)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [mir_bw_dl]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(mir_bw_ul) && !cJSON_IsNull(mir_bw_ul)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [mir_bw_ul]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(preempt_cap)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [preempt_cap]");
        goto end;
    }
    ...
    if (!cJSON_IsString(preempt_vuln)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [preempt_vuln]");
        goto end;
    }
    ...
    if (!cJSON_IsString(prio_sharing_ind)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [prio_sharing_ind]");
        goto end;
    }
    ...
    if (!cJSON_IsString(res_prio)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [res_prio]");
        goto end;
    }
    ...
    if (!cJSON_IsString(rr_bw) && !cJSON_IsNull(rr_bw)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [rr_bw]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(rs_bw) && !cJSON_IsNull(rs_bw)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [rs_bw]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(sharing_key_dl)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [sharing_key_dl]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(sharing_key_ul)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [sharing_key_ul]");
        goto end;
    }
    }
    ...
    if (!tsn_qos_local_nonprim) {
        log_error("OpenAPI_tsn_qos_container_parseFromJSON failed [tsn_qos]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(tscai_time_dom)) {
        log_error("OpenAPI_media_component_parseFromJSON() failed [tscai_time_dom]");
        goto end;
    }
    }
...
OpenAPI_media_component_t *OpenAPI_media_component_copy(OpenAPI_media_component_t *dst, OpenAPI_media_component_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_media_component_convertToJSON() failed");
        return NULL;
    }
