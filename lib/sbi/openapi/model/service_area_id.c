...
)
{
    ...
    log_assert(service_area_id_local_var);
...
cJSON *OpenAPI_service_area_id_convertToJSON(OpenAPI_service_area_id_t *service_area_id)
{
    ...
    if (service_area_id == NULL) {
        log_error("OpenAPI_service_area_id_convertToJSON() failed [ServiceAreaId]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!service_area_id->plmn_id) {
        log_error("OpenAPI_service_area_id_convertToJSON() failed [plmn_id]");
        return NULL;
    }
    ...
    if (!service_area_id->lac) {
        log_error("OpenAPI_service_area_id_convertToJSON() failed [lac]");
        return NULL;
    }
    ...
    if (!service_area_id->sac) {
        log_error("OpenAPI_service_area_id_convertToJSON() failed [sac]");
        return NULL;
    }
...
OpenAPI_service_area_id_t *OpenAPI_service_area_id_parseFromJSON(cJSON *service_area_idJSON)
{
    ...
    if (!plmn_id) {
        log_error("OpenAPI_service_area_id_parseFromJSON() failed [plmn_id]");
        goto end;
    }
    ...
    if (!lac) {
        log_error("OpenAPI_service_area_id_parseFromJSON() failed [lac]");
        goto end;
    }
    ...
    if (!sac) {
        log_error("OpenAPI_service_area_id_parseFromJSON() failed [sac]");
        goto end;
    }
...
OpenAPI_service_area_id_t *OpenAPI_service_area_id_copy(OpenAPI_service_area_id_t *dst, OpenAPI_service_area_id_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_service_area_id_convertToJSON() failed");
        return NULL;
    }
