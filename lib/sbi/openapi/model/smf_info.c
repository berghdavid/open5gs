...
cJSON *OpenAPI_smf_info_convertToJSON(OpenAPI_smf_info_t *smf_info)
{
    ...
    if (smf_info == NULL) {
        log_error("OpenAPI_smf_info_convertToJSON() failed [SmfInfo]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!smf_info->s_nssai_smf_info_list) {
        log_error("OpenAPI_smf_info_convertToJSON() failed [s_nssai_smf_info_list]");
        return NULL;
    }
    ...
    if (tai_listList == NULL) {
        log_error("OpenAPI_smf_info_convertToJSON() failed [tai_list]");
        goto end;
    }
    OpenAPI_list_for_each(smf_info->tai_list, node) {
    ...
    if (tai_range_listList == NULL) {
        log_error("OpenAPI_smf_info_convertToJSON() failed [tai_range_list]");
        goto end;
    }
    OpenAPI_list_for_each(smf_info->tai_range_list, node) {
    ...
    if (cJSON_AddStringToObject(item, "pgwFqdn", smf_info->pgw_fqdn) == NULL) {
        log_error("OpenAPI_smf_info_convertToJSON() failed [pgw_fqdn]");
        goto end;
    }
    }
    ...
    if (pgw_ip_addr_listList == NULL) {
        log_error("OpenAPI_smf_info_convertToJSON() failed [pgw_ip_addr_list]");
        goto end;
    }
    OpenAPI_list_for_each(smf_info->pgw_ip_addr_list, node) {
    ...
    if (access_typeList == NULL) {
        log_error("OpenAPI_smf_info_convertToJSON() failed [access_type]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "priority", smf_info->priority) == NULL) {
        log_error("OpenAPI_smf_info_convertToJSON() failed [priority]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "vsmfSupportInd", smf_info->vsmf_support_ind) == NULL) {
        log_error("OpenAPI_smf_info_convertToJSON() failed [vsmf_support_ind]");
        goto end;
    }
    }
    ...
    if (pgw_fqdn_listList == NULL) {
        log_error("OpenAPI_smf_info_convertToJSON() failed [pgw_fqdn_list]");
        goto end;
    }
    OpenAPI_list_for_each(smf_info->pgw_fqdn_list, node) {
    ...
    if (cJSON_AddBoolToObject(item, "smfOnboardingCapability", smf_info->smf_onboarding_capability) == NULL) {
        log_error("OpenAPI_smf_info_convertToJSON() failed [smf_onboarding_capability]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "ismfSupportInd", smf_info->ismf_support_ind) == NULL) {
        log_error("OpenAPI_smf_info_convertToJSON() failed [ismf_support_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "smfUPRPCapability", smf_info->smf_uprp_capability) == NULL) {
        log_error("OpenAPI_smf_info_convertToJSON() failed [smf_uprp_capability]");
        goto end;
    }
    }
...
OpenAPI_smf_info_t *OpenAPI_smf_info_parseFromJSON(cJSON *smf_infoJSON)
{
    ...
    if (!s_nssai_smf_info_list) {
        log_error("OpenAPI_smf_info_parseFromJSON() failed [s_nssai_smf_info_list]");
        goto end;
    }
    ...
    if (tai_list) {
        ...
        if (!cJSON_IsArray(tai_list)) {
            log_error("OpenAPI_smf_info_parseFromJSON() failed [tai_list]");
            goto end;
        }
    ...
    if (tai_range_list) {
        ...
        if (!cJSON_IsArray(tai_range_list)) {
            log_error("OpenAPI_smf_info_parseFromJSON() failed [tai_range_list]");
            goto end;
        }
    ...
    if (!cJSON_IsString(pgw_fqdn) && !cJSON_IsNull(pgw_fqdn)) {
        log_error("OpenAPI_smf_info_parseFromJSON() failed [pgw_fqdn]");
        goto end;
    }
    }
    ...
    if (pgw_ip_addr_list) {
        ...
        if (!cJSON_IsArray(pgw_ip_addr_list)) {
            log_error("OpenAPI_smf_info_parseFromJSON() failed [pgw_ip_addr_list]");
            goto end;
        }
    ...
    if (access_type) {
        ...
        if (!cJSON_IsArray(access_type)) {
            log_error("OpenAPI_smf_info_parseFromJSON() failed [access_type]");
            goto end;
        }
        ...
        if (access_typeList->count == 0) {
            log_error("OpenAPI_smf_info_parseFromJSON() failed: Expected access_typeList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (!cJSON_IsNumber(priority)) {
        log_error("OpenAPI_smf_info_parseFromJSON() failed [priority]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(vsmf_support_ind)) {
        log_error("OpenAPI_smf_info_parseFromJSON() failed [vsmf_support_ind]");
        goto end;
    }
    }
    ...
    if (pgw_fqdn_list) {
        ...
        if (!cJSON_IsArray(pgw_fqdn_list)) {
            log_error("OpenAPI_smf_info_parseFromJSON() failed [pgw_fqdn_list]");
            goto end;
        }
    ...
    if (!cJSON_IsBool(smf_onboarding_capability)) {
        log_error("OpenAPI_smf_info_parseFromJSON() failed [smf_onboarding_capability]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(ismf_support_ind)) {
        log_error("OpenAPI_smf_info_parseFromJSON() failed [ismf_support_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(smf_uprp_capability)) {
        log_error("OpenAPI_smf_info_parseFromJSON() failed [smf_uprp_capability]");
        goto end;
    }
    }
...
OpenAPI_smf_info_t *OpenAPI_smf_info_copy(OpenAPI_smf_info_t *dst, OpenAPI_smf_info_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_smf_info_convertToJSON() failed");
        return NULL;
    }
