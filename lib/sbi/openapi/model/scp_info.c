...
cJSON *OpenAPI_scp_info_convertToJSON(OpenAPI_scp_info_t *scp_info)
{
    ...
    if (scp_info == NULL) {
        log_error("OpenAPI_scp_info_convertToJSON() failed [ScpInfo]");
        return NULL;
    }
    ...
    if (scp_domain_info_list == NULL) {
        log_error("OpenAPI_scp_info_convertToJSON() failed [scp_domain_info_list]");
        goto end;
    }
    ...
    if (scp_info->scp_domain_info_list) {
        OpenAPI_list_for_each(scp_info->scp_domain_info_list, node) {
            ...
            cJSON *itemLocal = localKeyValue->value ?
                ...
                cJSON_CreateNull();
            if (itemLocal == NULL) {
                log_error("OpenAPI_scp_info_convertToJSON() failed [inner]");
                goto end;
            }
    ...
    if (cJSON_AddStringToObject(item, "scpPrefix", scp_info->scp_prefix) == NULL) {
        log_error("OpenAPI_scp_info_convertToJSON() failed [scp_prefix]");
        goto end;
    }
    }
    ...
    if (scp_ports == NULL) {
        log_error("OpenAPI_scp_info_convertToJSON() failed [scp_ports]");
        goto end;
    }
    ...
    if (address_domainsList == NULL) {
        log_error("OpenAPI_scp_info_convertToJSON() failed [address_domains]");
        goto end;
    }
    OpenAPI_list_for_each(scp_info->address_domains, node) {
    ...
    if (ipv4_addressesList == NULL) {
        log_error("OpenAPI_scp_info_convertToJSON() failed [ipv4_addresses]");
        goto end;
    }
    OpenAPI_list_for_each(scp_info->ipv4_addresses, node) {
    ...
    if (ipv6_prefixesList == NULL) {
        log_error("OpenAPI_scp_info_convertToJSON() failed [ipv6_prefixes]");
        goto end;
    }
    OpenAPI_list_for_each(scp_info->ipv6_prefixes, node) {
    ...
    if (ipv4_addr_rangesList == NULL) {
        log_error("OpenAPI_scp_info_convertToJSON() failed [ipv4_addr_ranges]");
        goto end;
    }
    OpenAPI_list_for_each(scp_info->ipv4_addr_ranges, node) {
    ...
    if (ipv6_prefix_rangesList == NULL) {
        log_error("OpenAPI_scp_info_convertToJSON() failed [ipv6_prefix_ranges]");
        goto end;
    }
    OpenAPI_list_for_each(scp_info->ipv6_prefix_ranges, node) {
    ...
    if (served_nf_set_id_listList == NULL) {
        log_error("OpenAPI_scp_info_convertToJSON() failed [served_nf_set_id_list]");
        goto end;
    }
    OpenAPI_list_for_each(scp_info->served_nf_set_id_list, node) {
    ...
    if (remote_plmn_listList == NULL) {
        log_error("OpenAPI_scp_info_convertToJSON() failed [remote_plmn_list]");
        goto end;
    }
    OpenAPI_list_for_each(scp_info->remote_plmn_list, node) {
    ...
    if (remote_snpn_listList == NULL) {
        log_error("OpenAPI_scp_info_convertToJSON() failed [remote_snpn_list]");
        goto end;
    }
    OpenAPI_list_for_each(scp_info->remote_snpn_list, node) {
    ...
    if (cJSON_AddStringToObject(item, "ipReachability", OpenAPI_ip_reachability_ToString(scp_info->ip_reachability)) == NULL) {
        log_error("OpenAPI_scp_info_convertToJSON() failed [ip_reachability]");
        goto end;
    }
    }
    ...
    if (scp_capabilitiesList == NULL) {
        log_error("OpenAPI_scp_info_convertToJSON() failed [scp_capabilities]");
        goto end;
    }
...
OpenAPI_scp_info_t *OpenAPI_scp_info_parseFromJSON(cJSON *scp_infoJSON)
{
    ...
    if (scp_domain_info_list) {
        ...
        if (!cJSON_IsObject(scp_domain_info_list) && !cJSON_IsNull(scp_domain_info_list)) {
            log_error("OpenAPI_scp_info_parseFromJSON() failed [scp_domain_info_list]");
            goto end;
        }
        if (cJSON_IsObject(scp_domain_info_list)) {
            ...
            cJSON_ArrayForEach(scp_domain_info_list_local_map, scp_domain_info_list) {
                ...
                if (cJSON_IsObject(localMapObject)) {
                    ...
                    log_error("OpenAPI_scp_info_parseFromJSON() failed [inner]");
                    goto end;
                }
    ...
    if (!cJSON_IsString(scp_prefix) && !cJSON_IsNull(scp_prefix)) {
        log_error("OpenAPI_scp_info_parseFromJSON() failed [scp_prefix]");
        goto end;
    }
    }
    ...
    if (scp_ports) {
        ...
        if (!cJSON_IsObject(scp_ports) && !cJSON_IsNull(scp_ports)) {
            log_error("OpenAPI_scp_info_parseFromJSON() failed [scp_ports]");
            goto end;
        }
    ...
    if (address_domains) {
        ...
        if (!cJSON_IsArray(address_domains)) {
            log_error("OpenAPI_scp_info_parseFromJSON() failed [address_domains]");
            goto end;
        }
    ...
    if (ipv4_addresses) {
        ...
        if (!cJSON_IsArray(ipv4_addresses)) {
            log_error("OpenAPI_scp_info_parseFromJSON() failed [ipv4_addresses]");
            goto end;
        }
    ...
    if (ipv6_prefixes) {
        ...
        if (!cJSON_IsArray(ipv6_prefixes)) {
            log_error("OpenAPI_scp_info_parseFromJSON() failed [ipv6_prefixes]");
            goto end;
        }
    ...
    if (ipv4_addr_ranges) {
        ...
        if (!cJSON_IsArray(ipv4_addr_ranges)) {
            log_error("OpenAPI_scp_info_parseFromJSON() failed [ipv4_addr_ranges]");
            goto end;
        }
    ...
    if (ipv6_prefix_ranges) {
        ...
        if (!cJSON_IsArray(ipv6_prefix_ranges)) {
            log_error("OpenAPI_scp_info_parseFromJSON() failed [ipv6_prefix_ranges]");
            goto end;
        }
    ...
    if (served_nf_set_id_list) {
        ...
        if (!cJSON_IsArray(served_nf_set_id_list)) {
            log_error("OpenAPI_scp_info_parseFromJSON() failed [served_nf_set_id_list]");
            goto end;
        }
    ...
    if (remote_plmn_list) {
        ...
        if (!cJSON_IsArray(remote_plmn_list)) {
            log_error("OpenAPI_scp_info_parseFromJSON() failed [remote_plmn_list]");
            goto end;
        }
    ...
    if (remote_snpn_list) {
        ...
        if (!cJSON_IsArray(remote_snpn_list)) {
            log_error("OpenAPI_scp_info_parseFromJSON() failed [remote_snpn_list]");
            goto end;
        }
    ...
    if (!cJSON_IsString(ip_reachability)) {
        log_error("OpenAPI_scp_info_parseFromJSON() failed [ip_reachability]");
        goto end;
    }
    ...
    if (scp_capabilities) {
        ...
        if (!cJSON_IsArray(scp_capabilities)) {
            log_error("OpenAPI_scp_info_parseFromJSON() failed [scp_capabilities]");
            goto end;
        }
        ...
        if (scp_capabilitiesList->count == 0) {
            log_error("OpenAPI_scp_info_parseFromJSON() failed: Expected scp_capabilitiesList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
...
OpenAPI_scp_info_t *OpenAPI_scp_info_copy(OpenAPI_scp_info_t *dst, OpenAPI_scp_info_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_scp_info_convertToJSON() failed");
        return NULL;
    }
