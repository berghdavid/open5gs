...
)
{
    ...
    log_assert(pro_se_authentication_info_result_local_var);
...
cJSON *OpenAPI_pro_se_authentication_info_result_convertToJSON(OpenAPI_pro_se_authentication_info_result_t *pro_se_authentication_info_result)
{
    ...
    if (pro_se_authentication_info_result == NULL) {
        log_error("OpenAPI_pro_se_authentication_info_result_convertToJSON() failed [ProSeAuthenticationInfoResult]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (pro_se_authentication_info_result->auth_type == OpenAPI_auth_type_NULL) {
        log_error("OpenAPI_pro_se_authentication_info_result_convertToJSON() failed [auth_type]");
        return NULL;
    }
    ...
    if (prose_authentication_vectors_local_JSON == NULL) {
        log_error("OpenAPI_pro_se_authentication_info_result_convertToJSON() failed [prose_authentication_vectors]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "supi", pro_se_authentication_info_result->supi) == NULL) {
        log_error("OpenAPI_pro_se_authentication_info_result_convertToJSON() failed [supi]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", pro_se_authentication_info_result->supported_features) == NULL) {
        log_error("OpenAPI_pro_se_authentication_info_result_convertToJSON() failed [supported_features]");
        goto end;
    }
    }
...
OpenAPI_pro_se_authentication_info_result_t *OpenAPI_pro_se_authentication_info_result_parseFromJSON(cJSON *pro_se_authentication_info_resultJSON)
{
    ...
    if (!auth_type) {
        log_error("OpenAPI_pro_se_authentication_info_result_parseFromJSON() failed [auth_type]");
        goto end;
    }
    ...
    if (!prose_authentication_vectors_local_nonprim) {
        log_error("OpenAPI_pro_se_authentication_vectors_parseFromJSON failed [prose_authentication_vectors]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(supi) && !cJSON_IsNull(supi)) {
        log_error("OpenAPI_pro_se_authentication_info_result_parseFromJSON() failed [supi]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_pro_se_authentication_info_result_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
...
OpenAPI_pro_se_authentication_info_result_t *OpenAPI_pro_se_authentication_info_result_copy(OpenAPI_pro_se_authentication_info_result_t *dst, OpenAPI_pro_se_authentication_info_result_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_pro_se_authentication_info_result_convertToJSON() failed");
        return NULL;
    }
