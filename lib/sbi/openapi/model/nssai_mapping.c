...
)
{
    ...
    log_assert(nssai_mapping_local_var);
...
cJSON *OpenAPI_nssai_mapping_convertToJSON(OpenAPI_nssai_mapping_t *nssai_mapping)
{
    ...
    if (nssai_mapping == NULL) {
        log_error("OpenAPI_nssai_mapping_convertToJSON() failed [NssaiMapping]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!nssai_mapping->mapped_snssai) {
        log_error("OpenAPI_nssai_mapping_convertToJSON() failed [mapped_snssai]");
        return NULL;
    }
    ...
    if (!nssai_mapping->h_snssai) {
        log_error("OpenAPI_nssai_mapping_convertToJSON() failed [h_snssai]");
        return NULL;
    }
...
OpenAPI_nssai_mapping_t *OpenAPI_nssai_mapping_copy(OpenAPI_nssai_mapping_t *dst, OpenAPI_nssai_mapping_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_nssai_mapping_convertToJSON() failed");
        return NULL;
    }
