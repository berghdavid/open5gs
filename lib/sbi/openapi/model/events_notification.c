...
)
{
    ...
    log_assert(events_notification_local_var);
...
cJSON *OpenAPI_events_notification_convertToJSON(OpenAPI_events_notification_t *events_notification)
{
    ...
    if (events_notification == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [EventsNotification]");
        return NULL;
    }
    ...
    if (ad_reportsList == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [ad_reports]");
        goto end;
    }
    OpenAPI_list_for_each(events_notification->ad_reports, node) {
    ...
    if (cJSON_AddStringToObject(item, "accessType", OpenAPI_access_type_ToString(events_notification->access_type)) == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [access_type]");
        goto end;
    }
    }
    ...
    if (add_access_info_local_JSON == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [add_access_info]");
        goto end;
    }
    ...
    if (rel_access_info_local_JSON == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [rel_access_info]");
        goto end;
    }
    ...
    if (an_charg_addr_local_JSON == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [an_charg_addr]");
        goto end;
    }
    ...
    if (an_charg_idsList == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [an_charg_ids]");
        goto end;
    }
    OpenAPI_list_for_each(events_notification->an_charg_ids, node) {
    ...
    if (an_gw_addr_local_JSON == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [an_gw_addr]");
        goto end;
    }
    ...
    if (!events_notification->ev_subs_uri) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [ev_subs_uri]");
        return NULL;
    }
    ...
    if (!events_notification->ev_notifs) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [ev_notifs]");
        return NULL;
    }
    ...
    if (failed_resourc_alloc_reportsList == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [failed_resourc_alloc_reports]");
        goto end;
    }
    OpenAPI_list_for_each(events_notification->failed_resourc_alloc_reports, node) {
    ...
    if (succ_resourc_alloc_reportsList == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [succ_resourc_alloc_reports]");
        goto end;
    }
    OpenAPI_list_for_each(events_notification->succ_resourc_alloc_reports, node) {
        cJSON *itemLocal = OpenAPI_resources_allocation_info_convertToJSON(node->data);
    ...
    if (cJSON_AddStringToObject(item, "noNetLocSupp", OpenAPI_net_loc_access_support_ToString(events_notification->no_net_loc_supp)) == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [no_net_loc_supp]");
        goto end;
    }
    }
    ...
    if (out_of_cred_reportsList == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [out_of_cred_reports]");
        goto end;
    }
    OpenAPI_list_for_each(events_notification->out_of_cred_reports, node) {
    ...
    if (plmn_id_local_JSON == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [plmn_id]");
        goto end;
    }
    ...
    if (qnc_reportsList == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [qnc_reports]");
        goto end;
    }
    OpenAPI_list_for_each(events_notification->qnc_reports, node) {
    ...
    if (qos_mon_reportsList == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [qos_mon_reports]");
        goto end;
    }
    OpenAPI_list_for_each(events_notification->qos_mon_reports, node) {
    ...
    if (ran_nas_rel_causesList == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [ran_nas_rel_causes]");
        goto end;
    }
    OpenAPI_list_for_each(events_notification->ran_nas_rel_causes, node) {
    ...
    if (cJSON_AddStringToObject(item, "ratType", OpenAPI_rat_type_ToString(events_notification->rat_type)) == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [rat_type]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "satBackhaulCategory", OpenAPI_satellite_backhaul_category_ToString(events_notification->sat_backhaul_category)) == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [sat_backhaul_category]");
        goto end;
    }
    }
    ...
    if (ue_loc_local_JSON == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [ue_loc]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "ueLocTime", events_notification->ue_loc_time) == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [ue_loc_time]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ueTimeZone", events_notification->ue_time_zone) == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [ue_time_zone]");
        goto end;
    }
    }
    ...
    if (usg_rep_local_JSON == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [usg_rep]");
        goto end;
    }
    ...
    if (tsn_bridge_man_cont_local_JSON == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [tsn_bridge_man_cont]");
        goto end;
    }
    ...
    if (tsn_port_man_cont_dstt_local_JSON == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [tsn_port_man_cont_dstt]");
        goto end;
    }
    ...
    if (tsn_port_man_cont_nwttsList == NULL) {
        log_error("OpenAPI_events_notification_convertToJSON() failed [tsn_port_man_cont_nwtts]");
        goto end;
    }
    OpenAPI_list_for_each(events_notification->tsn_port_man_cont_nwtts, node) {
...
OpenAPI_events_notification_t *OpenAPI_events_notification_parseFromJSON(cJSON *events_notificationJSON)
{
    ...
    if (ad_reports) {
        ...
        if (!cJSON_IsArray(ad_reports)) {
            log_error("OpenAPI_events_notification_parseFromJSON() failed [ad_reports]");
            goto end;
        }
    ...
    if (!cJSON_IsString(access_type)) {
        log_error("OpenAPI_events_notification_parseFromJSON() failed [access_type]");
        goto end;
    }
    ...
    if (an_charg_ids) {
        ...
        if (!cJSON_IsArray(an_charg_ids)) {
            log_error("OpenAPI_events_notification_parseFromJSON() failed [an_charg_ids]");
            goto end;
        }
    ...
    if (!ev_subs_uri) {
        log_error("OpenAPI_events_notification_parseFromJSON() failed [ev_subs_uri]");
        goto end;
    }
    ...
    if (!ev_notifs) {
        log_error("OpenAPI_events_notification_parseFromJSON() failed [ev_notifs]");
        goto end;
    }
    ...
    if (failed_resourc_alloc_reports) {
        ...
        if (!cJSON_IsArray(failed_resourc_alloc_reports)) {
            log_error("OpenAPI_events_notification_parseFromJSON() failed [failed_resourc_alloc_reports]");
            goto end;
        }
    ...
    if (succ_resourc_alloc_reports) {
        ...
        if (!cJSON_IsArray(succ_resourc_alloc_reports)) {
            log_error("OpenAPI_events_notification_parseFromJSON() failed [succ_resourc_alloc_reports]");
            goto end;
        }
    ...
    if (!cJSON_IsString(no_net_loc_supp)) {
        log_error("OpenAPI_events_notification_parseFromJSON() failed [no_net_loc_supp]");
        goto end;
    }
    ...
    if (out_of_cred_reports) {
        ...
        if (!cJSON_IsArray(out_of_cred_reports)) {
            log_error("OpenAPI_events_notification_parseFromJSON() failed [out_of_cred_reports]");
            goto end;
        }
    ...
    if (qnc_reports) {
        ...
        if (!cJSON_IsArray(qnc_reports)) {
            log_error("OpenAPI_events_notification_parseFromJSON() failed [qnc_reports]");
            goto end;
        }
    ...
    if (qos_mon_reports) {
        ...
        if (!cJSON_IsArray(qos_mon_reports)) {
            log_error("OpenAPI_events_notification_parseFromJSON() failed [qos_mon_reports]");
            goto end;
        }
    ...
    if (ran_nas_rel_causes) {
        ...
        if (!cJSON_IsArray(ran_nas_rel_causes)) {
            log_error("OpenAPI_events_notification_parseFromJSON() failed [ran_nas_rel_causes]");
            goto end;
        }
    ...
    if (!cJSON_IsString(rat_type)) {
        log_error("OpenAPI_events_notification_parseFromJSON() failed [rat_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(sat_backhaul_category)) {
        log_error("OpenAPI_events_notification_parseFromJSON() failed [sat_backhaul_category]");
        goto end;
    }
    ...
    if (!cJSON_IsString(ue_loc_time) && !cJSON_IsNull(ue_loc_time)) {
        log_error("OpenAPI_events_notification_parseFromJSON() failed [ue_loc_time]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ue_time_zone) && !cJSON_IsNull(ue_time_zone)) {
        log_error("OpenAPI_events_notification_parseFromJSON() failed [ue_time_zone]");
        goto end;
    }
    }
    ...
    if (tsn_port_man_cont_nwtts) {
        ...
        if (!cJSON_IsArray(tsn_port_man_cont_nwtts)) {
            log_error("OpenAPI_events_notification_parseFromJSON() failed [tsn_port_man_cont_nwtts]");
            goto end;
        }
...
OpenAPI_events_notification_t *OpenAPI_events_notification_copy(OpenAPI_events_notification_t *dst, OpenAPI_events_notification_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_events_notification_convertToJSON() failed");
        return NULL;
    }
