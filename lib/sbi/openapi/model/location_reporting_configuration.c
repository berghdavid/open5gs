...
)
{
    ...
    log_assert(location_reporting_configuration_local_var);
...
cJSON *OpenAPI_location_reporting_configuration_convertToJSON(OpenAPI_location_reporting_configuration_t *location_reporting_configuration)
{
    ...
    if (location_reporting_configuration == NULL) {
        log_error("OpenAPI_location_reporting_configuration_convertToJSON() failed [LocationReportingConfiguration]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (cJSON_AddBoolToObject(item, "currentLocation", location_reporting_configuration->current_location) == NULL) {
        log_error("OpenAPI_location_reporting_configuration_convertToJSON() failed [current_location]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "oneTime", location_reporting_configuration->one_time) == NULL) {
        log_error("OpenAPI_location_reporting_configuration_convertToJSON() failed [one_time]");
        goto end;
    }
    }
    ...
    if (accuracy_local_JSON == NULL) {
        log_error("OpenAPI_location_reporting_configuration_convertToJSON() failed [accuracy]");
        goto end;
    }
    ...
    if (n3gpp_accuracy_local_JSON == NULL) {
        log_error("OpenAPI_location_reporting_configuration_convertToJSON() failed [n3gpp_accuracy]");
        goto end;
    }
...
OpenAPI_location_reporting_configuration_t *OpenAPI_location_reporting_configuration_parseFromJSON(cJSON *location_reporting_configurationJSON)
{
    ...
    if (!current_location) {
        log_error("OpenAPI_location_reporting_configuration_parseFromJSON() failed [current_location]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(one_time)) {
        log_error("OpenAPI_location_reporting_configuration_parseFromJSON() failed [one_time]");
        goto end;
    }
    }
...
OpenAPI_location_reporting_configuration_t *OpenAPI_location_reporting_configuration_copy(OpenAPI_location_reporting_configuration_t *dst, OpenAPI_location_reporting_configuration_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_location_reporting_configuration_convertToJSON() failed");
        return NULL;
    }
