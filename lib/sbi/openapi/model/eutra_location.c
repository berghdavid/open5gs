...
)
{
    ...
    log_assert(eutra_location_local_var);
...
cJSON *OpenAPI_eutra_location_convertToJSON(OpenAPI_eutra_location_t *eutra_location)
{
    ...
    if (eutra_location == NULL) {
        log_error("OpenAPI_eutra_location_convertToJSON() failed [EutraLocation]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!eutra_location->tai) {
        log_error("OpenAPI_eutra_location_convertToJSON() failed [tai]");
        return NULL;
    }
    ...
    if (cJSON_AddBoolToObject(item, "ignoreTai", eutra_location->ignore_tai) == NULL) {
        log_error("OpenAPI_eutra_location_convertToJSON() failed [ignore_tai]");
        goto end;
    }
    }

    if (!eutra_location->ecgi) {
        log_error("OpenAPI_eutra_location_convertToJSON() failed [ecgi]");
        return NULL;
    }
    ...
    if (cJSON_AddBoolToObject(item, "ignoreEcgi", eutra_location->ignore_ecgi) == NULL) {
        log_error("OpenAPI_eutra_location_convertToJSON() failed [ignore_ecgi]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "ageOfLocationInformation", eutra_location->age_of_location_information) == NULL) {
        log_error("OpenAPI_eutra_location_convertToJSON() failed [age_of_location_information]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ueLocationTimestamp", eutra_location->ue_location_timestamp) == NULL) {
        log_error("OpenAPI_eutra_location_convertToJSON() failed [ue_location_timestamp]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "geographicalInformation", eutra_location->geographical_information) == NULL) {
        log_error("OpenAPI_eutra_location_convertToJSON() failed [geographical_information]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "geodeticInformation", eutra_location->geodetic_information) == NULL) {
        log_error("OpenAPI_eutra_location_convertToJSON() failed [geodetic_information]");
        goto end;
    }
    }
    ...
    if (global_ngenb_id_local_JSON == NULL) {
        log_error("OpenAPI_eutra_location_convertToJSON() failed [global_ngenb_id]");
        goto end;
    }
    ...
    if (global_enb_id_local_JSON == NULL) {
        log_error("OpenAPI_eutra_location_convertToJSON() failed [global_enb_id]");
        goto end;
    }
...
OpenAPI_eutra_location_t *OpenAPI_eutra_location_parseFromJSON(cJSON *eutra_locationJSON)
{
    ...
    if (!tai) {
        log_error("OpenAPI_eutra_location_parseFromJSON() failed [tai]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(ignore_tai)) {
        log_error("OpenAPI_eutra_location_parseFromJSON() failed [ignore_tai]");
        goto end;
    }
    }
    ...
    if (!ecgi) {
        log_error("OpenAPI_eutra_location_parseFromJSON() failed [ecgi]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(ignore_ecgi)) {
        log_error("OpenAPI_eutra_location_parseFromJSON() failed [ignore_ecgi]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(age_of_location_information)) {
        log_error("OpenAPI_eutra_location_parseFromJSON() failed [age_of_location_information]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ue_location_timestamp) && !cJSON_IsNull(ue_location_timestamp)) {
        log_error("OpenAPI_eutra_location_parseFromJSON() failed [ue_location_timestamp]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(geographical_information) && !cJSON_IsNull(geographical_information)) {
        log_error("OpenAPI_eutra_location_parseFromJSON() failed [geographical_information]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(geodetic_information) && !cJSON_IsNull(geodetic_information)) {
        log_error("OpenAPI_eutra_location_parseFromJSON() failed [geodetic_information]");
        goto end;
    }
    }
    ...
    if (!global_ngenb_id_local_nonprim) {
        log_error("OpenAPI_global_ran_node_id_parseFromJSON failed [global_ngenb_id]");
        goto end;
    }
    }
    ...
    if (!global_enb_id_local_nonprim) {
        log_error("OpenAPI_global_ran_node_id_parseFromJSON failed [global_enb_id]");
        goto end;
    }
    }
...
OpenAPI_eutra_location_t *OpenAPI_eutra_location_copy(OpenAPI_eutra_location_t *dst, OpenAPI_eutra_location_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_eutra_location_convertToJSON() failed");
        return NULL;
    }
