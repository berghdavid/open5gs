...
)
{
    ...
    log_assert(local_area_local_var);
...
cJSON *OpenAPI_local_area_convertToJSON(OpenAPI_local_area_t *local_area)
{
    ...
    if (local_area == NULL) {
        log_error("OpenAPI_local_area_convertToJSON() failed [LocalArea]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!local_area->shape) {
        log_error("OpenAPI_local_area_convertToJSON() failed [shape]");
        return NULL;
    }
    ...
    if (!local_area->local_origin) {
        log_error("OpenAPI_local_area_convertToJSON() failed [local_origin]");
        return NULL;
    }
    ...
    if (!local_area->point) {
        log_error("OpenAPI_local_area_convertToJSON() failed [point]");
        return NULL;
    }
    ...
    if (!local_area->uncertainty_ellipse) {
        log_error("OpenAPI_local_area_convertToJSON() failed [uncertainty_ellipse]");
        return NULL;
    }
    ...
    if (cJSON_AddNumberToObject(item, "confidence", local_area->confidence) == NULL) {
        log_error("OpenAPI_local_area_convertToJSON() failed [confidence]");
        goto end;
    }

    if (!local_area->uncertainty_ellipsoid) {
        log_error("OpenAPI_local_area_convertToJSON() failed [uncertainty_ellipsoid]");
        return NULL;
    }
...
OpenAPI_local_area_t *OpenAPI_local_area_parseFromJSON(cJSON *local_areaJSON)
{
    ...
    if (!shape) {
        log_error("OpenAPI_local_area_parseFromJSON() failed [shape]");
        goto end;
    }
    ...
    if (!local_origin) {
        log_error("OpenAPI_local_area_parseFromJSON() failed [local_origin]");
        goto end;
    }
    ...
    if (!point) {
        log_error("OpenAPI_local_area_parseFromJSON() failed [point]");
        goto end;
    }
    ...
    if (!uncertainty_ellipse) {
        log_error("OpenAPI_local_area_parseFromJSON() failed [uncertainty_ellipse]");
        goto end;
    }
    ...
    if (!confidence) {
        log_error("OpenAPI_local_area_parseFromJSON() failed [confidence]");
        goto end;
    }
    ...
    if (!uncertainty_ellipsoid) {
        log_error("OpenAPI_local_area_parseFromJSON() failed [uncertainty_ellipsoid]");
        goto end;
    }
...
OpenAPI_local_area_t *OpenAPI_local_area_copy(OpenAPI_local_area_t *dst, OpenAPI_local_area_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_local_area_convertToJSON() failed");
        return NULL;
    }
