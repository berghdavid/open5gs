...
)
{
    ...
    log_assert(sec_negotiate_req_data_local_var);
...
cJSON *OpenAPI_sec_negotiate_req_data_convertToJSON(OpenAPI_sec_negotiate_req_data_t *sec_negotiate_req_data)
{
    ...
    if (sec_negotiate_req_data == NULL) {
        log_error("OpenAPI_sec_negotiate_req_data_convertToJSON() failed [SecNegotiateReqData]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!sec_negotiate_req_data->sender) {
        log_error("OpenAPI_sec_negotiate_req_data_convertToJSON() failed [sender]");
        return NULL;
    }
    ...
    if (sec_negotiate_req_data->supported_sec_capability_list == OpenAPI_security_capability_NULL) {
        log_error("OpenAPI_sec_negotiate_req_data_convertToJSON() failed [supported_sec_capability_list]");
        return NULL;
    }
    ...
    if (cJSON_AddBoolToObject(item, "3GppSbiTargetApiRootSupported", sec_negotiate_req_data->_3_gpp_sbi_target_api_root_supported) == NULL) {
        log_error("OpenAPI_sec_negotiate_req_data_convertToJSON() failed [_3_gpp_sbi_target_api_root_supported]");
        goto end;
    }
    }
    ...
    if (plmn_id_listList == NULL) {
        log_error("OpenAPI_sec_negotiate_req_data_convertToJSON() failed [plmn_id_list]");
        goto end;
    }
    OpenAPI_list_for_each(sec_negotiate_req_data->plmn_id_list, node) {
    ...
    if (snpn_id_listList == NULL) {
        log_error("OpenAPI_sec_negotiate_req_data_convertToJSON() failed [snpn_id_list]");
        goto end;
    }
    OpenAPI_list_for_each(sec_negotiate_req_data->snpn_id_list, node) {
    ...
    if (target_plmn_id_local_JSON == NULL) {
        log_error("OpenAPI_sec_negotiate_req_data_convertToJSON() failed [target_plmn_id]");
        goto end;
    }
    ...
    if (target_snpn_id_local_JSON == NULL) {
        log_error("OpenAPI_sec_negotiate_req_data_convertToJSON() failed [target_snpn_id]");
        goto end;
    }
    ...
    if (intended_usage_purposeList == NULL) {
        log_error("OpenAPI_sec_negotiate_req_data_convertToJSON() failed [intended_usage_purpose]");
        goto end;
    }
    OpenAPI_list_for_each(sec_negotiate_req_data->intended_usage_purpose, node) {
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", sec_negotiate_req_data->supported_features) == NULL) {
        log_error("OpenAPI_sec_negotiate_req_data_convertToJSON() failed [supported_features]");
        goto end;
    }
    }
...
OpenAPI_sec_negotiate_req_data_t *OpenAPI_sec_negotiate_req_data_parseFromJSON(cJSON *sec_negotiate_req_dataJSON)
{
    ...
    if (!sender) {
        log_error("OpenAPI_sec_negotiate_req_data_parseFromJSON() failed [sender]");
        goto end;
    }
    ...
    if (!supported_sec_capability_list) {
        log_error("OpenAPI_sec_negotiate_req_data_parseFromJSON() failed [supported_sec_capability_list]");
        goto end;
    }
        ...
        cJSON_ArrayForEach(supported_sec_capability_list_local, supported_sec_capability_list) {
            ...
            if (!localEnum) {
                log_info("Enum value \"%s\" for field \"supported_sec_capability_list\" is not supported. Ignoring it ...",
        ...
        if (supported_sec_capability_listList->count == 0) {
            log_error("OpenAPI_sec_negotiate_req_data_parseFromJSON() failed: Expected supported_sec_capability_listList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    ...
    if (!cJSON_IsBool(_3_gpp_sbi_target_api_root_supported)) {
        log_error("OpenAPI_sec_negotiate_req_data_parseFromJSON() failed [_3_gpp_sbi_target_api_root_supported]");
        goto end;
    }
    }
    ...
    if (plmn_id_list) {
        ...
        if (!cJSON_IsArray(plmn_id_list)) {
            log_error("OpenAPI_sec_negotiate_req_data_parseFromJSON() failed [plmn_id_list]");
            goto end;
        }
    ...
    if (snpn_id_list) {
        ...
        if (!cJSON_IsArray(snpn_id_list)) {
            log_error("OpenAPI_sec_negotiate_req_data_parseFromJSON() failed [snpn_id_list]");
            goto end;
        }
    ...
    if (!target_plmn_id_local_nonprim) {
        log_error("OpenAPI_plmn_id_parseFromJSON failed [target_plmn_id]");
        goto end;
    }
    }
    ...
    if (!target_snpn_id_local_nonprim) {
        log_error("OpenAPI_plmn_id_nid_parseFromJSON failed [target_snpn_id]");
        goto end;
    }
    }
    ...
    if (intended_usage_purpose) {
        ...
        if (!cJSON_IsArray(intended_usage_purpose)) {
            log_error("OpenAPI_sec_negotiate_req_data_parseFromJSON() failed [intended_usage_purpose]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(intended_usage_purpose_local, intended_usage_purpose) {
            ...
            if (!intended_usage_purposeItem) {
                log_error("No intended_usage_purposeItem");
                goto end;
            }
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_sec_negotiate_req_data_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
...
OpenAPI_sec_negotiate_req_data_t *OpenAPI_sec_negotiate_req_data_copy(OpenAPI_sec_negotiate_req_data_t *dst, OpenAPI_sec_negotiate_req_data_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_sec_negotiate_req_data_convertToJSON() failed");
        return NULL;
    }
