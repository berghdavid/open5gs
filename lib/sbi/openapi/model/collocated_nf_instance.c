...
)
{
    ...
    log_assert(collocated_nf_instance_local_var);
...
cJSON *OpenAPI_collocated_nf_instance_convertToJSON(OpenAPI_collocated_nf_instance_t *collocated_nf_instance)
{
    ...
    if (collocated_nf_instance == NULL) {
        log_error("OpenAPI_collocated_nf_instance_convertToJSON() failed [CollocatedNfInstance]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!collocated_nf_instance->nf_instance_id) {
        log_error("OpenAPI_collocated_nf_instance_convertToJSON() failed [nf_instance_id]");
        return NULL;
    }
    ...
    if (collocated_nf_instance->nf_type == OpenAPI_collocated_nf_type_NULL) {
        log_error("OpenAPI_collocated_nf_instance_convertToJSON() failed [nf_type]");
        return NULL;
    }
...
OpenAPI_collocated_nf_instance_t *OpenAPI_collocated_nf_instance_parseFromJSON(cJSON *collocated_nf_instanceJSON)
{
    ...
    if (!nf_instance_id) {
        log_error("OpenAPI_collocated_nf_instance_parseFromJSON() failed [nf_instance_id]");
        goto end;
    }
    ...
    if (!nf_type) {
        log_error("OpenAPI_collocated_nf_instance_parseFromJSON() failed [nf_type]");
        goto end;
    }
...
OpenAPI_collocated_nf_instance_t *OpenAPI_collocated_nf_instance_copy(OpenAPI_collocated_nf_instance_t *dst, OpenAPI_collocated_nf_instance_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_collocated_nf_instance_convertToJSON() failed");
        return NULL;
    }
