...
)
{
    ...
    log_assert(presence_info_rm_local_var);
...
cJSON *OpenAPI_presence_info_rm_convertToJSON(OpenAPI_presence_info_rm_t *presence_info_rm)
{
    ...
    if (presence_info_rm == NULL) {
        log_error("OpenAPI_presence_info_rm_convertToJSON() failed [PresenceInfoRm]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "praId", presence_info_rm->pra_id) == NULL) {
        log_error("OpenAPI_presence_info_rm_convertToJSON() failed [pra_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "additionalPraId", presence_info_rm->additional_pra_id) == NULL) {
        log_error("OpenAPI_presence_info_rm_convertToJSON() failed [additional_pra_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "presenceState", OpenAPI_presence_state_ToString(presence_info_rm->presence_state)) == NULL) {
        log_error("OpenAPI_presence_info_rm_convertToJSON() failed [presence_state]");
        goto end;
    }
    }
    ...
    if (tracking_area_listList == NULL) {
        log_error("OpenAPI_presence_info_rm_convertToJSON() failed [tracking_area_list]");
        goto end;
    }
    OpenAPI_list_for_each(presence_info_rm->tracking_area_list, node) {
    ...
    if (ecgi_listList == NULL) {
        log_error("OpenAPI_presence_info_rm_convertToJSON() failed [ecgi_list]");
        goto end;
    }
    OpenAPI_list_for_each(presence_info_rm->ecgi_list, node) {
    ...
    if (ncgi_listList == NULL) {
        log_error("OpenAPI_presence_info_rm_convertToJSON() failed [ncgi_list]");
        goto end;
    }
    OpenAPI_list_for_each(presence_info_rm->ncgi_list, node) {
    ...
    if (global_ran_node_id_listList == NULL) {
        log_error("OpenAPI_presence_info_rm_convertToJSON() failed [global_ran_node_id_list]");
        goto end;
    }
    OpenAPI_list_for_each(presence_info_rm->global_ran_node_id_list, node) {
    ...
    if (globale_nb_id_listList == NULL) {
        log_error("OpenAPI_presence_info_rm_convertToJSON() failed [globale_nb_id_list]");
        goto end;
    }
    OpenAPI_list_for_each(presence_info_rm->globale_nb_id_list, node) {
        cJSON *itemLocal = OpenAPI_global_ran_node_id_convertToJSON(node->data);
...
OpenAPI_presence_info_rm_t *OpenAPI_presence_info_rm_parseFromJSON(cJSON *presence_info_rmJSON)
{
    ...
    if (!cJSON_IsString(pra_id) && !cJSON_IsNull(pra_id)) {
        log_error("OpenAPI_presence_info_rm_parseFromJSON() failed [pra_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(additional_pra_id) && !cJSON_IsNull(additional_pra_id)) {
        log_error("OpenAPI_presence_info_rm_parseFromJSON() failed [additional_pra_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(presence_state)) {
        log_error("OpenAPI_presence_info_rm_parseFromJSON() failed [presence_state]");
        goto end;
    }
    ...
    if (tracking_area_list) {
        ...
        if (!cJSON_IsArray(tracking_area_list)) {
            log_error("OpenAPI_presence_info_rm_parseFromJSON() failed [tracking_area_list]");
            goto end;
        }
    ...
    if (ecgi_list) {
        ...
        if (!cJSON_IsArray(ecgi_list)) {
            log_error("OpenAPI_presence_info_rm_parseFromJSON() failed [ecgi_list]");
            goto end;
        }
    ...
    if (ncgi_list) {
        ...
        if (!cJSON_IsArray(ncgi_list)) {
            log_error("OpenAPI_presence_info_rm_parseFromJSON() failed [ncgi_list]");
            goto end;
        }
    ...
    if (global_ran_node_id_list) {
        ...
        if (!cJSON_IsArray(global_ran_node_id_list)) {
            log_error("OpenAPI_presence_info_rm_parseFromJSON() failed [global_ran_node_id_list]");
            goto end;
        }
    ...
    if (globale_nb_id_list) {
        ...
        if (!cJSON_IsArray(globale_nb_id_list)) {
            log_error("OpenAPI_presence_info_rm_parseFromJSON() failed [globale_nb_id_list]");
            goto end;
        }
...
OpenAPI_presence_info_rm_t *OpenAPI_presence_info_rm_copy(OpenAPI_presence_info_rm_t *dst, OpenAPI_presence_info_rm_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_presence_info_rm_convertToJSON() failed");
        return NULL;
    }
