...
)
{
    ...
    log_assert(monitoring_configuration_local_var);
...
cJSON *OpenAPI_monitoring_configuration_convertToJSON(OpenAPI_monitoring_configuration_t *monitoring_configuration)
{
    ...
    if (monitoring_configuration == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [MonitoringConfiguration]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!monitoring_configuration->event_type) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [event_type]");
        return NULL;
    }
    ...
    if (cJSON_AddBoolToObject(item, "immediateFlag", monitoring_configuration->immediate_flag) == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [immediate_flag]");
        goto end;
    }
    }
    ...
    if (location_reporting_configuration_local_JSON == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [location_reporting_configuration]");
        goto end;
    }
    ...
    if (association_type_local_JSON == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [association_type]");
        goto end;
    }
    ...
    if (datalink_report_cfg_local_JSON == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [datalink_report_cfg]");
        goto end;
    }
    ...
    if (loss_connectivity_cfg_local_JSON == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [loss_connectivity_cfg]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "maximumLatency", monitoring_configuration->maximum_latency) == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [maximum_latency]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "maximumResponseTime", monitoring_configuration->maximum_response_time) == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [maximum_response_time]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "suggestedPacketNumDl", monitoring_configuration->suggested_packet_num_dl) == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [suggested_packet_num_dl]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "dnn", monitoring_configuration->dnn) == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [dnn]");
        goto end;
    }
    }
    ...
    if (single_nssai_local_JSON == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [single_nssai]");
        goto end;
    }
    ...
    if (pdu_session_status_cfg_local_JSON == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [pdu_session_status_cfg]");
        goto end;
    }
    ...
    if (reachability_for_sms_cfg_local_JSON == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [reachability_for_sms_cfg]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "mtcProviderInformation", monitoring_configuration->mtc_provider_information) == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [mtc_provider_information]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "afId", monitoring_configuration->af_id) == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [af_id]");
        goto end;
    }
    }
    ...
    if (reachability_for_data_cfg_local_JSON == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [reachability_for_data_cfg]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "idleStatusInd", monitoring_configuration->idle_status_ind) == NULL) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed [idle_status_ind]");
        goto end;
    }
    }
...
OpenAPI_monitoring_configuration_t *OpenAPI_monitoring_configuration_parseFromJSON(cJSON *monitoring_configurationJSON)
{
    ...
    if (!event_type) {
        log_error("OpenAPI_monitoring_configuration_parseFromJSON() failed [event_type]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(immediate_flag)) {
        log_error("OpenAPI_monitoring_configuration_parseFromJSON() failed [immediate_flag]");
        goto end;
    }
    }
    ...
    if (!location_reporting_configuration_local_nonprim) {
        log_error("OpenAPI_location_reporting_configuration_parseFromJSON failed [location_reporting_configuration]");
        goto end;
    }
    }
    ...
    if (!datalink_report_cfg_local_nonprim) {
        log_error("OpenAPI_datalink_reporting_configuration_parseFromJSON failed [datalink_report_cfg]");
        goto end;
    }
    }
    ...
    if (!loss_connectivity_cfg_local_nonprim) {
        log_error("OpenAPI_loss_connectivity_cfg_parseFromJSON failed [loss_connectivity_cfg]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(maximum_latency)) {
        log_error("OpenAPI_monitoring_configuration_parseFromJSON() failed [maximum_latency]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(maximum_response_time)) {
        log_error("OpenAPI_monitoring_configuration_parseFromJSON() failed [maximum_response_time]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(suggested_packet_num_dl)) {
        log_error("OpenAPI_monitoring_configuration_parseFromJSON() failed [suggested_packet_num_dl]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(dnn) && !cJSON_IsNull(dnn)) {
        log_error("OpenAPI_monitoring_configuration_parseFromJSON() failed [dnn]");
        goto end;
    }
    }
    ...
    if (!pdu_session_status_cfg_local_nonprim) {
        log_error("OpenAPI_pdu_session_status_cfg_parseFromJSON failed [pdu_session_status_cfg]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(mtc_provider_information) && !cJSON_IsNull(mtc_provider_information)) {
        log_error("OpenAPI_monitoring_configuration_parseFromJSON() failed [mtc_provider_information]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(af_id) && !cJSON_IsNull(af_id)) {
        log_error("OpenAPI_monitoring_configuration_parseFromJSON() failed [af_id]");
        goto end;
    }
    }
    ...
    if (!reachability_for_data_cfg_local_nonprim) {
        log_error("OpenAPI_reachability_for_data_configuration_parseFromJSON failed [reachability_for_data_cfg]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(idle_status_ind)) {
        log_error("OpenAPI_monitoring_configuration_parseFromJSON() failed [idle_status_ind]");
        goto end;
    }
    }
...
OpenAPI_monitoring_configuration_t *OpenAPI_monitoring_configuration_copy(OpenAPI_monitoring_configuration_t *dst, OpenAPI_monitoring_configuration_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_monitoring_configuration_convertToJSON() failed");
        return NULL;
    }
