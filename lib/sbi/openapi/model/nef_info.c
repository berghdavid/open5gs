...
cJSON *OpenAPI_nef_info_convertToJSON(OpenAPI_nef_info_t *nef_info)
{
    ...
    if (nef_info == NULL) {
        log_error("OpenAPI_nef_info_convertToJSON() failed [NefInfo]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "nefId", nef_info->nef_id) == NULL) {
        log_error("OpenAPI_nef_info_convertToJSON() failed [nef_id]");
        goto end;
    }
    }
    ...
    if (pfd_data_local_JSON == NULL) {
        log_error("OpenAPI_nef_info_convertToJSON() failed [pfd_data]");
        goto end;
    }
    ...
    if (af_ee_data_local_JSON == NULL) {
        log_error("OpenAPI_nef_info_convertToJSON() failed [af_ee_data]");
        goto end;
    }
    ...
    if (gpsi_rangesList == NULL) {
        log_error("OpenAPI_nef_info_convertToJSON() failed [gpsi_ranges]");
        goto end;
    }
    OpenAPI_list_for_each(nef_info->gpsi_ranges, node) {
    ...
    if (external_group_identifiers_rangesList == NULL) {
        log_error("OpenAPI_nef_info_convertToJSON() failed [external_group_identifiers_ranges]");
        goto end;
    }
    OpenAPI_list_for_each(nef_info->external_group_identifiers_ranges, node) {
        cJSON *itemLocal = OpenAPI_identity_range_convertToJSON(node->data);
    ...
    if (served_fqdn_listList == NULL) {
        log_error("OpenAPI_nef_info_convertToJSON() failed [served_fqdn_list]");
        goto end;
    }
    OpenAPI_list_for_each(nef_info->served_fqdn_list, node) {
    ...
    if (tai_listList == NULL) {
        log_error("OpenAPI_nef_info_convertToJSON() failed [tai_list]");
        goto end;
    }
    OpenAPI_list_for_each(nef_info->tai_list, node) {
    ...
    if (tai_range_listList == NULL) {
        log_error("OpenAPI_nef_info_convertToJSON() failed [tai_range_list]");
        goto end;
    }
    OpenAPI_list_for_each(nef_info->tai_range_list, node) {
    ...
    if (dnai_listList == NULL) {
        log_error("OpenAPI_nef_info_convertToJSON() failed [dnai_list]");
        goto end;
    }
    OpenAPI_list_for_each(nef_info->dnai_list, node) {
    ...
    if (un_trust_af_info_listList == NULL) {
        log_error("OpenAPI_nef_info_convertToJSON() failed [un_trust_af_info_list]");
        goto end;
    }
    OpenAPI_list_for_each(nef_info->un_trust_af_info_list, node) {
    ...
    if (cJSON_AddBoolToObject(item, "uasNfFunctionalityInd", nef_info->uas_nf_functionality_ind) == NULL) {
        log_error("OpenAPI_nef_info_convertToJSON() failed [uas_nf_functionality_ind]");
        goto end;
    }
    }
...
OpenAPI_nef_info_t *OpenAPI_nef_info_parseFromJSON(cJSON *nef_infoJSON)
{
    ...
    if (!cJSON_IsString(nef_id) && !cJSON_IsNull(nef_id)) {
        log_error("OpenAPI_nef_info_parseFromJSON() failed [nef_id]");
        goto end;
    }
    }
    ...
    if (gpsi_ranges) {
        ...
        if (!cJSON_IsArray(gpsi_ranges)) {
            log_error("OpenAPI_nef_info_parseFromJSON() failed [gpsi_ranges]");
            goto end;
        }
    ...
    if (external_group_identifiers_ranges) {
        ...
        if (!cJSON_IsArray(external_group_identifiers_ranges)) {
            log_error("OpenAPI_nef_info_parseFromJSON() failed [external_group_identifiers_ranges]");
            goto end;
        }
    ...
    if (served_fqdn_list) {
        ...
        if (!cJSON_IsArray(served_fqdn_list)) {
            log_error("OpenAPI_nef_info_parseFromJSON() failed [served_fqdn_list]");
            goto end;
        }
    ...
    if (tai_list) {
        ...
        if (!cJSON_IsArray(tai_list)) {
            log_error("OpenAPI_nef_info_parseFromJSON() failed [tai_list]");
            goto end;
        }
    ...
    if (tai_range_list) {
        ...
        if (!cJSON_IsArray(tai_range_list)) {
            log_error("OpenAPI_nef_info_parseFromJSON() failed [tai_range_list]");
            goto end;
        }
    ...
    if (dnai_list) {
        ...
        if (!cJSON_IsArray(dnai_list)) {
            log_error("OpenAPI_nef_info_parseFromJSON() failed [dnai_list]");
            goto end;
        }
    ...
    if (un_trust_af_info_list) {
        ...
        if (!cJSON_IsArray(un_trust_af_info_list)) {
            log_error("OpenAPI_nef_info_parseFromJSON() failed [un_trust_af_info_list]");
            goto end;
        }
    ...
    if (!cJSON_IsBool(uas_nf_functionality_ind)) {
        log_error("OpenAPI_nef_info_parseFromJSON() failed [uas_nf_functionality_ind]");
        goto end;
    }
    }
...
OpenAPI_nef_info_t *OpenAPI_nef_info_copy(OpenAPI_nef_info_t *dst, OpenAPI_nef_info_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_nef_info_convertToJSON() failed");
        return NULL;
    }
