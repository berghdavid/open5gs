...
)
{
    ...
    log_assert(nsi_load_level_info_local_var);
...
cJSON *OpenAPI_nsi_load_level_info_convertToJSON(OpenAPI_nsi_load_level_info_t *nsi_load_level_info)
{
    ...
    if (nsi_load_level_info == NULL) {
        log_error("OpenAPI_nsi_load_level_info_convertToJSON() failed [NsiLoadLevelInfo]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (cJSON_AddNumberToObject(item, "loadLevelInformation", nsi_load_level_info->load_level_information) == NULL) {
        log_error("OpenAPI_nsi_load_level_info_convertToJSON() failed [load_level_information]");
        goto end;
    }

    if (!nsi_load_level_info->snssai) {
        log_error("OpenAPI_nsi_load_level_info_convertToJSON() failed [snssai]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "nsiId", nsi_load_level_info->nsi_id) == NULL) {
        log_error("OpenAPI_nsi_load_level_info_convertToJSON() failed [nsi_id]");
        goto end;
    }
    }
    ...
    if (res_usage_local_JSON == NULL) {
        log_error("OpenAPI_nsi_load_level_info_convertToJSON() failed [res_usage]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "numOfExceedLoadLevelThr", nsi_load_level_info->num_of_exceed_load_level_thr) == NULL) {
        log_error("OpenAPI_nsi_load_level_info_convertToJSON() failed [num_of_exceed_load_level_thr]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "exceedLoadLevelThrInd", nsi_load_level_info->exceed_load_level_thr_ind) == NULL) {
        log_error("OpenAPI_nsi_load_level_info_convertToJSON() failed [exceed_load_level_thr_ind]");
        goto end;
    }
    }
    ...
    if (network_area_local_JSON == NULL) {
        log_error("OpenAPI_nsi_load_level_info_convertToJSON() failed [network_area]");
        goto end;
    }
    ...
    if (time_period_local_JSON == NULL) {
        log_error("OpenAPI_nsi_load_level_info_convertToJSON() failed [time_period]");
        goto end;
    }
    ...
    if (res_usg_thr_cross_time_periodList == NULL) {
        log_error("OpenAPI_nsi_load_level_info_convertToJSON() failed [res_usg_thr_cross_time_period]");
        goto end;
    }
    OpenAPI_list_for_each(nsi_load_level_info->res_usg_thr_cross_time_period, node) {
    ...
    if (num_of_ues_local_JSON == NULL) {
        log_error("OpenAPI_nsi_load_level_info_convertToJSON() failed [num_of_ues]");
        goto end;
    }
    ...
    if (num_of_pdu_sess_local_JSON == NULL) {
        log_error("OpenAPI_nsi_load_level_info_convertToJSON() failed [num_of_pdu_sess]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "confidence", nsi_load_level_info->confidence) == NULL) {
        log_error("OpenAPI_nsi_load_level_info_convertToJSON() failed [confidence]");
        goto end;
    }
    }
...
OpenAPI_nsi_load_level_info_t *OpenAPI_nsi_load_level_info_parseFromJSON(cJSON *nsi_load_level_infoJSON)
{
    ...
    if (!load_level_information) {
        log_error("OpenAPI_nsi_load_level_info_parseFromJSON() failed [load_level_information]");
        goto end;
    }
    ...
    if (!snssai) {
        log_error("OpenAPI_nsi_load_level_info_parseFromJSON() failed [snssai]");
        goto end;
    }
    ...
    if (!cJSON_IsString(nsi_id) && !cJSON_IsNull(nsi_id)) {
        log_error("OpenAPI_nsi_load_level_info_parseFromJSON() failed [nsi_id]");
        goto end;
    }
    }
    ...
    if (!res_usage_local_nonprim) {
        log_error("OpenAPI_resource_usage_parseFromJSON failed [res_usage]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(num_of_exceed_load_level_thr)) {
        log_error("OpenAPI_nsi_load_level_info_parseFromJSON() failed [num_of_exceed_load_level_thr]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(exceed_load_level_thr_ind)) {
        log_error("OpenAPI_nsi_load_level_info_parseFromJSON() failed [exceed_load_level_thr_ind]");
        goto end;
    }
    }
    ...
    if (!time_period_local_nonprim) {
        log_error("OpenAPI_time_window_parseFromJSON failed [time_period]");
        goto end;
    }
    }
    ...
    if (res_usg_thr_cross_time_period) {
        ...
        if (!cJSON_IsArray(res_usg_thr_cross_time_period)) {
            log_error("OpenAPI_nsi_load_level_info_parseFromJSON() failed [res_usg_thr_cross_time_period]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(res_usg_thr_cross_time_period_local, res_usg_thr_cross_time_period) {
            ...
            if (!res_usg_thr_cross_time_periodItem) {
                log_error("No res_usg_thr_cross_time_periodItem");
                goto end;
            }
    ...
    if (!num_of_ues_local_nonprim) {
        log_error("OpenAPI_number_average_parseFromJSON failed [num_of_ues]");
        goto end;
    }
    }
    ...
    if (!num_of_pdu_sess_local_nonprim) {
        log_error("OpenAPI_number_average_parseFromJSON failed [num_of_pdu_sess]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(confidence)) {
        log_error("OpenAPI_nsi_load_level_info_parseFromJSON() failed [confidence]");
        goto end;
    }
    }
...
OpenAPI_nsi_load_level_info_t *OpenAPI_nsi_load_level_info_copy(OpenAPI_nsi_load_level_info_t *dst, OpenAPI_nsi_load_level_info_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_nsi_load_level_info_convertToJSON() failed");
        return NULL;
    }
