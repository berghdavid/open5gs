...
)
{
    ...
    log_assert(edrx_parameters_1_local_var);
...
cJSON *OpenAPI_edrx_parameters_1_convertToJSON(OpenAPI_edrx_parameters_1_t *edrx_parameters_1)
{
    ...
    if (edrx_parameters_1 == NULL) {
        log_error("OpenAPI_edrx_parameters_1_convertToJSON() failed [EdrxParameters_1]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (edrx_parameters_1->rat_type == OpenAPI_rat_type_NULL) {
        log_error("OpenAPI_edrx_parameters_1_convertToJSON() failed [rat_type]");
        return NULL;
    }
    ...
    if (!edrx_parameters_1->edrx_value) {
        log_error("OpenAPI_edrx_parameters_1_convertToJSON() failed [edrx_value]");
        return NULL;
    }
...
OpenAPI_edrx_parameters_1_t *OpenAPI_edrx_parameters_1_parseFromJSON(cJSON *edrx_parameters_1JSON)
{
    ...
    if (!rat_type) {
        log_error("OpenAPI_edrx_parameters_1_parseFromJSON() failed [rat_type]");
        goto end;
    }
    ...
    if (!edrx_value) {
        log_error("OpenAPI_edrx_parameters_1_parseFromJSON() failed [edrx_value]");
        goto end;
    }
...
OpenAPI_edrx_parameters_1_t *OpenAPI_edrx_parameters_1_copy(OpenAPI_edrx_parameters_1_t *dst, OpenAPI_edrx_parameters_1_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_edrx_parameters_1_convertToJSON() failed");
        return NULL;
    }
