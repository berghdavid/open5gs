...
)
{
    ...
    log_assert(immediate_report_local_var);
...
cJSON *OpenAPI_immediate_report_convertToJSON(OpenAPI_immediate_report_t *immediate_report)
{
    ...
    if (immediate_report == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [ImmediateReport]");
        return NULL;
    }
    ...
    if (am_data_local_JSON == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [am_data]");
        goto end;
    }
    ...
    if (smf_sel_data_local_JSON == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [smf_sel_data]");
        goto end;
    }
    ...
    if (uec_amf_data_local_JSON == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [uec_amf_data]");
        goto end;
    }
    ...
    if (uec_smf_data_local_JSON == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [uec_smf_data]");
        goto end;
    }
    ...
    if (uec_smsf_data_local_JSON == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [uec_smsf_data]");
        goto end;
    }
    ...
    if (sms_subs_data_local_JSON == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [sms_subs_data]");
        goto end;
    }
    ...
    if (sm_data_local_JSON == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [sm_data]");
        goto end;
    }
    ...
    if (trace_data_local_JSON == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [trace_data]");
        goto end;
    }
    ...
    if (sms_mng_data_local_JSON == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [sms_mng_data]");
        goto end;
    }
    ...
    if (lcs_privacy_data_local_JSON == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [lcs_privacy_data]");
        goto end;
    }
    ...
    if (lcs_mo_data_local_JSON == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [lcs_mo_data]");
        goto end;
    }
    ...
    if (v2x_data_local_JSON == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [v2x_data]");
        goto end;
    }
    ...
    if (lcs_broadcast_assistance_types_data_local_JSON == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [lcs_broadcast_assistance_types_data]");
        goto end;
    }
    ...
    if (prose_data_local_JSON == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [prose_data]");
        goto end;
    }
    ...
    if (mbs_data_local_JSON == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [mbs_data]");
        goto end;
    }
    ...
    if (uc_data_local_JSON == NULL) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed [uc_data]");
        goto end;
    }
...
OpenAPI_immediate_report_t *OpenAPI_immediate_report_copy(OpenAPI_immediate_report_t *dst, OpenAPI_immediate_report_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_immediate_report_convertToJSON() failed");
        return NULL;
    }
