...
)
{
    ...
    log_assert(preferred_search_local_var);
...
cJSON *OpenAPI_preferred_search_convertToJSON(OpenAPI_preferred_search_t *preferred_search)
{
    ...
    if (preferred_search == NULL) {
        log_error("OpenAPI_preferred_search_convertToJSON() failed [PreferredSearch]");
        return NULL;
    }
    ...
    if (cJSON_AddBoolToObject(item, "preferredTaiMatchInd", preferred_search->preferred_tai_match_ind) == NULL) {
        log_error("OpenAPI_preferred_search_convertToJSON() failed [preferred_tai_match_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "preferredFullPlmnMatchInd", preferred_search->preferred_full_plmn_match_ind) == NULL) {
        log_error("OpenAPI_preferred_search_convertToJSON() failed [preferred_full_plmn_match_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "preferredApiVersionsMatchInd", preferred_search->preferred_api_versions_match_ind) == NULL) {
        log_error("OpenAPI_preferred_search_convertToJSON() failed [preferred_api_versions_match_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "otherApiVersionsInd", preferred_search->other_api_versions_ind) == NULL) {
        log_error("OpenAPI_preferred_search_convertToJSON() failed [other_api_versions_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "preferredLocalityMatchInd", preferred_search->preferred_locality_match_ind) == NULL) {
        log_error("OpenAPI_preferred_search_convertToJSON() failed [preferred_locality_match_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "otherLocalityInd", preferred_search->other_locality_ind) == NULL) {
        log_error("OpenAPI_preferred_search_convertToJSON() failed [other_locality_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "preferredVendorSpecificFeaturesInd", preferred_search->preferred_vendor_specific_features_ind) == NULL) {
        log_error("OpenAPI_preferred_search_convertToJSON() failed [preferred_vendor_specific_features_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "preferredCollocatedNfTypeInd", preferred_search->preferred_collocated_nf_type_ind) == NULL) {
        log_error("OpenAPI_preferred_search_convertToJSON() failed [preferred_collocated_nf_type_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "preferredPgwMatchInd", preferred_search->preferred_pgw_match_ind) == NULL) {
        log_error("OpenAPI_preferred_search_convertToJSON() failed [preferred_pgw_match_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "preferredAnalyticsDelaysInd", preferred_search->preferred_analytics_delays_ind) == NULL) {
        log_error("OpenAPI_preferred_search_convertToJSON() failed [preferred_analytics_delays_ind]");
        goto end;
    }
    }
...
OpenAPI_preferred_search_t *OpenAPI_preferred_search_parseFromJSON(cJSON *preferred_searchJSON)
{
    ...
    if (!cJSON_IsBool(preferred_tai_match_ind)) {
        log_error("OpenAPI_preferred_search_parseFromJSON() failed [preferred_tai_match_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(preferred_full_plmn_match_ind)) {
        log_error("OpenAPI_preferred_search_parseFromJSON() failed [preferred_full_plmn_match_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(preferred_api_versions_match_ind)) {
        log_error("OpenAPI_preferred_search_parseFromJSON() failed [preferred_api_versions_match_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(other_api_versions_ind)) {
        log_error("OpenAPI_preferred_search_parseFromJSON() failed [other_api_versions_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(preferred_locality_match_ind)) {
        log_error("OpenAPI_preferred_search_parseFromJSON() failed [preferred_locality_match_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(other_locality_ind)) {
        log_error("OpenAPI_preferred_search_parseFromJSON() failed [other_locality_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(preferred_vendor_specific_features_ind)) {
        log_error("OpenAPI_preferred_search_parseFromJSON() failed [preferred_vendor_specific_features_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(preferred_collocated_nf_type_ind)) {
        log_error("OpenAPI_preferred_search_parseFromJSON() failed [preferred_collocated_nf_type_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(preferred_pgw_match_ind)) {
        log_error("OpenAPI_preferred_search_parseFromJSON() failed [preferred_pgw_match_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(preferred_analytics_delays_ind)) {
        log_error("OpenAPI_preferred_search_parseFromJSON() failed [preferred_analytics_delays_ind]");
        goto end;
    }
    }
...
OpenAPI_preferred_search_t *OpenAPI_preferred_search_copy(OpenAPI_preferred_search_t *dst, OpenAPI_preferred_search_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_preferred_search_convertToJSON() failed");
        return NULL;
    }
