...
)
{
    ...
    log_assert(events_subsc_put_data_local_var);
...
cJSON *OpenAPI_events_subsc_put_data_convertToJSON(OpenAPI_events_subsc_put_data_t *events_subsc_put_data)
{
    ...
    if (events_subsc_put_data == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [EventsSubscPutData]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!events_subsc_put_data->events) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [events]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "notifUri", events_subsc_put_data->notif_uri) == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [notif_uri]");
        goto end;
    }
    }
    ...
    if (req_qos_mon_paramsList == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [req_qos_mon_params]");
        goto end;
    }
    ...
    if (qos_mon_local_JSON == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [qos_mon]");
        goto end;
    }
    ...
    if (req_anisList == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [req_anis]");
        goto end;
    }
    ...
    if (usg_thres_local_JSON == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [usg_thres]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "notifCorreId", events_subsc_put_data->notif_corre_id) == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [notif_corre_id]");
        goto end;
    }
    }
    ...
    if (af_app_idsList == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [af_app_ids]");
        goto end;
    }
    OpenAPI_list_for_each(events_subsc_put_data->af_app_ids, node) {
    ...
    if (cJSON_AddBoolToObject(item, "directNotifInd", events_subsc_put_data->direct_notif_ind) == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [direct_notif_ind]");
        goto end;
    }
    }
    ...
    if (ad_reportsList == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [ad_reports]");
        goto end;
    }
    OpenAPI_list_for_each(events_subsc_put_data->ad_reports, node) {
    ...
    if (cJSON_AddStringToObject(item, "accessType", OpenAPI_access_type_ToString(events_subsc_put_data->access_type)) == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [access_type]");
        goto end;
    }
    }
    ...
    if (add_access_info_local_JSON == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [add_access_info]");
        goto end;
    }
    ...
    if (rel_access_info_local_JSON == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [rel_access_info]");
        goto end;
    }
    ...
    if (an_charg_addr_local_JSON == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [an_charg_addr]");
        goto end;
    }
    ...
    if (an_charg_idsList == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [an_charg_ids]");
        goto end;
    }
    OpenAPI_list_for_each(events_subsc_put_data->an_charg_ids, node) {
    ...
    if (an_gw_addr_local_JSON == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [an_gw_addr]");
        goto end;
    }
    ...
    if (!events_subsc_put_data->ev_subs_uri) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [ev_subs_uri]");
        return NULL;
    }
    ...
    if (!events_subsc_put_data->ev_notifs) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [ev_notifs]");
        return NULL;
    }
    ...
    if (failed_resourc_alloc_reportsList == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [failed_resourc_alloc_reports]");
        goto end;
    }
    OpenAPI_list_for_each(events_subsc_put_data->failed_resourc_alloc_reports, node) {
    ...
    if (succ_resourc_alloc_reportsList == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [succ_resourc_alloc_reports]");
        goto end;
    }
    OpenAPI_list_for_each(events_subsc_put_data->succ_resourc_alloc_reports, node) {
        cJSON *itemLocal = OpenAPI_resources_allocation_info_convertToJSON(node->data);
    ...
    if (cJSON_AddStringToObject(item, "noNetLocSupp", OpenAPI_net_loc_access_support_ToString(events_subsc_put_data->no_net_loc_supp)) == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [no_net_loc_supp]");
        goto end;
    }
    }
    ...
    if (out_of_cred_reportsList == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [out_of_cred_reports]");
        goto end;
    }
    OpenAPI_list_for_each(events_subsc_put_data->out_of_cred_reports, node) {
    ...
    if (plmn_id_local_JSON == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [plmn_id]");
        goto end;
    }
    ...
    if (qnc_reportsList == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [qnc_reports]");
        goto end;
    }
    OpenAPI_list_for_each(events_subsc_put_data->qnc_reports, node) {
    ...
    if (qos_mon_reportsList == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [qos_mon_reports]");
        goto end;
    }
    OpenAPI_list_for_each(events_subsc_put_data->qos_mon_reports, node) {
    ...
    if (ran_nas_rel_causesList == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [ran_nas_rel_causes]");
        goto end;
    }
    OpenAPI_list_for_each(events_subsc_put_data->ran_nas_rel_causes, node) {
    ...
    if (cJSON_AddStringToObject(item, "ratType", OpenAPI_rat_type_ToString(events_subsc_put_data->rat_type)) == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [rat_type]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "satBackhaulCategory", OpenAPI_satellite_backhaul_category_ToString(events_subsc_put_data->sat_backhaul_category)) == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [sat_backhaul_category]");
        goto end;
    }
    }
    ...
    if (ue_loc_local_JSON == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [ue_loc]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "ueLocTime", events_subsc_put_data->ue_loc_time) == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [ue_loc_time]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ueTimeZone", events_subsc_put_data->ue_time_zone) == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [ue_time_zone]");
        goto end;
    }
    }
    ...
    if (usg_rep_local_JSON == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [usg_rep]");
        goto end;
    }
    ...
    if (tsn_bridge_man_cont_local_JSON == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [tsn_bridge_man_cont]");
        goto end;
    }
    ...
    if (tsn_port_man_cont_dstt_local_JSON == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [tsn_port_man_cont_dstt]");
        goto end;
    }
    ...
    if (tsn_port_man_cont_nwttsList == NULL) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed [tsn_port_man_cont_nwtts]");
        goto end;
    }
    OpenAPI_list_for_each(events_subsc_put_data->tsn_port_man_cont_nwtts, node) {
...
OpenAPI_events_subsc_put_data_t *OpenAPI_events_subsc_put_data_parseFromJSON(cJSON *events_subsc_put_dataJSON)
{
    ...
    if (!events) {
        log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [events]");
        goto end;
    }
    ...
    if (!cJSON_IsString(notif_uri) && !cJSON_IsNull(notif_uri)) {
        log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [notif_uri]");
        goto end;
    }
    }
    ...
    if (req_qos_mon_params) {
        ...
        if (!cJSON_IsArray(req_qos_mon_params)) {
            log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [req_qos_mon_params]");
            goto end;
        }
        ...
        if (req_qos_mon_paramsList->count == 0) {
            log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed: Expected req_qos_mon_paramsList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (!qos_mon_local_nonprim) {
        log_error("OpenAPI_qos_monitoring_information_parseFromJSON failed [qos_mon]");
        goto end;
    }
    }
    ...
    if (req_anis) {
        ...
        if (!cJSON_IsArray(req_anis)) {
            log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [req_anis]");
            goto end;
        }
        ...
        if (req_anisList->count == 0) {
            log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed: Expected req_anisList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (!usg_thres_local_nonprim) {
        log_error("OpenAPI_usage_threshold_parseFromJSON failed [usg_thres]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(notif_corre_id) && !cJSON_IsNull(notif_corre_id)) {
        log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [notif_corre_id]");
        goto end;
    }
    }
    ...
    if (af_app_ids) {
        ...
        if (!cJSON_IsArray(af_app_ids)) {
            log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [af_app_ids]");
            goto end;
        }
    ...
    if (!cJSON_IsBool(direct_notif_ind)) {
        log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [direct_notif_ind]");
        goto end;
    }
    }
    ...
    if (ad_reports) {
        ...
        if (!cJSON_IsArray(ad_reports)) {
            log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [ad_reports]");
            goto end;
        }
    ...
    if (!cJSON_IsString(access_type)) {
        log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [access_type]");
        goto end;
    }
    ...
    if (!an_charg_addr_local_nonprim) {
        log_error("OpenAPI_acc_net_charging_address_parseFromJSON failed [an_charg_addr]");
        goto end;
    }
    }
    ...
    if (an_charg_ids) {
        ...
        if (!cJSON_IsArray(an_charg_ids)) {
            log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [an_charg_ids]");
            goto end;
        }
    ...
    if (!ev_subs_uri) {
        log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [ev_subs_uri]");
        goto end;
    }
    ...
    if (!ev_notifs) {
        log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [ev_notifs]");
        goto end;
    }
    ...
    if (failed_resourc_alloc_reports) {
        ...
        if (!cJSON_IsArray(failed_resourc_alloc_reports)) {
            log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [failed_resourc_alloc_reports]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(failed_resourc_alloc_reports_local, failed_resourc_alloc_reports) {
            ...
            if (!failed_resourc_alloc_reportsItem) {
                log_error("No failed_resourc_alloc_reportsItem");
                goto end;
            }
    ...
    if (succ_resourc_alloc_reports) {
        ...
        if (!cJSON_IsArray(succ_resourc_alloc_reports)) {
            log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [succ_resourc_alloc_reports]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(succ_resourc_alloc_reports_local, succ_resourc_alloc_reports) {
            ...
            if (!succ_resourc_alloc_reportsItem) {
                log_error("No succ_resourc_alloc_reportsItem");
                goto end;
            }
    ...
    if (!cJSON_IsString(no_net_loc_supp)) {
        log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [no_net_loc_supp]");
        goto end;
    }
    ...
    if (out_of_cred_reports) {
        ...
        if (!cJSON_IsArray(out_of_cred_reports)) {
            log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [out_of_cred_reports]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(out_of_cred_reports_local, out_of_cred_reports) {
            ...
            if (!out_of_cred_reportsItem) {
                log_error("No out_of_cred_reportsItem");
                goto end;
            }
    ...
    if (!plmn_id_local_nonprim) {
        log_error("OpenAPI_plmn_id_nid_parseFromJSON failed [plmn_id]");
        goto end;
    }
    }
    ...
    if (qnc_reports) {
        ...
        if (!cJSON_IsArray(qnc_reports)) {
            log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [qnc_reports]");
            goto end;
        }
    ...
    if (qos_mon_reports) {
        ...
        if (!cJSON_IsArray(qos_mon_reports)) {
            log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [qos_mon_reports]");
            goto end;
        }
    ...
    if (ran_nas_rel_causes) {
        ...
        if (!cJSON_IsArray(ran_nas_rel_causes)) {
            log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [ran_nas_rel_causes]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(ran_nas_rel_causes_local, ran_nas_rel_causes) {
            ...
            if (!ran_nas_rel_causesItem) {
                log_error("No ran_nas_rel_causesItem");
                goto end;
            }
    ...
    if (!cJSON_IsString(rat_type)) {
        log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [rat_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(sat_backhaul_category)) {
        log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [sat_backhaul_category]");
        goto end;
    }
    ...
    if (!ue_loc_local_nonprim) {
        log_error("OpenAPI_user_location_parseFromJSON failed [ue_loc]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ue_loc_time) && !cJSON_IsNull(ue_loc_time)) {
        log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [ue_loc_time]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ue_time_zone) && !cJSON_IsNull(ue_time_zone)) {
        log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [ue_time_zone]");
        goto end;
    }
    }
    ...
    if (!usg_rep_local_nonprim) {
        log_error("OpenAPI_accumulated_usage_parseFromJSON failed [usg_rep]");
        goto end;
    }
    }
    ...
    if (tsn_port_man_cont_nwtts) {
        ...
        if (!cJSON_IsArray(tsn_port_man_cont_nwtts)) {
            log_error("OpenAPI_events_subsc_put_data_parseFromJSON() failed [tsn_port_man_cont_nwtts]");
            goto end;
        }
...
OpenAPI_events_subsc_put_data_t *OpenAPI_events_subsc_put_data_copy(OpenAPI_events_subsc_put_data_t *dst, OpenAPI_events_subsc_put_data_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_events_subsc_put_data_convertToJSON() failed");
        return NULL;
    }
