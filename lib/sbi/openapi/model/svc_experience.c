...
)
{
    ...
    log_assert(svc_experience_local_var);
...
cJSON *OpenAPI_svc_experience_convertToJSON(OpenAPI_svc_experience_t *svc_experience)
{
    ...
    if (svc_experience == NULL) {
        log_error("OpenAPI_svc_experience_convertToJSON() failed [SvcExperience]");
        return NULL;
    }
    ...
    if (cJSON_AddNumberToObject(item, "mos", svc_experience->mos) == NULL) {
        log_error("OpenAPI_svc_experience_convertToJSON() failed [mos]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "upperRange", svc_experience->upper_range) == NULL) {
        log_error("OpenAPI_svc_experience_convertToJSON() failed [upper_range]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "lowerRange", svc_experience->lower_range) == NULL) {
        log_error("OpenAPI_svc_experience_convertToJSON() failed [lower_range]");
        goto end;
    }
    }
...
OpenAPI_svc_experience_t *OpenAPI_svc_experience_parseFromJSON(cJSON *svc_experienceJSON)
{
    ...
    if (!cJSON_IsNumber(mos)) {
        log_error("OpenAPI_svc_experience_parseFromJSON() failed [mos]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(upper_range)) {
        log_error("OpenAPI_svc_experience_parseFromJSON() failed [upper_range]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(lower_range)) {
        log_error("OpenAPI_svc_experience_parseFromJSON() failed [lower_range]");
        goto end;
    }
    }
...
OpenAPI_svc_experience_t *OpenAPI_svc_experience_copy(OpenAPI_svc_experience_t *dst, OpenAPI_svc_experience_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_svc_experience_convertToJSON() failed");
        return NULL;
    }
