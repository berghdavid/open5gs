...
)
{
    ...
    log_assert(nrf_info_served_nef_info_value_local_var);
...
cJSON *OpenAPI_nrf_info_served_nef_info_value_convertToJSON(OpenAPI_nrf_info_served_nef_info_value_t *nrf_info_served_nef_info_value)
{
    ...
    if (nrf_info_served_nef_info_value == NULL) {
        log_error("OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [NrfInfo_servedNefInfo_value]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "nefId", nrf_info_served_nef_info_value->nef_id) == NULL) {
        log_error("OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [nef_id]");
        goto end;
    }
    }
    ...
    if (pfd_data_local_JSON == NULL) {
        log_error("OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [pfd_data]");
        goto end;
    }
    ...
    if (af_ee_data_local_JSON == NULL) {
        log_error("OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [af_ee_data]");
        goto end;
    }
    ...
    if (gpsi_rangesList == NULL) {
        log_error("OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [gpsi_ranges]");
        goto end;
    }
    OpenAPI_list_for_each(nrf_info_served_nef_info_value->gpsi_ranges, node) {
    ...
    if (external_group_identifiers_rangesList == NULL) {
        log_error("OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [external_group_identifiers_ranges]");
        goto end;
    }
    OpenAPI_list_for_each(nrf_info_served_nef_info_value->external_group_identifiers_ranges, node) {
        cJSON *itemLocal = OpenAPI_identity_range_convertToJSON(node->data);
    ...
    if (served_fqdn_listList == NULL) {
        log_error("OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [served_fqdn_list]");
        goto end;
    }
    OpenAPI_list_for_each(nrf_info_served_nef_info_value->served_fqdn_list, node) {
    ...
    if (tai_listList == NULL) {
        log_error("OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [tai_list]");
        goto end;
    }
    OpenAPI_list_for_each(nrf_info_served_nef_info_value->tai_list, node) {
    ...
    if (tai_range_listList == NULL) {
        log_error("OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [tai_range_list]");
        goto end;
    }
    OpenAPI_list_for_each(nrf_info_served_nef_info_value->tai_range_list, node) {
    ...
    if (dnai_listList == NULL) {
        log_error("OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [dnai_list]");
        goto end;
    }
    OpenAPI_list_for_each(nrf_info_served_nef_info_value->dnai_list, node) {
    ...
    if (un_trust_af_info_listList == NULL) {
        log_error("OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [un_trust_af_info_list]");
        goto end;
    }
    OpenAPI_list_for_each(nrf_info_served_nef_info_value->un_trust_af_info_list, node) {
    ...
    if (cJSON_AddBoolToObject(item, "uasNfFunctionalityInd", nrf_info_served_nef_info_value->uas_nf_functionality_ind) == NULL) {
        log_error("OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [uas_nf_functionality_ind]");
        goto end;
    }
    }
...
OpenAPI_nrf_info_served_nef_info_value_t *OpenAPI_nrf_info_served_nef_info_value_parseFromJSON(cJSON *nrf_info_served_nef_info_valueJSON)
{
    ...
    if (!cJSON_IsString(nef_id) && !cJSON_IsNull(nef_id)) {
        log_error("OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [nef_id]");
        goto end;
    }
    }
    ...
    if (!af_ee_data_local_nonprim) {
        log_error("OpenAPI_af_event_exposure_data_parseFromJSON failed [af_ee_data]");
        goto end;
    }
    }
    ...
    if (gpsi_ranges) {
        ...
        if (!cJSON_IsArray(gpsi_ranges)) {
            log_error("OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [gpsi_ranges]");
            goto end;
        }
    ...
    if (external_group_identifiers_ranges) {
        ...
        if (!cJSON_IsArray(external_group_identifiers_ranges)) {
            log_error("OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [external_group_identifiers_ranges]");
            goto end;
        }
    ...
    if (served_fqdn_list) {
        ...
        if (!cJSON_IsArray(served_fqdn_list)) {
            log_error("OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [served_fqdn_list]");
            goto end;
        }
    ...
    if (tai_list) {
        ...
        if (!cJSON_IsArray(tai_list)) {
            log_error("OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [tai_list]");
            goto end;
        }
    ...
    if (tai_range_list) {
        ...
        if (!cJSON_IsArray(tai_range_list)) {
            log_error("OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [tai_range_list]");
            goto end;
        }
    ...
    if (dnai_list) {
        ...
        if (!cJSON_IsArray(dnai_list)) {
            log_error("OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [dnai_list]");
            goto end;
        }
    ...
    if (un_trust_af_info_list) {
        ...
        if (!cJSON_IsArray(un_trust_af_info_list)) {
            log_error("OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [un_trust_af_info_list]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(un_trust_af_info_list_local, un_trust_af_info_list) {
            ...
            if (!un_trust_af_info_listItem) {
                log_error("No un_trust_af_info_listItem");
                goto end;
            }
    ...
    if (!cJSON_IsBool(uas_nf_functionality_ind)) {
        log_error("OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [uas_nf_functionality_ind]");
        goto end;
    }
    }
...
OpenAPI_nrf_info_served_nef_info_value_t *OpenAPI_nrf_info_served_nef_info_value_copy(OpenAPI_nrf_info_served_nef_info_value_t *dst, OpenAPI_nrf_info_served_nef_info_value_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed");
        return NULL;
    }
