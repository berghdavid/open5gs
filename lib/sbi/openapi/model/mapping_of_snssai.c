...
)
{
    ...
    log_assert(mapping_of_snssai_local_var);
...
cJSON *OpenAPI_mapping_of_snssai_convertToJSON(OpenAPI_mapping_of_snssai_t *mapping_of_snssai)
{
    ...
    if (mapping_of_snssai == NULL) {
        log_error("OpenAPI_mapping_of_snssai_convertToJSON() failed [MappingOfSnssai]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!mapping_of_snssai->serving_snssai) {
        log_error("OpenAPI_mapping_of_snssai_convertToJSON() failed [serving_snssai]");
        return NULL;
    }
    ...
    if (!mapping_of_snssai->home_snssai) {
        log_error("OpenAPI_mapping_of_snssai_convertToJSON() failed [home_snssai]");
        return NULL;
    }
...
OpenAPI_mapping_of_snssai_t *OpenAPI_mapping_of_snssai_parseFromJSON(cJSON *mapping_of_snssaiJSON)
{
    ...
    if (!serving_snssai) {
        log_error("OpenAPI_mapping_of_snssai_parseFromJSON() failed [serving_snssai]");
        goto end;
    }
    ...
    if (!home_snssai) {
        log_error("OpenAPI_mapping_of_snssai_parseFromJSON() failed [home_snssai]");
        goto end;
    }
...
OpenAPI_mapping_of_snssai_t *OpenAPI_mapping_of_snssai_copy(OpenAPI_mapping_of_snssai_t *dst, OpenAPI_mapping_of_snssai_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_mapping_of_snssai_convertToJSON() failed");
        return NULL;
    }
