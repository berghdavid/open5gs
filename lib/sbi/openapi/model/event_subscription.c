...
)
{
    ...
    log_assert(event_subscription_local_var);
...
cJSON *OpenAPI_event_subscription_convertToJSON(OpenAPI_event_subscription_t *event_subscription)
{
    ...
    if (event_subscription == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [EventSubscription]");
        return NULL;
    }
    ...
    if (cJSON_AddBoolToObject(item, "anySlice", event_subscription->any_slice) == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [any_slice]");
        goto end;
    }
    }
    ...
    if (app_idsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [app_ids]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->app_ids, node) {
    ...
    if (dnnsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [dnns]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->dnns, node) {
    ...
    if (dnaisList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [dnais]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->dnais, node) {
    ...
    if (!event_subscription->event) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [event]");
        return NULL;
    }
    ...
    if (extra_report_req_local_JSON == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [extra_report_req]");
        goto end;
    }
    ...
    if (ladn_dnnsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [ladn_dnns]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->ladn_dnns, node) {
    ...
    if (cJSON_AddNumberToObject(item, "loadLevelThreshold", event_subscription->load_level_threshold) == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [load_level_threshold]");
        goto end;
    }
    }
    ...
    if (notification_method_local_JSON == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [notification_method]");
        goto end;
    }
    ...
    if (matching_dir_local_JSON == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [matching_dir]");
        goto end;
    }
    ...
    if (nf_load_lvl_thdsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [nf_load_lvl_thds]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->nf_load_lvl_thds, node) {
    ...
    if (nf_instance_idsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [nf_instance_ids]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->nf_instance_ids, node) {
    ...
    if (nf_set_idsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [nf_set_ids]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->nf_set_ids, node) {
    ...
    if (nf_typesList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [nf_types]");
        goto end;
    }
    ...
    if (network_area_local_JSON == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [network_area]");
        goto end;
    }
    ...
    if (visited_areasList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [visited_areas]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->visited_areas, node) {
    ...
    if (cJSON_AddNumberToObject(item, "maxTopAppUlNbr", event_subscription->max_top_app_ul_nbr) == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [max_top_app_ul_nbr]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "maxTopAppDlNbr", event_subscription->max_top_app_dl_nbr) == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [max_top_app_dl_nbr]");
        goto end;
    }
    }
    ...
    if (nsi_id_infosList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [nsi_id_infos]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->nsi_id_infos, node) {
    ...
    if (nsi_level_thrdsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [nsi_level_thrds]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->nsi_level_thrds, node) {
        if (node->data == NULL) {
    ...
    if (qos_requ_local_JSON == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [qos_requ]");
        goto end;
    }
    ...
    if (qos_flow_ret_thdsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [qos_flow_ret_thds]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->qos_flow_ret_thds, node) {
    ...
    if (ran_ue_throu_thdsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [ran_ue_throu_thds]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->ran_ue_throu_thds, node) {
    ...
    if (cJSON_AddNumberToObject(item, "repetitionPeriod", event_subscription->repetition_period) == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [repetition_period]");
        goto end;
    }
    }
    ...
    if (snssaiaList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [snssaia]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->snssaia, node) {
    ...
    if (tgt_ue_local_JSON == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [tgt_ue]");
        goto end;
    }
    ...
    if (cong_thresholdsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [cong_thresholds]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->cong_thresholds, node) {
        cJSON *itemLocal = OpenAPI_threshold_level_convertToJSON(node->data);
    ...
    if (nw_perf_requsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [nw_perf_requs]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->nw_perf_requs, node) {
    ...
    if (bw_requsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [bw_requs]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->bw_requs, node) {
    ...
    if (excep_requsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [excep_requs]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->excep_requs, node) {
    ...
    if (expt_ana_type_local_JSON == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [expt_ana_type]");
        goto end;
    }
    ...
    if (expt_ue_behav_local_JSON == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [expt_ue_behav]");
        goto end;
    }
    ...
    if (rat_freqsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [rat_freqs]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->rat_freqs, node) {
    ...
    if (list_of_ana_subsetsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [list_of_ana_subsets]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->list_of_ana_subsets, node) {
    ...
    if (disper_reqsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [disper_reqs]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->disper_reqs, node) {
    ...
    if (red_trans_reqsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [red_trans_reqs]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->red_trans_reqs, node) {
    ...
    if (wlan_reqsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [wlan_reqs]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->wlan_reqs, node) {
    ...
    if (upf_info_local_JSON == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [upf_info]");
        goto end;
    }
    ...
    if (app_server_addrsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [app_server_addrs]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->app_server_addrs, node) {
    ...
    if (dn_perf_reqsList == NULL) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed [dn_perf_reqs]");
        goto end;
    }
    OpenAPI_list_for_each(event_subscription->dn_perf_reqs, node) {
...
OpenAPI_event_subscription_t *OpenAPI_event_subscription_parseFromJSON(cJSON *event_subscriptionJSON)
{
    ...
    if (!cJSON_IsBool(any_slice)) {
        log_error("OpenAPI_event_subscription_parseFromJSON() failed [any_slice]");
        goto end;
    }
    }
    ...
    if (app_ids) {
        ...
        if (!cJSON_IsArray(app_ids)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [app_ids]");
            goto end;
        }
    ...
    if (dnns) {
        ...
        if (!cJSON_IsArray(dnns)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [dnns]");
            goto end;
        }
    ...
    if (dnais) {
        ...
        if (!cJSON_IsArray(dnais)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [dnais]");
            goto end;
        }
    ...
    if (!event) {
        log_error("OpenAPI_event_subscription_parseFromJSON() failed [event]");
        goto end;
    }
    ...
    if (!extra_report_req_local_nonprim) {
        log_error("OpenAPI_event_reporting_requirement_parseFromJSON failed [extra_report_req]");
        goto end;
    }
    }
    ...
    if (ladn_dnns) {
        ...
        if (!cJSON_IsArray(ladn_dnns)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [ladn_dnns]");
            goto end;
        }
    ...
    if (!cJSON_IsNumber(load_level_threshold)) {
        log_error("OpenAPI_event_subscription_parseFromJSON() failed [load_level_threshold]");
        goto end;
    }
    }
    ...
    if (!notification_method_local_nonprim) {
        log_error("OpenAPI_notification_method_parseFromJSON failed [notification_method]");
        goto end;
    }
    }
    ...
    if (nf_load_lvl_thds) {
        ...
        if (!cJSON_IsArray(nf_load_lvl_thds)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [nf_load_lvl_thds]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(nf_load_lvl_thds_local, nf_load_lvl_thds) {
            ...
            if (!nf_load_lvl_thdsItem) {
                log_error("No nf_load_lvl_thdsItem");
                goto end;
            }
    ...
    if (nf_instance_ids) {
        ...
        if (!cJSON_IsArray(nf_instance_ids)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [nf_instance_ids]");
            goto end;
        }
    ...
    if (nf_set_ids) {
        ...
        if (!cJSON_IsArray(nf_set_ids)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [nf_set_ids]");
            goto end;
        }
    ...
    if (nf_types) {
        ...
        if (!cJSON_IsArray(nf_types)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [nf_types]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(nf_types_local, nf_types) {
            ...
            if (!localEnum) {
                log_info("Enum value \"%s\" for field \"nf_types\" is not supported. Ignoring it ...",
        ...
        if (nf_typesList->count == 0) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed: Expected nf_typesList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (visited_areas) {
        ...
        if (!cJSON_IsArray(visited_areas)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [visited_areas]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(visited_areas_local, visited_areas) {
            ...
            if (!visited_areasItem) {
                log_error("No visited_areasItem");
                goto end;
            }
    ...
    if (!cJSON_IsNumber(max_top_app_ul_nbr)) {
        log_error("OpenAPI_event_subscription_parseFromJSON() failed [max_top_app_ul_nbr]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(max_top_app_dl_nbr)) {
        log_error("OpenAPI_event_subscription_parseFromJSON() failed [max_top_app_dl_nbr]");
        goto end;
    }
    }
    ...
    if (nsi_id_infos) {
        ...
        if (!cJSON_IsArray(nsi_id_infos)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [nsi_id_infos]");
            goto end;
        }
    ...
    if (nsi_level_thrds) {
        ...
        if (!cJSON_IsArray(nsi_level_thrds)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [nsi_level_thrds]");
            goto end;
        }
    ...
    if (!qos_requ_local_nonprim) {
        log_error("OpenAPI_qos_requirement_parseFromJSON failed [qos_requ]");
        goto end;
    }
    }
    ...
    if (qos_flow_ret_thds) {
        ...
        if (!cJSON_IsArray(qos_flow_ret_thds)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [qos_flow_ret_thds]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(qos_flow_ret_thds_local, qos_flow_ret_thds) {
            ...
            if (!qos_flow_ret_thdsItem) {
                log_error("No qos_flow_ret_thdsItem");
                goto end;
            }
    ...
    if (ran_ue_throu_thds) {
        ...
        if (!cJSON_IsArray(ran_ue_throu_thds)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [ran_ue_throu_thds]");
            goto end;
        }
    ...
    if (!cJSON_IsNumber(repetition_period)) {
        log_error("OpenAPI_event_subscription_parseFromJSON() failed [repetition_period]");
        goto end;
    }
    }
    ...
    if (snssaia) {
        ...
        if (!cJSON_IsArray(snssaia)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [snssaia]");
            goto end;
        }
    ...
    if (!tgt_ue_local_nonprim) {
        log_error("OpenAPI_target_ue_information_parseFromJSON failed [tgt_ue]");
        goto end;
    }
    }
    ...
    if (cong_thresholds) {
        ...
        if (!cJSON_IsArray(cong_thresholds)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [cong_thresholds]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(cong_thresholds_local, cong_thresholds) {
            ...
            if (!cong_thresholdsItem) {
                log_error("No cong_thresholdsItem");
                goto end;
            }
    ...
    if (nw_perf_requs) {
        ...
        if (!cJSON_IsArray(nw_perf_requs)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [nw_perf_requs]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(nw_perf_requs_local, nw_perf_requs) {
            ...
            if (!nw_perf_requsItem) {
                log_error("No nw_perf_requsItem");
                goto end;
            }
    ...
    if (bw_requs) {
        ...
        if (!cJSON_IsArray(bw_requs)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [bw_requs]");
            goto end;
        }
    ...
    if (excep_requs) {
        ...
        if (!cJSON_IsArray(excep_requs)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [excep_requs]");
            goto end;
        }
    ...
    if (!expt_ana_type_local_nonprim) {
        log_error("OpenAPI_expected_analytics_type_parseFromJSON failed [expt_ana_type]");
        goto end;
    }
    }
    ...
    if (!expt_ue_behav_local_nonprim) {
        log_error("OpenAPI_expected_ue_behaviour_data_parseFromJSON failed [expt_ue_behav]");
        goto end;
    }
    }
    ...
    if (rat_freqs) {
        ...
        if (!cJSON_IsArray(rat_freqs)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [rat_freqs]");
            goto end;
        }
    ...
    if (list_of_ana_subsets) {
        ...
        if (!cJSON_IsArray(list_of_ana_subsets)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [list_of_ana_subsets]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(list_of_ana_subsets_local, list_of_ana_subsets) {
            ...
            if (!list_of_ana_subsetsItem) {
                log_error("No list_of_ana_subsetsItem");
                goto end;
            }
    ...
    if (disper_reqs) {
        ...
        if (!cJSON_IsArray(disper_reqs)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [disper_reqs]");
            goto end;
        }
    ...
    if (red_trans_reqs) {
        ...
        if (!cJSON_IsArray(red_trans_reqs)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [red_trans_reqs]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(red_trans_reqs_local, red_trans_reqs) {
            ...
            if (!red_trans_reqsItem) {
                log_error("No red_trans_reqsItem");
                goto end;
            }
    ...
    if (wlan_reqs) {
        ...
        if (!cJSON_IsArray(wlan_reqs)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [wlan_reqs]");
            goto end;
        }
    ...
    if (app_server_addrs) {
        ...
        if (!cJSON_IsArray(app_server_addrs)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [app_server_addrs]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(app_server_addrs_local, app_server_addrs) {
            ...
            if (!app_server_addrsItem) {
                log_error("No app_server_addrsItem");
                goto end;
            }
    ...
    if (dn_perf_reqs) {
        ...
        if (!cJSON_IsArray(dn_perf_reqs)) {
            log_error("OpenAPI_event_subscription_parseFromJSON() failed [dn_perf_reqs]");
            goto end;
        }
...
OpenAPI_event_subscription_t *OpenAPI_event_subscription_copy(OpenAPI_event_subscription_t *dst, OpenAPI_event_subscription_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_event_subscription_convertToJSON() failed");
        return NULL;
    }
