...
)
{
    ...
    log_assert(horizontal_with_vertical_velocity_local_var);
...
cJSON *OpenAPI_horizontal_with_vertical_velocity_convertToJSON(OpenAPI_horizontal_with_vertical_velocity_t *horizontal_with_vertical_velocity)
{
    ...
    if (horizontal_with_vertical_velocity == NULL) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_convertToJSON() failed [HorizontalWithVerticalVelocity]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (cJSON_AddNumberToObject(item, "hSpeed", horizontal_with_vertical_velocity->h_speed) == NULL) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_convertToJSON() failed [h_speed]");
        goto end;
    }

    if (cJSON_AddNumberToObject(item, "bearing", horizontal_with_vertical_velocity->bearing) == NULL) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_convertToJSON() failed [bearing]");
        goto end;
    }

    if (cJSON_AddNumberToObject(item, "vSpeed", horizontal_with_vertical_velocity->v_speed) == NULL) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_convertToJSON() failed [v_speed]");
        goto end;
    }

    if (horizontal_with_vertical_velocity->v_direction == OpenAPI_vertical_direction_NULL) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_convertToJSON() failed [v_direction]");
        return NULL;
    }
...
OpenAPI_horizontal_with_vertical_velocity_t *OpenAPI_horizontal_with_vertical_velocity_parseFromJSON(cJSON *horizontal_with_vertical_velocityJSON)
{
    ...
    if (!h_speed) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_parseFromJSON() failed [h_speed]");
        goto end;
    }
    ...
    if (!bearing) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_parseFromJSON() failed [bearing]");
        goto end;
    }
    ...
    if (!v_speed) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_parseFromJSON() failed [v_speed]");
        goto end;
    }
    ...
    if (!v_direction) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_parseFromJSON() failed [v_direction]");
        goto end;
    }
...
OpenAPI_horizontal_with_vertical_velocity_t *OpenAPI_horizontal_with_vertical_velocity_copy(OpenAPI_horizontal_with_vertical_velocity_t *dst, OpenAPI_horizontal_with_vertical_velocity_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_convertToJSON() failed");
        return NULL;
    }
