...
)
{
    ...
    log_assert(problem_details_1_local_var);
...
cJSON *OpenAPI_problem_details_1_convertToJSON(OpenAPI_problem_details_1_t *problem_details_1)
{
    ...
    if (problem_details_1 == NULL) {
        log_error("OpenAPI_problem_details_1_convertToJSON() failed [ProblemDetails_1]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "type", problem_details_1->type) == NULL) {
        log_error("OpenAPI_problem_details_1_convertToJSON() failed [type]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "title", problem_details_1->title) == NULL) {
        log_error("OpenAPI_problem_details_1_convertToJSON() failed [title]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "status", problem_details_1->status) == NULL) {
        log_error("OpenAPI_problem_details_1_convertToJSON() failed [status]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "detail", problem_details_1->detail) == NULL) {
        log_error("OpenAPI_problem_details_1_convertToJSON() failed [detail]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "instance", problem_details_1->instance) == NULL) {
        log_error("OpenAPI_problem_details_1_convertToJSON() failed [instance]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "cause", problem_details_1->cause) == NULL) {
        log_error("OpenAPI_problem_details_1_convertToJSON() failed [cause]");
        goto end;
    }
    }
    ...
    if (invalid_paramsList == NULL) {
        log_error("OpenAPI_problem_details_1_convertToJSON() failed [invalid_params]");
        goto end;
    }
    OpenAPI_list_for_each(problem_details_1->invalid_params, node) {
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", problem_details_1->supported_features) == NULL) {
        log_error("OpenAPI_problem_details_1_convertToJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (access_token_error_local_JSON == NULL) {
        log_error("OpenAPI_problem_details_1_convertToJSON() failed [access_token_error]");
        goto end;
    }
    ...
    if (access_token_request_local_JSON == NULL) {
        log_error("OpenAPI_problem_details_1_convertToJSON() failed [access_token_request]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "nrfId", problem_details_1->nrf_id) == NULL) {
        log_error("OpenAPI_problem_details_1_convertToJSON() failed [nrf_id]");
        goto end;
    }
    }
...
OpenAPI_problem_details_1_t *OpenAPI_problem_details_1_parseFromJSON(cJSON *problem_details_1JSON)
{
    ...
    if (!cJSON_IsString(type) && !cJSON_IsNull(type)) {
        log_error("OpenAPI_problem_details_1_parseFromJSON() failed [type]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(title) && !cJSON_IsNull(title)) {
        log_error("OpenAPI_problem_details_1_parseFromJSON() failed [title]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(status)) {
        log_error("OpenAPI_problem_details_1_parseFromJSON() failed [status]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(detail) && !cJSON_IsNull(detail)) {
        log_error("OpenAPI_problem_details_1_parseFromJSON() failed [detail]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(instance) && !cJSON_IsNull(instance)) {
        log_error("OpenAPI_problem_details_1_parseFromJSON() failed [instance]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(cause) && !cJSON_IsNull(cause)) {
        log_error("OpenAPI_problem_details_1_parseFromJSON() failed [cause]");
        goto end;
    }
    }
    ...
    if (invalid_params) {
        ...
        if (!cJSON_IsArray(invalid_params)) {
            log_error("OpenAPI_problem_details_1_parseFromJSON() failed [invalid_params]");
            goto end;
        }
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_problem_details_1_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(nrf_id) && !cJSON_IsNull(nrf_id)) {
        log_error("OpenAPI_problem_details_1_parseFromJSON() failed [nrf_id]");
        goto end;
    }
    }
...
OpenAPI_problem_details_1_t *OpenAPI_problem_details_1_copy(OpenAPI_problem_details_1_t *dst, OpenAPI_problem_details_1_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_problem_details_1_convertToJSON() failed");
        return NULL;
    }
