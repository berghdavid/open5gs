...
)
{
    ...
    log_assert(sec_param_exch_req_data_local_var);
...
cJSON *OpenAPI_sec_param_exch_req_data_convertToJSON(OpenAPI_sec_param_exch_req_data_t *sec_param_exch_req_data)
{
    ...
    if (sec_param_exch_req_data == NULL) {
        log_error("OpenAPI_sec_param_exch_req_data_convertToJSON() failed [SecParamExchReqData]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!sec_param_exch_req_data->n32f_context_id) {
        log_error("OpenAPI_sec_param_exch_req_data_convertToJSON() failed [n32f_context_id]");
        return NULL;
    }
    ...
    if (jwe_cipher_suite_listList == NULL) {
        log_error("OpenAPI_sec_param_exch_req_data_convertToJSON() failed [jwe_cipher_suite_list]");
        goto end;
    }
    OpenAPI_list_for_each(sec_param_exch_req_data->jwe_cipher_suite_list, node) {
    ...
    if (jws_cipher_suite_listList == NULL) {
        log_error("OpenAPI_sec_param_exch_req_data_convertToJSON() failed [jws_cipher_suite_list]");
        goto end;
    }
    OpenAPI_list_for_each(sec_param_exch_req_data->jws_cipher_suite_list, node) {
    ...
    if (protection_policy_info_local_JSON == NULL) {
        log_error("OpenAPI_sec_param_exch_req_data_convertToJSON() failed [protection_policy_info]");
        goto end;
    }
    ...
    if (ipx_provider_sec_info_listList == NULL) {
        log_error("OpenAPI_sec_param_exch_req_data_convertToJSON() failed [ipx_provider_sec_info_list]");
        goto end;
    }
    OpenAPI_list_for_each(sec_param_exch_req_data->ipx_provider_sec_info_list, node) {
    ...
    if (cJSON_AddStringToObject(item, "sender", sec_param_exch_req_data->sender) == NULL) {
        log_error("OpenAPI_sec_param_exch_req_data_convertToJSON() failed [sender]");
        goto end;
    }
    }
...
OpenAPI_sec_param_exch_req_data_t *OpenAPI_sec_param_exch_req_data_parseFromJSON(cJSON *sec_param_exch_req_dataJSON)
{
    ...
    if (!n32f_context_id) {
        log_error("OpenAPI_sec_param_exch_req_data_parseFromJSON() failed [n32f_context_id]");
        goto end;
    }
    ...
    if (jwe_cipher_suite_list) {
        ...
        if (!cJSON_IsArray(jwe_cipher_suite_list)) {
            log_error("OpenAPI_sec_param_exch_req_data_parseFromJSON() failed [jwe_cipher_suite_list]");
            goto end;
        }
    ...
    if (jws_cipher_suite_list) {
        ...
        if (!cJSON_IsArray(jws_cipher_suite_list)) {
            log_error("OpenAPI_sec_param_exch_req_data_parseFromJSON() failed [jws_cipher_suite_list]");
            goto end;
        }
    ...
    if (!protection_policy_info_local_nonprim) {
        log_error("OpenAPI_protection_policy_parseFromJSON failed [protection_policy_info]");
        goto end;
    }
    }
    ...
    if (ipx_provider_sec_info_list) {
        ...
        if (!cJSON_IsArray(ipx_provider_sec_info_list)) {
            log_error("OpenAPI_sec_param_exch_req_data_parseFromJSON() failed [ipx_provider_sec_info_list]");
            goto end;
        }
    ...
    if (!cJSON_IsString(sender) && !cJSON_IsNull(sender)) {
        log_error("OpenAPI_sec_param_exch_req_data_parseFromJSON() failed [sender]");
        goto end;
    }
    }
...
OpenAPI_sec_param_exch_req_data_t *OpenAPI_sec_param_exch_req_data_copy(OpenAPI_sec_param_exch_req_data_t *dst, OpenAPI_sec_param_exch_req_data_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_sec_param_exch_req_data_convertToJSON() failed");
        return NULL;
    }
