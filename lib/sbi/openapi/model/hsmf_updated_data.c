...
)
{
    ...
    log_assert(hsmf_updated_data_local_var);
...
cJSON *OpenAPI_hsmf_updated_data_convertToJSON(OpenAPI_hsmf_updated_data_t *hsmf_updated_data)
{
    ...
    if (hsmf_updated_data == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [HsmfUpdatedData]");
        return NULL;
    }
    ...
    if (n1_sm_info_to_ue_local_JSON == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [n1_sm_info_to_ue]");
        goto end;
    }
    ...
    if (n4_info_local_JSON == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [n4_info]");
        goto end;
    }
    ...
    if (n4_info_ext1_local_JSON == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [n4_info_ext1]");
        goto end;
    }
    ...
    if (n4_info_ext2_local_JSON == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [n4_info_ext2]");
        goto end;
    }
    ...
    if (dnai_listList == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [dnai_list]");
        goto end;
    }
    OpenAPI_list_for_each(hsmf_updated_data->dnai_list, node) {
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", hsmf_updated_data->supported_features) == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (roaming_charging_profile_local_JSON == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [roaming_charging_profile]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "homeProvidedChargingId", hsmf_updated_data->home_provided_charging_id) == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [home_provided_charging_id]");
        goto end;
    }
    }
    ...
    if (up_security_local_JSON == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [up_security]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "maxIntegrityProtectedDataRateUl", OpenAPI_max_integrity_protected_data_rate_ToString(hsmf_updated_data->max_integrity_protected_data_rate_ul)) == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [max_integrity_protected_data_rate_ul]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "maxIntegrityProtectedDataRateDl", OpenAPI_max_integrity_protected_data_rate_ToString(hsmf_updated_data->max_integrity_protected_data_rate_dl)) == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [max_integrity_protected_data_rate_dl]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "ipv6MultiHomingInd", hsmf_updated_data->ipv6_multi_homing_ind) == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [ipv6_multi_homing_ind]");
        goto end;
    }
    }
    ...
    if (qos_flows_setup_listList == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [qos_flows_setup_list]");
        goto end;
    }
    OpenAPI_list_for_each(hsmf_updated_data->qos_flows_setup_list, node) {
    ...
    if (session_ambr_local_JSON == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [session_ambr]");
        goto end;
    }
    ...
    if (eps_pdn_cnx_info_local_JSON == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [eps_pdn_cnx_info]");
        goto end;
    }
    ...
    if (eps_bearer_infoList == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [eps_bearer_info]");
        goto end;
    }
    OpenAPI_list_for_each(hsmf_updated_data->eps_bearer_info, node) {
    ...
    if (cJSON_AddNumberToObject(item, "pti", hsmf_updated_data->pti) == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [pti]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "interPlmnApiRoot", hsmf_updated_data->inter_plmn_api_root) == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [inter_plmn_api_root]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "intraPlmnApiRoot", hsmf_updated_data->intra_plmn_api_root) == NULL) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed [intra_plmn_api_root]");
        goto end;
    }
    }
...
OpenAPI_hsmf_updated_data_t *OpenAPI_hsmf_updated_data_parseFromJSON(cJSON *hsmf_updated_dataJSON)
{
    ...
    if (dnai_list) {
        ...
        if (!cJSON_IsArray(dnai_list)) {
            log_error("OpenAPI_hsmf_updated_data_parseFromJSON() failed [dnai_list]");
            goto end;
        }
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_hsmf_updated_data_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(home_provided_charging_id) && !cJSON_IsNull(home_provided_charging_id)) {
        log_error("OpenAPI_hsmf_updated_data_parseFromJSON() failed [home_provided_charging_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(max_integrity_protected_data_rate_ul)) {
        log_error("OpenAPI_hsmf_updated_data_parseFromJSON() failed [max_integrity_protected_data_rate_ul]");
        goto end;
    }
    ...
    if (!cJSON_IsString(max_integrity_protected_data_rate_dl)) {
        log_error("OpenAPI_hsmf_updated_data_parseFromJSON() failed [max_integrity_protected_data_rate_dl]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(ipv6_multi_homing_ind)) {
        log_error("OpenAPI_hsmf_updated_data_parseFromJSON() failed [ipv6_multi_homing_ind]");
        goto end;
    }
    }
    ...
    if (qos_flows_setup_list) {
        ...
        if (!cJSON_IsArray(qos_flows_setup_list)) {
            log_error("OpenAPI_hsmf_updated_data_parseFromJSON() failed [qos_flows_setup_list]");
            goto end;
        }
    ...
    if (eps_bearer_info) {
        ...
        if (!cJSON_IsArray(eps_bearer_info)) {
            log_error("OpenAPI_hsmf_updated_data_parseFromJSON() failed [eps_bearer_info]");
            goto end;
        }
    ...
    if (!cJSON_IsNumber(pti)) {
        log_error("OpenAPI_hsmf_updated_data_parseFromJSON() failed [pti]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(inter_plmn_api_root) && !cJSON_IsNull(inter_plmn_api_root)) {
        log_error("OpenAPI_hsmf_updated_data_parseFromJSON() failed [inter_plmn_api_root]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(intra_plmn_api_root) && !cJSON_IsNull(intra_plmn_api_root)) {
        log_error("OpenAPI_hsmf_updated_data_parseFromJSON() failed [intra_plmn_api_root]");
        goto end;
    }
    }
...
OpenAPI_hsmf_updated_data_t *OpenAPI_hsmf_updated_data_copy(OpenAPI_hsmf_updated_data_t *dst, OpenAPI_hsmf_updated_data_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_hsmf_updated_data_convertToJSON() failed");
        return NULL;
    }
