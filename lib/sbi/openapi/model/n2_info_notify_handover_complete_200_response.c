...
)
{
    ...
    log_assert(n2_info_notify_handover_complete_200_response_local_var);
...
cJSON *OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON(OpenAPI_n2_info_notify_handover_complete_200_response_t *n2_info_notify_handover_complete_200_response)
{
    ...
    if (n2_info_notify_handover_complete_200_response == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [N2InfoNotifyHandoverComplete_200_response]");
        return NULL;
    }
    ...
    if (json_data_local_JSON == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [json_data]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt1", encoded_str_binary_data_n2_information_ext1) == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [binary_data_n2_information_ext1]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt2", encoded_str_binary_data_n2_information_ext2) == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [binary_data_n2_information_ext2]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt3", encoded_str_binary_data_n2_information_ext3) == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [binary_data_n2_information_ext3]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt4", encoded_str_binary_data_n2_information_ext4) == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [binary_data_n2_information_ext4]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt5", encoded_str_binary_data_n2_information_ext5) == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [binary_data_n2_information_ext5]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt6", encoded_str_binary_data_n2_information_ext6) == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [binary_data_n2_information_ext6]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt7", encoded_str_binary_data_n2_information_ext7) == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [binary_data_n2_information_ext7]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt8", encoded_str_binary_data_n2_information_ext8) == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [binary_data_n2_information_ext8]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt9", encoded_str_binary_data_n2_information_ext9) == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [binary_data_n2_information_ext9]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt10", encoded_str_binary_data_n2_information_ext10) == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [binary_data_n2_information_ext10]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt11", encoded_str_binary_data_n2_information_ext11) == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [binary_data_n2_information_ext11]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt12", encoded_str_binary_data_n2_information_ext12) == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [binary_data_n2_information_ext12]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt13", encoded_str_binary_data_n2_information_ext13) == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [binary_data_n2_information_ext13]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt14", encoded_str_binary_data_n2_information_ext14) == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [binary_data_n2_information_ext14]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt15", encoded_str_binary_data_n2_information_ext15) == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [binary_data_n2_information_ext15]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt16", encoded_str_binary_data_n2_information_ext16) == NULL) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed [binary_data_n2_information_ext16]");
        goto end;
    }
...
OpenAPI_n2_info_notify_handover_complete_200_response_t *OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON(cJSON *n2_info_notify_handover_complete_200_responseJSON)
{
    ...
    if (!json_data_local_nonprim) {
        log_error("OpenAPI_n2_info_notification_rsp_data_parseFromJSON failed [json_data]");
        goto end;
    }
    }
    ...
    log_assert(decoded_str_binary_data_n2_information_ext1);
    if (!cJSON_IsString(binary_data_n2_information_ext1)) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON() failed [binary_data_n2_information_ext1]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_information_ext2);
    if (!cJSON_IsString(binary_data_n2_information_ext2)) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON() failed [binary_data_n2_information_ext2]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_information_ext3);
    if (!cJSON_IsString(binary_data_n2_information_ext3)) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON() failed [binary_data_n2_information_ext3]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_information_ext4);
    if (!cJSON_IsString(binary_data_n2_information_ext4)) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON() failed [binary_data_n2_information_ext4]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_information_ext5);
    if (!cJSON_IsString(binary_data_n2_information_ext5)) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON() failed [binary_data_n2_information_ext5]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_information_ext6);
    if (!cJSON_IsString(binary_data_n2_information_ext6)) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON() failed [binary_data_n2_information_ext6]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_information_ext7);
    if (!cJSON_IsString(binary_data_n2_information_ext7)) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON() failed [binary_data_n2_information_ext7]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_information_ext8);
    if (!cJSON_IsString(binary_data_n2_information_ext8)) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON() failed [binary_data_n2_information_ext8]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_information_ext9);
    if (!cJSON_IsString(binary_data_n2_information_ext9)) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON() failed [binary_data_n2_information_ext9]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_information_ext10);
    if (!cJSON_IsString(binary_data_n2_information_ext10)) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON() failed [binary_data_n2_information_ext10]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_information_ext11);
    if (!cJSON_IsString(binary_data_n2_information_ext11)) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON() failed [binary_data_n2_information_ext11]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_information_ext12);
    if (!cJSON_IsString(binary_data_n2_information_ext12)) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON() failed [binary_data_n2_information_ext12]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_information_ext13);
    if (!cJSON_IsString(binary_data_n2_information_ext13)) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON() failed [binary_data_n2_information_ext13]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_information_ext14);
    if (!cJSON_IsString(binary_data_n2_information_ext14)) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON() failed [binary_data_n2_information_ext14]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_information_ext15);
    if (!cJSON_IsString(binary_data_n2_information_ext15)) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON() failed [binary_data_n2_information_ext15]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_information_ext16);
    if (!cJSON_IsString(binary_data_n2_information_ext16)) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_parseFromJSON() failed [binary_data_n2_information_ext16]");
        goto end;
    }
...
OpenAPI_n2_info_notify_handover_complete_200_response_t *OpenAPI_n2_info_notify_handover_complete_200_response_copy(OpenAPI_n2_info_notify_handover_complete_200_response_t *dst, OpenAPI_n2_info_notify_handover_complete_200_response_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_n2_info_notify_handover_complete_200_response_convertToJSON() failed");
        return NULL;
    }
