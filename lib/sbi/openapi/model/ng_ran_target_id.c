...
)
{
    ...
    log_assert(ng_ran_target_id_local_var);
...
cJSON *OpenAPI_ng_ran_target_id_convertToJSON(OpenAPI_ng_ran_target_id_t *ng_ran_target_id)
{
    ...
    if (ng_ran_target_id == NULL) {
        log_error("OpenAPI_ng_ran_target_id_convertToJSON() failed [NgRanTargetId]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!ng_ran_target_id->ran_node_id) {
        log_error("OpenAPI_ng_ran_target_id_convertToJSON() failed [ran_node_id]");
        return NULL;
    }
    ...
    if (!ng_ran_target_id->tai) {
        log_error("OpenAPI_ng_ran_target_id_convertToJSON() failed [tai]");
        return NULL;
    }
...
OpenAPI_ng_ran_target_id_t *OpenAPI_ng_ran_target_id_parseFromJSON(cJSON *ng_ran_target_idJSON)
{
    ...
    if (!ran_node_id) {
        log_error("OpenAPI_ng_ran_target_id_parseFromJSON() failed [ran_node_id]");
        goto end;
    }
    ...
    if (!tai) {
        log_error("OpenAPI_ng_ran_target_id_parseFromJSON() failed [tai]");
        goto end;
    }
...
OpenAPI_ng_ran_target_id_t *OpenAPI_ng_ran_target_id_copy(OpenAPI_ng_ran_target_id_t *dst, OpenAPI_ng_ran_target_id_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_ng_ran_target_id_convertToJSON() failed");
        return NULL;
    }
