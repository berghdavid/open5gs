...
)
{
    ...
    log_assert(smsf_registration_local_var);
...
cJSON *OpenAPI_smsf_registration_convertToJSON(OpenAPI_smsf_registration_t *smsf_registration)
{
    ...
    if (smsf_registration == NULL) {
        log_error("OpenAPI_smsf_registration_convertToJSON() failed [SmsfRegistration]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!smsf_registration->smsf_instance_id) {
        log_error("OpenAPI_smsf_registration_convertToJSON() failed [smsf_instance_id]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "smsfSetId", smsf_registration->smsf_set_id) == NULL) {
        log_error("OpenAPI_smsf_registration_convertToJSON() failed [smsf_set_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", smsf_registration->supported_features) == NULL) {
        log_error("OpenAPI_smsf_registration_convertToJSON() failed [supported_features]");
        goto end;
    }
    }

    if (!smsf_registration->plmn_id) {
        log_error("OpenAPI_smsf_registration_convertToJSON() failed [plmn_id]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "smsfMAPAddress", smsf_registration->smsf_map_address) == NULL) {
        log_error("OpenAPI_smsf_registration_convertToJSON() failed [smsf_map_address]");
        goto end;
    }
    }
    ...
    if (smsf_diameter_address_local_JSON == NULL) {
        log_error("OpenAPI_smsf_registration_convertToJSON() failed [smsf_diameter_address]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "registrationTime", smsf_registration->registration_time) == NULL) {
        log_error("OpenAPI_smsf_registration_convertToJSON() failed [registration_time]");
        goto end;
    }
    }
    ...
    if (context_info_local_JSON == NULL) {
        log_error("OpenAPI_smsf_registration_convertToJSON() failed [context_info]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "dataRestorationCallbackUri", smsf_registration->data_restoration_callback_uri) == NULL) {
        log_error("OpenAPI_smsf_registration_convertToJSON() failed [data_restoration_callback_uri]");
        goto end;
    }
    }
    ...
    if (reset_idsList == NULL) {
        log_error("OpenAPI_smsf_registration_convertToJSON() failed [reset_ids]");
        goto end;
    }
    OpenAPI_list_for_each(smsf_registration->reset_ids, node) {
    ...
    if (cJSON_AddBoolToObject(item, "smsfSbiSupInd", smsf_registration->smsf_sbi_sup_ind) == NULL) {
        log_error("OpenAPI_smsf_registration_convertToJSON() failed [smsf_sbi_sup_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "udrRestartInd", smsf_registration->udr_restart_ind) == NULL) {
        log_error("OpenAPI_smsf_registration_convertToJSON() failed [udr_restart_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "lastSynchronizationTime", smsf_registration->last_synchronization_time) == NULL) {
        log_error("OpenAPI_smsf_registration_convertToJSON() failed [last_synchronization_time]");
        goto end;
    }
    }
...
OpenAPI_smsf_registration_t *OpenAPI_smsf_registration_parseFromJSON(cJSON *smsf_registrationJSON)
{
    ...
    if (!smsf_instance_id) {
        log_error("OpenAPI_smsf_registration_parseFromJSON() failed [smsf_instance_id]");
        goto end;
    }
    ...
    if (!cJSON_IsString(smsf_set_id) && !cJSON_IsNull(smsf_set_id)) {
        log_error("OpenAPI_smsf_registration_parseFromJSON() failed [smsf_set_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_smsf_registration_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (!plmn_id) {
        log_error("OpenAPI_smsf_registration_parseFromJSON() failed [plmn_id]");
        goto end;
    }
    ...
    if (!cJSON_IsString(smsf_map_address) && !cJSON_IsNull(smsf_map_address)) {
        log_error("OpenAPI_smsf_registration_parseFromJSON() failed [smsf_map_address]");
        goto end;
    }
    }
    ...
    if (!smsf_diameter_address_local_nonprim) {
        log_error("OpenAPI_network_node_diameter_address_parseFromJSON failed [smsf_diameter_address]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(registration_time) && !cJSON_IsNull(registration_time)) {
        log_error("OpenAPI_smsf_registration_parseFromJSON() failed [registration_time]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(data_restoration_callback_uri) && !cJSON_IsNull(data_restoration_callback_uri)) {
        log_error("OpenAPI_smsf_registration_parseFromJSON() failed [data_restoration_callback_uri]");
        goto end;
    }
    }
    ...
    if (reset_ids) {
        ...
        if (!cJSON_IsArray(reset_ids)) {
            log_error("OpenAPI_smsf_registration_parseFromJSON() failed [reset_ids]");
            goto end;
        }
    ...
    if (!cJSON_IsBool(smsf_sbi_sup_ind)) {
        log_error("OpenAPI_smsf_registration_parseFromJSON() failed [smsf_sbi_sup_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(udr_restart_ind)) {
        log_error("OpenAPI_smsf_registration_parseFromJSON() failed [udr_restart_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(last_synchronization_time) && !cJSON_IsNull(last_synchronization_time)) {
        log_error("OpenAPI_smsf_registration_parseFromJSON() failed [last_synchronization_time]");
        goto end;
    }
    }
...
OpenAPI_smsf_registration_t *OpenAPI_smsf_registration_copy(OpenAPI_smsf_registration_t *dst, OpenAPI_smsf_registration_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_smsf_registration_convertToJSON() failed");
        return NULL;
    }
