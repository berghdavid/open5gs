...
)
{
    ...
    log_assert(location_area_1_local_var);
...
cJSON *OpenAPI_location_area_1_convertToJSON(OpenAPI_location_area_1_t *location_area_1)
{
    ...
    if (location_area_1 == NULL) {
        log_error("OpenAPI_location_area_1_convertToJSON() failed [LocationArea_1]");
        return NULL;
    }
    ...
    if (geographic_areasList == NULL) {
        log_error("OpenAPI_location_area_1_convertToJSON() failed [geographic_areas]");
        goto end;
    }
    OpenAPI_list_for_each(location_area_1->geographic_areas, node) {
    ...
    if (civic_addressesList == NULL) {
        log_error("OpenAPI_location_area_1_convertToJSON() failed [civic_addresses]");
        goto end;
    }
    OpenAPI_list_for_each(location_area_1->civic_addresses, node) {
    ...
    if (nw_area_info_local_JSON == NULL) {
        log_error("OpenAPI_location_area_1_convertToJSON() failed [nw_area_info]");
        goto end;
    }
    ...
    if (umt_time_local_JSON == NULL) {
        log_error("OpenAPI_location_area_1_convertToJSON() failed [umt_time]");
        goto end;
    }
...
OpenAPI_location_area_1_t *OpenAPI_location_area_1_parseFromJSON(cJSON *location_area_1JSON)
{
    ...
    if (geographic_areas) {
        ...
        if (!cJSON_IsArray(geographic_areas)) {
            log_error("OpenAPI_location_area_1_parseFromJSON() failed [geographic_areas]");
            goto end;
        }
    ...
    if (civic_addresses) {
        ...
        if (!cJSON_IsArray(civic_addresses)) {
            log_error("OpenAPI_location_area_1_parseFromJSON() failed [civic_addresses]");
            goto end;
        }
    ...
    if (!umt_time_local_nonprim) {
        log_error("OpenAPI_umt_time_1_parseFromJSON failed [umt_time]");
        goto end;
    }
    }
...
OpenAPI_location_area_1_t *OpenAPI_location_area_1_copy(OpenAPI_location_area_1_t *dst, OpenAPI_location_area_1_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_location_area_1_convertToJSON() failed");
        return NULL;
    }
