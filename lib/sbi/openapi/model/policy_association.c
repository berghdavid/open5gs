...
)
{
    ...
    log_assert(policy_association_local_var);
...
cJSON *OpenAPI_policy_association_convertToJSON(OpenAPI_policy_association_t *policy_association)
{
    ...
    if (policy_association == NULL) {
        log_error("OpenAPI_policy_association_convertToJSON() failed [PolicyAssociation]");
        return NULL;
    }
    ...
    if (request_local_JSON == NULL) {
        log_error("OpenAPI_policy_association_convertToJSON() failed [request]");
        goto end;
    }
    ...
    if (triggersList == NULL) {
        log_error("OpenAPI_policy_association_convertToJSON() failed [triggers]");
        goto end;
    }
    ...
    if (serv_area_res_local_JSON == NULL) {
        log_error("OpenAPI_policy_association_convertToJSON() failed [serv_area_res]");
        goto end;
    }
    ...
    if (wl_serv_area_res_local_JSON == NULL) {
        log_error("OpenAPI_policy_association_convertToJSON() failed [wl_serv_area_res]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "rfsp", policy_association->rfsp) == NULL) {
        log_error("OpenAPI_policy_association_convertToJSON() failed [rfsp]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "targetRfsp", policy_association->target_rfsp) == NULL) {
        log_error("OpenAPI_policy_association_convertToJSON() failed [target_rfsp]");
        goto end;
    }
    }
    ...
    if (smf_sel_info_local_JSON == NULL) {
        log_error("OpenAPI_policy_association_convertToJSON() failed [smf_sel_info]");
        goto end;
    }
    ...
    if (ue_ambr_local_JSON == NULL) {
        log_error("OpenAPI_policy_association_convertToJSON() failed [ue_ambr]");
        goto end;
    }
    ...
    if (ue_slice_mbrsList == NULL) {
        log_error("OpenAPI_policy_association_convertToJSON() failed [ue_slice_mbrs]");
        goto end;
    }
    OpenAPI_list_for_each(policy_association->ue_slice_mbrs, node) {
    ...
    if (pras == NULL) {
        log_error("OpenAPI_policy_association_convertToJSON() failed [pras]");
        goto end;
    }
    ...
    if (policy_association->pras) {
        OpenAPI_list_for_each(policy_association->pras, node) {
            ...
            cJSON *itemLocal = localKeyValue->value ?
                ...
                cJSON_CreateNull();
            if (itemLocal == NULL) {
                log_error("OpenAPI_policy_association_convertToJSON() failed [inner]");
                goto end;
            }
    ...
    if (!policy_association->supp_feat) {
        log_error("OpenAPI_policy_association_convertToJSON() failed [supp_feat]");
        return NULL;
    }
    ...
    if (pcf_ue_info_local_JSON == NULL) {
        log_error("OpenAPI_policy_association_convertToJSON() failed [pcf_ue_info]");
        goto end;
    }
    ...
    if (match_pdusList == NULL) {
        log_error("OpenAPI_policy_association_convertToJSON() failed [match_pdus]");
        goto end;
    }
    OpenAPI_list_for_each(policy_association->match_pdus, node) {
    ...
    if (as_time_dis_param_local_JSON == NULL) {
        log_error("OpenAPI_policy_association_convertToJSON() failed [as_time_dis_param]");
        goto end;
    }
...
OpenAPI_policy_association_t *OpenAPI_policy_association_parseFromJSON(cJSON *policy_associationJSON)
{
    ...
    if (!request_local_nonprim) {
        log_error("OpenAPI_policy_association_request_parseFromJSON failed [request]");
        goto end;
    }
    }
    ...
    if (triggers) {
        ...
        if (!cJSON_IsArray(triggers)) {
            log_error("OpenAPI_policy_association_parseFromJSON() failed [triggers]");
            goto end;
        }
        ...
        if (triggersList->count == 0) {
            log_error("OpenAPI_policy_association_parseFromJSON() failed: Expected triggersList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (!cJSON_IsNumber(rfsp)) {
        log_error("OpenAPI_policy_association_parseFromJSON() failed [rfsp]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(target_rfsp)) {
        log_error("OpenAPI_policy_association_parseFromJSON() failed [target_rfsp]");
        goto end;
    }
    }
    ...
    if (ue_slice_mbrs) {
        ...
        if (!cJSON_IsArray(ue_slice_mbrs)) {
            log_error("OpenAPI_policy_association_parseFromJSON() failed [ue_slice_mbrs]");
            goto end;
        }
    ...
    if (pras) {
        ...
        if (!cJSON_IsObject(pras) && !cJSON_IsNull(pras)) {
            log_error("OpenAPI_policy_association_parseFromJSON() failed [pras]");
            goto end;
        }
        if (cJSON_IsObject(pras)) {
            ...
            cJSON_ArrayForEach(pras_local_map, pras) {
                ...
                if (cJSON_IsObject(localMapObject)) {
                    ...
                    log_error("OpenAPI_policy_association_parseFromJSON() failed [inner]");
                    goto end;
                }
    ...
    if (!supp_feat) {
        log_error("OpenAPI_policy_association_parseFromJSON() failed [supp_feat]");
        goto end;
    }
    ...
    if (!cJSON_IsNull(match_pdus)) {
        ...
        if (!cJSON_IsArray(match_pdus)) {
            log_error("OpenAPI_policy_association_parseFromJSON() failed [match_pdus]");
            goto end;
        }
    ...
    if (!as_time_dis_param_local_nonprim) {
        log_error("OpenAPI_as_time_distribution_param_parseFromJSON failed [as_time_dis_param]");
        goto end;
    }
    }
    }
...
OpenAPI_policy_association_t *OpenAPI_policy_association_copy(OpenAPI_policy_association_t *dst, OpenAPI_policy_association_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_policy_association_convertToJSON() failed");
        return NULL;
    }
