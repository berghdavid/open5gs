...
)
{
    ...
    log_assert(nwdaf_info_local_var);
...
cJSON *OpenAPI_nwdaf_info_convertToJSON(OpenAPI_nwdaf_info_t *nwdaf_info)
{
    ...
    if (nwdaf_info == NULL) {
        log_error("OpenAPI_nwdaf_info_convertToJSON() failed [NwdafInfo]");
        return NULL;
    }
    ...
    if (event_idsList == NULL) {
        log_error("OpenAPI_nwdaf_info_convertToJSON() failed [event_ids]");
        goto end;
    }
    OpenAPI_list_for_each(nwdaf_info->event_ids, node) {
    ...
    if (nwdaf_eventsList == NULL) {
        log_error("OpenAPI_nwdaf_info_convertToJSON() failed [nwdaf_events]");
        goto end;
    }
    OpenAPI_list_for_each(nwdaf_info->nwdaf_events, node) {
    ...
    if (tai_listList == NULL) {
        log_error("OpenAPI_nwdaf_info_convertToJSON() failed [tai_list]");
        goto end;
    }
    OpenAPI_list_for_each(nwdaf_info->tai_list, node) {
    ...
    if (tai_range_listList == NULL) {
        log_error("OpenAPI_nwdaf_info_convertToJSON() failed [tai_range_list]");
        goto end;
    }
    OpenAPI_list_for_each(nwdaf_info->tai_range_list, node) {
    ...
    if (nwdaf_capability_local_JSON == NULL) {
        log_error("OpenAPI_nwdaf_info_convertToJSON() failed [nwdaf_capability]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "analyticsDelay", nwdaf_info->analytics_delay) == NULL) {
        log_error("OpenAPI_nwdaf_info_convertToJSON() failed [analytics_delay]");
        goto end;
    }
    }
    ...
    if (serving_nf_set_id_listList == NULL) {
        log_error("OpenAPI_nwdaf_info_convertToJSON() failed [serving_nf_set_id_list]");
        goto end;
    }
    OpenAPI_list_for_each(nwdaf_info->serving_nf_set_id_list, node) {
    ...
    if (serving_nf_type_listList == NULL) {
        log_error("OpenAPI_nwdaf_info_convertToJSON() failed [serving_nf_type_list]");
        goto end;
    }
    ...
    if (ml_analytics_listList == NULL) {
        log_error("OpenAPI_nwdaf_info_convertToJSON() failed [ml_analytics_list]");
        goto end;
    }
    OpenAPI_list_for_each(nwdaf_info->ml_analytics_list, node) {
...
OpenAPI_nwdaf_info_t *OpenAPI_nwdaf_info_parseFromJSON(cJSON *nwdaf_infoJSON)
{
    ...
    if (event_ids) {
        ...
        if (!cJSON_IsArray(event_ids)) {
            log_error("OpenAPI_nwdaf_info_parseFromJSON() failed [event_ids]");
            goto end;
        }
    ...
    if (nwdaf_events) {
        ...
        if (!cJSON_IsArray(nwdaf_events)) {
            log_error("OpenAPI_nwdaf_info_parseFromJSON() failed [nwdaf_events]");
            goto end;
        }
    ...
    if (tai_list) {
        ...
        if (!cJSON_IsArray(tai_list)) {
            log_error("OpenAPI_nwdaf_info_parseFromJSON() failed [tai_list]");
            goto end;
        }
    ...
    if (tai_range_list) {
        ...
        if (!cJSON_IsArray(tai_range_list)) {
            log_error("OpenAPI_nwdaf_info_parseFromJSON() failed [tai_range_list]");
            goto end;
        }
    ...
    if (!cJSON_IsNumber(analytics_delay)) {
        log_error("OpenAPI_nwdaf_info_parseFromJSON() failed [analytics_delay]");
        goto end;
    }
    }
    ...
    if (serving_nf_set_id_list) {
        ...
        if (!cJSON_IsArray(serving_nf_set_id_list)) {
            log_error("OpenAPI_nwdaf_info_parseFromJSON() failed [serving_nf_set_id_list]");
            goto end;
        }
    ...
    if (serving_nf_type_list) {
        ...
        if (!cJSON_IsArray(serving_nf_type_list)) {
            log_error("OpenAPI_nwdaf_info_parseFromJSON() failed [serving_nf_type_list]");
            goto end;
        }
        ...
        if (serving_nf_type_listList->count == 0) {
            log_error("OpenAPI_nwdaf_info_parseFromJSON() failed: Expected serving_nf_type_listList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (ml_analytics_list) {
        ...
        if (!cJSON_IsArray(ml_analytics_list)) {
            log_error("OpenAPI_nwdaf_info_parseFromJSON() failed [ml_analytics_list]");
            goto end;
        }
...
OpenAPI_nwdaf_info_t *OpenAPI_nwdaf_info_copy(OpenAPI_nwdaf_info_t *dst, OpenAPI_nwdaf_info_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_nwdaf_info_convertToJSON() failed");
        return NULL;
    }
