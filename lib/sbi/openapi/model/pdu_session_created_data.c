...
)
{
    ...
    log_assert(pdu_session_created_data_local_var);
...
cJSON *OpenAPI_pdu_session_created_data_convertToJSON(OpenAPI_pdu_session_created_data_t *pdu_session_created_data)
{
    ...
    if (pdu_session_created_data == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [PduSessionCreatedData]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (pdu_session_created_data->pdu_session_type == OpenAPI_pdu_session_type_NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [pdu_session_type]");
        return NULL;
    }
    ...
    if (!pdu_session_created_data->ssc_mode) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [ssc_mode]");
        return NULL;
    }
    ...
    if (hcn_tunnel_info_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [hcn_tunnel_info]");
        goto end;
    }
    ...
    if (cn_tunnel_info_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [cn_tunnel_info]");
        goto end;
    }
    ...
    if (additional_cn_tunnel_info_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [additional_cn_tunnel_info]");
        goto end;
    }
    ...
    if (session_ambr_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [session_ambr]");
        goto end;
    }
    ...
    if (qos_flows_setup_listList == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [qos_flows_setup_list]");
        goto end;
    }
    OpenAPI_list_for_each(pdu_session_created_data->qos_flows_setup_list, node) {
    ...
    if (cJSON_AddStringToObject(item, "hSmfInstanceId", pdu_session_created_data->h_smf_instance_id) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [h_smf_instance_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "smfInstanceId", pdu_session_created_data->smf_instance_id) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [smf_instance_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "pduSessionId", pdu_session_created_data->pdu_session_id) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [pdu_session_id]");
        goto end;
    }
    }
    ...
    if (s_nssai_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [s_nssai]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "enablePauseCharging", pdu_session_created_data->enable_pause_charging) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [enable_pause_charging]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ueIpv4Address", pdu_session_created_data->ue_ipv4_address) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [ue_ipv4_address]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ueIpv6Prefix", pdu_session_created_data->ue_ipv6_prefix) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [ue_ipv6_prefix]");
        goto end;
    }
    }
    ...
    if (n1_sm_info_to_ue_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [n1_sm_info_to_ue]");
        goto end;
    }
    ...
    if (eps_pdn_cnx_info_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [eps_pdn_cnx_info]");
        goto end;
    }
    ...
    if (eps_bearer_infoList == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [eps_bearer_info]");
        goto end;
    }
    OpenAPI_list_for_each(pdu_session_created_data->eps_bearer_info, node) {
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", pdu_session_created_data->supported_features) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "maxIntegrityProtectedDataRate", OpenAPI_max_integrity_protected_data_rate_ToString(pdu_session_created_data->max_integrity_protected_data_rate)) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [max_integrity_protected_data_rate]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "maxIntegrityProtectedDataRateDl", OpenAPI_max_integrity_protected_data_rate_ToString(pdu_session_created_data->max_integrity_protected_data_rate_dl)) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [max_integrity_protected_data_rate_dl]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "alwaysOnGranted", pdu_session_created_data->always_on_granted) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [always_on_granted]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "gpsi", pdu_session_created_data->gpsi) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [gpsi]");
        goto end;
    }
    }
    ...
    if (up_security_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [up_security]");
        goto end;
    }
    ...
    if (roaming_charging_profile_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [roaming_charging_profile]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "hSmfServiceInstanceId", pdu_session_created_data->h_smf_service_instance_id) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [h_smf_service_instance_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "smfServiceInstanceId", pdu_session_created_data->smf_service_instance_id) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [smf_service_instance_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "recoveryTime", pdu_session_created_data->recovery_time) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [recovery_time]");
        goto end;
    }
    }
    ...
    if (dnai_listList == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [dnai_list]");
        goto end;
    }
    OpenAPI_list_for_each(pdu_session_created_data->dnai_list, node) {
    ...
    if (cJSON_AddBoolToObject(item, "ipv6MultiHomingInd", pdu_session_created_data->ipv6_multi_homing_ind) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [ipv6_multi_homing_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "maAcceptedInd", pdu_session_created_data->ma_accepted_ind) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [ma_accepted_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "homeProvidedChargingId", pdu_session_created_data->home_provided_charging_id) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [home_provided_charging_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "nefExtBufSupportInd", pdu_session_created_data->nef_ext_buf_support_ind) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [nef_ext_buf_support_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "smallDataRateControlEnabled", pdu_session_created_data->small_data_rate_control_enabled) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [small_data_rate_control_enabled]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ueIpv6InterfaceId", pdu_session_created_data->ue_ipv6_interface_id) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [ue_ipv6_interface_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "ipv6Index", pdu_session_created_data->ipv6_index) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [ipv6_index]");
        goto end;
    }
    }
    ...
    if (dn_aaa_address_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [dn_aaa_address]");
        goto end;
    }
    ...
    if (redundant_pdu_session_info_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [redundant_pdu_session_info]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "nspuSupportInd", pdu_session_created_data->nspu_support_ind) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [nspu_support_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "interPlmnApiRoot", pdu_session_created_data->inter_plmn_api_root) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [inter_plmn_api_root]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "intraPlmnApiRoot", pdu_session_created_data->intra_plmn_api_root) == NULL) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed [intra_plmn_api_root]");
        goto end;
    }
    }
...
OpenAPI_pdu_session_created_data_t *OpenAPI_pdu_session_created_data_parseFromJSON(cJSON *pdu_session_created_dataJSON)
{
    ...
    if (!pdu_session_type) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [pdu_session_type]");
        goto end;
    }
    ...
    if (!ssc_mode) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [ssc_mode]");
        goto end;
    }
    ...
    if (!hcn_tunnel_info_local_nonprim) {
        log_error("OpenAPI_tunnel_info_parseFromJSON failed [hcn_tunnel_info]");
        goto end;
    }
    }
    ...
    if (!cn_tunnel_info_local_nonprim) {
        log_error("OpenAPI_tunnel_info_parseFromJSON failed [cn_tunnel_info]");
        goto end;
    }
    }
    ...
    if (qos_flows_setup_list) {
        ...
        if (!cJSON_IsArray(qos_flows_setup_list)) {
            log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [qos_flows_setup_list]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(qos_flows_setup_list_local, qos_flows_setup_list) {
            ...
            if (!qos_flows_setup_listItem) {
                log_error("No qos_flows_setup_listItem");
                goto end;
            }
    ...
    if (!cJSON_IsString(h_smf_instance_id) && !cJSON_IsNull(h_smf_instance_id)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [h_smf_instance_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(smf_instance_id) && !cJSON_IsNull(smf_instance_id)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [smf_instance_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(pdu_session_id)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [pdu_session_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(enable_pause_charging)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [enable_pause_charging]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ue_ipv4_address) && !cJSON_IsNull(ue_ipv4_address)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [ue_ipv4_address]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ue_ipv6_prefix) && !cJSON_IsNull(ue_ipv6_prefix)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [ue_ipv6_prefix]");
        goto end;
    }
    }
    ...
    if (!n1_sm_info_to_ue_local_nonprim) {
        log_error("OpenAPI_ref_to_binary_data_parseFromJSON failed [n1_sm_info_to_ue]");
        goto end;
    }
    }
    ...
    if (eps_bearer_info) {
        ...
        if (!cJSON_IsArray(eps_bearer_info)) {
            log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [eps_bearer_info]");
            goto end;
        }
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(max_integrity_protected_data_rate)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [max_integrity_protected_data_rate]");
        goto end;
    }
    ...
    if (!cJSON_IsString(max_integrity_protected_data_rate_dl)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [max_integrity_protected_data_rate_dl]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(always_on_granted)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [always_on_granted]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(gpsi) && !cJSON_IsNull(gpsi)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [gpsi]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(h_smf_service_instance_id) && !cJSON_IsNull(h_smf_service_instance_id)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [h_smf_service_instance_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(smf_service_instance_id) && !cJSON_IsNull(smf_service_instance_id)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [smf_service_instance_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(recovery_time) && !cJSON_IsNull(recovery_time)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [recovery_time]");
        goto end;
    }
    }
    ...
    if (dnai_list) {
        ...
        if (!cJSON_IsArray(dnai_list)) {
            log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [dnai_list]");
            goto end;
        }
    ...
    if (!cJSON_IsBool(ipv6_multi_homing_ind)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [ipv6_multi_homing_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(ma_accepted_ind)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [ma_accepted_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(home_provided_charging_id) && !cJSON_IsNull(home_provided_charging_id)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [home_provided_charging_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(nef_ext_buf_support_ind)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [nef_ext_buf_support_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(small_data_rate_control_enabled)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [small_data_rate_control_enabled]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ue_ipv6_interface_id) && !cJSON_IsNull(ue_ipv6_interface_id)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [ue_ipv6_interface_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(ipv6_index)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [ipv6_index]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(nspu_support_ind)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [nspu_support_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(inter_plmn_api_root) && !cJSON_IsNull(inter_plmn_api_root)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [inter_plmn_api_root]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(intra_plmn_api_root) && !cJSON_IsNull(intra_plmn_api_root)) {
        log_error("OpenAPI_pdu_session_created_data_parseFromJSON() failed [intra_plmn_api_root]");
        goto end;
    }
    }
...
OpenAPI_pdu_session_created_data_t *OpenAPI_pdu_session_created_data_copy(OpenAPI_pdu_session_created_data_t *dst, OpenAPI_pdu_session_created_data_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_pdu_session_created_data_convertToJSON() failed");
        return NULL;
    }
