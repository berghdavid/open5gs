...
)
{
    ...
    log_assert(location_area_id_local_var);
...
cJSON *OpenAPI_location_area_id_convertToJSON(OpenAPI_location_area_id_t *location_area_id)
{
    ...
    if (location_area_id == NULL) {
        log_error("OpenAPI_location_area_id_convertToJSON() failed [LocationAreaId]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!location_area_id->plmn_id) {
        log_error("OpenAPI_location_area_id_convertToJSON() failed [plmn_id]");
        return NULL;
    }
    ...
    if (!location_area_id->lac) {
        log_error("OpenAPI_location_area_id_convertToJSON() failed [lac]");
        return NULL;
    }
...
OpenAPI_location_area_id_t *OpenAPI_location_area_id_parseFromJSON(cJSON *location_area_idJSON)
{
    ...
    if (!plmn_id) {
        log_error("OpenAPI_location_area_id_parseFromJSON() failed [plmn_id]");
        goto end;
    }
    ...
    if (!lac) {
        log_error("OpenAPI_location_area_id_parseFromJSON() failed [lac]");
        goto end;
    }
...
OpenAPI_location_area_id_t *OpenAPI_location_area_id_copy(OpenAPI_location_area_id_t *dst, OpenAPI_location_area_id_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_location_area_id_convertToJSON() failed");
        return NULL;
    }
