...
)
{
    ...
    log_assert(gad_shape_local_var);
...
cJSON *OpenAPI_gad_shape_convertToJSON(OpenAPI_gad_shape_t *gad_shape)
{
    ...
    if (gad_shape == NULL) {
        log_error("OpenAPI_gad_shape_convertToJSON() failed [GADShape]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!gad_shape->shape) {
        log_error("OpenAPI_gad_shape_convertToJSON() failed [shape]");
        return NULL;
    }
...
OpenAPI_gad_shape_t *OpenAPI_gad_shape_parseFromJSON(cJSON *gad_shapeJSON)
{
    ...
    if (!shape) {
        log_error("OpenAPI_gad_shape_parseFromJSON() failed [shape]");
        goto end;
    }
...
OpenAPI_gad_shape_t *OpenAPI_gad_shape_copy(OpenAPI_gad_shape_t *dst, OpenAPI_gad_shape_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_gad_shape_convertToJSON() failed");
        return NULL;
    }
