...
)
{
    ...
    log_assert(update_pdu_session_request_local_var);
...
cJSON *OpenAPI_update_pdu_session_request_convertToJSON(OpenAPI_update_pdu_session_request_t *update_pdu_session_request)
{
    ...
    if (update_pdu_session_request == NULL) {
        log_error("OpenAPI_update_pdu_session_request_convertToJSON() failed [UpdatePduSession_request]");
        return NULL;
    }
    ...
    if (json_data_local_JSON == NULL) {
        log_error("OpenAPI_update_pdu_session_request_convertToJSON() failed [json_data]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN1SmInfoFromUe", encoded_str_binary_data_n1_sm_info_from_ue) == NULL) {
        log_error("OpenAPI_update_pdu_session_request_convertToJSON() failed [binary_data_n1_sm_info_from_ue]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataUnknownN1SmInfo", encoded_str_binary_data_unknown_n1_sm_info) == NULL) {
        log_error("OpenAPI_update_pdu_session_request_convertToJSON() failed [binary_data_unknown_n1_sm_info]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN4Information", encoded_str_binary_data_n4_information) == NULL) {
        log_error("OpenAPI_update_pdu_session_request_convertToJSON() failed [binary_data_n4_information]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN4InformationExt1", encoded_str_binary_data_n4_information_ext1) == NULL) {
        log_error("OpenAPI_update_pdu_session_request_convertToJSON() failed [binary_data_n4_information_ext1]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN4InformationExt2", encoded_str_binary_data_n4_information_ext2) == NULL) {
        log_error("OpenAPI_update_pdu_session_request_convertToJSON() failed [binary_data_n4_information_ext2]");
        goto end;
    }
...
OpenAPI_update_pdu_session_request_t *OpenAPI_update_pdu_session_request_parseFromJSON(cJSON *update_pdu_session_requestJSON)
{
    ...
    if (!json_data_local_nonprim) {
        log_error("OpenAPI_hsmf_update_data_parseFromJSON failed [json_data]");
        goto end;
    }
    }
    ...
    log_assert(decoded_str_binary_data_n1_sm_info_from_ue);
    if (!cJSON_IsString(binary_data_n1_sm_info_from_ue)) {
        log_error("OpenAPI_update_pdu_session_request_parseFromJSON() failed [binary_data_n1_sm_info_from_ue]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_unknown_n1_sm_info);
    if (!cJSON_IsString(binary_data_unknown_n1_sm_info)) {
        log_error("OpenAPI_update_pdu_session_request_parseFromJSON() failed [binary_data_unknown_n1_sm_info]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n4_information)) {
        log_error("OpenAPI_update_pdu_session_request_parseFromJSON() failed [binary_data_n4_information]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n4_information_ext1)) {
        log_error("OpenAPI_update_pdu_session_request_parseFromJSON() failed [binary_data_n4_information_ext1]");
        goto end;
    }
    ...
    if (!cJSON_IsString(binary_data_n4_information_ext2)) {
        log_error("OpenAPI_update_pdu_session_request_parseFromJSON() failed [binary_data_n4_information_ext2]");
        goto end;
    }
...
OpenAPI_update_pdu_session_request_t *OpenAPI_update_pdu_session_request_copy(OpenAPI_update_pdu_session_request_t *dst, OpenAPI_update_pdu_session_request_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_update_pdu_session_request_convertToJSON() failed");
        return NULL;
    }
