...
)
{
    ...
    log_assert(nrf_info_served_mb_smf_info_list_value_value_local_var);
...
cJSON *OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON(OpenAPI_nrf_info_served_mb_smf_info_list_value_value_t *nrf_info_served_mb_smf_info_list_value_value)
{
    ...
    if (nrf_info_served_mb_smf_info_list_value_value == NULL) {
        log_error("OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON() failed [NrfInfo_servedMbSmfInfoList_value_value]");
        return NULL;
    }
    ...
    if (s_nssai_info_list == NULL) {
        log_error("OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON() failed [s_nssai_info_list]");
        goto end;
    }
    ...
    if (nrf_info_served_mb_smf_info_list_value_value->s_nssai_info_list) {
        OpenAPI_list_for_each(nrf_info_served_mb_smf_info_list_value_value->s_nssai_info_list, node) {
            ...
            cJSON *itemLocal = localKeyValue->value ?
                ...
                cJSON_CreateNull();
            if (itemLocal == NULL) {
                log_error("OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON() failed [inner]");
                goto end;
            }
    ...
    if (tmgi_range_list == NULL) {
        log_error("OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON() failed [tmgi_range_list]");
        goto end;
    }
    ...
    if (tai_listList == NULL) {
        log_error("OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON() failed [tai_list]");
        goto end;
    }
    OpenAPI_list_for_each(nrf_info_served_mb_smf_info_list_value_value->tai_list, node) {
    ...
    if (tai_range_listList == NULL) {
        log_error("OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON() failed [tai_range_list]");
        goto end;
    }
    OpenAPI_list_for_each(nrf_info_served_mb_smf_info_list_value_value->tai_range_list, node) {
    ...
    if (mbs_session_list == NULL) {
        log_error("OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON() failed [mbs_session_list]");
        goto end;
    }
...
OpenAPI_nrf_info_served_mb_smf_info_list_value_value_t *OpenAPI_nrf_info_served_mb_smf_info_list_value_value_parseFromJSON(cJSON *nrf_info_served_mb_smf_info_list_value_valueJSON)
{
    ...
    if (s_nssai_info_list) {
        ...
        if (!cJSON_IsObject(s_nssai_info_list) && !cJSON_IsNull(s_nssai_info_list)) {
            log_error("OpenAPI_nrf_info_served_mb_smf_info_list_value_value_parseFromJSON() failed [s_nssai_info_list]");
            goto end;
        }
        if (cJSON_IsObject(s_nssai_info_list)) {
            ...
            cJSON_ArrayForEach(s_nssai_info_list_local_map, s_nssai_info_list) {
                ...
                if (cJSON_IsObject(localMapObject)) {
                    ...
                    log_error("OpenAPI_nrf_info_served_mb_smf_info_list_value_value_parseFromJSON() failed [inner]");
                    goto end;
                }
    ...
    if (tmgi_range_list) {
        ...
        if (!cJSON_IsObject(tmgi_range_list) && !cJSON_IsNull(tmgi_range_list)) {
            log_error("OpenAPI_nrf_info_served_mb_smf_info_list_value_value_parseFromJSON() failed [tmgi_range_list]");
            goto end;
        }
    ...
    if (tai_list) {
        ...
        if (!cJSON_IsArray(tai_list)) {
            log_error("OpenAPI_nrf_info_served_mb_smf_info_list_value_value_parseFromJSON() failed [tai_list]");
            goto end;
        }
    ...
    if (tai_range_list) {
        ...
        if (!cJSON_IsArray(tai_range_list)) {
            log_error("OpenAPI_nrf_info_served_mb_smf_info_list_value_value_parseFromJSON() failed [tai_range_list]");
            goto end;
        }
    ...
    if (mbs_session_list) {
        ...
        if (!cJSON_IsObject(mbs_session_list) && !cJSON_IsNull(mbs_session_list)) {
            log_error("OpenAPI_nrf_info_served_mb_smf_info_list_value_value_parseFromJSON() failed [mbs_session_list]");
            goto end;
        }
...
OpenAPI_nrf_info_served_mb_smf_info_list_value_value_t *OpenAPI_nrf_info_served_mb_smf_info_list_value_value_copy(OpenAPI_nrf_info_served_mb_smf_info_list_value_value_t *dst, OpenAPI_nrf_info_served_mb_smf_info_list_value_value_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON() failed");
        return NULL;
    }
