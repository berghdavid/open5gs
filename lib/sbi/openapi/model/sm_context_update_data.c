...
)
{
    ...
    log_assert(sm_context_update_data_local_var);
...
cJSON *OpenAPI_sm_context_update_data_convertToJSON(OpenAPI_sm_context_update_data_t *sm_context_update_data)
{
    ...
    if (sm_context_update_data == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [SmContextUpdateData]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "pei", sm_context_update_data->pei) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [pei]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "servingNfId", sm_context_update_data->serving_nf_id) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [serving_nf_id]");
        goto end;
    }
    }
    ...
    if (guami_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [guami]");
        goto end;
    }
    ...
    if (serving_network_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [serving_network]");
        goto end;
    }
    ...
    if (backup_amf_infoList == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [backup_amf_info]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_update_data->backup_amf_info, node) {
    ...
    if (cJSON_AddStringToObject(item, "anType", OpenAPI_access_type_ToString(sm_context_update_data->an_type)) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [an_type]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "additionalAnType", OpenAPI_access_type_ToString(sm_context_update_data->additional_an_type)) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [additional_an_type]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "anTypeToReactivate", OpenAPI_access_type_ToString(sm_context_update_data->an_type_to_reactivate)) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [an_type_to_reactivate]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ratType", OpenAPI_rat_type_ToString(sm_context_update_data->rat_type)) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [rat_type]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "presenceInLadn", OpenAPI_presence_state_ToString(sm_context_update_data->presence_in_ladn)) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [presence_in_ladn]");
        goto end;
    }
    }
    ...
    if (ue_location_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [ue_location]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "ueTimeZone", sm_context_update_data->ue_time_zone) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [ue_time_zone]");
        goto end;
    }
    }
    ...
    if (add_ue_location_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [add_ue_location]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "upCnxState", OpenAPI_up_cnx_state_ToString(sm_context_update_data->up_cnx_state)) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [up_cnx_state]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "hoState", OpenAPI_ho_state_ToString(sm_context_update_data->ho_state)) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [ho_state]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "toBeSwitched", sm_context_update_data->to_be_switched) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [to_be_switched]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "failedToBeSwitched", sm_context_update_data->failed_to_be_switched) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [failed_to_be_switched]");
        goto end;
    }
    }
    ...
    if (n1_sm_msg_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [n1_sm_msg]");
        goto end;
    }
    ...
    if (n2_sm_info_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [n2_sm_info]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "n2SmInfoType", OpenAPI_n2_sm_info_type_ToString(sm_context_update_data->n2_sm_info_type)) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [n2_sm_info_type]");
        goto end;
    }
    }
    ...
    if (target_id_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [target_id]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "targetServingNfId", sm_context_update_data->target_serving_nf_id) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [target_serving_nf_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "smContextStatusUri", sm_context_update_data->sm_context_status_uri) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [sm_context_status_uri]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "dataForwarding", sm_context_update_data->data_forwarding) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [data_forwarding]");
        goto end;
    }
    }
    ...
    if (n9_forwarding_tunnel_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [n9_forwarding_tunnel]");
        goto end;
    }
    ...
    if (n9_dl_forwarding_tnl_listList == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [n9_dl_forwarding_tnl_list]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_update_data->n9_dl_forwarding_tnl_list, node) {
    ...
    if (n9_ul_forwarding_tnl_listList == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [n9_ul_forwarding_tnl_list]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_update_data->n9_ul_forwarding_tnl_list, node) {
        cJSON *itemLocal = OpenAPI_indirect_data_forwarding_tunnel_info_convertToJSON(node->data);
    ...
    if (n9_dl_forwarding_tunnel_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [n9_dl_forwarding_tunnel]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "n9InactivityTimer", sm_context_update_data->n9_inactivity_timer) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [n9_inactivity_timer]");
        goto end;
    }
    }
    ...
    if (eps_bearer_setupList == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [eps_bearer_setup]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_update_data->eps_bearer_setup, node) {
    ...
    if (revoke_ebi_listList == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [revoke_ebi_list]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_update_data->revoke_ebi_list, node) {
        if (node->data == NULL) {
    ...
    if (cJSON_AddBoolToObject(item, "release", sm_context_update_data->release) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [release]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "cause", OpenAPI_cause_ToString(sm_context_update_data->cause)) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [cause]");
        goto end;
    }
    }
    ...
    if (ng_ap_cause_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [ng_ap_cause]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "5gMmCauseValue", sm_context_update_data->_5g_mm_cause_value) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [_5g_mm_cause_value]");
        goto end;
    }
    }
    ...
    if (s_nssai_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [s_nssai]");
        goto end;
    }
    ...
    if (trace_data_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [trace_data]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "epsInterworkingInd", OpenAPI_eps_interworking_indication_ToString(sm_context_update_data->eps_interworking_ind)) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [eps_interworking_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "anTypeCanBeChanged", sm_context_update_data->an_type_can_be_changed) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [an_type_can_be_changed]");
        goto end;
    }
    }
    ...
    if (n2_sm_info_ext1_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [n2_sm_info_ext1]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "n2SmInfoTypeExt1", OpenAPI_n2_sm_info_type_ToString(sm_context_update_data->n2_sm_info_type_ext1)) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [n2_sm_info_type_ext1]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "maReleaseInd", OpenAPI_ma_release_indication_ToString(sm_context_update_data->ma_release_ind)) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [ma_release_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "maNwUpgradeInd", sm_context_update_data->ma_nw_upgrade_ind) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [ma_nw_upgrade_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "maRequestInd", sm_context_update_data->ma_request_ind) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [ma_request_ind]");
        goto end;
    }
    }
    ...
    if (exemption_ind_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [exemption_ind]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", sm_context_update_data->supported_features) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (mo_exp_data_counter_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [mo_exp_data_counter]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "extendedNasSmTimerInd", sm_context_update_data->extended_nas_sm_timer_ind) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [extended_nas_sm_timer_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "forwardingFTeid", sm_context_update_data->forwarding_f_teid) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [forwarding_f_teid]");
        goto end;
    }
    }
    ...
    if (forwarding_bearer_contextsList == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [forwarding_bearer_contexts]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_update_data->forwarding_bearer_contexts, node) {
    ...
    if (ddn_failure_subs_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [ddn_failure_subs]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "skipN2PduSessionResRelInd", sm_context_update_data->skip_n2_pdu_session_res_rel_ind) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [skip_n2_pdu_session_res_rel_ind]");
        goto end;
    }
    }
    ...
    if (secondary_rat_usage_data_report_containerList == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [secondary_rat_usage_data_report_container]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_update_data->secondary_rat_usage_data_report_container, node) {
    ...
    if (cJSON_AddStringToObject(item, "smPolicyNotifyInd", OpenAPI_sm_policy_notify_indsm_context_update_data_ToString(sm_context_update_data->sm_policy_notify_ind)) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [sm_policy_notify_ind]");
        goto end;
    }
    }
    ...
    if (pcf_ue_callback_info_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [pcf_ue_callback_info]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "satelliteBackhaulCat", OpenAPI_satellite_backhaul_category_ToString(sm_context_update_data->satellite_backhaul_cat)) == NULL) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed [satellite_backhaul_cat]");
        goto end;
    }
    }
...
OpenAPI_sm_context_update_data_t *OpenAPI_sm_context_update_data_parseFromJSON(cJSON *sm_context_update_dataJSON)
{
    ...
    if (!cJSON_IsString(pei) && !cJSON_IsNull(pei)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [pei]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(serving_nf_id) && !cJSON_IsNull(serving_nf_id)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [serving_nf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNull(backup_amf_info)) {
        ...
        if (!cJSON_IsArray(backup_amf_info)) {
            log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [backup_amf_info]");
            goto end;
        }
    ...
    if (!cJSON_IsString(an_type)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [an_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(additional_an_type)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [additional_an_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(an_type_to_reactivate)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [an_type_to_reactivate]");
        goto end;
    }
    ...
    if (!cJSON_IsString(rat_type)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [rat_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(presence_in_ladn)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [presence_in_ladn]");
        goto end;
    }
    ...
    if (!cJSON_IsString(ue_time_zone) && !cJSON_IsNull(ue_time_zone)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [ue_time_zone]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(up_cnx_state)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [up_cnx_state]");
        goto end;
    }
    ...
    if (!cJSON_IsString(ho_state)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [ho_state]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(to_be_switched)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [to_be_switched]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(failed_to_be_switched)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [failed_to_be_switched]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(n2_sm_info_type)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [n2_sm_info_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(target_serving_nf_id) && !cJSON_IsNull(target_serving_nf_id)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [target_serving_nf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(sm_context_status_uri) && !cJSON_IsNull(sm_context_status_uri)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [sm_context_status_uri]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(data_forwarding)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [data_forwarding]");
        goto end;
    }
    }
    ...
    if (!n9_forwarding_tunnel_local_nonprim) {
        log_error("OpenAPI_tunnel_info_parseFromJSON failed [n9_forwarding_tunnel]");
        goto end;
    }
    }
    ...
    if (n9_dl_forwarding_tnl_list) {
        ...
        if (!cJSON_IsArray(n9_dl_forwarding_tnl_list)) {
            log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [n9_dl_forwarding_tnl_list]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(n9_dl_forwarding_tnl_list_local, n9_dl_forwarding_tnl_list) {
            ...
            if (!n9_dl_forwarding_tnl_listItem) {
                log_error("No n9_dl_forwarding_tnl_listItem");
                goto end;
            }
    ...
    if (n9_ul_forwarding_tnl_list) {
        ...
        if (!cJSON_IsArray(n9_ul_forwarding_tnl_list)) {
            log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [n9_ul_forwarding_tnl_list]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(n9_ul_forwarding_tnl_list_local, n9_ul_forwarding_tnl_list) {
            ...
            if (!n9_ul_forwarding_tnl_listItem) {
                log_error("No n9_ul_forwarding_tnl_listItem");
                goto end;
            }
    ...
    if (!n9_dl_forwarding_tunnel_local_nonprim) {
        log_error("OpenAPI_tunnel_info_parseFromJSON failed [n9_dl_forwarding_tunnel]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(n9_inactivity_timer)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [n9_inactivity_timer]");
        goto end;
    }
    }
    ...
    if (eps_bearer_setup) {
        ...
        if (!cJSON_IsArray(eps_bearer_setup)) {
            log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [eps_bearer_setup]");
            goto end;
        }
    ...
    if (revoke_ebi_list) {
        ...
        if (!cJSON_IsArray(revoke_ebi_list)) {
            log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [revoke_ebi_list]");
            goto end;
        }
    ...
    if (!cJSON_IsBool(release)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [release]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(cause)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [cause]");
        goto end;
    }
    ...
    if (!cJSON_IsNumber(_5g_mm_cause_value)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [_5g_mm_cause_value]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(eps_interworking_ind)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [eps_interworking_ind]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(an_type_can_be_changed)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [an_type_can_be_changed]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(n2_sm_info_type_ext1)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [n2_sm_info_type_ext1]");
        goto end;
    }
    ...
    if (!cJSON_IsString(ma_release_ind)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [ma_release_ind]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(ma_nw_upgrade_ind)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [ma_nw_upgrade_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(ma_request_ind)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [ma_request_ind]");
        goto end;
    }
    }
    ...
    if (!exemption_ind_local_nonprim) {
        log_error("OpenAPI_exemption_ind_parseFromJSON failed [exemption_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(extended_nas_sm_timer_ind)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [extended_nas_sm_timer_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(forwarding_f_teid) && !cJSON_IsNull(forwarding_f_teid)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [forwarding_f_teid]");
        goto end;
    }
    }
    ...
    if (forwarding_bearer_contexts) {
        ...
        if (!cJSON_IsArray(forwarding_bearer_contexts)) {
            log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [forwarding_bearer_contexts]");
            goto end;
        }
    ...
    if (!cJSON_IsBool(skip_n2_pdu_session_res_rel_ind)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [skip_n2_pdu_session_res_rel_ind]");
        goto end;
    }
    }
    ...
    if (secondary_rat_usage_data_report_container) {
        ...
        if (!cJSON_IsArray(secondary_rat_usage_data_report_container)) {
            log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [secondary_rat_usage_data_report_container]");
            goto end;
        }
    ...
    if (!cJSON_IsString(sm_policy_notify_ind)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [sm_policy_notify_ind]");
        goto end;
    }
    ...
    if (!cJSON_IsString(satellite_backhaul_cat)) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON() failed [satellite_backhaul_cat]");
        goto end;
    }
...
OpenAPI_sm_context_update_data_t *OpenAPI_sm_context_update_data_copy(OpenAPI_sm_context_update_data_t *dst, OpenAPI_sm_context_update_data_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_sm_context_update_data_convertToJSON() failed");
        return NULL;
    }
