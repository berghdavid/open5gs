...
)
{
    ...
    log_assert(authentication_vector_local_var);
...
cJSON *OpenAPI_authentication_vector_convertToJSON(OpenAPI_authentication_vector_t *authentication_vector)
{
    ...
    if (authentication_vector == NULL) {
        log_error("OpenAPI_authentication_vector_convertToJSON() failed [AuthenticationVector]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (authentication_vector->av_type == OpenAPI_av_type_NULL) {
        log_error("OpenAPI_authentication_vector_convertToJSON() failed [av_type]");
        return NULL;
    }
    ...
    if (!authentication_vector->rand) {
        log_error("OpenAPI_authentication_vector_convertToJSON() failed [rand]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "xres", authentication_vector->xres) == NULL) {
        log_error("OpenAPI_authentication_vector_convertToJSON() failed [xres]");
        goto end;
    }
    }

    if (!authentication_vector->autn) {
        log_error("OpenAPI_authentication_vector_convertToJSON() failed [autn]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "ckPrime", authentication_vector->ck_prime) == NULL) {
        log_error("OpenAPI_authentication_vector_convertToJSON() failed [ck_prime]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ikPrime", authentication_vector->ik_prime) == NULL) {
        log_error("OpenAPI_authentication_vector_convertToJSON() failed [ik_prime]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "xresStar", authentication_vector->xres_star) == NULL) {
        log_error("OpenAPI_authentication_vector_convertToJSON() failed [xres_star]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "kausf", authentication_vector->kausf) == NULL) {
        log_error("OpenAPI_authentication_vector_convertToJSON() failed [kausf]");
        goto end;
    }
    }
...
OpenAPI_authentication_vector_t *OpenAPI_authentication_vector_parseFromJSON(cJSON *authentication_vectorJSON)
{
    ...
    if (!av_type) {
        log_error("OpenAPI_authentication_vector_parseFromJSON() failed [av_type]");
        goto end;
    }
    ...
    if (!rand) {
        log_error("OpenAPI_authentication_vector_parseFromJSON() failed [rand]");
        goto end;
    }
    ...
    if (!cJSON_IsString(xres) && !cJSON_IsNull(xres)) {
        log_error("OpenAPI_authentication_vector_parseFromJSON() failed [xres]");
        goto end;
    }
    }
    ...
    if (!autn) {
        log_error("OpenAPI_authentication_vector_parseFromJSON() failed [autn]");
        goto end;
    }
    ...
    if (!cJSON_IsString(ck_prime) && !cJSON_IsNull(ck_prime)) {
        log_error("OpenAPI_authentication_vector_parseFromJSON() failed [ck_prime]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ik_prime) && !cJSON_IsNull(ik_prime)) {
        log_error("OpenAPI_authentication_vector_parseFromJSON() failed [ik_prime]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(xres_star) && !cJSON_IsNull(xres_star)) {
        log_error("OpenAPI_authentication_vector_parseFromJSON() failed [xres_star]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(kausf) && !cJSON_IsNull(kausf)) {
        log_error("OpenAPI_authentication_vector_parseFromJSON() failed [kausf]");
        goto end;
    }
    }
...
OpenAPI_authentication_vector_t *OpenAPI_authentication_vector_copy(OpenAPI_authentication_vector_t *dst, OpenAPI_authentication_vector_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_authentication_vector_convertToJSON() failed");
        return NULL;
    }
