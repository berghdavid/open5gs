...
)
{
    ...
    log_assert(nf_service_local_var);
...
cJSON *OpenAPI_nf_service_convertToJSON(OpenAPI_nf_service_t *nf_service)
{
    ...
    if (nf_service == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [NFService]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!nf_service->service_instance_id) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [service_instance_id]");
        return NULL;
    }
    ...
    if (!nf_service->service_name) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [service_name]");
        return NULL;
    }
    ...
    if (!nf_service->versions) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [versions]");
        return NULL;
    }
    ...
    if (nf_service->scheme == OpenAPI_uri_scheme_NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [scheme]");
        return NULL;
    }
    ...
    if (nf_service->nf_service_status == OpenAPI_nf_service_status_NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [nf_service_status]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "fqdn", nf_service->fqdn) == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [fqdn]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "interPlmnFqdn", nf_service->inter_plmn_fqdn) == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [inter_plmn_fqdn]");
        goto end;
    }
    }
    ...
    if (ip_end_pointsList == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [ip_end_points]");
        goto end;
    }
    OpenAPI_list_for_each(nf_service->ip_end_points, node) {
    ...
    if (cJSON_AddStringToObject(item, "apiPrefix", nf_service->api_prefix) == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [api_prefix]");
        goto end;
    }
    }
    ...
    if (default_notification_subscriptionsList == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [default_notification_subscriptions]");
        goto end;
    }
    OpenAPI_list_for_each(nf_service->default_notification_subscriptions, node) {
    ...
    if (allowed_plmnsList == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [allowed_plmns]");
        goto end;
    }
    OpenAPI_list_for_each(nf_service->allowed_plmns, node) {
    ...
    if (allowed_snpnsList == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [allowed_snpns]");
        goto end;
    }
    OpenAPI_list_for_each(nf_service->allowed_snpns, node) {
    ...
    if (allowed_nf_typesList == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [allowed_nf_types]");
        goto end;
    }
    ...
    if (allowed_nf_domainsList == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [allowed_nf_domains]");
        goto end;
    }
    OpenAPI_list_for_each(nf_service->allowed_nf_domains, node) {
    ...
    if (allowed_nssaisList == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [allowed_nssais]");
        goto end;
    }
    OpenAPI_list_for_each(nf_service->allowed_nssais, node) {
    ...
    if (allowed_operations_per_nf_type == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [allowed_operations_per_nf_type]");
        goto end;
    }
    ...
    if (allowed_operations_per_nf_instance == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [allowed_operations_per_nf_instance]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "priority", nf_service->priority) == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [priority]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "capacity", nf_service->capacity) == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [capacity]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "load", nf_service->load) == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [load]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "loadTimeStamp", nf_service->load_time_stamp) == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [load_time_stamp]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "recoveryTime", nf_service->recovery_time) == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [recovery_time]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", nf_service->supported_features) == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (nf_service_set_id_listList == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [nf_service_set_id_list]");
        goto end;
    }
    OpenAPI_list_for_each(nf_service->nf_service_set_id_list, node) {
    ...
    if (s_nssaisList == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [s_nssais]");
        goto end;
    }
    OpenAPI_list_for_each(nf_service->s_nssais, node) {
        cJSON *itemLocal = OpenAPI_ext_snssai_convertToJSON(node->data);
    ...
    if (per_plmn_snssai_listList == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [per_plmn_snssai_list]");
        goto end;
    }
    OpenAPI_list_for_each(nf_service->per_plmn_snssai_list, node) {
    ...
    if (cJSON_AddStringToObject(item, "vendorId", nf_service->vendor_id) == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [vendor_id]");
        goto end;
    }
    }
    ...
    if (supported_vendor_specific_features == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [supported_vendor_specific_features]");
        goto end;
    }
    ...
    if (nf_service->supported_vendor_specific_features) {
        OpenAPI_list_for_each(nf_service->supported_vendor_specific_features, node) {
            ...
            cJSON *itemLocal = localKeyValue->value ?
                ...
                cJSON_CreateNull();
            if (itemLocal == NULL) {
                log_error("OpenAPI_nf_service_convertToJSON() failed [inner]");
                goto end;
            }
    ...
    if (cJSON_AddBoolToObject(item, "oauth2Required", nf_service->oauth2_required) == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [oauth2_required]");
        goto end;
    }
    }
    ...
    if (per_plmn_oauth2_req_list_local_JSON == NULL) {
        log_error("OpenAPI_nf_service_convertToJSON() failed [per_plmn_oauth2_req_list]");
        goto end;
    }
...
OpenAPI_nf_service_t *OpenAPI_nf_service_parseFromJSON(cJSON *nf_serviceJSON)
{
    ...
    if (!service_instance_id) {
        log_error("OpenAPI_nf_service_parseFromJSON() failed [service_instance_id]");
        goto end;
    }
    ...
    if (!service_name) {
        log_error("OpenAPI_nf_service_parseFromJSON() failed [service_name]");
        goto end;
    }
    ...
    if (!versions) {
        log_error("OpenAPI_nf_service_parseFromJSON() failed [versions]");
        goto end;
    }
    ...
    if (!scheme) {
        log_error("OpenAPI_nf_service_parseFromJSON() failed [scheme]");
        goto end;
    }
    ...
    if (!nf_service_status) {
        log_error("OpenAPI_nf_service_parseFromJSON() failed [nf_service_status]");
        goto end;
    }
    ...
    if (!cJSON_IsString(fqdn) && !cJSON_IsNull(fqdn)) {
        log_error("OpenAPI_nf_service_parseFromJSON() failed [fqdn]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(inter_plmn_fqdn) && !cJSON_IsNull(inter_plmn_fqdn)) {
        log_error("OpenAPI_nf_service_parseFromJSON() failed [inter_plmn_fqdn]");
        goto end;
    }
    }
    ...
    if (ip_end_points) {
        ...
        if (!cJSON_IsArray(ip_end_points)) {
            log_error("OpenAPI_nf_service_parseFromJSON() failed [ip_end_points]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(ip_end_points_local, ip_end_points) {
            ...
            if (!ip_end_pointsItem) {
                log_error("No ip_end_pointsItem");
                goto end;
            }
    ...
    if (!cJSON_IsString(api_prefix) && !cJSON_IsNull(api_prefix)) {
        log_error("OpenAPI_nf_service_parseFromJSON() failed [api_prefix]");
        goto end;
    }
    }
    ...
    if (default_notification_subscriptions) {
        ...
        if (!cJSON_IsArray(default_notification_subscriptions)) {
            log_error("OpenAPI_nf_service_parseFromJSON() failed [default_notification_subscriptions]");
            goto end;
        }
    ...
    if (allowed_plmns) {
        ...
        if (!cJSON_IsArray(allowed_plmns)) {
            log_error("OpenAPI_nf_service_parseFromJSON() failed [allowed_plmns]");
            goto end;
        }
    ...
    if (allowed_snpns) {
        ...
        if (!cJSON_IsArray(allowed_snpns)) {
            log_error("OpenAPI_nf_service_parseFromJSON() failed [allowed_snpns]");
            goto end;
        }
    ...
    if (allowed_nf_types) {
        ...
        if (!cJSON_IsArray(allowed_nf_types)) {
            log_error("OpenAPI_nf_service_parseFromJSON() failed [allowed_nf_types]");
            goto end;
        }
        ...
        if (allowed_nf_typesList->count == 0) {
            log_error("OpenAPI_nf_service_parseFromJSON() failed: Expected allowed_nf_typesList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (allowed_nf_domains) {
        ...
        if (!cJSON_IsArray(allowed_nf_domains)) {
            log_error("OpenAPI_nf_service_parseFromJSON() failed [allowed_nf_domains]");
            goto end;
        }
    ...
    if (allowed_nssais) {
        ...
        if (!cJSON_IsArray(allowed_nssais)) {
            log_error("OpenAPI_nf_service_parseFromJSON() failed [allowed_nssais]");
            goto end;
        }
    ...
    if (allowed_operations_per_nf_type) {
        ...
        if (!cJSON_IsObject(allowed_operations_per_nf_type) && !cJSON_IsNull(allowed_operations_per_nf_type)) {
            log_error("OpenAPI_nf_service_parseFromJSON() failed [allowed_operations_per_nf_type]");
            goto end;
        }
    ...
    if (allowed_operations_per_nf_instance) {
        ...
        if (!cJSON_IsObject(allowed_operations_per_nf_instance) && !cJSON_IsNull(allowed_operations_per_nf_instance)) {
            log_error("OpenAPI_nf_service_parseFromJSON() failed [allowed_operations_per_nf_instance]");
            goto end;
        }
    ...
    if (!cJSON_IsNumber(priority)) {
        log_error("OpenAPI_nf_service_parseFromJSON() failed [priority]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(capacity)) {
        log_error("OpenAPI_nf_service_parseFromJSON() failed [capacity]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(load)) {
        log_error("OpenAPI_nf_service_parseFromJSON() failed [load]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(load_time_stamp) && !cJSON_IsNull(load_time_stamp)) {
        log_error("OpenAPI_nf_service_parseFromJSON() failed [load_time_stamp]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(recovery_time) && !cJSON_IsNull(recovery_time)) {
        log_error("OpenAPI_nf_service_parseFromJSON() failed [recovery_time]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_nf_service_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (nf_service_set_id_list) {
        ...
        if (!cJSON_IsArray(nf_service_set_id_list)) {
            log_error("OpenAPI_nf_service_parseFromJSON() failed [nf_service_set_id_list]");
            goto end;
        }
    ...
    if (s_nssais) {
        ...
        if (!cJSON_IsArray(s_nssais)) {
            log_error("OpenAPI_nf_service_parseFromJSON() failed [s_nssais]");
            goto end;
        }
    ...
    if (per_plmn_snssai_list) {
        ...
        if (!cJSON_IsArray(per_plmn_snssai_list)) {
            log_error("OpenAPI_nf_service_parseFromJSON() failed [per_plmn_snssai_list]");
            goto end;
        }
    ...
    if (!cJSON_IsString(vendor_id) && !cJSON_IsNull(vendor_id)) {
        log_error("OpenAPI_nf_service_parseFromJSON() failed [vendor_id]");
        goto end;
    }
    }
    ...
    if (supported_vendor_specific_features) {
        ...
        if (!cJSON_IsObject(supported_vendor_specific_features) && !cJSON_IsNull(supported_vendor_specific_features)) {
            log_error("OpenAPI_nf_service_parseFromJSON() failed [supported_vendor_specific_features]");
            goto end;
        }
        if (cJSON_IsObject(supported_vendor_specific_features)) {
            ...
            cJSON_ArrayForEach(supported_vendor_specific_features_local_map, supported_vendor_specific_features) {
                ...
                if (cJSON_IsObject(localMapObject)) {
                    ...
                    log_error("OpenAPI_nf_service_parseFromJSON() failed [inner]");
                    goto end;
                }
    ...
    if (!cJSON_IsBool(oauth2_required)) {
        log_error("OpenAPI_nf_service_parseFromJSON() failed [oauth2_required]");
        goto end;
    }
    }
    ...
    if (!per_plmn_oauth2_req_list_local_nonprim) {
        log_error("OpenAPI_plmn_oauth2_parseFromJSON failed [per_plmn_oauth2_req_list]");
        goto end;
    }
    }
...
OpenAPI_nf_service_t *OpenAPI_nf_service_copy(OpenAPI_nf_service_t *dst, OpenAPI_nf_service_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_nf_service_convertToJSON() failed");
        return NULL;
    }
