...
)
{
    ...
    log_assert(av_ims_gba_eap_aka_local_var);
...
cJSON *OpenAPI_av_ims_gba_eap_aka_convertToJSON(OpenAPI_av_ims_gba_eap_aka_t *av_ims_gba_eap_aka)
{
    ...
    if (av_ims_gba_eap_aka == NULL) {
        log_error("OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [AvImsGbaEapAka]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (av_ims_gba_eap_aka->av_type == OpenAPI_hss_av_type_NULL) {
        log_error("OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [av_type]");
        return NULL;
    }
    ...
    if (!av_ims_gba_eap_aka->rand) {
        log_error("OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [rand]");
        return NULL;
    }
    ...
    if (!av_ims_gba_eap_aka->xres) {
        log_error("OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [xres]");
        return NULL;
    }
    ...
    if (!av_ims_gba_eap_aka->autn) {
        log_error("OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [autn]");
        return NULL;
    }
    ...
    if (!av_ims_gba_eap_aka->ck) {
        log_error("OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [ck]");
        return NULL;
    }
    ...
    if (!av_ims_gba_eap_aka->ik) {
        log_error("OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [ik]");
        return NULL;
    }
...
OpenAPI_av_ims_gba_eap_aka_t *OpenAPI_av_ims_gba_eap_aka_parseFromJSON(cJSON *av_ims_gba_eap_akaJSON)
{
    ...
    if (!av_type) {
        log_error("OpenAPI_av_ims_gba_eap_aka_parseFromJSON() failed [av_type]");
        goto end;
    }
    ...
    if (!rand) {
        log_error("OpenAPI_av_ims_gba_eap_aka_parseFromJSON() failed [rand]");
        goto end;
    }
    ...
    if (!xres) {
        log_error("OpenAPI_av_ims_gba_eap_aka_parseFromJSON() failed [xres]");
        goto end;
    }
    ...
    if (!autn) {
        log_error("OpenAPI_av_ims_gba_eap_aka_parseFromJSON() failed [autn]");
        goto end;
    }
    ...
    if (!ck) {
        log_error("OpenAPI_av_ims_gba_eap_aka_parseFromJSON() failed [ck]");
        goto end;
    }
    ...
    if (!ik) {
        log_error("OpenAPI_av_ims_gba_eap_aka_parseFromJSON() failed [ik]");
        goto end;
    }
...
OpenAPI_av_ims_gba_eap_aka_t *OpenAPI_av_ims_gba_eap_aka_copy(OpenAPI_av_ims_gba_eap_aka_t *dst, OpenAPI_av_ims_gba_eap_aka_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed");
        return NULL;
    }
