...
)
{
    ...
    log_assert(sm_context_release_data_local_var);
...
cJSON *OpenAPI_sm_context_release_data_convertToJSON(OpenAPI_sm_context_release_data_t *sm_context_release_data)
{
    ...
    if (sm_context_release_data == NULL) {
        log_error("OpenAPI_sm_context_release_data_convertToJSON() failed [SmContextReleaseData]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "cause", OpenAPI_cause_ToString(sm_context_release_data->cause)) == NULL) {
        log_error("OpenAPI_sm_context_release_data_convertToJSON() failed [cause]");
        goto end;
    }
    }
    ...
    if (ng_ap_cause_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_release_data_convertToJSON() failed [ng_ap_cause]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "5gMmCauseValue", sm_context_release_data->_5g_mm_cause_value) == NULL) {
        log_error("OpenAPI_sm_context_release_data_convertToJSON() failed [_5g_mm_cause_value]");
        goto end;
    }
    }
    ...
    if (ue_location_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_release_data_convertToJSON() failed [ue_location]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "ueTimeZone", sm_context_release_data->ue_time_zone) == NULL) {
        log_error("OpenAPI_sm_context_release_data_convertToJSON() failed [ue_time_zone]");
        goto end;
    }
    }
    ...
    if (add_ue_location_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_release_data_convertToJSON() failed [add_ue_location]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "vsmfReleaseOnly", sm_context_release_data->vsmf_release_only) == NULL) {
        log_error("OpenAPI_sm_context_release_data_convertToJSON() failed [vsmf_release_only]");
        goto end;
    }
    }
    ...
    if (n2_sm_info_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_release_data_convertToJSON() failed [n2_sm_info]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "n2SmInfoType", OpenAPI_n2_sm_info_type_ToString(sm_context_release_data->n2_sm_info_type)) == NULL) {
        log_error("OpenAPI_sm_context_release_data_convertToJSON() failed [n2_sm_info_type]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "ismfReleaseOnly", sm_context_release_data->ismf_release_only) == NULL) {
        log_error("OpenAPI_sm_context_release_data_convertToJSON() failed [ismf_release_only]");
        goto end;
    }
    }
...
OpenAPI_sm_context_release_data_t *OpenAPI_sm_context_release_data_parseFromJSON(cJSON *sm_context_release_dataJSON)
{
    ...
    if (!cJSON_IsString(cause)) {
        log_error("OpenAPI_sm_context_release_data_parseFromJSON() failed [cause]");
        goto end;
    }
    ...
    if (!cJSON_IsNumber(_5g_mm_cause_value)) {
        log_error("OpenAPI_sm_context_release_data_parseFromJSON() failed [_5g_mm_cause_value]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ue_time_zone) && !cJSON_IsNull(ue_time_zone)) {
        log_error("OpenAPI_sm_context_release_data_parseFromJSON() failed [ue_time_zone]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(vsmf_release_only)) {
        log_error("OpenAPI_sm_context_release_data_parseFromJSON() failed [vsmf_release_only]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(n2_sm_info_type)) {
        log_error("OpenAPI_sm_context_release_data_parseFromJSON() failed [n2_sm_info_type]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(ismf_release_only)) {
        log_error("OpenAPI_sm_context_release_data_parseFromJSON() failed [ismf_release_only]");
        goto end;
    }
    }
...
OpenAPI_sm_context_release_data_t *OpenAPI_sm_context_release_data_copy(OpenAPI_sm_context_release_data_t *dst, OpenAPI_sm_context_release_data_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_sm_context_release_data_convertToJSON() failed");
        return NULL;
    }
