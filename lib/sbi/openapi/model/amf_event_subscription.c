...
)
{
    ...
    log_assert(amf_event_subscription_local_var);
...
cJSON *OpenAPI_amf_event_subscription_convertToJSON(OpenAPI_amf_event_subscription_t *amf_event_subscription)
{
    ...
    if (amf_event_subscription == NULL) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [AmfEventSubscription]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!amf_event_subscription->event_list) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [event_list]");
        return NULL;
    }
    ...
    if (!amf_event_subscription->event_notify_uri) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [event_notify_uri]");
        return NULL;
    }
    ...
    if (!amf_event_subscription->notify_correlation_id) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [notify_correlation_id]");
        return NULL;
    }
    ...
    if (!amf_event_subscription->nf_id) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [nf_id]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "subsChangeNotifyUri", amf_event_subscription->subs_change_notify_uri) == NULL) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [subs_change_notify_uri]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "subsChangeNotifyCorrelationId", amf_event_subscription->subs_change_notify_correlation_id) == NULL) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [subs_change_notify_correlation_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "supi", amf_event_subscription->supi) == NULL) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [supi]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "groupId", amf_event_subscription->group_id) == NULL) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [group_id]");
        goto end;
    }
    }
    ...
    if (exclude_supi_listList == NULL) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [exclude_supi_list]");
        goto end;
    }
    OpenAPI_list_for_each(amf_event_subscription->exclude_supi_list, node) {
    ...
    if (exclude_gpsi_listList == NULL) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [exclude_gpsi_list]");
        goto end;
    }
    OpenAPI_list_for_each(amf_event_subscription->exclude_gpsi_list, node) {
    ...
    if (include_supi_listList == NULL) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [include_supi_list]");
        goto end;
    }
    OpenAPI_list_for_each(amf_event_subscription->include_supi_list, node) {
    ...
    if (include_gpsi_listList == NULL) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [include_gpsi_list]");
        goto end;
    }
    OpenAPI_list_for_each(amf_event_subscription->include_gpsi_list, node) {
    ...
    if (cJSON_AddStringToObject(item, "gpsi", amf_event_subscription->gpsi) == NULL) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [gpsi]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "pei", amf_event_subscription->pei) == NULL) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [pei]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "anyUE", amf_event_subscription->any_ue) == NULL) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [any_ue]");
        goto end;
    }
    }
    ...
    if (options_local_JSON == NULL) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [options]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "sourceNfType", OpenAPI_nf_type_ToString(amf_event_subscription->source_nf_type)) == NULL) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed [source_nf_type]");
        goto end;
    }
    }
...
OpenAPI_amf_event_subscription_t *OpenAPI_amf_event_subscription_parseFromJSON(cJSON *amf_event_subscriptionJSON)
{
    ...
    if (!event_list) {
        log_error("OpenAPI_amf_event_subscription_parseFromJSON() failed [event_list]");
        goto end;
    }
    ...
    if (!event_notify_uri) {
        log_error("OpenAPI_amf_event_subscription_parseFromJSON() failed [event_notify_uri]");
        goto end;
    }
    ...
    if (!notify_correlation_id) {
        log_error("OpenAPI_amf_event_subscription_parseFromJSON() failed [notify_correlation_id]");
        goto end;
    }
    ...
    if (!nf_id) {
        log_error("OpenAPI_amf_event_subscription_parseFromJSON() failed [nf_id]");
        goto end;
    }
    ...
    if (!cJSON_IsString(subs_change_notify_uri) && !cJSON_IsNull(subs_change_notify_uri)) {
        log_error("OpenAPI_amf_event_subscription_parseFromJSON() failed [subs_change_notify_uri]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(subs_change_notify_correlation_id) && !cJSON_IsNull(subs_change_notify_correlation_id)) {
        log_error("OpenAPI_amf_event_subscription_parseFromJSON() failed [subs_change_notify_correlation_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(supi) && !cJSON_IsNull(supi)) {
        log_error("OpenAPI_amf_event_subscription_parseFromJSON() failed [supi]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(group_id) && !cJSON_IsNull(group_id)) {
        log_error("OpenAPI_amf_event_subscription_parseFromJSON() failed [group_id]");
        goto end;
    }
    }
    ...
    if (exclude_supi_list) {
        ...
        if (!cJSON_IsArray(exclude_supi_list)) {
            log_error("OpenAPI_amf_event_subscription_parseFromJSON() failed [exclude_supi_list]");
            goto end;
        }
    ...
    if (exclude_gpsi_list) {
        ...
        if (!cJSON_IsArray(exclude_gpsi_list)) {
            log_error("OpenAPI_amf_event_subscription_parseFromJSON() failed [exclude_gpsi_list]");
            goto end;
        }
    ...
    if (include_supi_list) {
        ...
        if (!cJSON_IsArray(include_supi_list)) {
            log_error("OpenAPI_amf_event_subscription_parseFromJSON() failed [include_supi_list]");
            goto end;
        }
    ...
    if (include_gpsi_list) {
        ...
        if (!cJSON_IsArray(include_gpsi_list)) {
            log_error("OpenAPI_amf_event_subscription_parseFromJSON() failed [include_gpsi_list]");
            goto end;
        }
    ...
    if (!cJSON_IsString(gpsi) && !cJSON_IsNull(gpsi)) {
        log_error("OpenAPI_amf_event_subscription_parseFromJSON() failed [gpsi]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(pei) && !cJSON_IsNull(pei)) {
        log_error("OpenAPI_amf_event_subscription_parseFromJSON() failed [pei]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(any_ue)) {
        log_error("OpenAPI_amf_event_subscription_parseFromJSON() failed [any_ue]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(source_nf_type)) {
        log_error("OpenAPI_amf_event_subscription_parseFromJSON() failed [source_nf_type]");
        goto end;
    }
...
OpenAPI_amf_event_subscription_t *OpenAPI_amf_event_subscription_copy(OpenAPI_amf_event_subscription_t *dst, OpenAPI_amf_event_subscription_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_amf_event_subscription_convertToJSON() failed");
        return NULL;
    }
