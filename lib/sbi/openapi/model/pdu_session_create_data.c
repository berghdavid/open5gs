...
)
{
    ...
    log_assert(pdu_session_create_data_local_var);
...
cJSON *OpenAPI_pdu_session_create_data_convertToJSON(OpenAPI_pdu_session_create_data_t *pdu_session_create_data)
{
    ...
    if (pdu_session_create_data == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [PduSessionCreateData]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "supi", pdu_session_create_data->supi) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [supi]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "unauthenticatedSupi", pdu_session_create_data->unauthenticated_supi) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [unauthenticated_supi]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "pei", pdu_session_create_data->pei) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [pei]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "pduSessionId", pdu_session_create_data->pdu_session_id) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [pdu_session_id]");
        goto end;
    }
    }

    if (!pdu_session_create_data->dnn) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [dnn]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "selectedDnn", pdu_session_create_data->selected_dnn) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [selected_dnn]");
        goto end;
    }
    }
    ...
    if (s_nssai_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [s_nssai]");
        goto end;
    }
    ...
    if (hplmn_snssai_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [hplmn_snssai]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "vsmfId", pdu_session_create_data->vsmf_id) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [vsmf_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ismfId", pdu_session_create_data->ismf_id) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [ismf_id]");
        goto end;
    }
    }

    if (!pdu_session_create_data->serving_network) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [serving_network]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "requestType", OpenAPI_request_type_ToString(pdu_session_create_data->request_type)) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [request_type]");
        goto end;
    }
    }
    ...
    if (eps_bearer_idList == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [eps_bearer_id]");
        goto end;
    }
    OpenAPI_list_for_each(pdu_session_create_data->eps_bearer_id, node) {
        if (node->data == NULL) {
    ...
    if (cJSON_AddStringToObject(item, "pgwS8cFteid", pdu_session_create_data->pgw_s8c_fteid) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [pgw_s8c_fteid]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "vsmfPduSessionUri", pdu_session_create_data->vsmf_pdu_session_uri) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [vsmf_pdu_session_uri]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ismfPduSessionUri", pdu_session_create_data->ismf_pdu_session_uri) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [ismf_pdu_session_uri]");
        goto end;
    }
    }
    ...
    if (vcn_tunnel_info_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [vcn_tunnel_info]");
        goto end;
    }
    ...
    if (icn_tunnel_info_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [icn_tunnel_info]");
        goto end;
    }
    ...
    if (n9_forwarding_tunnel_info_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [n9_forwarding_tunnel_info]");
        goto end;
    }
    ...
    if (additional_cn_tunnel_info_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [additional_cn_tunnel_info]");
        goto end;
    }
    ...
    if (pdu_session_create_data->an_type == OpenAPI_access_type_NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [an_type]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "additionalAnType", OpenAPI_access_type_ToString(pdu_session_create_data->additional_an_type)) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [additional_an_type]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ratType", OpenAPI_rat_type_ToString(pdu_session_create_data->rat_type)) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [rat_type]");
        goto end;
    }
    }
    ...
    if (ue_location_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [ue_location]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "ueTimeZone", pdu_session_create_data->ue_time_zone) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [ue_time_zone]");
        goto end;
    }
    }
    ...
    if (add_ue_location_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [add_ue_location]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "gpsi", pdu_session_create_data->gpsi) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [gpsi]");
        goto end;
    }
    }
    ...
    if (n1_sm_info_from_ue_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [n1_sm_info_from_ue]");
        goto end;
    }
    ...
    if (unknown_n1_sm_info_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [unknown_n1_sm_info]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", pdu_session_create_data->supported_features) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "hPcfId", pdu_session_create_data->h_pcf_id) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [h_pcf_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "pcfId", pdu_session_create_data->pcf_id) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [pcf_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "pcfGroupId", pdu_session_create_data->pcf_group_id) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [pcf_group_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "pcfSetId", pdu_session_create_data->pcf_set_id) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [pcf_set_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "hoPreparationIndication", pdu_session_create_data->ho_preparation_indication) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [ho_preparation_indication]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "selMode", OpenAPI_dnn_selection_mode_ToString(pdu_session_create_data->sel_mode)) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [sel_mode]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "alwaysOnRequested", pdu_session_create_data->always_on_requested) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [always_on_requested]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "udmGroupId", pdu_session_create_data->udm_group_id) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [udm_group_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "routingIndicator", pdu_session_create_data->routing_indicator) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [routing_indicator]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "hNwPubKeyId", pdu_session_create_data->h_nw_pub_key_id) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [h_nw_pub_key_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "epsInterworkingInd", OpenAPI_eps_interworking_indication_ToString(pdu_session_create_data->eps_interworking_ind)) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [eps_interworking_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "vSmfServiceInstanceId", pdu_session_create_data->v_smf_service_instance_id) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [v_smf_service_instance_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "iSmfServiceInstanceId", pdu_session_create_data->i_smf_service_instance_id) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [i_smf_service_instance_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "recoveryTime", pdu_session_create_data->recovery_time) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [recovery_time]");
        goto end;
    }
    }
    ...
    if (roaming_charging_profile_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [roaming_charging_profile]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "chargingId", pdu_session_create_data->charging_id) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [charging_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "oldPduSessionId", pdu_session_create_data->old_pdu_session_id) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [old_pdu_session_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "epsBearerCtxStatus", pdu_session_create_data->eps_bearer_ctx_status) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [eps_bearer_ctx_status]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "amfNfId", pdu_session_create_data->amf_nf_id) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [amf_nf_id]");
        goto end;
    }
    }
    ...
    if (guami_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [guami]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "maxIntegrityProtectedDataRateUl", OpenAPI_max_integrity_protected_data_rate_ToString(pdu_session_create_data->max_integrity_protected_data_rate_ul)) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [max_integrity_protected_data_rate_ul]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "maxIntegrityProtectedDataRateDl", OpenAPI_max_integrity_protected_data_rate_ToString(pdu_session_create_data->max_integrity_protected_data_rate_dl)) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [max_integrity_protected_data_rate_dl]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "cpCiotEnabled", pdu_session_create_data->cp_ciot_enabled) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [cp_ciot_enabled]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "cpOnlyInd", pdu_session_create_data->cp_only_ind) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [cp_only_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "invokeNef", pdu_session_create_data->invoke_nef) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [invoke_nef]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "maRequestInd", pdu_session_create_data->ma_request_ind) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [ma_request_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "maNwUpgradeInd", pdu_session_create_data->ma_nw_upgrade_ind) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [ma_nw_upgrade_ind]");
        goto end;
    }
    }
    ...
    if (dnai_listList == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [dnai_list]");
        goto end;
    }
    OpenAPI_list_for_each(pdu_session_create_data->dnai_list, node) {
    ...
    if (cJSON_AddStringToObject(item, "presenceInLadn", OpenAPI_presence_state_ToString(pdu_session_create_data->presence_in_ladn)) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [presence_in_ladn]");
        goto end;
    }
    }
    ...
    if (secondary_rat_usage_infoList == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [secondary_rat_usage_info]");
        goto end;
    }
    OpenAPI_list_for_each(pdu_session_create_data->secondary_rat_usage_info, node) {
    ...
    if (small_data_rate_status_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [small_data_rate_status]");
        goto end;
    }
    ...
    if (apn_rate_status_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [apn_rate_status]");
        goto end;
    }
    ...
    if (cJSON_AddNumberToObject(item, "dlServingPlmnRateCtl", pdu_session_create_data->dl_serving_plmn_rate_ctl) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [dl_serving_plmn_rate_ctl]");
        goto end;
    }
    }
    ...
    if (up_security_info_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [up_security_info]");
        goto end;
    }
    ...
    if (vplmn_qos_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [vplmn_qos]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "oldSmContextRef", pdu_session_create_data->old_sm_context_ref) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [old_sm_context_ref]");
        goto end;
    }
    }
    ...
    if (redundant_pdu_session_info_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [redundant_pdu_session_info]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "oldPduSessionRef", pdu_session_create_data->old_pdu_session_ref) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [old_pdu_session_ref]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "smPolicyNotifyInd", pdu_session_create_data->sm_policy_notify_ind) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [sm_policy_notify_ind]");
        goto end;
    }
    }
    ...
    if (pcf_ue_callback_info_local_JSON == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [pcf_ue_callback_info]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "satelliteBackhaulCat", OpenAPI_satellite_backhaul_category_ToString(pdu_session_create_data->satellite_backhaul_cat)) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [satellite_backhaul_cat]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "upipSupported", pdu_session_create_data->upip_supported) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [upip_supported]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "upCnxState", OpenAPI_up_cnx_state_ToString(pdu_session_create_data->up_cnx_state)) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [up_cnx_state]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "disasterRoamingInd", pdu_session_create_data->disaster_roaming_ind) == NULL) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed [disaster_roaming_ind]");
        goto end;
    }
    }
...
OpenAPI_pdu_session_create_data_t *OpenAPI_pdu_session_create_data_parseFromJSON(cJSON *pdu_session_create_dataJSON)
{
    ...
    if (!cJSON_IsString(supi) && !cJSON_IsNull(supi)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [supi]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(unauthenticated_supi)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [unauthenticated_supi]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(pei) && !cJSON_IsNull(pei)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [pei]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(pdu_session_id)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [pdu_session_id]");
        goto end;
    }
    }
    ...
    if (!dnn) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [dnn]");
        goto end;
    }
    ...
    if (!cJSON_IsString(selected_dnn) && !cJSON_IsNull(selected_dnn)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [selected_dnn]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(vsmf_id) && !cJSON_IsNull(vsmf_id)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [vsmf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ismf_id) && !cJSON_IsNull(ismf_id)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [ismf_id]");
        goto end;
    }
    }
    ...
    if (!serving_network) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [serving_network]");
        goto end;
    }
    ...
    if (!cJSON_IsString(request_type)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [request_type]");
        goto end;
    }
    ...
    if (eps_bearer_id) {
        ...
        if (!cJSON_IsArray(eps_bearer_id)) {
            log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [eps_bearer_id]");
            goto end;
        }
    ...
    if (!cJSON_IsString(pgw_s8c_fteid) && !cJSON_IsNull(pgw_s8c_fteid)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [pgw_s8c_fteid]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(vsmf_pdu_session_uri) && !cJSON_IsNull(vsmf_pdu_session_uri)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [vsmf_pdu_session_uri]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ismf_pdu_session_uri) && !cJSON_IsNull(ismf_pdu_session_uri)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [ismf_pdu_session_uri]");
        goto end;
    }
    }
    ...
    if (!vcn_tunnel_info_local_nonprim) {
        log_error("OpenAPI_tunnel_info_parseFromJSON failed [vcn_tunnel_info]");
        goto end;
    }
    }
    ...
    if (!icn_tunnel_info_local_nonprim) {
        log_error("OpenAPI_tunnel_info_parseFromJSON failed [icn_tunnel_info]");
        goto end;
    }
    }
    ...
    if (!n9_forwarding_tunnel_info_local_nonprim) {
        log_error("OpenAPI_tunnel_info_parseFromJSON failed [n9_forwarding_tunnel_info]");
        goto end;
    }
    }
    ...
    if (!additional_cn_tunnel_info_local_nonprim) {
        log_error("OpenAPI_tunnel_info_parseFromJSON failed [additional_cn_tunnel_info]");
        goto end;
    }
    }
    ...
    if (!an_type) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [an_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(additional_an_type)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [additional_an_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(rat_type)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [rat_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(ue_time_zone) && !cJSON_IsNull(ue_time_zone)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [ue_time_zone]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(gpsi) && !cJSON_IsNull(gpsi)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [gpsi]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(h_pcf_id) && !cJSON_IsNull(h_pcf_id)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [h_pcf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(pcf_id) && !cJSON_IsNull(pcf_id)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [pcf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(pcf_group_id) && !cJSON_IsNull(pcf_group_id)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [pcf_group_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(pcf_set_id) && !cJSON_IsNull(pcf_set_id)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [pcf_set_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(ho_preparation_indication)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [ho_preparation_indication]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(sel_mode)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [sel_mode]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(always_on_requested)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [always_on_requested]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(udm_group_id) && !cJSON_IsNull(udm_group_id)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [udm_group_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(routing_indicator) && !cJSON_IsNull(routing_indicator)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [routing_indicator]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(h_nw_pub_key_id)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [h_nw_pub_key_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(eps_interworking_ind)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [eps_interworking_ind]");
        goto end;
    }
    ...
    if (!cJSON_IsString(v_smf_service_instance_id) && !cJSON_IsNull(v_smf_service_instance_id)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [v_smf_service_instance_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(i_smf_service_instance_id) && !cJSON_IsNull(i_smf_service_instance_id)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [i_smf_service_instance_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(recovery_time) && !cJSON_IsNull(recovery_time)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [recovery_time]");
        goto end;
    }
    }
    ...
    if (!roaming_charging_profile_local_nonprim) {
        log_error("OpenAPI_roaming_charging_profile_parseFromJSON failed [roaming_charging_profile]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(charging_id) && !cJSON_IsNull(charging_id)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [charging_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(old_pdu_session_id)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [old_pdu_session_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(eps_bearer_ctx_status) && !cJSON_IsNull(eps_bearer_ctx_status)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [eps_bearer_ctx_status]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(amf_nf_id) && !cJSON_IsNull(amf_nf_id)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [amf_nf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(max_integrity_protected_data_rate_ul)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [max_integrity_protected_data_rate_ul]");
        goto end;
    }
    ...
    if (!cJSON_IsString(max_integrity_protected_data_rate_dl)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [max_integrity_protected_data_rate_dl]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(cp_ciot_enabled)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [cp_ciot_enabled]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(cp_only_ind)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [cp_only_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(invoke_nef)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [invoke_nef]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(ma_request_ind)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [ma_request_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(ma_nw_upgrade_ind)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [ma_nw_upgrade_ind]");
        goto end;
    }
    }
    ...
    if (dnai_list) {
        ...
        if (!cJSON_IsArray(dnai_list)) {
            log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [dnai_list]");
            goto end;
        }
    ...
    if (!cJSON_IsString(presence_in_ladn)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [presence_in_ladn]");
        goto end;
    }
    ...
    if (secondary_rat_usage_info) {
        ...
        if (!cJSON_IsArray(secondary_rat_usage_info)) {
            log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [secondary_rat_usage_info]");
            goto end;
        }
    ...
    if (!cJSON_IsNumber(dl_serving_plmn_rate_ctl)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [dl_serving_plmn_rate_ctl]");
        goto end;
    }
    }
    ...
    if (!up_security_info_local_nonprim) {
        log_error("OpenAPI_up_security_info_parseFromJSON failed [up_security_info]");
        goto end;
    }
    }
    ...
    if (!vplmn_qos_local_nonprim) {
        log_error("OpenAPI_vplmn_qos_parseFromJSON failed [vplmn_qos]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(old_sm_context_ref) && !cJSON_IsNull(old_sm_context_ref)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [old_sm_context_ref]");
        goto end;
    }
    }
    ...
    if (!redundant_pdu_session_info_local_nonprim) {
        log_error("OpenAPI_redundant_pdu_session_information_parseFromJSON failed [redundant_pdu_session_info]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(old_pdu_session_ref) && !cJSON_IsNull(old_pdu_session_ref)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [old_pdu_session_ref]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(sm_policy_notify_ind)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [sm_policy_notify_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(satellite_backhaul_cat)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [satellite_backhaul_cat]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(upip_supported)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [upip_supported]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(up_cnx_state)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [up_cnx_state]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(disaster_roaming_ind)) {
        log_error("OpenAPI_pdu_session_create_data_parseFromJSON() failed [disaster_roaming_ind]");
        goto end;
    }
    }
...
OpenAPI_pdu_session_create_data_t *OpenAPI_pdu_session_create_data_copy(OpenAPI_pdu_session_create_data_t *dst, OpenAPI_pdu_session_create_data_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_pdu_session_create_data_convertToJSON() failed");
        return NULL;
    }
