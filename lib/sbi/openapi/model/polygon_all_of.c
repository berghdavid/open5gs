...
)
{
    ...
    log_assert(polygon_all_of_local_var);
...
cJSON *OpenAPI_polygon_all_of_convertToJSON(OpenAPI_polygon_all_of_t *polygon_all_of)
{
    ...
    if (polygon_all_of == NULL) {
        log_error("OpenAPI_polygon_all_of_convertToJSON() failed [Polygon_allOf]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!polygon_all_of->point_list) {
        log_error("OpenAPI_polygon_all_of_convertToJSON() failed [point_list]");
        return NULL;
    }
...
OpenAPI_polygon_all_of_t *OpenAPI_polygon_all_of_parseFromJSON(cJSON *polygon_all_ofJSON)
{
    ...
    if (!point_list) {
        log_error("OpenAPI_polygon_all_of_parseFromJSON() failed [point_list]");
        goto end;
    }
...
OpenAPI_polygon_all_of_t *OpenAPI_polygon_all_of_copy(OpenAPI_polygon_all_of_t *dst, OpenAPI_polygon_all_of_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_polygon_all_of_convertToJSON() failed");
        return NULL;
    }
