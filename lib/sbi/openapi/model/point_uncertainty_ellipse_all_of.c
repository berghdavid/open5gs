...
)
{
    ...
    log_assert(point_uncertainty_ellipse_all_of_local_var);
...
cJSON *OpenAPI_point_uncertainty_ellipse_all_of_convertToJSON(OpenAPI_point_uncertainty_ellipse_all_of_t *point_uncertainty_ellipse_all_of)
{
    ...
    if (point_uncertainty_ellipse_all_of == NULL) {
        log_error("OpenAPI_point_uncertainty_ellipse_all_of_convertToJSON() failed [PointUncertaintyEllipse_allOf]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!point_uncertainty_ellipse_all_of->point) {
        log_error("OpenAPI_point_uncertainty_ellipse_all_of_convertToJSON() failed [point]");
        return NULL;
    }
    ...
    if (!point_uncertainty_ellipse_all_of->uncertainty_ellipse) {
        log_error("OpenAPI_point_uncertainty_ellipse_all_of_convertToJSON() failed [uncertainty_ellipse]");
        return NULL;
    }
    ...
    if (cJSON_AddNumberToObject(item, "confidence", point_uncertainty_ellipse_all_of->confidence) == NULL) {
        log_error("OpenAPI_point_uncertainty_ellipse_all_of_convertToJSON() failed [confidence]");
        goto end;
    }
...
OpenAPI_point_uncertainty_ellipse_all_of_t *OpenAPI_point_uncertainty_ellipse_all_of_parseFromJSON(cJSON *point_uncertainty_ellipse_all_ofJSON)
{
    ...
    if (!point) {
        log_error("OpenAPI_point_uncertainty_ellipse_all_of_parseFromJSON() failed [point]");
        goto end;
    }
    ...
    if (!uncertainty_ellipse) {
        log_error("OpenAPI_point_uncertainty_ellipse_all_of_parseFromJSON() failed [uncertainty_ellipse]");
        goto end;
    }
    ...
    if (!confidence) {
        log_error("OpenAPI_point_uncertainty_ellipse_all_of_parseFromJSON() failed [confidence]");
        goto end;
    }
...
OpenAPI_point_uncertainty_ellipse_all_of_t *OpenAPI_point_uncertainty_ellipse_all_of_copy(OpenAPI_point_uncertainty_ellipse_all_of_t *dst, OpenAPI_point_uncertainty_ellipse_all_of_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_point_uncertainty_ellipse_all_of_convertToJSON() failed");
        return NULL;
    }
