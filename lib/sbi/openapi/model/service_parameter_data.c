...
)
{
    ...
    log_assert(service_parameter_data_local_var);
...
cJSON *OpenAPI_service_parameter_data_convertToJSON(OpenAPI_service_parameter_data_t *service_parameter_data)
{
    ...
    if (service_parameter_data == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [ServiceParameterData]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "appId", service_parameter_data->app_id) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [app_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "dnn", service_parameter_data->dnn) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [dnn]");
        goto end;
    }
    }
    ...
    if (snssai_local_JSON == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [snssai]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "interGroupId", service_parameter_data->inter_group_id) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [inter_group_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "supi", service_parameter_data->supi) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [supi]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ueIpv4", service_parameter_data->ue_ipv4) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [ue_ipv4]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ueIpv6", service_parameter_data->ue_ipv6) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [ue_ipv6]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ueMac", service_parameter_data->ue_mac) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [ue_mac]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "anyUeInd", service_parameter_data->any_ue_ind) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [any_ue_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "paramOverPc5", service_parameter_data->param_over_pc5) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [param_over_pc5]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "paramOverUu", service_parameter_data->param_over_uu) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [param_over_uu]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "paramForProSeDd", service_parameter_data->param_for_pro_se_dd) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [param_for_pro_se_dd]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "paramForProSeDc", service_parameter_data->param_for_pro_se_dc) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [param_for_pro_se_dc]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "paramForProSeU2NRelUe", service_parameter_data->param_for_pro_se_u2_n_rel_ue) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [param_for_pro_se_u2_n_rel_ue]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "paramForProSeRemUe", service_parameter_data->param_for_pro_se_rem_ue) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [param_for_pro_se_rem_ue]");
        goto end;
    }
    }
    ...
    if (ursp_guidanceList == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [ursp_guidance]");
        goto end;
    }
    OpenAPI_list_for_each(service_parameter_data->ursp_guidance, node) {
    ...
    if (delivery_eventsList == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [delivery_events]");
        goto end;
    }
    OpenAPI_list_for_each(service_parameter_data->delivery_events, node) {
    ...
    if (cJSON_AddStringToObject(item, "policDelivNotifCorreId", service_parameter_data->polic_deliv_notif_corre_id) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [polic_deliv_notif_corre_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "policDelivNotifUri", service_parameter_data->polic_deliv_notif_uri) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [polic_deliv_notif_uri]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "suppFeat", service_parameter_data->supp_feat) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [supp_feat]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "resUri", service_parameter_data->res_uri) == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [res_uri]");
        goto end;
    }
    }
    ...
    if (headersList == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [headers]");
        goto end;
    }
    OpenAPI_list_for_each(service_parameter_data->headers, node) {
    ...
    if (reset_idsList == NULL) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed [reset_ids]");
        goto end;
    }
    OpenAPI_list_for_each(service_parameter_data->reset_ids, node) {
...
OpenAPI_service_parameter_data_t *OpenAPI_service_parameter_data_parseFromJSON(cJSON *service_parameter_dataJSON)
{
    ...
    if (!cJSON_IsString(app_id) && !cJSON_IsNull(app_id)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [app_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(dnn) && !cJSON_IsNull(dnn)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [dnn]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(inter_group_id) && !cJSON_IsNull(inter_group_id)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [inter_group_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(supi) && !cJSON_IsNull(supi)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [supi]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ue_ipv4) && !cJSON_IsNull(ue_ipv4)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [ue_ipv4]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ue_ipv6) && !cJSON_IsNull(ue_ipv6)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [ue_ipv6]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ue_mac) && !cJSON_IsNull(ue_mac)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [ue_mac]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(any_ue_ind)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [any_ue_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(param_over_pc5) && !cJSON_IsNull(param_over_pc5)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [param_over_pc5]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(param_over_uu) && !cJSON_IsNull(param_over_uu)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [param_over_uu]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(param_for_pro_se_dd) && !cJSON_IsNull(param_for_pro_se_dd)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [param_for_pro_se_dd]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(param_for_pro_se_dc) && !cJSON_IsNull(param_for_pro_se_dc)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [param_for_pro_se_dc]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(param_for_pro_se_u2_n_rel_ue) && !cJSON_IsNull(param_for_pro_se_u2_n_rel_ue)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [param_for_pro_se_u2_n_rel_ue]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(param_for_pro_se_rem_ue) && !cJSON_IsNull(param_for_pro_se_rem_ue)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [param_for_pro_se_rem_ue]");
        goto end;
    }
    }
    ...
    if (ursp_guidance) {
        ...
        if (!cJSON_IsArray(ursp_guidance)) {
            log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [ursp_guidance]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(ursp_guidance_local, ursp_guidance) {
            ...
            if (!ursp_guidanceItem) {
                log_error("No ursp_guidanceItem");
                goto end;
            }
    ...
    if (delivery_events) {
        ...
        if (!cJSON_IsArray(delivery_events)) {
            log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [delivery_events]");
            goto end;
        }
    ...
    if (!cJSON_IsString(polic_deliv_notif_corre_id) && !cJSON_IsNull(polic_deliv_notif_corre_id)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [polic_deliv_notif_corre_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(polic_deliv_notif_uri) && !cJSON_IsNull(polic_deliv_notif_uri)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [polic_deliv_notif_uri]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(supp_feat) && !cJSON_IsNull(supp_feat)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [supp_feat]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(res_uri) && !cJSON_IsNull(res_uri)) {
        log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [res_uri]");
        goto end;
    }
    }
    ...
    if (headers) {
        ...
        if (!cJSON_IsArray(headers)) {
            log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [headers]");
            goto end;
        }
    ...
    if (reset_ids) {
        ...
        if (!cJSON_IsArray(reset_ids)) {
            log_error("OpenAPI_service_parameter_data_parseFromJSON() failed [reset_ids]");
            goto end;
        }
...
OpenAPI_service_parameter_data_t *OpenAPI_service_parameter_data_copy(OpenAPI_service_parameter_data_t *dst, OpenAPI_service_parameter_data_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_service_parameter_data_convertToJSON() failed");
        return NULL;
    }
