...
)
{
    ...
    log_assert(qos_flow_profile_local_var);
...
cJSON *OpenAPI_qos_flow_profile_convertToJSON(OpenAPI_qos_flow_profile_t *qos_flow_profile)
{
    ...
    if (qos_flow_profile == NULL) {
        log_error("OpenAPI_qos_flow_profile_convertToJSON() failed [QosFlowProfile]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (cJSON_AddNumberToObject(item, "5qi", qos_flow_profile->_5qi) == NULL) {
        log_error("OpenAPI_qos_flow_profile_convertToJSON() failed [_5qi]");
        goto end;
    }
    ...
    if (non_dynamic5_qi_local_JSON == NULL) {
        log_error("OpenAPI_qos_flow_profile_convertToJSON() failed [non_dynamic5_qi]");
        goto end;
    }
    ...
    if (dynamic5_qi_local_JSON == NULL) {
        log_error("OpenAPI_qos_flow_profile_convertToJSON() failed [dynamic5_qi]");
        goto end;
    }
    ...
    if (arp_local_JSON == NULL) {
        log_error("OpenAPI_qos_flow_profile_convertToJSON() failed [arp]");
        goto end;
    }
    ...
    if (gbr_qos_flow_info_local_JSON == NULL) {
        log_error("OpenAPI_qos_flow_profile_convertToJSON() failed [gbr_qos_flow_info]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "rqa", OpenAPI_reflective_qo_s_attribute_ToString(qos_flow_profile->rqa)) == NULL) {
        log_error("OpenAPI_qos_flow_profile_convertToJSON() failed [rqa]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "additionalQosFlowInfo", OpenAPI_additional_qos_flow_info_ToString(qos_flow_profile->additional_qos_flow_info)) == NULL) {
        log_error("OpenAPI_qos_flow_profile_convertToJSON() failed [additional_qos_flow_info]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "qosMonitoringReq", OpenAPI_qos_monitoring_req_ToString(qos_flow_profile->qos_monitoring_req)) == NULL) {
        log_error("OpenAPI_qos_flow_profile_convertToJSON() failed [qos_monitoring_req]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "qosRepPeriod", qos_flow_profile->qos_rep_period) == NULL) {
        log_error("OpenAPI_qos_flow_profile_convertToJSON() failed [qos_rep_period]");
        goto end;
    }
    }
...
OpenAPI_qos_flow_profile_t *OpenAPI_qos_flow_profile_parseFromJSON(cJSON *qos_flow_profileJSON)
{
    ...
    if (!_5qi) {
        log_error("OpenAPI_qos_flow_profile_parseFromJSON() failed [_5qi]");
        goto end;
    }
    ...
    if (!non_dynamic5_qi_local_nonprim) {
        log_error("OpenAPI_non_dynamic5_qi_parseFromJSON failed [non_dynamic5_qi]");
        goto end;
    }
    }
    ...
    if (!dynamic5_qi_local_nonprim) {
        log_error("OpenAPI_dynamic5_qi_parseFromJSON failed [dynamic5_qi]");
        goto end;
    }
    }
    ...
    if (!gbr_qos_flow_info_local_nonprim) {
        log_error("OpenAPI_gbr_qos_flow_information_parseFromJSON failed [gbr_qos_flow_info]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(rqa)) {
        log_error("OpenAPI_qos_flow_profile_parseFromJSON() failed [rqa]");
        goto end;
    }
    ...
    if (!cJSON_IsString(additional_qos_flow_info)) {
        log_error("OpenAPI_qos_flow_profile_parseFromJSON() failed [additional_qos_flow_info]");
        goto end;
    }
    ...
    if (!cJSON_IsString(qos_monitoring_req)) {
        log_error("OpenAPI_qos_flow_profile_parseFromJSON() failed [qos_monitoring_req]");
        goto end;
    }
    ...
    if (!cJSON_IsNumber(qos_rep_period)) {
        log_error("OpenAPI_qos_flow_profile_parseFromJSON() failed [qos_rep_period]");
        goto end;
    }
    }
...
OpenAPI_qos_flow_profile_t *OpenAPI_qos_flow_profile_copy(OpenAPI_qos_flow_profile_t *dst, OpenAPI_qos_flow_profile_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_qos_flow_profile_convertToJSON() failed");
        return NULL;
    }
