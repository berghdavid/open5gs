...
)
{
    ...
    log_assert(sm_context_create_data_local_var);
...
cJSON *OpenAPI_sm_context_create_data_convertToJSON(OpenAPI_sm_context_create_data_t *sm_context_create_data)
{
    ...
    if (sm_context_create_data == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [SmContextCreateData]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "supi", sm_context_create_data->supi) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [supi]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "unauthenticatedSupi", sm_context_create_data->unauthenticated_supi) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [unauthenticated_supi]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "pei", sm_context_create_data->pei) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [pei]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "gpsi", sm_context_create_data->gpsi) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [gpsi]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "pduSessionId", sm_context_create_data->pdu_session_id) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [pdu_session_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "dnn", sm_context_create_data->dnn) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [dnn]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "selectedDnn", sm_context_create_data->selected_dnn) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [selected_dnn]");
        goto end;
    }
    }
    ...
    if (s_nssai_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [s_nssai]");
        goto end;
    }
    ...
    if (hplmn_snssai_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [hplmn_snssai]");
        goto end;
    }
    ...
    if (!sm_context_create_data->serving_nf_id) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [serving_nf_id]");
        return NULL;
    }
    ...
    if (guami_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [guami]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "serviceName", sm_context_create_data->service_name) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [service_name]");
        goto end;
    }
    }

    if (!sm_context_create_data->serving_network) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [serving_network]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "requestType", OpenAPI_request_type_ToString(sm_context_create_data->request_type)) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [request_type]");
        goto end;
    }
    }
    ...
    if (n1_sm_msg_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [n1_sm_msg]");
        goto end;
    }
    ...
    if (sm_context_create_data->an_type == OpenAPI_access_type_NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [an_type]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "additionalAnType", OpenAPI_access_type_ToString(sm_context_create_data->additional_an_type)) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [additional_an_type]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "ratType", OpenAPI_rat_type_ToString(sm_context_create_data->rat_type)) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [rat_type]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "presenceInLadn", OpenAPI_presence_state_ToString(sm_context_create_data->presence_in_ladn)) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [presence_in_ladn]");
        goto end;
    }
    }
    ...
    if (ue_location_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [ue_location]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "ueTimeZone", sm_context_create_data->ue_time_zone) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [ue_time_zone]");
        goto end;
    }
    }
    ...
    if (add_ue_location_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [add_ue_location]");
        goto end;
    }
    ...
    if (!sm_context_create_data->sm_context_status_uri) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_status_uri]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "hSmfUri", sm_context_create_data->h_smf_uri) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [h_smf_uri]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "hSmfId", sm_context_create_data->h_smf_id) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [h_smf_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "smfUri", sm_context_create_data->smf_uri) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [smf_uri]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "smfId", sm_context_create_data->smf_id) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [smf_id]");
        goto end;
    }
    }
    ...
    if (additional_hsmf_uriList == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [additional_hsmf_uri]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_create_data->additional_hsmf_uri, node) {
    ...
    if (additional_hsmf_idList == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [additional_hsmf_id]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_create_data->additional_hsmf_id, node) {
    ...
    if (additional_smf_uriList == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [additional_smf_uri]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_create_data->additional_smf_uri, node) {
    ...
    if (additional_smf_idList == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [additional_smf_id]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_create_data->additional_smf_id, node) {
    ...
    if (cJSON_AddNumberToObject(item, "oldPduSessionId", sm_context_create_data->old_pdu_session_id) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [old_pdu_session_id]");
        goto end;
    }
    }
    ...
    if (pdu_sessions_activate_listList == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [pdu_sessions_activate_list]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_create_data->pdu_sessions_activate_list, node) {
        if (node->data == NULL) {
    ...
    if (cJSON_AddStringToObject(item, "ueEpsPdnConnection", sm_context_create_data->ue_eps_pdn_connection) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [ue_eps_pdn_connection]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "hoState", OpenAPI_ho_state_ToString(sm_context_create_data->ho_state)) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [ho_state]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "pcfId", sm_context_create_data->pcf_id) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [pcf_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "pcfGroupId", sm_context_create_data->pcf_group_id) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [pcf_group_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "pcfSetId", sm_context_create_data->pcf_set_id) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [pcf_set_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "nrfUri", sm_context_create_data->nrf_uri) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [nrf_uri]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", sm_context_create_data->supported_features) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "selMode", OpenAPI_dnn_selection_mode_ToString(sm_context_create_data->sel_mode)) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [sel_mode]");
        goto end;
    }
    }
    ...
    if (backup_amf_infoList == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [backup_amf_info]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_create_data->backup_amf_info, node) {
    ...
    if (trace_data_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [trace_data]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "udmGroupId", sm_context_create_data->udm_group_id) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [udm_group_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "routingIndicator", sm_context_create_data->routing_indicator) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [routing_indicator]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "hNwPubKeyId", sm_context_create_data->h_nw_pub_key_id) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [h_nw_pub_key_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "epsInterworkingInd", OpenAPI_eps_interworking_indication_ToString(sm_context_create_data->eps_interworking_ind)) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [eps_interworking_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "indirectForwardingFlag", sm_context_create_data->indirect_forwarding_flag) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [indirect_forwarding_flag]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "directForwardingFlag", sm_context_create_data->direct_forwarding_flag) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [direct_forwarding_flag]");
        goto end;
    }
    }
    ...
    if (target_id_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [target_id]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "epsBearerCtxStatus", sm_context_create_data->eps_bearer_ctx_status) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [eps_bearer_ctx_status]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "cpCiotEnabled", sm_context_create_data->cp_ciot_enabled) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [cp_ciot_enabled]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "cpOnlyInd", sm_context_create_data->cp_only_ind) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [cp_only_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "invokeNef", sm_context_create_data->invoke_nef) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [invoke_nef]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "maRequestInd", sm_context_create_data->ma_request_ind) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [ma_request_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "maNwUpgradeInd", sm_context_create_data->ma_nw_upgrade_ind) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [ma_nw_upgrade_ind]");
        goto end;
    }
    }
    ...
    if (n2_sm_info_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [n2_sm_info]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "n2SmInfoType", OpenAPI_n2_sm_info_type_ToString(sm_context_create_data->n2_sm_info_type)) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [n2_sm_info_type]");
        goto end;
    }
    }
    ...
    if (n2_sm_info_ext1_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [n2_sm_info_ext1]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "n2SmInfoTypeExt1", OpenAPI_n2_sm_info_type_ToString(sm_context_create_data->n2_sm_info_type_ext1)) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [n2_sm_info_type_ext1]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "smContextRef", sm_context_create_data->sm_context_ref) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_ref]");
        goto end;
    }
    }
    ...
    if (sm_context_smf_plmn_id_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_smf_plmn_id]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "smContextSmfId", sm_context_create_data->sm_context_smf_id) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_smf_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "smContextSmfSetId", sm_context_create_data->sm_context_smf_set_id) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_smf_set_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "smContextSmfServiceSetId", sm_context_create_data->sm_context_smf_service_set_id) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_smf_service_set_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "smContextSmfBinding", OpenAPI_sbi_binding_level_ToString(sm_context_create_data->sm_context_smf_binding)) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_smf_binding]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "upCnxState", OpenAPI_up_cnx_state_ToString(sm_context_create_data->up_cnx_state)) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [up_cnx_state]");
        goto end;
    }
    }
    ...
    if (small_data_rate_status_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [small_data_rate_status]");
        goto end;
    }
    ...
    if (apn_rate_status_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [apn_rate_status]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "extendedNasSmTimerInd", sm_context_create_data->extended_nas_sm_timer_ind) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [extended_nas_sm_timer_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "dlDataWaitingInd", sm_context_create_data->dl_data_waiting_ind) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [dl_data_waiting_ind]");
        goto end;
    }
    }
    ...
    if (ddn_failure_subs_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [ddn_failure_subs]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "smfTransferInd", sm_context_create_data->smf_transfer_ind) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [smf_transfer_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "oldSmfId", sm_context_create_data->old_smf_id) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [old_smf_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "oldSmContextRef", sm_context_create_data->old_sm_context_ref) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [old_sm_context_ref]");
        goto end;
    }
    }
    ...
    if (w_agf_info_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [w_agf_info]");
        goto end;
    }
    ...
    if (tngf_info_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [tngf_info]");
        goto end;
    }
    ...
    if (twif_info_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [twif_info]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "ranUnchangedInd", sm_context_create_data->ran_unchanged_ind) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [ran_unchanged_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "samePcfSelectionInd", sm_context_create_data->same_pcf_selection_ind) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [same_pcf_selection_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "targetDnai", sm_context_create_data->target_dnai) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [target_dnai]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "nrfManagementUri", sm_context_create_data->nrf_management_uri) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [nrf_management_uri]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "nrfDiscoveryUri", sm_context_create_data->nrf_discovery_uri) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [nrf_discovery_uri]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "nrfAccessTokenUri", sm_context_create_data->nrf_access_token_uri) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [nrf_access_token_uri]");
        goto end;
    }
    }
    ...
    if (nrf_oauth2_required == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [nrf_oauth2_required]");
        goto end;
    }
    ...
    if (sm_context_create_data->nrf_oauth2_required) {
        OpenAPI_list_for_each(sm_context_create_data->nrf_oauth2_required, node) {
            ...
            if (cJSON_AddBoolToObject(localMapObject, localKeyValue->key, (uintptr_t)localKeyValue->value) == NULL) {
                log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [inner]");
                goto end;
            }
        }
    }
    ...
    if (cJSON_AddStringToObject(item, "smfBindingInfo", sm_context_create_data->smf_binding_info) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [smf_binding_info]");
        goto end;
    }
    }
    ...
    if (pvs_infoList == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [pvs_info]");
        goto end;
    }
    OpenAPI_list_for_each(sm_context_create_data->pvs_info, node) {
    ...
    if (cJSON_AddBoolToObject(item, "onboardingInd", sm_context_create_data->onboarding_ind) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [onboarding_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "oldPduSessionRef", sm_context_create_data->old_pdu_session_ref) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [old_pdu_session_ref]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "smPolicyNotifyInd", sm_context_create_data->sm_policy_notify_ind) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [sm_policy_notify_ind]");
        goto end;
    }
    }
    ...
    if (pcf_ue_callback_info_local_JSON == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [pcf_ue_callback_info]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "satelliteBackhaulCat", OpenAPI_satellite_backhaul_category_ToString(sm_context_create_data->satellite_backhaul_cat)) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [satellite_backhaul_cat]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "upipSupported", sm_context_create_data->upip_supported) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [upip_supported]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "uavAuthenticated", sm_context_create_data->uav_authenticated) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [uav_authenticated]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "disasterRoamingInd", sm_context_create_data->disaster_roaming_ind) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [disaster_roaming_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "anchorSmfOauth2Required", sm_context_create_data->anchor_smf_oauth2_required) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [anchor_smf_oauth2_required]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "smContextSmfOauth2Required", sm_context_create_data->sm_context_smf_oauth2_required) == NULL) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_smf_oauth2_required]");
        goto end;
    }
    }
...
OpenAPI_sm_context_create_data_t *OpenAPI_sm_context_create_data_parseFromJSON(cJSON *sm_context_create_dataJSON)
{
    ...
    if (!cJSON_IsString(supi) && !cJSON_IsNull(supi)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [supi]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(unauthenticated_supi)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [unauthenticated_supi]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(pei) && !cJSON_IsNull(pei)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [pei]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(gpsi) && !cJSON_IsNull(gpsi)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [gpsi]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(pdu_session_id)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [pdu_session_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(dnn) && !cJSON_IsNull(dnn)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [dnn]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(selected_dnn) && !cJSON_IsNull(selected_dnn)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [selected_dnn]");
        goto end;
    }
    }
    ...
    if (!hplmn_snssai_local_nonprim) {
        log_error("OpenAPI_snssai_parseFromJSON failed [hplmn_snssai]");
        goto end;
    }
    }
    ...
    if (!serving_nf_id) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [serving_nf_id]");
        goto end;
    }
    ...
    if (!cJSON_IsString(service_name) && !cJSON_IsNull(service_name)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [service_name]");
        goto end;
    }
    }
    ...
    if (!serving_network) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [serving_network]");
        goto end;
    }
    ...
    if (!cJSON_IsString(request_type)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [request_type]");
        goto end;
    }
    ...
    if (!an_type) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [an_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(additional_an_type)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [additional_an_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(rat_type)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [rat_type]");
        goto end;
    }
    ...
    if (!cJSON_IsString(presence_in_ladn)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [presence_in_ladn]");
        goto end;
    }
    ...
    if (!cJSON_IsString(ue_time_zone) && !cJSON_IsNull(ue_time_zone)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [ue_time_zone]");
        goto end;
    }
    }
    ...
    if (!sm_context_status_uri) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [sm_context_status_uri]");
        goto end;
    }
    ...
    if (!cJSON_IsString(h_smf_uri) && !cJSON_IsNull(h_smf_uri)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [h_smf_uri]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(h_smf_id) && !cJSON_IsNull(h_smf_id)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [h_smf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(smf_uri) && !cJSON_IsNull(smf_uri)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [smf_uri]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(smf_id) && !cJSON_IsNull(smf_id)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [smf_id]");
        goto end;
    }
    }
    ...
    if (additional_hsmf_uri) {
        ...
        if (!cJSON_IsArray(additional_hsmf_uri)) {
            log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [additional_hsmf_uri]");
            goto end;
        }
    ...
    if (additional_hsmf_id) {
        ...
        if (!cJSON_IsArray(additional_hsmf_id)) {
            log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [additional_hsmf_id]");
            goto end;
        }
    ...
    if (additional_smf_uri) {
        ...
        if (!cJSON_IsArray(additional_smf_uri)) {
            log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [additional_smf_uri]");
            goto end;
        }
    ...
    if (additional_smf_id) {
        ...
        if (!cJSON_IsArray(additional_smf_id)) {
            log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [additional_smf_id]");
            goto end;
        }
    ...
    if (!cJSON_IsNumber(old_pdu_session_id)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [old_pdu_session_id]");
        goto end;
    }
    }
    ...
    if (pdu_sessions_activate_list) {
        ...
        if (!cJSON_IsArray(pdu_sessions_activate_list)) {
            log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [pdu_sessions_activate_list]");
            goto end;
        }
    ...
    if (!cJSON_IsString(ue_eps_pdn_connection) && !cJSON_IsNull(ue_eps_pdn_connection)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [ue_eps_pdn_connection]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ho_state)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [ho_state]");
        goto end;
    }
    ...
    if (!cJSON_IsString(pcf_id) && !cJSON_IsNull(pcf_id)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [pcf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(pcf_group_id) && !cJSON_IsNull(pcf_group_id)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [pcf_group_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(pcf_set_id) && !cJSON_IsNull(pcf_set_id)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [pcf_set_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(nrf_uri) && !cJSON_IsNull(nrf_uri)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [nrf_uri]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(sel_mode)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [sel_mode]");
        goto end;
    }
    ...
    if (backup_amf_info) {
        ...
        if (!cJSON_IsArray(backup_amf_info)) {
            log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [backup_amf_info]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(backup_amf_info_local, backup_amf_info) {
            ...
            if (!backup_amf_infoItem) {
                log_error("No backup_amf_infoItem");
                goto end;
            }
    ...
    if (!cJSON_IsString(udm_group_id) && !cJSON_IsNull(udm_group_id)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [udm_group_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(routing_indicator) && !cJSON_IsNull(routing_indicator)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [routing_indicator]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(h_nw_pub_key_id)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [h_nw_pub_key_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(eps_interworking_ind)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [eps_interworking_ind]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(indirect_forwarding_flag)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [indirect_forwarding_flag]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(direct_forwarding_flag)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [direct_forwarding_flag]");
        goto end;
    }
    }
    ...
    if (!target_id_local_nonprim) {
        log_error("OpenAPI_ng_ran_target_id_parseFromJSON failed [target_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(eps_bearer_ctx_status) && !cJSON_IsNull(eps_bearer_ctx_status)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [eps_bearer_ctx_status]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(cp_ciot_enabled)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [cp_ciot_enabled]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(cp_only_ind)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [cp_only_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(invoke_nef)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [invoke_nef]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(ma_request_ind)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [ma_request_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(ma_nw_upgrade_ind)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [ma_nw_upgrade_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(n2_sm_info_type)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [n2_sm_info_type]");
        goto end;
    }
    ...
    if (!n2_sm_info_ext1_local_nonprim) {
        log_error("OpenAPI_ref_to_binary_data_parseFromJSON failed [n2_sm_info_ext1]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(n2_sm_info_type_ext1)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [n2_sm_info_type_ext1]");
        goto end;
    }
    ...
    if (!cJSON_IsString(sm_context_ref) && !cJSON_IsNull(sm_context_ref)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [sm_context_ref]");
        goto end;
    }
    }
    ...
    if (!sm_context_smf_plmn_id_local_nonprim) {
        log_error("OpenAPI_plmn_id_nid_parseFromJSON failed [sm_context_smf_plmn_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(sm_context_smf_id) && !cJSON_IsNull(sm_context_smf_id)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [sm_context_smf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(sm_context_smf_set_id) && !cJSON_IsNull(sm_context_smf_set_id)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [sm_context_smf_set_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(sm_context_smf_service_set_id) && !cJSON_IsNull(sm_context_smf_service_set_id)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [sm_context_smf_service_set_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(sm_context_smf_binding)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [sm_context_smf_binding]");
        goto end;
    }
    ...
    if (!cJSON_IsString(up_cnx_state)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [up_cnx_state]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(extended_nas_sm_timer_ind)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [extended_nas_sm_timer_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(dl_data_waiting_ind)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [dl_data_waiting_ind]");
        goto end;
    }
    }
    ...
    if (!ddn_failure_subs_local_nonprim) {
        log_error("OpenAPI_ddn_failure_subs_parseFromJSON failed [ddn_failure_subs]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(smf_transfer_ind)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [smf_transfer_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(old_smf_id) && !cJSON_IsNull(old_smf_id)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [old_smf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(old_sm_context_ref) && !cJSON_IsNull(old_sm_context_ref)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [old_sm_context_ref]");
        goto end;
    }
    }
    ...
    if (!w_agf_info_local_nonprim) {
        log_error("OpenAPI_w_agf_info_parseFromJSON failed [w_agf_info]");
        goto end;
    }
    }
    ...
    if (!tngf_info_local_nonprim) {
        log_error("OpenAPI_tngf_info_parseFromJSON failed [tngf_info]");
        goto end;
    }
    }
    ...
    if (!twif_info_local_nonprim) {
        log_error("OpenAPI_twif_info_parseFromJSON failed [twif_info]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(ran_unchanged_ind)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [ran_unchanged_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(same_pcf_selection_ind)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [same_pcf_selection_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(target_dnai) && !cJSON_IsNull(target_dnai)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [target_dnai]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(nrf_management_uri) && !cJSON_IsNull(nrf_management_uri)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [nrf_management_uri]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(nrf_discovery_uri) && !cJSON_IsNull(nrf_discovery_uri)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [nrf_discovery_uri]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(nrf_access_token_uri) && !cJSON_IsNull(nrf_access_token_uri)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [nrf_access_token_uri]");
        goto end;
    }
    }
    ...
    if (nrf_oauth2_required) {
        ...
        if (!cJSON_IsObject(nrf_oauth2_required) && !cJSON_IsNull(nrf_oauth2_required)) {
            log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [nrf_oauth2_required]");
            goto end;
        }
        if (cJSON_IsObject(nrf_oauth2_required)) {
            ...
            cJSON_ArrayForEach(nrf_oauth2_required_local_map, nrf_oauth2_required) {
                ...
                if (!cJSON_IsBool(localMapObject)) {
                    log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [inner]");
                    goto end;
                }
    ...
    if (!cJSON_IsString(smf_binding_info) && !cJSON_IsNull(smf_binding_info)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [smf_binding_info]");
        goto end;
    }
    }
    ...
    if (pvs_info) {
        ...
        if (!cJSON_IsArray(pvs_info)) {
            log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [pvs_info]");
            goto end;
        }
    ...
    if (!cJSON_IsBool(onboarding_ind)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [onboarding_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(old_pdu_session_ref) && !cJSON_IsNull(old_pdu_session_ref)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [old_pdu_session_ref]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(sm_policy_notify_ind)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [sm_policy_notify_ind]");
        goto end;
    }
    }
    ...
    if (!pcf_ue_callback_info_local_nonprim) {
        log_error("OpenAPI_pcf_ue_callback_info_parseFromJSON failed [pcf_ue_callback_info]");
        goto end;
    }
    }
    }
    ...
    if (!cJSON_IsString(satellite_backhaul_cat)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [satellite_backhaul_cat]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(upip_supported)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [upip_supported]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(uav_authenticated)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [uav_authenticated]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(disaster_roaming_ind)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [disaster_roaming_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(anchor_smf_oauth2_required)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [anchor_smf_oauth2_required]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(sm_context_smf_oauth2_required)) {
        log_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [sm_context_smf_oauth2_required]");
        goto end;
    }
    }
...
OpenAPI_sm_context_create_data_t *OpenAPI_sm_context_create_data_copy(OpenAPI_sm_context_create_data_t *dst, OpenAPI_sm_context_create_data_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_sm_context_create_data_convertToJSON() failed");
        return NULL;
    }
