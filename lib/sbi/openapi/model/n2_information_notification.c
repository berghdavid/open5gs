...
)
{
    ...
    log_assert(n2_information_notification_local_var);
...
cJSON *OpenAPI_n2_information_notification_convertToJSON(OpenAPI_n2_information_notification_t *n2_information_notification)
{
    ...
    if (n2_information_notification == NULL) {
        log_error("OpenAPI_n2_information_notification_convertToJSON() failed [N2InformationNotification]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!n2_information_notification->n2_notify_subscription_id) {
        log_error("OpenAPI_n2_information_notification_convertToJSON() failed [n2_notify_subscription_id]");
        return NULL;
    }
    ...
    if (n2_info_container_local_JSON == NULL) {
        log_error("OpenAPI_n2_information_notification_convertToJSON() failed [n2_info_container]");
        goto end;
    }
    ...
    if (to_release_session_listList == NULL) {
        log_error("OpenAPI_n2_information_notification_convertToJSON() failed [to_release_session_list]");
        goto end;
    }
    OpenAPI_list_for_each(n2_information_notification->to_release_session_list, node) {
        if (node->data == NULL) {
    ...
    if (cJSON_AddStringToObject(item, "lcsCorrelationId", n2_information_notification->lcs_correlation_id) == NULL) {
        log_error("OpenAPI_n2_information_notification_convertToJSON() failed [lcs_correlation_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "notifyReason", OpenAPI_n2_info_notify_reason_ToString(n2_information_notification->notify_reason)) == NULL) {
        log_error("OpenAPI_n2_information_notification_convertToJSON() failed [notify_reason]");
        goto end;
    }
    }
    ...
    if (smf_change_info_listList == NULL) {
        log_error("OpenAPI_n2_information_notification_convertToJSON() failed [smf_change_info_list]");
        goto end;
    }
    OpenAPI_list_for_each(n2_information_notification->smf_change_info_list, node) {
    ...
    if (ran_node_id_local_JSON == NULL) {
        log_error("OpenAPI_n2_information_notification_convertToJSON() failed [ran_node_id]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "initialAmfName", n2_information_notification->initial_amf_name) == NULL) {
        log_error("OpenAPI_n2_information_notification_convertToJSON() failed [initial_amf_name]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "anN2IPv4Addr", n2_information_notification->an_n2_ipv4_addr) == NULL) {
        log_error("OpenAPI_n2_information_notification_convertToJSON() failed [an_n2_ipv4_addr]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "anN2IPv6Addr", n2_information_notification->an_n2_ipv6_addr) == NULL) {
        log_error("OpenAPI_n2_information_notification_convertToJSON() failed [an_n2_ipv6_addr]");
        goto end;
    }
    }
    ...
    if (guami_local_JSON == NULL) {
        log_error("OpenAPI_n2_information_notification_convertToJSON() failed [guami]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "notifySourceNgRan", n2_information_notification->notify_source_ng_ran) == NULL) {
        log_error("OpenAPI_n2_information_notification_convertToJSON() failed [notify_source_ng_ran]");
        goto end;
    }
    }
...
OpenAPI_n2_information_notification_t *OpenAPI_n2_information_notification_parseFromJSON(cJSON *n2_information_notificationJSON)
{
    ...
    if (!n2_notify_subscription_id) {
        log_error("OpenAPI_n2_information_notification_parseFromJSON() failed [n2_notify_subscription_id]");
        goto end;
    }
    ...
    if (!n2_info_container_local_nonprim) {
        log_error("OpenAPI_n2_info_container_parseFromJSON failed [n2_info_container]");
        goto end;
    }
    }
    ...
    if (to_release_session_list) {
        ...
        if (!cJSON_IsArray(to_release_session_list)) {
            log_error("OpenAPI_n2_information_notification_parseFromJSON() failed [to_release_session_list]");
            goto end;
        }
    ...
    if (!cJSON_IsString(lcs_correlation_id) && !cJSON_IsNull(lcs_correlation_id)) {
        log_error("OpenAPI_n2_information_notification_parseFromJSON() failed [lcs_correlation_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(notify_reason)) {
        log_error("OpenAPI_n2_information_notification_parseFromJSON() failed [notify_reason]");
        goto end;
    }
    ...
    if (smf_change_info_list) {
        ...
        if (!cJSON_IsArray(smf_change_info_list)) {
            log_error("OpenAPI_n2_information_notification_parseFromJSON() failed [smf_change_info_list]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(smf_change_info_list_local, smf_change_info_list) {
            ...
            if (!smf_change_info_listItem) {
                log_error("No smf_change_info_listItem");
                goto end;
            }
    ...
    if (!cJSON_IsString(initial_amf_name) && !cJSON_IsNull(initial_amf_name)) {
        log_error("OpenAPI_n2_information_notification_parseFromJSON() failed [initial_amf_name]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(an_n2_ipv4_addr) && !cJSON_IsNull(an_n2_ipv4_addr)) {
        log_error("OpenAPI_n2_information_notification_parseFromJSON() failed [an_n2_ipv4_addr]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(an_n2_ipv6_addr) && !cJSON_IsNull(an_n2_ipv6_addr)) {
        log_error("OpenAPI_n2_information_notification_parseFromJSON() failed [an_n2_ipv6_addr]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(notify_source_ng_ran)) {
        log_error("OpenAPI_n2_information_notification_parseFromJSON() failed [notify_source_ng_ran]");
        goto end;
    }
    }
...
OpenAPI_n2_information_notification_t *OpenAPI_n2_information_notification_copy(OpenAPI_n2_information_notification_t *dst, OpenAPI_n2_information_notification_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_n2_information_notification_convertToJSON() failed");
        return NULL;
    }
