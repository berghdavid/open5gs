...
)
{
    ...
    log_assert(pro_se_authentication_ctx_local_var);
...
cJSON *OpenAPI_pro_se_authentication_ctx_convertToJSON(OpenAPI_pro_se_authentication_ctx_t *pro_se_authentication_ctx)
{
    ...
    if (pro_se_authentication_ctx == NULL) {
        log_error("OpenAPI_pro_se_authentication_ctx_convertToJSON() failed [ProSeAuthenticationCtx]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (pro_se_authentication_ctx->auth_type == OpenAPI_auth_type_NULL) {
        log_error("OpenAPI_pro_se_authentication_ctx_convertToJSON() failed [auth_type]");
        return NULL;
    }
    ...
    if (!pro_se_authentication_ctx->_links) {
        log_error("OpenAPI_pro_se_authentication_ctx_convertToJSON() failed [_links]");
        return NULL;
    }
    ...
    if (pro_se_authentication_ctx->_links) {
        OpenAPI_list_for_each(pro_se_authentication_ctx->_links, node) {
            ...
            cJSON *itemLocal = localKeyValue->value ?
                ...
                cJSON_CreateNull();
            if (itemLocal == NULL) {
                log_error("OpenAPI_pro_se_authentication_ctx_convertToJSON() failed [inner]");
                goto end;
            }
    ...
    if (!pro_se_authentication_ctx->pro_se_auth_data) {
        log_error("OpenAPI_pro_se_authentication_ctx_convertToJSON() failed [pro_se_auth_data]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", pro_se_authentication_ctx->supported_features) == NULL) {
        log_error("OpenAPI_pro_se_authentication_ctx_convertToJSON() failed [supported_features]");
        goto end;
    }
    }
...
OpenAPI_pro_se_authentication_ctx_t *OpenAPI_pro_se_authentication_ctx_parseFromJSON(cJSON *pro_se_authentication_ctxJSON)
{
    ...
    if (!auth_type) {
        log_error("OpenAPI_pro_se_authentication_ctx_parseFromJSON() failed [auth_type]");
        goto end;
    }
    ...
    if (!_links) {
        log_error("OpenAPI_pro_se_authentication_ctx_parseFromJSON() failed [_links]");
        goto end;
    }
        ...
        if (cJSON_IsObject(_links)) {
            ...
            cJSON_ArrayForEach(_links_local_map, _links) {
                ...
                if (cJSON_IsObject(localMapObject)) {
                    ...
                    log_error("OpenAPI_pro_se_authentication_ctx_parseFromJSON() failed [inner]");
                    goto end;
                }
    ...
    if (!pro_se_auth_data) {
        log_error("OpenAPI_pro_se_authentication_ctx_parseFromJSON() failed [pro_se_auth_data]");
        goto end;
    }
    pro_se_auth_data_local_nonprim = OpenAPI_pro_se_auth_data_parseFromJSON(pro_se_auth_data);
    if (!pro_se_auth_data_local_nonprim) {
        log_error("OpenAPI_pro_se_auth_data_parseFromJSON failed [pro_se_auth_data]");
        goto end;
    }
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_pro_se_authentication_ctx_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
...
OpenAPI_pro_se_authentication_ctx_t *OpenAPI_pro_se_authentication_ctx_copy(OpenAPI_pro_se_authentication_ctx_t *dst, OpenAPI_pro_se_authentication_ctx_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_pro_se_authentication_ctx_convertToJSON() failed");
        return NULL;
    }
