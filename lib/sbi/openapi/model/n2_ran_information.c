...
)
{
    ...
    log_assert(n2_ran_information_local_var);
...
cJSON *OpenAPI_n2_ran_information_convertToJSON(OpenAPI_n2_ran_information_t *n2_ran_information)
{
    ...
    if (n2_ran_information == NULL) {
        log_error("OpenAPI_n2_ran_information_convertToJSON() failed [N2RanInformation]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!n2_ran_information->n2_info_content) {
        log_error("OpenAPI_n2_ran_information_convertToJSON() failed [n2_info_content]");
        return NULL;
    }
...
OpenAPI_n2_ran_information_t *OpenAPI_n2_ran_information_parseFromJSON(cJSON *n2_ran_informationJSON)
{
    ...
    if (!n2_info_content) {
        log_error("OpenAPI_n2_ran_information_parseFromJSON() failed [n2_info_content]");
        goto end;
    }
...
OpenAPI_n2_ran_information_t *OpenAPI_n2_ran_information_copy(OpenAPI_n2_ran_information_t *dst, OpenAPI_n2_ran_information_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_n2_ran_information_convertToJSON() failed");
        return NULL;
    }
