...
)
{
    ...
    log_assert(nidd_information_1_local_var);
...
cJSON *OpenAPI_nidd_information_1_convertToJSON(OpenAPI_nidd_information_1_t *nidd_information_1)
{
    ...
    if (nidd_information_1 == NULL) {
        log_error("OpenAPI_nidd_information_1_convertToJSON() failed [NiddInformation_1]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!nidd_information_1->af_id) {
        log_error("OpenAPI_nidd_information_1_convertToJSON() failed [af_id]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "gpsi", nidd_information_1->gpsi) == NULL) {
        log_error("OpenAPI_nidd_information_1_convertToJSON() failed [gpsi]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "extGroupId", nidd_information_1->ext_group_id) == NULL) {
        log_error("OpenAPI_nidd_information_1_convertToJSON() failed [ext_group_id]");
        goto end;
    }
    }
...
OpenAPI_nidd_information_1_t *OpenAPI_nidd_information_1_parseFromJSON(cJSON *nidd_information_1JSON)
{
    ...
    if (!af_id) {
        log_error("OpenAPI_nidd_information_1_parseFromJSON() failed [af_id]");
        goto end;
    }
    ...
    if (!cJSON_IsString(gpsi) && !cJSON_IsNull(gpsi)) {
        log_error("OpenAPI_nidd_information_1_parseFromJSON() failed [gpsi]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(ext_group_id) && !cJSON_IsNull(ext_group_id)) {
        log_error("OpenAPI_nidd_information_1_parseFromJSON() failed [ext_group_id]");
        goto end;
    }
    }
...
OpenAPI_nidd_information_1_t *OpenAPI_nidd_information_1_copy(OpenAPI_nidd_information_1_t *dst, OpenAPI_nidd_information_1_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_nidd_information_1_convertToJSON() failed");
        return NULL;
    }
