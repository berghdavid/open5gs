...
)
{
    ...
    log_assert(registration_context_container_local_var);
...
cJSON *OpenAPI_registration_context_container_convertToJSON(OpenAPI_registration_context_container_t *registration_context_container)
{
    ...
    if (registration_context_container == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [RegistrationContextContainer]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!registration_context_container->ue_context) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [ue_context]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "localTimeZone", registration_context_container->local_time_zone) == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [local_time_zone]");
        goto end;
    }
    }

    if (registration_context_container->an_type == OpenAPI_access_type_NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [an_type]");
        return NULL;
    }
    ...
    if (cJSON_AddNumberToObject(item, "anN2ApId", registration_context_container->an_n2_ap_id) == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [an_n2_ap_id]");
        goto end;
    }

    if (!registration_context_container->ran_node_id) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [ran_node_id]");
        return NULL;
    }
    ...
    if (!registration_context_container->initial_amf_name) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [initial_amf_name]");
        return NULL;
    }
    ...
    if (!registration_context_container->user_location) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [user_location]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "rrcEstCause", registration_context_container->rrc_est_cause) == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [rrc_est_cause]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "ueContextRequest", registration_context_container->ue_context_request) == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [ue_context_request]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "initialAmfN2ApId", registration_context_container->initial_amf_n2_ap_id) == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [initial_amf_n2_ap_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "anN2IPv4Addr", registration_context_container->an_n2_ipv4_addr) == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [an_n2_ipv4_addr]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "anN2IPv6Addr", registration_context_container->an_n2_ipv6_addr) == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [an_n2_ipv6_addr]");
        goto end;
    }
    }
    ...
    if (allowed_nssai_local_JSON == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [allowed_nssai]");
        goto end;
    }
    ...
    if (configured_nssaiList == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [configured_nssai]");
        goto end;
    }
    OpenAPI_list_for_each(registration_context_container->configured_nssai, node) {
    ...
    if (rejected_nssai_in_plmnList == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [rejected_nssai_in_plmn]");
        goto end;
    }
    OpenAPI_list_for_each(registration_context_container->rejected_nssai_in_plmn, node) {
    ...
    if (rejected_nssai_in_taList == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [rejected_nssai_in_ta]");
        goto end;
    }
    OpenAPI_list_for_each(registration_context_container->rejected_nssai_in_ta, node) {
        cJSON *itemLocal = OpenAPI_snssai_convertToJSON(node->data);
    ...
    if (selected_plmn_id_local_JSON == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [selected_plmn_id]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "iabNodeInd", registration_context_container->iab_node_ind) == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [iab_node_ind]");
        goto end;
    }
    }
    ...
    if (ce_mode_b_ind_local_JSON == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [ce_mode_b_ind]");
        goto end;
    }
    ...
    if (lte_m_ind_local_JSON == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [lte_m_ind]");
        goto end;
    }
    ...
    if (cJSON_AddBoolToObject(item, "authenticatedInd", registration_context_container->authenticated_ind) == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [authenticated_ind]");
        goto end;
    }
    }
    ...
    if (npn_access_info_local_JSON == NULL) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed [npn_access_info]");
        goto end;
    }
...
OpenAPI_registration_context_container_t *OpenAPI_registration_context_container_parseFromJSON(cJSON *registration_context_containerJSON)
{
    ...
    if (!ue_context) {
        log_error("OpenAPI_registration_context_container_parseFromJSON() failed [ue_context]");
        goto end;
    }
    ...
    if (!cJSON_IsString(local_time_zone) && !cJSON_IsNull(local_time_zone)) {
        log_error("OpenAPI_registration_context_container_parseFromJSON() failed [local_time_zone]");
        goto end;
    }
    }
    ...
    if (!an_type) {
        log_error("OpenAPI_registration_context_container_parseFromJSON() failed [an_type]");
        goto end;
    }
    ...
    if (!an_n2_ap_id) {
        log_error("OpenAPI_registration_context_container_parseFromJSON() failed [an_n2_ap_id]");
        goto end;
    }
    ...
    if (!ran_node_id) {
        log_error("OpenAPI_registration_context_container_parseFromJSON() failed [ran_node_id]");
        goto end;
    }
    ran_node_id_local_nonprim = OpenAPI_global_ran_node_id_parseFromJSON(ran_node_id);
    if (!ran_node_id_local_nonprim) {
        log_error("OpenAPI_global_ran_node_id_parseFromJSON failed [ran_node_id]");
        goto end;
    }

    initial_amf_name = cJSON_GetObjectItemCaseSensitive(registration_context_containerJSON, "initialAmfName");
    if (!initial_amf_name) {
        log_error("OpenAPI_registration_context_container_parseFromJSON() failed [initial_amf_name]");
        goto end;
    }
    ...
    if (!user_location) {
        log_error("OpenAPI_registration_context_container_parseFromJSON() failed [user_location]");
        goto end;
    }
    user_location_local_nonprim = OpenAPI_user_location_parseFromJSON(user_location);
    if (!user_location_local_nonprim) {
        log_error("OpenAPI_user_location_parseFromJSON failed [user_location]");
        goto end;
    }
    ...
    if (!cJSON_IsString(rrc_est_cause) && !cJSON_IsNull(rrc_est_cause)) {
        log_error("OpenAPI_registration_context_container_parseFromJSON() failed [rrc_est_cause]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(ue_context_request)) {
        log_error("OpenAPI_registration_context_container_parseFromJSON() failed [ue_context_request]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(initial_amf_n2_ap_id)) {
        log_error("OpenAPI_registration_context_container_parseFromJSON() failed [initial_amf_n2_ap_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(an_n2_ipv4_addr) && !cJSON_IsNull(an_n2_ipv4_addr)) {
        log_error("OpenAPI_registration_context_container_parseFromJSON() failed [an_n2_ipv4_addr]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(an_n2_ipv6_addr) && !cJSON_IsNull(an_n2_ipv6_addr)) {
        log_error("OpenAPI_registration_context_container_parseFromJSON() failed [an_n2_ipv6_addr]");
        goto end;
    }
    }
    ...
    if (!allowed_nssai_local_nonprim) {
        log_error("OpenAPI_allowed_nssai_parseFromJSON failed [allowed_nssai]");
        goto end;
    }
    }
    ...
    if (configured_nssai) {
        ...
        if (!cJSON_IsArray(configured_nssai)) {
            log_error("OpenAPI_registration_context_container_parseFromJSON() failed [configured_nssai]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(configured_nssai_local, configured_nssai) {
            ...
            if (!configured_nssaiItem) {
                log_error("No configured_nssaiItem");
                goto end;
            }
    ...
    if (rejected_nssai_in_plmn) {
        ...
        if (!cJSON_IsArray(rejected_nssai_in_plmn)) {
            log_error("OpenAPI_registration_context_container_parseFromJSON() failed [rejected_nssai_in_plmn]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(rejected_nssai_in_plmn_local, rejected_nssai_in_plmn) {
            ...
            if (!rejected_nssai_in_plmnItem) {
                log_error("No rejected_nssai_in_plmnItem");
                goto end;
            }
    ...
    if (rejected_nssai_in_ta) {
        ...
        if (!cJSON_IsArray(rejected_nssai_in_ta)) {
            log_error("OpenAPI_registration_context_container_parseFromJSON() failed [rejected_nssai_in_ta]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(rejected_nssai_in_ta_local, rejected_nssai_in_ta) {
            ...
            if (!rejected_nssai_in_taItem) {
                log_error("No rejected_nssai_in_taItem");
                goto end;
            }
    ...
    if (!selected_plmn_id_local_nonprim) {
        log_error("OpenAPI_plmn_id_parseFromJSON failed [selected_plmn_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(iab_node_ind)) {
        log_error("OpenAPI_registration_context_container_parseFromJSON() failed [iab_node_ind]");
        goto end;
    }
    }
    ...
    if (!ce_mode_b_ind_local_nonprim) {
        log_error("OpenAPI_ce_mode_b_ind_parseFromJSON failed [ce_mode_b_ind]");
        goto end;
    }
    }
    ...
    if (!lte_m_ind_local_nonprim) {
        log_error("OpenAPI_lte_m_ind_parseFromJSON failed [lte_m_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(authenticated_ind)) {
        log_error("OpenAPI_registration_context_container_parseFromJSON() failed [authenticated_ind]");
        goto end;
    }
    }
    ...
    if (!npn_access_info_local_nonprim) {
        log_error("OpenAPI_npn_access_info_parseFromJSON failed [npn_access_info]");
        goto end;
    }
    }
...
OpenAPI_registration_context_container_t *OpenAPI_registration_context_container_copy(OpenAPI_registration_context_container_t *dst, OpenAPI_registration_context_container_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_registration_context_container_convertToJSON() failed");
        return NULL;
    }
