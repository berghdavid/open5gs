...
)
{
    ...
    log_assert(authentication_subscription_local_var);
...
cJSON *OpenAPI_authentication_subscription_convertToJSON(OpenAPI_authentication_subscription_t *authentication_subscription)
{
    ...
    if (authentication_subscription == NULL) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed [AuthenticationSubscription]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (authentication_subscription->authentication_method == OpenAPI_auth_method_NULL) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed [authentication_method]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "encPermanentKey", authentication_subscription->enc_permanent_key) == NULL) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed [enc_permanent_key]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "protectionParameterId", authentication_subscription->protection_parameter_id) == NULL) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed [protection_parameter_id]");
        goto end;
    }
    }
    ...
    if (sequence_number_local_JSON == NULL) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed [sequence_number]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "authenticationManagementField", authentication_subscription->authentication_management_field) == NULL) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed [authentication_management_field]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "algorithmId", authentication_subscription->algorithm_id) == NULL) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed [algorithm_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "encOpcKey", authentication_subscription->enc_opc_key) == NULL) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed [enc_opc_key]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "encTopcKey", authentication_subscription->enc_topc_key) == NULL) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed [enc_topc_key]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "vectorGenerationInHss", authentication_subscription->vector_generation_in_hss) == NULL) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed [vector_generation_in_hss]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "hssGroupId", authentication_subscription->hss_group_id) == NULL) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed [hss_group_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "n5gcAuthMethod", OpenAPI_auth_method_ToString(authentication_subscription->n5gc_auth_method)) == NULL) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed [n5gc_auth_method]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "rgAuthenticationInd", authentication_subscription->rg_authentication_ind) == NULL) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed [rg_authentication_ind]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "supi", authentication_subscription->supi) == NULL) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed [supi]");
        goto end;
    }
    }
    ...
    if (cJSON_AddBoolToObject(item, "akmaAllowed", authentication_subscription->akma_allowed) == NULL) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed [akma_allowed]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "routingId", authentication_subscription->routing_id) == NULL) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed [routing_id]");
        goto end;
    }
    }
...
OpenAPI_authentication_subscription_t *OpenAPI_authentication_subscription_parseFromJSON(cJSON *authentication_subscriptionJSON)
{
    ...
    if (!authentication_method) {
        log_error("OpenAPI_authentication_subscription_parseFromJSON() failed [authentication_method]");
        goto end;
    }
    ...
    if (!cJSON_IsString(enc_permanent_key) && !cJSON_IsNull(enc_permanent_key)) {
        log_error("OpenAPI_authentication_subscription_parseFromJSON() failed [enc_permanent_key]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(protection_parameter_id) && !cJSON_IsNull(protection_parameter_id)) {
        log_error("OpenAPI_authentication_subscription_parseFromJSON() failed [protection_parameter_id]");
        goto end;
    }
    }
    ...
    if (!sequence_number_local_nonprim) {
        log_error("OpenAPI_sequence_number_parseFromJSON failed [sequence_number]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(authentication_management_field) && !cJSON_IsNull(authentication_management_field)) {
        log_error("OpenAPI_authentication_subscription_parseFromJSON() failed [authentication_management_field]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(algorithm_id) && !cJSON_IsNull(algorithm_id)) {
        log_error("OpenAPI_authentication_subscription_parseFromJSON() failed [algorithm_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(enc_opc_key) && !cJSON_IsNull(enc_opc_key)) {
        log_error("OpenAPI_authentication_subscription_parseFromJSON() failed [enc_opc_key]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(enc_topc_key) && !cJSON_IsNull(enc_topc_key)) {
        log_error("OpenAPI_authentication_subscription_parseFromJSON() failed [enc_topc_key]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(vector_generation_in_hss)) {
        log_error("OpenAPI_authentication_subscription_parseFromJSON() failed [vector_generation_in_hss]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(hss_group_id) && !cJSON_IsNull(hss_group_id)) {
        log_error("OpenAPI_authentication_subscription_parseFromJSON() failed [hss_group_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(n5gc_auth_method)) {
        log_error("OpenAPI_authentication_subscription_parseFromJSON() failed [n5gc_auth_method]");
        goto end;
    }
    ...
    if (!cJSON_IsBool(rg_authentication_ind)) {
        log_error("OpenAPI_authentication_subscription_parseFromJSON() failed [rg_authentication_ind]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(supi) && !cJSON_IsNull(supi)) {
        log_error("OpenAPI_authentication_subscription_parseFromJSON() failed [supi]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsBool(akma_allowed)) {
        log_error("OpenAPI_authentication_subscription_parseFromJSON() failed [akma_allowed]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(routing_id) && !cJSON_IsNull(routing_id)) {
        log_error("OpenAPI_authentication_subscription_parseFromJSON() failed [routing_id]");
        goto end;
    }
    }
...
OpenAPI_authentication_subscription_t *OpenAPI_authentication_subscription_copy(OpenAPI_authentication_subscription_t *dst, OpenAPI_authentication_subscription_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_authentication_subscription_convertToJSON() failed");
        return NULL;
    }
