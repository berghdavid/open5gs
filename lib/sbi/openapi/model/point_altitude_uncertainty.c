...
)
{
    ...
    log_assert(point_altitude_uncertainty_local_var);
...
cJSON *OpenAPI_point_altitude_uncertainty_convertToJSON(OpenAPI_point_altitude_uncertainty_t *point_altitude_uncertainty)
{
    ...
    if (point_altitude_uncertainty == NULL) {
        log_error("OpenAPI_point_altitude_uncertainty_convertToJSON() failed [PointAltitudeUncertainty]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!point_altitude_uncertainty->shape) {
        log_error("OpenAPI_point_altitude_uncertainty_convertToJSON() failed [shape]");
        return NULL;
    }
    ...
    if (!point_altitude_uncertainty->point) {
        log_error("OpenAPI_point_altitude_uncertainty_convertToJSON() failed [point]");
        return NULL;
    }
    ...
    if (cJSON_AddNumberToObject(item, "altitude", point_altitude_uncertainty->altitude) == NULL) {
        log_error("OpenAPI_point_altitude_uncertainty_convertToJSON() failed [altitude]");
        goto end;
    }

    if (!point_altitude_uncertainty->uncertainty_ellipse) {
        log_error("OpenAPI_point_altitude_uncertainty_convertToJSON() failed [uncertainty_ellipse]");
        return NULL;
    }
    ...
    if (cJSON_AddNumberToObject(item, "uncertaintyAltitude", point_altitude_uncertainty->uncertainty_altitude) == NULL) {
        log_error("OpenAPI_point_altitude_uncertainty_convertToJSON() failed [uncertainty_altitude]");
        goto end;
    }

    if (cJSON_AddNumberToObject(item, "confidence", point_altitude_uncertainty->confidence) == NULL) {
        log_error("OpenAPI_point_altitude_uncertainty_convertToJSON() failed [confidence]");
        goto end;
    }
...
OpenAPI_point_altitude_uncertainty_t *OpenAPI_point_altitude_uncertainty_parseFromJSON(cJSON *point_altitude_uncertaintyJSON)
{
    ...
    if (!shape) {
        log_error("OpenAPI_point_altitude_uncertainty_parseFromJSON() failed [shape]");
        goto end;
    }
    ...
    if (!point) {
        log_error("OpenAPI_point_altitude_uncertainty_parseFromJSON() failed [point]");
        goto end;
    }
    ...
    if (!altitude) {
        log_error("OpenAPI_point_altitude_uncertainty_parseFromJSON() failed [altitude]");
        goto end;
    }
    ...
    if (!uncertainty_ellipse) {
        log_error("OpenAPI_point_altitude_uncertainty_parseFromJSON() failed [uncertainty_ellipse]");
        goto end;
    }
    ...
    if (!uncertainty_altitude) {
        log_error("OpenAPI_point_altitude_uncertainty_parseFromJSON() failed [uncertainty_altitude]");
        goto end;
    }
    ...
    if (!confidence) {
        log_error("OpenAPI_point_altitude_uncertainty_parseFromJSON() failed [confidence]");
        goto end;
    }
...
OpenAPI_point_altitude_uncertainty_t *OpenAPI_point_altitude_uncertainty_copy(OpenAPI_point_altitude_uncertainty_t *dst, OpenAPI_point_altitude_uncertainty_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_point_altitude_uncertainty_convertToJSON() failed");
        return NULL;
    }
