...
)
{
    ...
    log_assert(up_security_1_local_var);
...
cJSON *OpenAPI_up_security_1_convertToJSON(OpenAPI_up_security_1_t *up_security_1)
{
    ...
    if (up_security_1 == NULL) {
        log_error("OpenAPI_up_security_1_convertToJSON() failed [UpSecurity_1]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (up_security_1->up_integr == OpenAPI_up_integrity_NULL) {
        log_error("OpenAPI_up_security_1_convertToJSON() failed [up_integr]");
        return NULL;
    }
    ...
    if (up_security_1->up_confid == OpenAPI_up_confidentiality_NULL) {
        log_error("OpenAPI_up_security_1_convertToJSON() failed [up_confid]");
        return NULL;
    }
...
OpenAPI_up_security_1_t *OpenAPI_up_security_1_parseFromJSON(cJSON *up_security_1JSON)
{
    ...
    if (!up_integr) {
        log_error("OpenAPI_up_security_1_parseFromJSON() failed [up_integr]");
        goto end;
    }
    ...
    if (!up_confid) {
        log_error("OpenAPI_up_security_1_parseFromJSON() failed [up_confid]");
        goto end;
    }
...
OpenAPI_up_security_1_t *OpenAPI_up_security_1_copy(OpenAPI_up_security_1_t *dst, OpenAPI_up_security_1_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_up_security_1_convertToJSON() failed");
        return NULL;
    }
