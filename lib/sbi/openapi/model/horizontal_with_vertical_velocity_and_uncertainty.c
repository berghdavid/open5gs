...
)
{
    ...
    log_assert(horizontal_with_vertical_velocity_and_uncertainty_local_var);
...
cJSON *OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_convertToJSON(OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_t *horizontal_with_vertical_velocity_and_uncertainty)
{
    ...
    if (horizontal_with_vertical_velocity_and_uncertainty == NULL) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_convertToJSON() failed [HorizontalWithVerticalVelocityAndUncertainty]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (cJSON_AddNumberToObject(item, "hSpeed", horizontal_with_vertical_velocity_and_uncertainty->h_speed) == NULL) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_convertToJSON() failed [h_speed]");
        goto end;
    }

    if (cJSON_AddNumberToObject(item, "bearing", horizontal_with_vertical_velocity_and_uncertainty->bearing) == NULL) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_convertToJSON() failed [bearing]");
        goto end;
    }

    if (cJSON_AddNumberToObject(item, "vSpeed", horizontal_with_vertical_velocity_and_uncertainty->v_speed) == NULL) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_convertToJSON() failed [v_speed]");
        goto end;
    }

    if (horizontal_with_vertical_velocity_and_uncertainty->v_direction == OpenAPI_vertical_direction_NULL) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_convertToJSON() failed [v_direction]");
        return NULL;
    }
    ...
    if (cJSON_AddNumberToObject(item, "hUncertainty", horizontal_with_vertical_velocity_and_uncertainty->h_uncertainty) == NULL) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_convertToJSON() failed [h_uncertainty]");
        goto end;
    }

    if (cJSON_AddNumberToObject(item, "vUncertainty", horizontal_with_vertical_velocity_and_uncertainty->v_uncertainty) == NULL) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_convertToJSON() failed [v_uncertainty]");
        goto end;
    }
...
OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_t *OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_parseFromJSON(cJSON *horizontal_with_vertical_velocity_and_uncertaintyJSON)
{
    ...
    if (!h_speed) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_parseFromJSON() failed [h_speed]");
        goto end;
    }
    ...
    if (!bearing) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_parseFromJSON() failed [bearing]");
        goto end;
    }
    ...
    if (!v_speed) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_parseFromJSON() failed [v_speed]");
        goto end;
    }
    ...
    if (!v_direction) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_parseFromJSON() failed [v_direction]");
        goto end;
    }
    ...
    if (!h_uncertainty) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_parseFromJSON() failed [h_uncertainty]");
        goto end;
    }
    ...
    if (!v_uncertainty) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_parseFromJSON() failed [v_uncertainty]");
        goto end;
    }
...
OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_t *OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_copy(OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_t *dst, OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_horizontal_with_vertical_velocity_and_uncertainty_convertToJSON() failed");
        return NULL;
    }
