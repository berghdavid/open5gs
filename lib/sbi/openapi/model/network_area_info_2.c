...
)
{
    ...
    log_assert(network_area_info_2_local_var);
...
cJSON *OpenAPI_network_area_info_2_convertToJSON(OpenAPI_network_area_info_2_t *network_area_info_2)
{
    ...
    if (network_area_info_2 == NULL) {
        log_error("OpenAPI_network_area_info_2_convertToJSON() failed [NetworkAreaInfo_2]");
        return NULL;
    }
    ...
    if (ecgisList == NULL) {
        log_error("OpenAPI_network_area_info_2_convertToJSON() failed [ecgis]");
        goto end;
    }
    OpenAPI_list_for_each(network_area_info_2->ecgis, node) {
    ...
    if (ncgisList == NULL) {
        log_error("OpenAPI_network_area_info_2_convertToJSON() failed [ncgis]");
        goto end;
    }
    OpenAPI_list_for_each(network_area_info_2->ncgis, node) {
    ...
    if (g_ran_node_idsList == NULL) {
        log_error("OpenAPI_network_area_info_2_convertToJSON() failed [g_ran_node_ids]");
        goto end;
    }
    OpenAPI_list_for_each(network_area_info_2->g_ran_node_ids, node) {
    ...
    if (taisList == NULL) {
        log_error("OpenAPI_network_area_info_2_convertToJSON() failed [tais]");
        goto end;
    }
    OpenAPI_list_for_each(network_area_info_2->tais, node) {
...
OpenAPI_network_area_info_2_t *OpenAPI_network_area_info_2_parseFromJSON(cJSON *network_area_info_2JSON)
{
    ...
    if (ecgis) {
        ...
        if (!cJSON_IsArray(ecgis)) {
            log_error("OpenAPI_network_area_info_2_parseFromJSON() failed [ecgis]");
            goto end;
        }
    ...
    if (ncgis) {
        ...
        if (!cJSON_IsArray(ncgis)) {
            log_error("OpenAPI_network_area_info_2_parseFromJSON() failed [ncgis]");
            goto end;
        }
    ...
    if (g_ran_node_ids) {
        ...
        if (!cJSON_IsArray(g_ran_node_ids)) {
            log_error("OpenAPI_network_area_info_2_parseFromJSON() failed [g_ran_node_ids]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(g_ran_node_ids_local, g_ran_node_ids) {
            ...
            if (!g_ran_node_idsItem) {
                log_error("No g_ran_node_idsItem");
                goto end;
            }
    ...
    if (tais) {
        ...
        if (!cJSON_IsArray(tais)) {
            log_error("OpenAPI_network_area_info_2_parseFromJSON() failed [tais]");
            goto end;
        }
...
OpenAPI_network_area_info_2_t *OpenAPI_network_area_info_2_copy(OpenAPI_network_area_info_2_t *dst, OpenAPI_network_area_info_2_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_network_area_info_2_convertToJSON() failed");
        return NULL;
    }
