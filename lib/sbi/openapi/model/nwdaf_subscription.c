...
)
{
    ...
    log_assert(nwdaf_subscription_local_var);
...
cJSON *OpenAPI_nwdaf_subscription_convertToJSON(OpenAPI_nwdaf_subscription_t *nwdaf_subscription)
{
    ...
    if (nwdaf_subscription == NULL) {
        log_error("OpenAPI_nwdaf_subscription_convertToJSON() failed [NwdafSubscription]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!nwdaf_subscription->nwdaf_evt_subs_service_uri) {
        log_error("OpenAPI_nwdaf_subscription_convertToJSON() failed [nwdaf_evt_subs_service_uri]");
        return NULL;
    }
    ...
    if (!nwdaf_subscription->nwdaf_events_subscription) {
        log_error("OpenAPI_nwdaf_subscription_convertToJSON() failed [nwdaf_events_subscription]");
        return NULL;
    }
...
OpenAPI_nwdaf_subscription_t *OpenAPI_nwdaf_subscription_parseFromJSON(cJSON *nwdaf_subscriptionJSON)
{
    ...
    if (!nwdaf_evt_subs_service_uri) {
        log_error("OpenAPI_nwdaf_subscription_parseFromJSON() failed [nwdaf_evt_subs_service_uri]");
        goto end;
    }
    ...
    if (!nwdaf_events_subscription) {
        log_error("OpenAPI_nwdaf_subscription_parseFromJSON() failed [nwdaf_events_subscription]");
        goto end;
    }
    ...
    if (!nwdaf_events_subscription_local_nonprim) {
        log_error("OpenAPI_nnwdaf_events_subscription_parseFromJSON failed [nwdaf_events_subscription]");
        goto end;
    }
...
OpenAPI_nwdaf_subscription_t *OpenAPI_nwdaf_subscription_copy(OpenAPI_nwdaf_subscription_t *dst, OpenAPI_nwdaf_subscription_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_nwdaf_subscription_convertToJSON() failed");
        return NULL;
    }
