...
)
{
    ...
    log_assert(non_ue_n2_info_subscription_create_data_local_var);
...
cJSON *OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON(OpenAPI_non_ue_n2_info_subscription_create_data_t *non_ue_n2_info_subscription_create_data)
{
    ...
    if (non_ue_n2_info_subscription_create_data == NULL) {
        log_error("OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON() failed [NonUeN2InfoSubscriptionCreateData]");
        return NULL;
    }
    ...
    if (global_ran_node_listList == NULL) {
        log_error("OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON() failed [global_ran_node_list]");
        goto end;
    }
    OpenAPI_list_for_each(non_ue_n2_info_subscription_create_data->global_ran_node_list, node) {
    ...
    if (an_type_listList == NULL) {
        log_error("OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON() failed [an_type_list]");
        goto end;
    }
    ...
    if (non_ue_n2_info_subscription_create_data->n2_information_class == OpenAPI_n2_information_class_NULL) {
        log_error("OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON() failed [n2_information_class]");
        return NULL;
    }
    ...
    if (!non_ue_n2_info_subscription_create_data->n2_notify_callback_uri) {
        log_error("OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON() failed [n2_notify_callback_uri]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "nfId", non_ue_n2_info_subscription_create_data->nf_id) == NULL) {
        log_error("OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON() failed [nf_id]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "supportedFeatures", non_ue_n2_info_subscription_create_data->supported_features) == NULL) {
        log_error("OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON() failed [supported_features]");
        goto end;
    }
    }
...
OpenAPI_non_ue_n2_info_subscription_create_data_t *OpenAPI_non_ue_n2_info_subscription_create_data_parseFromJSON(cJSON *non_ue_n2_info_subscription_create_dataJSON)
{
    ...
    if (global_ran_node_list) {
        ...
        if (!cJSON_IsArray(global_ran_node_list)) {
            log_error("OpenAPI_non_ue_n2_info_subscription_create_data_parseFromJSON() failed [global_ran_node_list]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(global_ran_node_list_local, global_ran_node_list) {
            ...
            if (!global_ran_node_listItem) {
                log_error("No global_ran_node_listItem");
                goto end;
            }
    ...
    if (an_type_list) {
        ...
        if (!cJSON_IsArray(an_type_list)) {
            log_error("OpenAPI_non_ue_n2_info_subscription_create_data_parseFromJSON() failed [an_type_list]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(an_type_list_local, an_type_list) {
            ...
            if (!localEnum) {
                log_info("Enum value \"%s\" for field \"an_type_list\" is not supported. Ignoring it ...",
        ...
        if (an_type_listList->count == 0) {
            log_error("OpenAPI_non_ue_n2_info_subscription_create_data_parseFromJSON() failed: Expected an_type_listList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (!n2_information_class) {
        log_error("OpenAPI_non_ue_n2_info_subscription_create_data_parseFromJSON() failed [n2_information_class]");
        goto end;
    }
    ...
    if (!n2_notify_callback_uri) {
        log_error("OpenAPI_non_ue_n2_info_subscription_create_data_parseFromJSON() failed [n2_notify_callback_uri]");
        goto end;
    }
    ...
    if (!cJSON_IsString(nf_id) && !cJSON_IsNull(nf_id)) {
        log_error("OpenAPI_non_ue_n2_info_subscription_create_data_parseFromJSON() failed [nf_id]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsString(supported_features) && !cJSON_IsNull(supported_features)) {
        log_error("OpenAPI_non_ue_n2_info_subscription_create_data_parseFromJSON() failed [supported_features]");
        goto end;
    }
    }
...
OpenAPI_non_ue_n2_info_subscription_create_data_t *OpenAPI_non_ue_n2_info_subscription_create_data_copy(OpenAPI_non_ue_n2_info_subscription_create_data_t *dst, OpenAPI_non_ue_n2_info_subscription_create_data_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON() failed");
        return NULL;
    }
