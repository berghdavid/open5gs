...
)
{
    ...
    log_assert(secondary_rat_usage_report_local_var);
...
cJSON *OpenAPI_secondary_rat_usage_report_convertToJSON(OpenAPI_secondary_rat_usage_report_t *secondary_rat_usage_report)
{
    ...
    if (secondary_rat_usage_report == NULL) {
        log_error("OpenAPI_secondary_rat_usage_report_convertToJSON() failed [SecondaryRatUsageReport]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (secondary_rat_usage_report->secondary_rat_type == OpenAPI_rat_type_NULL) {
        log_error("OpenAPI_secondary_rat_usage_report_convertToJSON() failed [secondary_rat_type]");
        return NULL;
    }
    ...
    if (!secondary_rat_usage_report->qos_flows_usage_data) {
        log_error("OpenAPI_secondary_rat_usage_report_convertToJSON() failed [qos_flows_usage_data]");
        return NULL;
    }
...
OpenAPI_secondary_rat_usage_report_t *OpenAPI_secondary_rat_usage_report_parseFromJSON(cJSON *secondary_rat_usage_reportJSON)
{
    ...
    if (!secondary_rat_type) {
        log_error("OpenAPI_secondary_rat_usage_report_parseFromJSON() failed [secondary_rat_type]");
        goto end;
    }
    ...
    if (!qos_flows_usage_data) {
        log_error("OpenAPI_secondary_rat_usage_report_parseFromJSON() failed [qos_flows_usage_data]");
        goto end;
    }
...
OpenAPI_secondary_rat_usage_report_t *OpenAPI_secondary_rat_usage_report_copy(OpenAPI_secondary_rat_usage_report_t *dst, OpenAPI_secondary_rat_usage_report_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_secondary_rat_usage_report_convertToJSON() failed");
        return NULL;
    }
