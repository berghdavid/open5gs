...
)
{
    ...
    log_assert(patch_result_local_var);
...
cJSON *OpenAPI_patch_result_convertToJSON(OpenAPI_patch_result_t *patch_result)
{
    ...
    if (patch_result == NULL) {
        log_error("OpenAPI_patch_result_convertToJSON() failed [PatchResult]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!patch_result->report) {
        log_error("OpenAPI_patch_result_convertToJSON() failed [report]");
        return NULL;
    }
...
OpenAPI_patch_result_t *OpenAPI_patch_result_parseFromJSON(cJSON *patch_resultJSON)
{
    ...
    if (!report) {
        log_error("OpenAPI_patch_result_parseFromJSON() failed [report]");
        goto end;
    }
...
OpenAPI_patch_result_t *OpenAPI_patch_result_copy(OpenAPI_patch_result_t *dst, OpenAPI_patch_result_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_patch_result_convertToJSON() failed");
        return NULL;
    }
