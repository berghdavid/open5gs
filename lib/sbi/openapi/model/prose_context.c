...
)
{
    ...
    log_assert(prose_context_local_var);
...
cJSON *OpenAPI_prose_context_convertToJSON(OpenAPI_prose_context_t *prose_context)
{
    ...
    if (prose_context == NULL) {
        log_error("OpenAPI_prose_context_convertToJSON() failed [ProseContext]");
        return NULL;
    }
    ...
    if (cJSON_AddStringToObject(item, "directDiscovery", OpenAPI_ue_auth_ToString(prose_context->direct_discovery)) == NULL) {
        log_error("OpenAPI_prose_context_convertToJSON() failed [direct_discovery]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "directComm", OpenAPI_ue_auth_ToString(prose_context->direct_comm)) == NULL) {
        log_error("OpenAPI_prose_context_convertToJSON() failed [direct_comm]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "l2Relay", OpenAPI_ue_auth_ToString(prose_context->l2_relay)) == NULL) {
        log_error("OpenAPI_prose_context_convertToJSON() failed [l2_relay]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "l3Relay", OpenAPI_ue_auth_ToString(prose_context->l3_relay)) == NULL) {
        log_error("OpenAPI_prose_context_convertToJSON() failed [l3_relay]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "l2Remote", OpenAPI_ue_auth_ToString(prose_context->l2_remote)) == NULL) {
        log_error("OpenAPI_prose_context_convertToJSON() failed [l2_remote]");
        goto end;
    }
    }
    ...
    if (cJSON_AddStringToObject(item, "nrUePc5Ambr", prose_context->nr_ue_pc5_ambr) == NULL) {
        log_error("OpenAPI_prose_context_convertToJSON() failed [nr_ue_pc5_ambr]");
        goto end;
    }
    }
    ...
    if (pc5_qo_s_para_local_JSON == NULL) {
        log_error("OpenAPI_prose_context_convertToJSON() failed [pc5_qo_s_para]");
        goto end;
    }
...
OpenAPI_prose_context_t *OpenAPI_prose_context_parseFromJSON(cJSON *prose_contextJSON)
{
    ...
    if (!cJSON_IsString(direct_discovery)) {
        log_error("OpenAPI_prose_context_parseFromJSON() failed [direct_discovery]");
        goto end;
    }
    ...
    if (!cJSON_IsString(direct_comm)) {
        log_error("OpenAPI_prose_context_parseFromJSON() failed [direct_comm]");
        goto end;
    }
    ...
    if (!cJSON_IsString(l2_relay)) {
        log_error("OpenAPI_prose_context_parseFromJSON() failed [l2_relay]");
        goto end;
    }
    ...
    if (!cJSON_IsString(l3_relay)) {
        log_error("OpenAPI_prose_context_parseFromJSON() failed [l3_relay]");
        goto end;
    }
    ...
    if (!cJSON_IsString(l2_remote)) {
        log_error("OpenAPI_prose_context_parseFromJSON() failed [l2_remote]");
        goto end;
    }
    ...
    if (!cJSON_IsString(nr_ue_pc5_ambr) && !cJSON_IsNull(nr_ue_pc5_ambr)) {
        log_error("OpenAPI_prose_context_parseFromJSON() failed [nr_ue_pc5_ambr]");
        goto end;
    }
    }
...
OpenAPI_prose_context_t *OpenAPI_prose_context_copy(OpenAPI_prose_context_t *dst, OpenAPI_prose_context_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_prose_context_convertToJSON() failed");
        return NULL;
    }
