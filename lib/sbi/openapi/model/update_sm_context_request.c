...
)
{
    ...
    log_assert(update_sm_context_request_local_var);
...
cJSON *OpenAPI_update_sm_context_request_convertToJSON(OpenAPI_update_sm_context_request_t *update_sm_context_request)
{
    ...
    if (update_sm_context_request == NULL) {
        log_error("OpenAPI_update_sm_context_request_convertToJSON() failed [UpdateSmContext_request]");
        return NULL;
    }
    ...
    if (json_data_local_JSON == NULL) {
        log_error("OpenAPI_update_sm_context_request_convertToJSON() failed [json_data]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN1SmMessage", encoded_str_binary_data_n1_sm_message) == NULL) {
        log_error("OpenAPI_update_sm_context_request_convertToJSON() failed [binary_data_n1_sm_message]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2SmInformation", encoded_str_binary_data_n2_sm_information) == NULL) {
        log_error("OpenAPI_update_sm_context_request_convertToJSON() failed [binary_data_n2_sm_information]");
        goto end;
    }
    ...
    if (cJSON_AddStringToObject(item, "binaryDataN2SmInformationExt1", encoded_str_binary_data_n2_sm_information_ext1) == NULL) {
        log_error("OpenAPI_update_sm_context_request_convertToJSON() failed [binary_data_n2_sm_information_ext1]");
        goto end;
    }
...
OpenAPI_update_sm_context_request_t *OpenAPI_update_sm_context_request_parseFromJSON(cJSON *update_sm_context_requestJSON)
{
    ...
    if (!json_data_local_nonprim) {
        log_error("OpenAPI_sm_context_update_data_parseFromJSON failed [json_data]");
        goto end;
    }
    }
    ...
    log_assert(decoded_str_binary_data_n1_sm_message);
    if (!cJSON_IsString(binary_data_n1_sm_message)) {
        log_error("OpenAPI_update_sm_context_request_parseFromJSON() failed [binary_data_n1_sm_message]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_sm_information);
    if (!cJSON_IsString(binary_data_n2_sm_information)) {
        log_error("OpenAPI_update_sm_context_request_parseFromJSON() failed [binary_data_n2_sm_information]");
        goto end;
    }
    ...
    log_assert(decoded_str_binary_data_n2_sm_information_ext1);
    if (!cJSON_IsString(binary_data_n2_sm_information_ext1)) {
        log_error("OpenAPI_update_sm_context_request_parseFromJSON() failed [binary_data_n2_sm_information_ext1]");
        goto end;
    }
...
OpenAPI_update_sm_context_request_t *OpenAPI_update_sm_context_request_copy(OpenAPI_update_sm_context_request_t *dst, OpenAPI_update_sm_context_request_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_update_sm_context_request_convertToJSON() failed");
        return NULL;
    }
