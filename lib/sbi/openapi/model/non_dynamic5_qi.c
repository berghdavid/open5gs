...
)
{
    ...
    log_assert(non_dynamic5_qi_local_var);
...
cJSON *OpenAPI_non_dynamic5_qi_convertToJSON(OpenAPI_non_dynamic5_qi_t *non_dynamic5_qi)
{
    ...
    if (non_dynamic5_qi == NULL) {
        log_error("OpenAPI_non_dynamic5_qi_convertToJSON() failed [NonDynamic5Qi]");
        return NULL;
    }
    ...
    if (cJSON_AddNumberToObject(item, "priorityLevel", non_dynamic5_qi->priority_level) == NULL) {
        log_error("OpenAPI_non_dynamic5_qi_convertToJSON() failed [priority_level]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "averWindow", non_dynamic5_qi->aver_window) == NULL) {
        log_error("OpenAPI_non_dynamic5_qi_convertToJSON() failed [aver_window]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "maxDataBurstVol", non_dynamic5_qi->max_data_burst_vol) == NULL) {
        log_error("OpenAPI_non_dynamic5_qi_convertToJSON() failed [max_data_burst_vol]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "extMaxDataBurstVol", non_dynamic5_qi->ext_max_data_burst_vol) == NULL) {
        log_error("OpenAPI_non_dynamic5_qi_convertToJSON() failed [ext_max_data_burst_vol]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "cnPacketDelayBudgetDl", non_dynamic5_qi->cn_packet_delay_budget_dl) == NULL) {
        log_error("OpenAPI_non_dynamic5_qi_convertToJSON() failed [cn_packet_delay_budget_dl]");
        goto end;
    }
    }
    ...
    if (cJSON_AddNumberToObject(item, "cnPacketDelayBudgetUl", non_dynamic5_qi->cn_packet_delay_budget_ul) == NULL) {
        log_error("OpenAPI_non_dynamic5_qi_convertToJSON() failed [cn_packet_delay_budget_ul]");
        goto end;
    }
    }
...
OpenAPI_non_dynamic5_qi_t *OpenAPI_non_dynamic5_qi_parseFromJSON(cJSON *non_dynamic5_qiJSON)
{
    ...
    if (!cJSON_IsNumber(priority_level)) {
        log_error("OpenAPI_non_dynamic5_qi_parseFromJSON() failed [priority_level]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(aver_window)) {
        log_error("OpenAPI_non_dynamic5_qi_parseFromJSON() failed [aver_window]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(max_data_burst_vol)) {
        log_error("OpenAPI_non_dynamic5_qi_parseFromJSON() failed [max_data_burst_vol]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(ext_max_data_burst_vol)) {
        log_error("OpenAPI_non_dynamic5_qi_parseFromJSON() failed [ext_max_data_burst_vol]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(cn_packet_delay_budget_dl)) {
        log_error("OpenAPI_non_dynamic5_qi_parseFromJSON() failed [cn_packet_delay_budget_dl]");
        goto end;
    }
    }
    ...
    if (!cJSON_IsNumber(cn_packet_delay_budget_ul)) {
        log_error("OpenAPI_non_dynamic5_qi_parseFromJSON() failed [cn_packet_delay_budget_ul]");
        goto end;
    }
    }
...
OpenAPI_non_dynamic5_qi_t *OpenAPI_non_dynamic5_qi_copy(OpenAPI_non_dynamic5_qi_t *dst, OpenAPI_non_dynamic5_qi_t *src)
{
    ...
    if (!item) {
        log_error("OpenAPI_non_dynamic5_qi_convertToJSON() failed");
        return NULL;
    }
